...
export const BENCHMARK_SCRIPTS: BenchmarkScript[] = [
  ...
  {
    path: "tests/benchmarks/competitive-workload-replica.test.ts",
    label: "COMPETITIVE 9-WORKLOAD REPLICA",
    shortLabel: "Competitive",
    level: 0,
    section: "baseline",
    intensity: "medium",
    estimatedMs: 15_000,
    desc: "Replicates the exact 9 external benchmark workloads under 8 parallel workers.",
    strategy: "all",
    tags: ["network", "cpu"],
    metricCategory: "throughput",
  },
  {
    path: "tests/benchmarks/middleware-flamegraph.test.ts",
    label: "MIDDLEWARE FLAMEGRAPH PROFILER",
    shortLabel: "Flamegraph",
    level: 2,
    section: "internals",
    intensity: "low",
    estimatedMs: 8_000,
    desc: "Measures layer-by-layer middleware execution costs from edge to database.",
    strategy: "all",
    tags: ["cpu", "security"],
    metricCategory: "latency",
  },
  {
    path: "tests/benchmarks/event-loop-lag.test.ts",
    label: "EVENT LOOP LAG & SATURATION",
    shortLabel: "EventLoop",
    level: 2,
    section: "internals",
    intensity: "medium",
    estimatedMs: 10_000,
    desc: "Measures event loop delay and microtask drain during continuous write bursts.",
    strategy: "all",
    tags: ["cpu", "memory"],
    metricCategory: "latency",
  },
  ...
  },
  {
    ...
    intensity: "high",
    estimatedMs: 60_000,
    desc: "Measures image resizing, SHA-256 media hashing, metadata extraction efficiency, derivative fan-out per uploaded image (SIZES ladder, asserted), and duplicate-upload cost with zero rewrites.",
    strategy: "once",
    tags: ["cpu", "memory"],
    metricCategory: "latency",
  },
  ...
  {
    path: "tests/benchmarks/graphql-cache-hit.test.ts",
    label: "GraphQL Response Cache Hit",
    shortLabel: "GQL Cache",
    level: 2,
    section: "api",
    intensity: "low",
    estimatedMs: 10_000,
    desc: "L1 response cache: cold-query vs cache-hit latency verification.",
    strategy: "all",
    tags: ["network"],
    metricCategory: "latency",
  },
