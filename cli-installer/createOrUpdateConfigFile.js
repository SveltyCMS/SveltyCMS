...
export async function createOrUpdateConfigFile(configData) {
	...
	const privateConfigContent = `
        ...
        export const privateEnv = createPrivateConfig({
            ...
            SMTP_PORT: ${configData.email?.SMTP_PORT || 587},
            ...
            USE_REDIS: ${configData.system?.USE_REDIS === 'false'},
            REDIS_HOST: '${configData.system?.REDIS_HOST || ''}', // The hostname or IP address of your Redis server.
            REDIS_PORT: ${configData.system?.REDIS_PORT || 6379}, // The port number of your Redis server.
            REDIS_PASSWORD: '${configData.system?.REDIS_PASSWORD || ''}', // The password for your Redis server (if any).

            // Enable Google OAuth (optional).
            USE_GOOGLE_OAUTH: ${configData.system?.USE_GOOGLE_OAUTH === 'false'},
            ...
            // Mapbox (optional).
            USE_MAPBOX: ${configData.system?.USE_MAPBOX === 'false'},
	...
	const publicConfigContent = `
        ...
        export const publicEnv = createPublicConfig({
            ...
            AVAILABLE_CONTENT_LANGUAGES: ${JSON.stringify(configData.system?.AVAILABLE_CONTENT_LANGUAGES || ['en'])},
            ...
            AVAILABLE_SYSTEM_LANGUAGES: ${JSON.stringify(configData.system?.AVAILABLE_SYSTEM_LANGUAGES || ['en'])},
