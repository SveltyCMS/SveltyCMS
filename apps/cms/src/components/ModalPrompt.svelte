...
<div class="space-y-4">
	...
	<div class="flex justify-end gap-2 pt-2">
		<button type="button" class="btn preset-outlined-surface-500" onclick={onCancel}> Cancel </button>
		<button type="button" class="btn preset-filled-primary-500" onclick={onConfirm}> Confirm </button>
	</div>
</div>
