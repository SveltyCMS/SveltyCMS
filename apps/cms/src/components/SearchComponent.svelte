...
<script lang="ts">
	...
	import { getEditDistance } from '@shared/utils/utils';
	...
	// Stores
	import { isSearchVisible, globalSearchIndex, triggerActionStore } from '@shared/utils/globalSearchIndex';
	import type { SearchData } from '@shared/utils/globalSearchIndex';
	...
	>
		...
		<div class="relative w-full max-w-xl pointer-events-auto">
			<input
				...
				class="input w-full rounded-lg preset-tonal-surface-500"
				autocomplete="off"
			/>
