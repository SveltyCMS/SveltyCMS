<!-- 
@file shared/components/src/system/builder/AddWidget.svelte
@component Add widget component for the system builder
-->
	...
	{:else}
		<div class="flex-col items-center justify-center overflow-auto">
			...
			<div class="w-100 mx-2 mb-2 flex justify-between gap-2">
				...
				<button class="preset-filled-secondary-500 btn dark:preset-outlined-secondary-500" onclick={handleWidgetCancel}>Cancel</button>
			</div>
