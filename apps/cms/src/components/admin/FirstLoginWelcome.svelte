<!--
@file shared/components/src/admin/FirstLoginWelcome.svelte
@component Welcome screen for admin users on their first login after setup
...
<script lang="ts">
	...
	import Button from '@cms/components/system/buttons/Button.svelte';
	// Utils
