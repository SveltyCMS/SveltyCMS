...
import type { Role, Token, User } from '@shared/database/auth/types'; // Import the actual types
import type { DatabaseAdapter, Theme } from '@shared/database/dbInterface'; // Ensure correct import path
