...
<script lang="ts">
	...
	// activeTab removed - this component now only shows widgets
...
{:else}
	...
	<div class="grid grid-cols-2 gap-4 md:grid-cols-4" data-testid="widget-stats">
		...
		<!-- Custom Widgets -->
		<div class="relative rounded-lg bg-yellow-50 p-4 shadow-sm transition-all hover:bg-yellow-100 dark:bg-yellow-900/20 dark:hover:bg-yellow-900/30">
			<div class="flex items-center gap-3">
	...
	<div class="mb-12 grid grid-cols-1 gap-4 lg:grid-cols-2" data-testid="widget-grid">
		{#if filteredWidgets.length === 0}
			<div class="col-span-full rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 p-12 text-center dark:border-gray-600 dark:bg-gray-800">
