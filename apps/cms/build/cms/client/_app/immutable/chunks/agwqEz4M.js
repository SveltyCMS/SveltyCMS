...
import { p as Q, z as R, b as S, d as U, c as n, s as q, r as l, t as u, g as i, u as A, a as V, f as N } from './DrlZFkx8.js';
...
function ce(B, e) {
	...
	const E = A(() => Y(e.field)),
		...
		x = A(() => F[e.field.variant] || F.default);
	let v = U(!1);
	R(() => {
		S(v, e.field.collapsed || !1, !0);
	});
	function J() {
		e.field.collapsible && S(v, !i(v));
	}
	function G(a) {
		(a.key === 'Enter' || a.key === ' ') && (a.preventDefault(), J());
	}
	var k = ie(),
		K = n(k);
	{
		...
		b(K, (a) => {
			(e.field.groupTitle || e.field.collapsible) && a(H);
		});
	}
	var p = q(K, 2),
		I = n(p);
...
//# sourceMappingURL=agwqEz4M.js.map
