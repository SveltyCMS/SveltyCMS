...
function V(k, a) {
	O(a, !0);
	const S = L(a, 'format', 3, 'medium'),
		T = u(() => (typeof document < 'u' && document.documentElement.lang) || 'en-US'),
		F = u(() => {
	...
	var N = b(_, 2);
	{
		var R = (t) => {
			...
			(d(e),
				v(() => {
					(U(e, 1, E(r(p))), h(e, 'aria-label', `Time context: ${r(i) ?? ''}`), x(n, r(i)));
				}),
				y(t, e));
		};
		w(N, (t) => {
	...
	(d(l),
		v(() => {
			(h(l, 'title', r(C)), x(I, r(F)));
		}),
		y(k, l),
		P());
}
export { V as default };
//# sourceMappingURL=wSiCarUI.js.map
