...
export const options = {
	...
	async: false,
	csp: {"mode":"nonce","directives":{"default-src":["self"],"worker-src":["self","blob:"],"connect-src":["self","https://*.iconify.design","https://*.simplesvg.com","https://*.unisvg.com","https://code.iconify.design","https://raw.githubusercontent.com","wss:","ws:"],"font-src":["self","data:"],"img-src":["self","data:","blob:","https://*.iconify.design","https://*.simplesvg.com","https://*.unisvg.com","https://placehold.co","https://api.qrserver.com","https://github.com","https://raw.githubusercontent.com"],"object-src":["none"],"script-src":["self","unsafe-inline","unsafe-eval","blob:","https://*.iconify.design","https://code.iconify.design"],"style-src":["self","unsafe-inline","https://*.iconify.design"],"base-uri":["self"],"form-action":["self"],"upgrade-insecure-requests":false,"block-all-mixed-content":false},"reportOnly":{"upgrade-insecure-requests":false,"block-all-mixed-content":false}},
...
export async function get_hooks() {
	...
	let reroute;
	let transport;
	({ reroute, transport } = await import("../../../src/hooks/index.ts"));
