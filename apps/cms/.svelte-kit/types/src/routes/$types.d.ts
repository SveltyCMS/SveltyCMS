...
type LayoutRouteId = RouteId | "/" | "/[language]" | "/[language]/[...collection]" | "/config" | "/config/accessManagement" | "/config/collectionbuilder" | "/config/collectionbuilder/[action]/[...contentPath]" | "/config/configurationManager" | "/config/import-export" | "/config/system-health" | "/config/systemsetting" | "/config/themeManagement" | "/config/widgetManagement" | "/dashboard" | "/email-previews" | "/graphql-test" | "/login" | "/login/oauth" | "/mediagallery" | "/mediagallery/uploadMedia" | "/user" | null
type LayoutParams = RouteParams & { language?: string; collection?: string; action?: string; contentPath?: string }
