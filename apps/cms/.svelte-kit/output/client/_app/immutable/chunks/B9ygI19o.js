	...
	Tt = (e) => {
		...
		return (
			...
			((typeof FormData == 'function' && e instanceof FormData) ||
				(T(e.append) && ((t = se(e)) === 'formdata' || (t === 'object' && T(e.toString) && e.toString() === '[object FormData]'))))
		);
	},
...
const nt = { silentJSONParsing: !0, forcedJSONParsing: !0, clarifyTimeoutError: !1 },
	...
	fn = Object.freeze(
		Object.defineProperty(
			{ __proto__: null, hasBrowserEnv: Ee, hasStandardBrowserEnv: cn, hasStandardBrowserWebWorkerEnv: ln, navigator: me, origin: un },
			Symbol.toStringTag,
			{ value: 'Module' }
		)
	),
	...
	function t(n, r, s, i) {
		...
		return (
			...
			d
				...
				: ((!s[o] || !a.isObject(s[o])) && (s[o] = []), t(n, r, s[o], i) && a.isArray(s[o]) && (s[o] = hn(s[o])), !c)
		);
	}
...
`
					...
					.forEach(function (o) {
						((s = o.indexOf(':')),
							...
							!(!n || (t[n] && yn[n])) && (n === 'set-cookie' ? (t[n] ? t[n].push(r) : (t[n] = [r])) : (t[n] = t[n] ? t[n] + ', ' + r : r)));
					}),
			t
		);
	},
...
const ne = (e, t, n = 3) => {
	...
	Le =
		...
		(...t) =>
			a.asap(() => e(...t)),
	An = R.hasStandardBrowserEnv
		? ((e, t) => (n) => ((n = new URL(n, R.origin)), e.protocol === n.protocol && e.host === n.host && (t || e.port === n.port)))(
				new URL(R.origin),
				...
				('onloadend' in p
					...
					(p.ontimeout = function () {
						...
						(s.timeoutErrorMessage && (O = s.timeoutErrorMessage),
							r(new y(O, N.clarifyTimeoutError ? y.ETIMEDOUT : y.ECONNABORTED, e, p)),
							(p = null));
					}),
			...
			try {
				...
				throw (
					...
					F && F.name === 'TypeError' && /Load failed|fetch/i.test(F.message)
						? Object.assign(new y('Network Error', y.ERR_NETWORK, u, z), { cause: F.cause || F })
				...
				function (r) {
					return (
						st(r) ||
							...
							r &&
								r.response &&
								((r.response.data = fe.call(e, e.transformResponse, r.response)), (r.response.headers = A.from(r.response.headers)))),
						Promise.reject(r)
					);
				}
			)
...
ae.transitional = function (t, n, r) {
	...
	return (i, o, c) => {
		...
		return (
			n && !$e[o] && (($e[o] = !0), console.warn(s(o, ' has been deprecated since v' + n + ' and will be removed in the near future'))),
			t ? t(i, o, c) : !0
		);
	};
};
...
` + i)
	...
	_request(t, n) {
		...
		(r !== void 0 &&
			...
			s != null &&
				(a.isFunction(s) ? (n.paramsSerializer = { serialize: s }) : te.assertOptions(s, { encode: _.function, serialize: _.function }, !0)),
			n.allowAbsoluteUrls !== void 0 ||
				(this.defaults.allowAbsoluteUrls !== void 0 ? (n.allowAbsoluteUrls = this.defaults.allowAbsoluteUrls) : (n.allowAbsoluteUrls = !0)),
...
export { w as a };
//# sourceMappingURL=B9ygI19o.js.map
