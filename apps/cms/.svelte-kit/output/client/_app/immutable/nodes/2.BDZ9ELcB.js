...
import { S as I, a as it } from '../chunks/B9MNxn3G.js';
import { a as nt } from '../chunks/C-hhfhAN.js';
		...
		B = $(C);
	{
		var D = (r) => {
			...
			(E(c, 'width: 140px; height: 140px; font-size: 0.9em; animation-duration: 20000ms;'),
				...
				t(c));
			var F = i(c, 2);
			(it(F, { fill: 'red', className: 'absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 h-16 mb-2' }), t(d));
			var x = i(d, 2),
				u = a(x),
				G = a(u, !0);
			t(u);
			...
			(t(j),
				...
				y(
					(s, o, f) => {
						(ot(e, 'lang', nt.contentLanguage), l(G, v.status), l(H, v.url), l(J, s), l(Q, o), l(R, f));
					},
					[() => lt(), () => vt(), () => mt()]
				),
				m(r, e));
...
//# sourceMappingURL=2.BDZ9ELcB.js.map
