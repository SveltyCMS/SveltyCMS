...
function validator(expected) {
	function validate(module, file) {
		...
		for (const key in module) {
			...
			const hint =
				hint_for_supported_files(key, file?.slice(file.lastIndexOf('.'))) ?? `valid exports are ${values.join(', ')}, or anything with a '_' prefix`;
...
const valid_layout_exports = /* @__PURE__ */ new Set(['load', 'prerender', 'csr', 'ssr', 'trailingSlash', 'config']);
