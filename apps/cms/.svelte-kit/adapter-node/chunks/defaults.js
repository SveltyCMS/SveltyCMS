...
const settingsGroups = [
	{
		...
		// Telemetry checks this live
		adminOnly: true,
		// Only admins should see legal/license info
	...
	},
	{
		...
		enabled: false,
		// Disabled: DB settings are bootstrap config in config/private.ts
...
const defaultPrivateSettings = [
	...
	{ key: 'SESSION_CLEANUP_INTERVAL', value: 3e5, description: 'Interval in ms to clean up expired sessions' },
...
export { defaultPrivateSettings as a, defaultPublicSettings as d, getSettingGroup as g, settingsGroups as s };
