...
import { b as dbInitPromise, d as dbAdapter } from '../../../../../chunks/db.js';
import { g as getAllPermissions } from '../../../../../chunks/permissions.js';
import { invalidateRolesCache } from '../../../../../chunks/handleAuthorization.js';
...
const POST = async ({ request, locals }) => {
	...
	try {
		...
		const incomingRoleIds = new Set(roles.map((r) => r._id));
		...
		for (const role of roles) {
			const roleData = { ...role, tenantId: tenantId || void 0 };
...
function validateRoleStructure(role) {
	return (
		...
		(role.isAdmin === void 0 || typeof role.isAdmin === 'boolean') &&
		(role.tenantId === void 0 || typeof role.tenantId === 'string')
	);
}
