import * as server from '../entries/pages/mediagallery/_page.server.ts.js';

export const index = 21;
let component_cache;
export const component = async () => (component_cache ??= (await import('../entries/pages/mediagallery/_page.svelte.js')).default);
export { server };
export const server_id = 'src/routes/mediagallery/+page.server.ts';
export const imports = [
	'_app/immutable/nodes/21.y6o_i9qX.js',
	...
	'_app/immutable/chunks/DtH1sEIR.js',
...
export const stylesheets = ['_app/immutable/assets/21.DkRz48gU.css'];
export const fonts = [];
