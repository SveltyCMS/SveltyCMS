...
- [🏗️ Collection Builder](/docs/guides/collection-builder) - Build content structures

### Developer Documentation (How It Works)

- [⚙️ Installation & Setup](/docs/installation) - Automated installer explained
- [🔐 Authentication System](/docs/architecture/authentication) - Security implementation
- [⚡ Cache System](/docs/architecture/cache-system) - Dual-layer caching (Redis + MongoDB)
- [⚙️ System Settings](/docs/guides/system-settings) - Configuration management
- [📡 API Reference](/docs/api) - Complete API documentation
- [🧩 Widget Architecture](/docs/widgets/widget-architecture) - Modern widget system
