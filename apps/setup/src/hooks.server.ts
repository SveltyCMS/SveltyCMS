 ...
 *
 * IMPORTANT: Do NOT import from apps/cms/ here - it causes Vite to parse
 * CMS files and their tsconfig, which breaks when CMS hasn't been synced.
 */
...
// --- MIDDLEWARE SEQUENCE ---
// Setup wizard only needs the setup handler
const middleware: Handle[] = [handleSetup];
