<!--
@file apps/setup/src/routes/setup/SetupHeader.svelte
		...
		<div class="flex shrink-0 items-center gap-1 sm:gap-4">
			...
			<div class="language-selector relative">
				<Menu positioning={{ placement: 'bottom-end', gutter: 10 }}>
					<Menu.Trigger
						class="preset-outlined-surface-500 btn rounded px-2 py-1 flex items-center gap-2"
						title={m.applayout_systemlanguage?.() || 'Change system language'}
					>
