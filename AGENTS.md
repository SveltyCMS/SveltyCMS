...
title: "AGENTS.md"
path: "AGENTS"
description: "Comprehensive guidance for AI Coding Assistants working with SveltyCMS"
updated: "2026-07-02"
---
...
- [ ] No discrediting language (see prohibited terms above)
...
- Native addons (e.g., `argon2`, `sharp`) cannot compile without Python/build tools, halting the entire install
