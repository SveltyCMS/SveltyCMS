---
path: 'docs/database/Performance_Architecture.mdx'
...
**Method:** `createIndexes(model, schema)`
**Lines:** 235-333
...
- `/src/databases/CacheService.ts` - Main cache service implementation
...
Layer 2: MongoDB (Persistent)  → Sub-100ms latency, survives restarts
```
...
- **Status:** Fully operational in production
- **Files:**
  - `/src/components/PermissionsSetting.svelte` - Permission UI component
...
- **Cache Hit Rate:** 85-95% (Redis + MongoDB dual-layer)
