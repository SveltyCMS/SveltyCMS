...
| :------------------- | :--------- | :---------- | :------------- | :--------- | :--------------------------- |
| **Cache Hit Rate**   | 92%        | 92%         | 92%            | 92%        | Agnostic L2 infrastructure   |
| **Response Time**    | 0.5ms      | 1.2ms       | 1.8ms          | 0.6ms      | Optimized caching flow       |
| **P99 Latency**      | <10ms      | <15ms       | <12ms          | <0.8ms     | Consistent performance       |
| **Storage Engine**   | WiredTiger | InnoDB      | RocksDB/B-Tree | SQLite WAL | Data integrity and speed     |
| **JSON Performance** | $$$        | $$          | $$$            | $          | `jsonb` indexing in PG/Mongo |
| **Scaling**          | Sharding   | Replication | Clustering     | Embedded   | Future-proof growth          |
