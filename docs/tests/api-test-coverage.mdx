...
| --------------------- | ------------------------------------------------------------------------------- |
| API Dispatcher        | `tests/unit/api/*.test.ts`, `tests/unit/hooks/api-requests.test.ts`             |
...
> **Note**: API test coverage documentation is actively being expanded. See the [Test Status dashboard](./test-status.mdx), [Hook Test Coverage](./hook-test-coverage.mdx), and [E2E Coverage Matrix](./e2e-coverage-matrix.mdx) for route-level detail.
