...
> **Total Tests:** ~615  
> **Pass Rate:** ~65% (403 passing, 172 failing, 40 skipped)
...
> [!NOTE]
> **Coming Soon**: Parallel testing against multiple databases
> 
> ```yaml
> strategy:
>   matrix:
...
- **[Test Status Report](./test-status.mdx)** - Current pass/fail rates, known issues
- **[E2E Testing Guide](./e2e-testing-guide.mdx)** - Playwright setup and best practices
- **[Git Workflow & CI/CD](./git-workflow.mdx)** - GitHub Actions automation

### Coverage Reports

- **[API Test Coverage](./api-test-coverage.mdx)** - REST API endpoint testing (460+ tests)
- **[Hook Test Coverage](./hook-test-coverage.mdx)** - Middleware hooks (11 hooks, 485+ tests)
- **[Store Test Coverage](./store-test-coverage.mdx)** - Svelte stores (system, UI, loading)
- **[Widget Test Coverage](./widget-test-coverage.mdx)** - Widget validation and security
- **[Utility Test Coverage](./utility-test-coverage.mdx)** - Helper functions and utilities

### Specific Test Documentation

- **[API Test Summary](./api-test-summary.mdx)** - Quick API test overview
- **[User API Tests](./user-api-tests.mdx)** - User management endpoint tests
- **[Database Tests](./database-tests.mdx)** - Database adapter testing
...
1. **Follow existing patterns**
   - See [Hook Test Coverage](./hook-test-coverage.mdx) for examples
...
- [Contributing Guide](../contributing/index.mdx)
- [Development Setup](../getting-started/development.mdx)
