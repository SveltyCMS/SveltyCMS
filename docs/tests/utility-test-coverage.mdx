...
| --------------------------------------- | ------ | ------------------------------------------------ | ------------------ |
| `tests/bun/utils/dateUtils.test.ts`     | 18     | Type Guards, Conversions, Formatting, Edge Cases | ✅ Passing         |
| `tests/bun/utils/crypto.test.ts`        | 25     | Password Hashing, Tokens, Checksums, Security    | ✅ Passing         |
| `tests/bun/utils/errorHandling.test.ts` | 22     | AppError, Type Guards, Messages, Wrapping        | ✅ Passing         |
| `tests/bun/utils/languageUtils.test.ts` | 11     | Basic, Common Languages, Edge Cases              | ✅ Passing         |
...
bun test tests/bun/utils/dateUtils.test.ts
bun test tests/bun/utils/errorHandling.test.ts
bun test tests/bun/utils/languageUtils.test.ts
```
