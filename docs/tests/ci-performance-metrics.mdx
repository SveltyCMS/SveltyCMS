...
- **Trend Indicators**: Every report includes a **Traffic Light Trend** (🔴/🟢/⚪) comparing the current run to the previous run.
- **SQLite Backend**: Summary results are persisted in `history.sqlite` for professional long-term analysis.
