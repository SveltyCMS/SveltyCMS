...
Shared code: `tests/unit/utils/mock-event.ts` + `rbac-matrix.ts` (see [API Unit Helpers](./api-unit-helpers.mdx)).
...
Inventory & tiers: [headless-test-inventory.mdx](./headless-test-inventory.mdx).
