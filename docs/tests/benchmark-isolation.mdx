...
description: "Filesystem and GraphQL boundaries between user live collection data and benchmark/test fixtures (June 2026)."
...
| `integration` | `scripts/run-integration-tests.ts`                    | CI integration fixture                 |
