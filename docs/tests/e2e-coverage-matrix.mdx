...
| `/config/design-system` | Canonical Appearance + Live Preview      | `config/design-system.spec.ts`, `appearance.spec.ts`, `appearance-golden.spec.ts` | `appearance`    | ✅     |
| `/config/appearance`    | Redirect → design-system (tab preserved) | `config/design-system.spec.ts`                                                    | `appearance`    | ✅     |
| `/config/workflows`     | —                                        | —                                                                                 | —               | ❌     |
...
| `content`    | _(merged into builder golden)_         | auth-setup |
...
| `builder`           | `collection-builder/builder.spec.ts` only (shell + golden) | auth-setup |
