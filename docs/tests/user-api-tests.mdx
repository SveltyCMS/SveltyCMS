...
> **UI control map (profile + admin):** see [routes/user.mdx](./routes/user.mdx) for the 1:1 unit/integration/E2E plan for `/user`.
...
- [API Documentation](/docs/reference/api/auth.mdx) - User API reference
- [Security Architecture](../reference/security/index.mdx) - Fail-Closed model details
