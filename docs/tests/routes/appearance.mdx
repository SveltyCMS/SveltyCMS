...
| Piece                          | Role                                                        |
| ------------------------------ | ----------------------------------------------------------- |
| `/config/design-system`        | **Canonical** workspace (Appearance + Live Preview)         |
...
| `/config/appearance`           | Redirect → design-system (preserves `?tab=`)                |
...
| Live Preview + legacy redirect | —                   | ✅ design-system.spec |
