...
- commerce-orders, commerce-inventory (freemium; empty `{ available: false }` without the ecommerce preset)
...
- [dashboard-license-gate.test.ts](../../../tests/unit/api/dashboard-license-gate.test.ts)
