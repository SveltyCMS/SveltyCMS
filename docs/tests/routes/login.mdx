...
- [login.spec.ts](../../../tests/e2e/routes/login/login.spec.ts)
- [signup.spec.ts](../../../tests/e2e/routes/login/signup.spec.ts)
- [oauth.spec.ts](../../../tests/e2e/routes/login/oauth.spec.ts)
- [accessibility.spec.ts](../../../tests/e2e/routes/login/accessibility.spec.ts)
- [branding.spec.ts](../../../tests/e2e/routes/login/branding.spec.ts)
- [extended-auth.spec.ts](../../../tests/e2e/routes/login/extended-auth.spec.ts)
