...
See [Widget Architecture](/docs/architecture/widgets/architecture) for details.
...
- [Widget Architecture](/docs/architecture/widgets/architecture) - Modern widget system design
