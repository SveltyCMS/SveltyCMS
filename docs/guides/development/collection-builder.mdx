---
path: "docs/guides/development/collection-builder.mdx"
...
See [Widget Architecture](/docs/guides/development/widgets/development) for details.
...
- See [Widget Management](/docs/guides/development/widgets/index)
...
- [Widget Architecture](/docs/guides/development/widgets/development) - Modern widget system design
- [Widget Management](/docs/guides/development/widgets/index) - Managing widgets

### Guides

- [Smart Importer](/docs/guides/content/smart-importer) - Migrating legacy content into collections
- [Permission System](/docs/guides/configuration/access-management) - Roles and permissions
- [Multi-Tenant Setup](/docs/architecture/multi-tenancy) - Tenant configuration
