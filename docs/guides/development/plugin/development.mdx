...
| WebMCP                            | MCP server for AI assistants         | [webmcp.mdx](/src/plugins/webmcp/webmcp.mdx)                               |
| Cookie Consent                    | GDPR cookie banner                   | [cookie-consent.mdx](/src/plugins/cookie-consent/cookie-consent.mdx)       |
| Redirect Manager                  | Auto-redirect + MV caching           | [redirect-manager.mdx](/src/plugins/redirect-manager/redirect-manager.mdx) |
| Stripe                            | Payment processing                   | [stripe.mdx](/src/plugins/stripe/stripe.mdx)                               |
...
- [AI Integration](../../ai-integration.mdx) — Widget scaffolder + behavioral learning
