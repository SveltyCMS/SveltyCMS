...
- [Webhook Integrations](../../api/system.mdx#3-webhooks-integrations): For outbound events to third-party services.
- **[System Settings](../../api/system.mdx)**: Manage SMTP credentials.
