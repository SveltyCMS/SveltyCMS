...
Navigate to **Config** -> **System Settings** -> **Privacy & GDPR**.
...
SveltyCMS includes a `CookieConsent` mechanism (roadmap) that blocks non-essential scripts until explicit consent is given, complying with the ePrivacy Directive.
