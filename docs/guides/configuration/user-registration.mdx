...
- [Admin User Management](/docs/reference/architecture/admin-user-management.mdx) - Managing users and permissions
- [Access Management](/docs/guides/configuration/access-management.mdx) - Roles and permissions system
- [Email System](/docs/guides/configuration/email-system.mdx) - SMTP configuration and email templates
- [Two-Factor Authentication](/docs/reference/api/auth.mdx) - Enhanced security setup
- [Multi-Tenant Configuration](/docs/reference/architecture/multi-tenancy.mdx) - Tenant isolation setup

---

> **Note on SMTP**: If SMTP is not configured, invitation tokens and password reset links are
> **not sent via email**. The admin must copy the token/link from the server terminal or share
> it manually. See the [Email System Guide](/docs/guides/configuration/email-system.mdx)
> for details.
