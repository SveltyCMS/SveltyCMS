...
The following test (`tests/e2e/setup-wizard.spec.ts`) demonstrates how to automate the multi-step configuration, including handling modal portals and cookie consent banners:
