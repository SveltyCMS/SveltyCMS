...
This is how an administrator adds a locale for the admin chrome. How catalogs are compiled is [Language architecture](../../reference/architecture/language-architecture.mdx). Entry translations are a separate path: [Multilingual data loading](../../reference/architecture/multilingual-data-loading.mdx).
