...
Fresh installs seed the active theme with the **Corporate** workspace from `/src/themes/corporate.json`:
...
**Example — Corporate (default on install)** (`/src/themes/corporate.json`):
