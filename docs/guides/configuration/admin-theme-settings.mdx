...
3. SveltyCMS instantly generates full 50–950 tint and shade scales via native CSS `color-mix()` algorithms, automatically binding semantic variables (`--admin-bg-*`, `--admin-border-*`).
