...
For a full visual generator (typography, edges, etc.), use [Skeleton Theme Create](https://themes.skeleton.dev/themes/create) and import the JSON below.

### Export / Import

- **Export Theme JSON**: Downloads the current theme (density, variant, features, custom CSS) as a portable JSON file.
- **Import**: Paste SveltyCMS theme JSON or [Skeleton.dev](https://themes.skeleton.dev/themes/create) theme exports in the **Palette & Import** tab.
