...
- **CI/CD Integration**: Every release is audited against the [Performance Benchmarks](../../project/benchmarks/README.mdx) to prevent regressions in latency or bundle size.
