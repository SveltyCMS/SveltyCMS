...
This is the screen an administrator uses. How those values are loaded and cached is [System settings architecture](../../reference/architecture/system-settings-architecture.mdx).
