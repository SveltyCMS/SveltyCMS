---
path: "docs/guides/configuration/maintenance.mdx"
...
This page is the background watchdog: cache compaction, index checks, and trash purge. Emails and webhooks that you configure are [Automations](../content/automations.mdx).
...
- [System State Architecture](../../reference/architecture/state-management.mdx)
- [Enterprise Monitor Dashboard](./enterprise-monitor.mdx)
