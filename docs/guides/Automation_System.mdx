---
path: 'docs/guides/Automation_System.mdx'
...
| `src/services/automation/eventBus.ts`          | Singleton event bus with wildcard listeners |
| `src/services/automation/automationService.ts` | CRUD + execution engine                     |
