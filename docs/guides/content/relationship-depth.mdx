...
The relationship population feature allows you to control how deeply related content is fetched when reading entries from the API. This significantly reduces payload size and improves performance when you only need ID references instead of full related documents.
