...
This is the task: create and edit a collection in the admin. How that save is compiled is [Collection builder architecture](../../reference/architecture/collection-builder-architecture.mdx).
