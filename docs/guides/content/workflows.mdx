---
path: "docs/guides/content/workflows.mdx"
...
- **[Automation System](./automations.mdx)**: For triggering transitions via events.
- **[Content System Architecture](../../reference/architecture/index.mdx)**: For understanding node structures.
- **[Access management](../configuration/access-management.mdx)**: Roles that may run a transition.
