...
The planned MariaDB adapter will be optimized for relational data integrity and high-concurrency connection pooling. For current performance metrics, please refer to the [Performance Benchmarks](/docs/project/benchmarks/index) document.
