...
- **[MariaDB Implementation](./mariadb-implementation.mdx)** 🟡 **Planned** — High-concurrency pooling via `mysql2`, optimized relational schemas.
...
graph TD
    ...
    subgraph Adapters["3 Production + 1 Planned"]
        H[(MongoDB)]
        I[(MariaDB 🟡 Planned)]
        J[(PostgreSQL)]
        K[(SQLite)]
...
| ---------------------------------- | ------ | ---------- | ---------- | ------- |
| Schema-aware row conversion        | ✅     | ✅         | 🟡 Planned | N/A     |
| Ring-buffer result pool (64 slots) | ✅     | ✅         | 🟡 Planned | ✅      |
| Conditions array pool (32 slots)   | ✅     | ✅         | 🟡 Planned | N/A     |
| Fused mapQuery (no IR objects)     | ✅     | ✅         | 🟡 Planned | ✅      |
| for...in (zero Object.entries)     | ✅     | ✅         | 🟡 Planned | ✅      |
| Pre-allocated meta object          | ✅     | ✅         | 🟡 Planned | ✅      |
