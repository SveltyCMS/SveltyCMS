---
path: "docs/reference/components/fields.mdx"
...
> [!NOTE]
> For the full handshake architecture (cookies, security, multi-tenancy), see [Live Preview Architecture](/docs/reference/architecture/live-preview-architecture.mdx).
