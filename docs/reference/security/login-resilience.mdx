---
path: "docs/reference/security/login-resilience.mdx"
title: Login Resilience & Recovery
...
- Now: 10 seconds (module-level constant `AUTH_SERVICE_TIMEOUT_MS`)
...
- [Database Health Checks](../database/database-resilience.mdx)
