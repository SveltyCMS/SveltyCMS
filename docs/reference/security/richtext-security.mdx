---
path: "docs/reference/security/richtext-security.mdx"
...
### 6. Link Extension Protocol Hardening (June 2026) ✅
...
- [Content Security Policy Guide](/docs/reference/security/content-security-policy.mdx)
