...
**Allowed raw `console.*` (not app runtime):** CLI entrypoints (e.g. smart-importer CLI), Vite plugins, compile/benchmark sandbox reports, and the logger implementation itself.
