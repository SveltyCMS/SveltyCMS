...
| Tier                  | Scope                    | Purpose                                           |
| --------------------- | ------------------------ | ------------------------------------------------- |
| **Per-IP bucket**     | Single IP address        | Prevents a single client from flooding the server |
| **Per-tenant bucket** | All traffic for a tenant | Prevents one noisy tenant from starving others    |
