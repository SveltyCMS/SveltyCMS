...
description: "Complete architecture and administrator guide for Access Management, including Users, Roles, Permissions, and Website Tokens."
order: 4
...
- [Authentication Architecture](../security/authentication-system.mdx)
- [API Access Tokens](../api/tokens.mdx)
- [Audit Log System](./user-management-overview.mdx#4-audit-log-system-auditlogservicets)
- [Behavioral Learning Engine](./behavioral-learning.mdx) — Learns from user access patterns to optimize cache and navigation
