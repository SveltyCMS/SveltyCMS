---
path: "docs/reference/architecture/behavioral-learning.mdx"
...
| **Self-pruning**         | Score &lt; 0.01 dropped; caps: 5k collections, 20k entries, **10k transitions**/tenant, 1k tenants, 5k prediction-stats |
...
- [Access Management](../../guides/configuration/access-management.mdx) — User roles and tenant isolation; the behavioral engine respects tenant boundaries
- [AI Integration](../../development/ai-integration.mdx) — AI widget scaffolder and hosted MCP knowledge core
- [Marketplace System](./marketplace.mdx) — Plugin ecosystem; the behavioral engine can surface popular plugin categories

- [API Security & Token Hardening](../security/api-security.mdx) — Security model the behavioral engine operates within
