...
| Marketplace          | `marketplace`       | Extensions Marketplace tab  | `icon-park-outline:shopping-bag` | No         | No    |
...
## 🔍 Global Search (Command Palette) {#global-search-command-palette}
...
├──────────────────────────────────────────────────────┤
│  command-palette.ts + global-search-index.svelte.ts  │
