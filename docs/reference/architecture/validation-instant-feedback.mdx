---
path: "docs/reference/architecture/validation-instant-feedback.mdx"
...
- [Enterprise Widget System Architecture](../../development/widgets/architecture.mdx)
- [Validation Store API](../api/index.mdx)
