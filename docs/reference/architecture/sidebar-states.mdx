---
path: "docs/reference/architecture/sidebar-states.mdx"
...
- [Screen Size Store](../../src/stores/screen-size-store.svelte.ts)
- [UI Store Source](../../src/stores/ui-store.svelte.ts)
- [Left Sidebar Component](../../src/components/left-sidebar.svelte)
- [Modal & Dialog System](../../src/utils/modal.svelte.ts)
