...
| Collection           | Role                                                                                          |
| -------------------- | --------------------------------------------------------------------------------------------- |
| `products`           | Catalog: price, SKU, inventory, **variants** (own SKU / price / inventory), categories, media |
| `product_categories` | Nested categories                                                                             |
| `product_reviews`    | Rating + visibility                                                                           |
| `coupons`            | `percentage`, `fixed_cart`, `fixed_product`, `free_shipping`                                  |
...
| `orders`             | Line items, totals, addresses, **status** (see below)                                         |
