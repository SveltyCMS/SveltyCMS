...
### Phase 1: Vite Startup (Build Time) {#restart-phase1}
...
- [Setup Actions](/docs/api/setup.mdx) - Complete setup API reference
- [Collection Management](/docs/api/collections.mdx) - Collection CRUD operations
- [Authentication & Identity](/docs/api/auth.mdx) - User authentication and security

### Database

- [Core Infrastructure](/docs/architecture/database/core-infrastructure.mdx) - Database adapter system
- [MongoDB Methods](/docs/architecture/database/mongodb-implementation) - MongoDB-specific implementation
