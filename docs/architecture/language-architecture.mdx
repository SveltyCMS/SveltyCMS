---
path: "docs/architecture/language-architecture.mdx"
...
### Architecture {#content-language-arch}
...
- **[Widget Development](../guides/development/widgets/index.mdx)** - Creating multilingual widgets
