...
The output of this pipeline is monitored by the **Content System (`src/content/content-service.server.ts`)**, which reconciles the compiled JavaScript modules into the live system state.
...
- [Widget Architecture](/docs/guides/development/widgets/development) - Understanding widget transformation
