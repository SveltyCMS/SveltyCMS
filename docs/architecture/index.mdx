...
```
User Action → Store Update → API Call → Database → Cache Update → Store Update → UI Update
```
...
```
New Feature/
├── routes/api/feature/      # API endpoints
├── components/feature/      # UI components
├── stores/feature.ts        # State management
└── tests/feature/           # Tests
```
