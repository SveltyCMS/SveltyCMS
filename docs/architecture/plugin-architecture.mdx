...
→ **[Plugin Architecture Guide](/docs/guides/development/plugin/architecture.mdx)** — System overview, injection zones, hooks, sandbox, config-page pattern, case studies, and available plugins.

→ **[Plugin Development Guide](/docs/guides/development/plugin/development.mdx)** — Quick start, lifecycle hooks, SSR enrichment, UI slots, migrations, and security boundaries.
