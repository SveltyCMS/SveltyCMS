...
const middleware: Handle[] = [
  ...
  handleCompression, // 2. ESM-Native Streaming Compression
  handleTestIsolation, // 3. ✨ CI ISOLATION (Tenant Routing & Bypass)
  handleStaticAssetCaching, // 4. Dedicated Asset Cache Layer
  handleTurboPipeline, // 5. CONSOLIDATED GATEWAY (State, Setup, CORS)
  handleSecurity, // 6. Firewall & Load Shedding
  handleUserPreferences, // 7. i18n and SSR theme
  handleSetup, // 8. Granular Setup Gate
  handleAuthentication, // 9. Identity & Multi-tenancy
  handleContentInitialization, // 10. Content + Redirects
  handleAuditLogging, // 11. Async Audit Trails
  handleApiRequests, // 12. API Caching (ETags)
  handleTokenResolution, // 13. RBAC Token Replacement
];
