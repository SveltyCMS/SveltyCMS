...
| Feature                    | Drupal    | WordPress         | Strapi    | SveltyCMS                 |
| :------------------------- | :-------- | :---------------- | :-------- | :------------------------ |
| **Authentication**         | UUID only | N/A (centralized) | UUID only | ✅ HMAC + Repo + Cache    |
| **Replay Protection**      | ❌ None   | N/A               | ❌ None   | ✅ 5-min timestamp window |
| **Spoofing Difficulty**    | Easy      | N/A               | Easy      | Hard (multi-layer)        |
| **Rate Limiting**          | Basic     | N/A               | Basic     | ✅ Per-IP + flood alerts  |
| **Version Validation**     | ❌ None   | ❌ None           | ❌ None   | ✅ GitHub cache           |
