---
path: 'docs/architecture/components/EntryList_MultiButton.mdx'
...
The `EntryList_MultiButton` is an enterprise-grade component for managing bulk actions on collection entries with advanced features like action queuing, optimistic UI, and keyboard navigation.
...
- [ScheduleModal Component](./ScheduleModal.mdx)
