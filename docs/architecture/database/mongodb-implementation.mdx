...
### How It Works {#field-selection-how}
...
### Performance Impact {#field-selection-perf}
...
#### Performance Comparison {#streaming-comparison}
...
#### Implementation {#query-hints-impl}
...
#### Usage Examples {#query-hints-usage}
...
### Cursor Pagination {#quick-ref-cursor}
...
### Query Hints {#quick-ref-query-hints}
...
- [Authentication System](/docs/architecture/security/authentication-system) - Auth & session management
...
- [Cache System Architecture](/docs/architecture/cache-system.mdx)
