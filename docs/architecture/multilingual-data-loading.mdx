...
**Why `goto()` instead of `window.location.href`?**

- Preserves SPA behavior (smooth transition)
- Triggers SSR data fetch automatically via `invalidateAll: true`
