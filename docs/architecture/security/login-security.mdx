...
- **A2**: Added programmatic focus to the `#twofa-code` input field using `tick()` when Two-Factor Authentication is required (see [2FA documentation](/docs/architecture/security/authentication-system.mdx#4-advanced-security-features)).
