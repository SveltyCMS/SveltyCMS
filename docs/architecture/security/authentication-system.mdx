---
path: "docs/architecture/security/authentication-system.mdx"
...
API keys use the same hash-keyed credential cache as website tokens (see [Cache System](../cache-system.mdx)):
...
### Security Considerations {#magic-links-security}
...
### Security Considerations {#guest-auth-security}
...
### Security Considerations {#webauthn-security}
...
- [Cache System Architecture](../cache-system.mdx) — Bearer credential cache, tag invalidation, negative Bloom filter
