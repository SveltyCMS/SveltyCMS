...
1.  **⚙️ Configuration as Code:** Every piece of site structure (collections, roles, widget states, etc.) is represented by a version-controllable JSON file in the Git repository. The filesystem is the **source of truth**.
