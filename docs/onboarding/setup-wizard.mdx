...
description: "Short first-run walkthrough: database, admin user, and the moment setup locks."
order: 3
icon: "mdi:wizard-hat"
...
Short first run: pick a database, create the admin, finish. Every option, preset, and validation rule is the [Setup wizard guide](../guides/configuration/setup-wizard.mdx). Install commands are [Getting started](../getting-started.mdx).
