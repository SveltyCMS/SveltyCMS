...
4. **Audit & CI parity**: Run the full check suite and Audit 2.0 matrix (if code changed).

   ```bash
   # Run quality gate (1030+ tests)
...
- [ ] **1030+ Test Suite passes**: All unit and integration tests are green.
- [ ] **Audit 2.0 Budget verified**: No regressions in `enterprise-matrix.ts`.
