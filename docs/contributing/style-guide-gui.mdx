...
| `?tab=themes` …  | Admin workspace themes, presets, features, advanced              |

Legacy `/config/appearance` redirects here (preserves `?tab=`).

See [Admin Theme Settings](../guides/configuration/admin-theme-settings.mdx).
