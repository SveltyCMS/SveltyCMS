...
<div class="variant-filled-surface btn-group flex w-full items-center rounded">
  ...
  <div class="flex items-center">
    <button type="button" class="btn variant-ghost-primary !rounded-none !px-3">
      Select
    </button>
  </div>
</div>
...
<div class="relative w-full rounded-lg border border-surface-300 dark:border-surface-700 ... pb-6 ...">
  ...
  <div class="toolbar flex flex-wrap ... border-b border-surface-300 dark:border-surface-700 ...">
    </div>
...
```svelte
<fieldset>
  <legend class="... " class:!text-error-500={!!error}>
    Select an Option
  </legend>
  </fieldset>
...
{#if show}
  ...
  <div class="fixed left-1/2 top-1/2 z-50 ... rounded-lg bg-white p-6 shadow-xl dark:bg-surface-800">
    </div>
{/if}
```
