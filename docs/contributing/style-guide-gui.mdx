...
- **Container**: `preset-filled-surface-500 btn-group flex w-full items-center rounded`
...
```svelte
<div class="preset-filled-surface-500 btn-group flex w-full items-center rounded">
	<span class="min-w-0 flex-1 truncate p-2 text-left">
		{displayText}
	</span>

	<div class="flex items-center">
		<button type="button" class="btn preset-outlined-primary-500 rounded-none! px-3!"> Select </button>
	</div>
</div>
```
...
- **Primary Action**: `class="... btn preset-filled-primary-500"` (e.g., "Save").
- **Secondary Action**: `class="... btn preset-filled-secondary-500"` (e.g., "YouTube").
- **Tertiary/Brand Action**: `class="... btn preset-filled-tertiary-500"` (e.g., "Add New").
- **Ghost Action**: `class="... btn preset-outlined-surface-500"` (e.g., toolbar buttons).
- **Destructive Action**: `class="... btn preset-outlined-error-500"` or a hover effect `class="... hover:text-error-500 dark:hover:text-error-400"`.
