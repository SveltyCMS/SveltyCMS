...
| **System Utils**   | [Reference](./system-utilities-api.mdx)                     | `locals.cms.system`      | ✅ Complete |
| **Setup API**      | [Reference](./setup-actions-api.mdx)                        | `setupManager`           | ✅ Complete |
| **SCIM v2.0**      | [Reference](./scim-v2-api.mdx)                              | N/A                      | ✅ Complete |
| **SAML SSO**       | [Reference](./saml-sso-api.mdx)                             | N/A                      | ✅ Complete |
| **OpenAPI**        | [Reference](./openapi-spec.mdx)                             | `apiSpecService`         | ✅ Complete |
