...
| :--- | :--- | :--- | :--- |
| **List Schemas** | `/api/collections` | `GET` | `collection:read` |
| **Find Entries** | `/api/collections/{id}` | `GET` | `collection:read` |
| **Get Entry** | `/api/collections/{colId}/{entId}`| `GET` | `collection:read` |
| **Create Entry** | `/api/collections/{id}` | `POST` | `collection:create` |
| **Update Entry** | `/api/collections/{colId}/{entId}`| `PATCH` | `collection:update` |
| **Delete Entry** | `/api/collections/{colId}/{entId}`| `DELETE`| `collection:delete` |
