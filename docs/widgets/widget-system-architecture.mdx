...
```
⚡ 10 core widgets loaded: Checkbox, Date, DateRange, Input, MediaUpload, Radio, Relation, RichText, ...
📦 3 custom widgets loaded: SEO, ColorPicker, Rating
🚀 All 13 widgets loaded Successfully in 45.32ms
```
...
// Results in: ⚠️ Widget "NonExistentWidget" is missing or disabled.
```
...
- ✅ Added to widget functions map
- ✅ Registered in widget registry
- ✅ Available in collections immediately
...
If you see "⚠️ Widget X is missing or disabled":
...
- ✅ **Three Pillars Architecture**: Definition, Input, Display separation
- ✅ **Factory Pattern**: Type-safe widget creation with `createWidget()`
- ✅ **Centralized Registry**: Single source of truth for widgets
- ✅ **Valibot Validation**: Declarative, type-safe validation
- ✅ **MDX Documentation**: Per-widget documentation with mdsvex
- ✅ **Auto-Discovery**: Dynamic loading from file system
- ✅ **Dependency Management**: Automatic dependency checking
- ✅ **Type Safety**: Full TypeScript support with generics
- ✅ **Graceful Fallbacks**: MissingWidget component for errors
