...
1. **📋 Definition** - Widget blueprint and configuration (index.ts)
2. **✏️ Input** - Interactive component for editing (Input.svelte)
3. **👁️ Display** - Lightweight component for viewing (Display.svelte)
