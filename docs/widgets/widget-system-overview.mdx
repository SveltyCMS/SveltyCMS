...
- **🌍 Multilingual**: Built-in support for translated content with app.contentLanguage integration
...
- Widgets automatically read from `app.contentLanguage` singleton
