---
path: 'docs/User_Guide/01_Installation/04-Configuration.mdx'
title: 'Configuration'
...
### 2. GUI Configuration (src/routes/setup/guiConfig.ts)

Controls the admin interface appearance and behavior (moved from `config/guiConfig.ts`):

```typescript
// src/routes/setup/guiConfig.ts
