...
<div class="fixed bottom-0 left-0 right-0 border-t bg-surface-100 p-4 dark:bg-surface-800">
	<div class="mx-auto flex max-w-7xl items-center justify-between gap-4">
		...
		<div class="flex items-center gap-2">
			...
			<button onclick={cancel} class="preset-outlined-surface-500 btn">Cancel</button>
			<button onclick={save} class="preset-filled-primary-500 btn">Save</button>
		</div>
	</div>
</div>
```
...
<div class="flex items-center gap-2">
	...
	<!-- Apply -->
	<button class="preset-filled-success-500 btn" onclick={() => cropToolRef.apply()}> Apply Crop </button>
</div>
```
...
{#if isMobile}
	<div class="fixed bottom-0 left-0 right-0 space-y-3 bg-surface-100 p-3">
		...
		<div class="flex gap-2">
			...
			<button class="preset-filled-primary-500 btn flex-1">Save</button>
		</div>
	</div>
{/if}
```
