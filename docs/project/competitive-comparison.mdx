...
| -------------------------- | ----------------------- | -------------------- | ------------------------------------------ |
| **SveltyCMS (SQLite)**    | **741 RPS**             | **17,900 RPS**       | In-process DB, batch 20, file lock safety |
| **SveltyCMS (MongoDB)**    | **932 RPS**             | **5,100 RPS**        | Native driver, batch 100 full blast       |
| **SveltyCMS (PostgreSQL)** | **354 RPS**             | **6,300 RPS**        | postgres.js pool, batch 50                |
| **SveltyCMS (MariaDB)**    | **388 RPS**             | **9,000 RPS**        | mysql2 pool, batch 20, JSON_SET atomic    |
...
- **Auth pipeline: 1.84ms** — 50% fewer DB queries via innerJoin consolidation, 5% faster.
