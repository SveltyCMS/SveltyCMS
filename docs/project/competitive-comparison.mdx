...
> [!NOTE]
> All SveltyCMS metrics are based on our **[Performance Benchmarks](./benchmarks/README.mdx)** conducted on dedicated Intel hardware. For raw results and methodology, visit the **[Benchmarks page](./benchmarks/README.mdx)**.
