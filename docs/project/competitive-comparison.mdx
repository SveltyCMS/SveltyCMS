...
| :----------------------- | :-------------------------------- | :----------------------------- | :--------------------------------- | :----------------------- | :------------------ |
| **Avg API Read Latency** | **0.38–0.46 ms**                  | 4–12 ms (sub-10 ms co-located) | 3–18 ms (avg ~35 ms in some tests) | 6–25 ms (avg 120–150 ms) | N/A (Git-based)     |
| **Avg GraphQL Latency**  | **0.92–1.38 ms**                  | 15–150+ ms                     | 15–150+ ms                         | ~120–150 ms              | N/A                 |
...
| **Throughput (RPS)**     | **110k–363k RPS** (Full Stack)    | ~900–2,100 RPS (REST/GraphQL)  | Lower (optimized ~ higher)         | 900–1,200 RPS (REST)     | N/A (static/Git)    |
| **Media Upload**         | **0.12 ms** (async/background)    | 100–350 ms                     | 120–400 ms                         | 150–500 ms               | N/A                 |
| **Cold Start**           | **~184–250 ms** (Ready state)     | Variable (Next.js)             | ~5 s                               | ~8 s                     | Very fast (<300 ms) |
| **Bundle Size (Brotli)** | **~1 MB** (Transfer)              | 3–5 MB+                        | Medium/Large                       | Largest                  | <300–500 KB         |
| Auth Latency             | **< 0.4 ms** (3-layer cache)      | Not specified                  | Not highlighted                    | Not highlighted          | Fast (GitHub OAuth) |
| Real-time / Sync         | **Sub-10 ms** (WebSocket/Yjs)     | Good (with config)             | Supports WebSockets                | Limited                  | N/A (Git-based)     |
