...
| :----------------------- | :------------------------------- | :----------------------------- | :--------------------------------- | :----------------------- | :------------------ |
| **Avg API Read Latency** | **0.06 - 0.45 ms** (Ultra-Elite) | 4–12 ms (sub-10 ms co-located) | 3–18 ms (avg ~35 ms in some tests) | 6–25 ms (avg 120–150 ms) | N/A (Git-based)     |
...
| **Avg GraphQL Latency**  | **0.08–0.45 ms** (JIT)           | 15–150+ ms                     | 15–150+ ms                         | ~120–150 ms              | N/A                 |
| **UX Logic Prep**        | **0.05 ms** (Ultra-Elite)        | ~150 ms (React Hydration)      | ~120 ms                            | ~250 ms                  | Fast (Local)        |
| **Middleware Overhead**  | **0.012–0.015 ms** (12 µs p95)   | ~115 µs                        | ~145 µs                            | ~180 µs                  | N/A (browser-based) |
| **Throughput (RPS)**     | **14,000+ RPS** (Content Core)   | ~900–2,100 RPS (REST/GraphQL)  | Lower (optimized ~ higher)         | 900–1,200 RPS (REST)     | N/A (static/Git)    |
