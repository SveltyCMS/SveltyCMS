...
**✅ PASS** _(partial invocation)_ · 1/62 tests · 61 skipped · **sqlite-redis** · standalone run
...
| -------- | ------- | --------------------------------- | ------ | ------ |
| **DB**   | 0.006ms | ⚪ established at 0.006ms (1 run) | < 5ms  | 🟢     |
| **SDK**  | 0.001ms | ⚪ established at 0.001ms (1 run) | < 5ms  | 🟢     |
| **SDK**  | 0.005ms | ⚪ established at 0.005ms (1 run) | < 5ms  | 🟢     |
| **SDK**  | 0.080ms | ⚪ established at 0.080ms (1 run) | < 5ms  | 🟢     |
| **SDK**  | 0.060ms | ⚪ established at 0.060ms (1 run) | < 5ms  | 🟢     |
| **SDK**  | 0.166ms | ⚪ established at 0.166ms (1 run) | < 5ms  | 🟢     |
...
**Detail:** [`tests/benchmarks/results/history.sqlite`](../../../tests/benchmarks/results/history.sqlite) · `SELECT test_id, phase, avg_ms, p95_ms, rps, timestamp FROM runs WHERE db_type='sqlite' AND redis=1 ORDER BY timestamp DESC`

**Series:** 1 · **DB:** sqlite-redis

| Metric                | Trend | Sparkline (last 7) | Latest  |
| --------------------- | ----- | ------------------ | ------- |
| LOCAL CMS CRUD (warm) | 🟢    | `▁▄▁▁█▄`           | 0.060ms |
