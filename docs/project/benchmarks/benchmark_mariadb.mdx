...
| ------------ | ------- | ---------------------------------------- | ------ | ------ |
| **System**   | 0.514ms | ⚪ stable at 0.563ms (±0.117ms) (2 runs) | < 5ms  | 🟢     |
| **Metadata** | 0.756ms | ⚪ stable at 0.859ms (±0.203ms) (2 runs) | < 5ms  | 🟢     |
| **CRUD**     | 0.753ms | ⚪ stable at 0.836ms (±0.210ms) (2 runs) | < 5ms  | 🟢     |
| **CRUD**     | 0.726ms | ⚪ stable at 0.778ms (±0.126ms) (2 runs) | < 5ms  | 🟢     |
...
| ---------------------------------------------------- | ----- | -------------- | ---------- |
| cold start phased (Cold Start (IDLE → READY)) (cold) | 🟢    | `█▅▁`          | 1602.395ms |
| database performance (FIND MANY (limit 50)) (warm)   | 🟢    | `▅▆█▆▅▂▂▂▄▁▂▁` | 0.656ms    |
...
**Run ID:** `440a8a00-ffbb-4af1-9078-9f6e0c7f734f` · **Tests invoked:** 1 · **Metrics:** 4 · **DB:** mariadb

| Test                 | Metric                 | Avg (ms) | p95 (ms) | RPS  | Trend | Detail                                   |
| -------------------- | ---------------------- | -------- | -------- | ---- | ----- | ---------------------------------------- |
| Rest Api Performance | Health Check           | 0.514    | 0.959    | 5153 | 🟢    | ⚪ stable at 0.563ms (±0.117ms) (2 runs) |
| Rest Api Performance | Collection Schema      | 0.756    | 1.257    | 3458 | 🟢    | ⚪ stable at 0.859ms (±0.203ms) (2 runs) |
| Rest Api Performance | Collection Find (List) | 0.753    | 1.185    | 3490 | 🟢    | ⚪ stable at 0.836ms (±0.210ms) (2 runs) |
| Rest Api Performance | Collection Search      | 0.726    | 1.126    | 3622 | 🟢    | ⚪ stable at 0.778ms (±0.126ms) (2 runs) |
...
| DATABASE PERFORMANCE (warm)         | 🟢    | `▂▂█▄▁▃▁`          | 0.474ms    |
| HOOKS PERFORMANCE (warm)            | 🟢    | `▂▁▂▂▁█▂`          | 0.914ms    |
| TRANSACTION ACID (warm)             | 🟢    | `█▂▃▁▂▂▂`          | 2.216ms    |
| TRUTH LATENCY (warm)                | 🟢    | `▁█▁▁█▁▁`          | 0.000ms    |
| COLD START PHASED (cold)            | ⚪    | `█▅▁`              | 1602.395ms |
| COMPETITIVE WORKLOAD REPLICA (warm) | ⚪    | `▃▁▁▁▁▄█`          | 14.945ms   |
| REST API PERFORMANCE (warm)         | ⚪    | `█▇▁██▇▁`          | 0.514ms    |
...
<summary><strong>🏷️ cold start phased</strong> · ⚪ 1602.395ms · ↘️ 🟢 faster: 1692.77ms → 1602.39ms (-5%) (2 runs) (2026-08-19 18:56:23) · <a href="../../../tests/benchmarks/cold-start-phased.test.ts">source</a></summary>
...
║                                Ran: 2026-08-19 18:56:23                                 ║
║       Measures server cold-start latency to READY state, using the built server.        ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Cold Start (IDLE → READY)      │     1602.395 ms │ p95:     2175.705 ms │ RPS:          0 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
║                                Ran: 2026-08-19 18:56:29                                 ║
║     Validates performance claims by comparing SDK, Middleware, and Real HTTP Stack      ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Logic Baseline                 │        0.000 ms │ p95:        0.001 ms │ RPS:  2,483,444 ║
║ Local SDK (Full)               │        0.004 ms │ p95:        0.007 ms │ RPS:    245,942 ║
║ HTTP End-to-End                │        0.465 ms │ p95:        0.574 ms │ RPS:      2,149 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ Middleware & Hooks Performance</strong> · 🟢 0.930ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/hooks-performance.test.ts">source</a></summary>
...
║                                Ran: 2026-08-19 18:58:51                                 ║
║Measures the cost of the full middleware chain including Turbo, Security, Auth, and Audit via HTTP E2E.║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Static Asset (No Middleware)   │        0.930 ms │ p95:        1.609 ms │ RPS:      2,680 ║
║ Turbo Pipeline (Light)         │        0.667 ms │ p95:        1.131 ms │ RPS:      3,686 ║
║ Full Security + Auth Pipeline  │        1.108 ms │ p95:        1.884 ms │ RPS:      2,312 ║
║ REST with API Caching          │        0.914 ms │ p95:        1.595 ms │ RPS:      2,825 ║
║ Mutation (audit logging disabled) │        3.173 ms │ p95:        4.245 ms │ RPS:        309 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ database performance</strong> · 🟢 9.126ms · ↘️ ⚪ stable at 9.72ms (±0.891ms) (7 runs) (2026-08-19 18:58:19) · <a href="../../../tests/benchmarks/database-performance.test.ts">source</a></summary>
<!-- LEDGER_INSIGHT_START -->
> [!NOTE]
> **Specific to this test**: Performance improved — recent optimizations or cache warming likely effective.
<!-- LEDGER_INSIGHT_END -->
...
║                                Ran: 2026-08-19 18:58:19                                 ║
║   Measures raw CRUD performance, indexing efficiency, and connection pool resilience    ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ INSERT                         │        1.982 ms │ p95:        2.649 ms │ RPS:        479 ║
║ FIND ONE                       │        0.458 ms │ p95:        0.557 ms │ RPS:      1,981 ║
║ FIND MANY (limit 50)           │        0.656 ms │ p95:        0.768 ms │ RPS:      1,459 ║
║ FIND PAGE (50 hasMore)         │        0.728 ms │ p95:        0.861 ms │ RPS:      1,295 ║
║ FIND PAGE keyset               │        0.740 ms │ p95:        0.877 ms │ RPS:      1,236 ║
║ FIND MANY offset 50            │        0.600 ms │ p95:        0.720 ms │ RPS:      1,544 ║
║ LIST+COUNT (legacy)            │        1.079 ms │ p95:        1.219 ms │ RPS:        825 ║
║ UPDATE                         │        0.915 ms │ p95:        1.113 ms │ RPS:        947 ║
║ UPDATE (no-returning)          │        0.474 ms │ p95:        0.573 ms │ RPS:      1,859 ║
║ NATIVE UPSERT                  │        0.429 ms │ p95:        0.512 ms │ RPS:      2,074 ║
║ COUNT                          │        0.822 ms │ p95:        0.962 ms │ RPS:      1,063 ║
║ COUNT ESTIMATE                 │        0.393 ms │ p95:        0.482 ms │ RPS:      2,243 ║
║ COUNT CACHED                   │        0.001 ms │ p95:        0.001 ms │ RPS:    905,296 ║
║ DELETE                         │        1.667 ms │ p95:        2.010 ms │ RPS:        626 ║
║ BULK INSERT (100)              │        9.126 ms │ p95:       24.222 ms │ RPS:         85 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ transaction acid</strong> · 🟢 2.216ms · ↘️ ⚪ stable at 5.01ms (±2.85ms) (6 runs) (2026-08-19 18:58:30) · <a href="../../../tests/benchmarks/transaction-acid.test.ts">source</a></summary>
<!-- LEDGER_INSIGHT_START -->
> [!NOTE]
> **Specific to this test**: Performance improved — recent optimizations or cache warming likely effective.
<!-- LEDGER_INSIGHT_END -->
...
║                                Ran: 2026-08-19 18:58:30                                 ║
║  Measures transaction commit latencies and rollback overhead across database adapters   ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ TX Commit                      │        2.188 ms │ p95:        3.904 ms │ RPS:      1,647 ║
║ TX Rollback Integrity          │        2.216 ms │ p95:        2.645 ms │ RPS:        451 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ Cache</strong> · 🟢 0.368ms · ➡️ ⚪ stable at 0.370ms (±0.012ms) (2 runs) (2026-08-19 18:58:39) · <a href="../../../tests/benchmarks/cache-performance.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
```text
╔═════════════════════════════════════════════════════════════════════════════════════════╗
║                           SVELTYCMS — CACHE EFFICIENCY AUDIT                            ║
║                    File: tests/benchmarks/cache-performance.test.ts                     ║
║                                Ran: 2026-08-19 18:58:39                                 ║
║  Measures cache hit vs miss latency and efficiency via real HTTP end-to-end requests.   ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Cache Miss (Bypass)            │        0.368 ms │ p95:        0.508 ms │ RPS:      2,428 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
<!-- LEDGER_TRUTH_END -->
...
<summary><strong>🏷️ Logic</strong> · 🟢 ⏳ pending · ➡️ ⚪ stable at 0ms (2 runs) (2026-08-19 18:56:37) · <a href="../../../tests/benchmarks/truth-latency.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
> ⏳ Pending
<!-- LEDGER_TRUTH_END -->
...
<summary><strong>🏷️ SDK</strong> · 🟢 0.004ms · ↘️ ⚪ stable at 0.005ms (±0.001ms) (2 runs) (2026-08-19 18:56:37) · <a href="../../../tests/benchmarks/truth-latency.test.ts">source</a></summary>
<!-- LEDGER_INSIGHT_START -->
> [!NOTE]
> **Specific to this test**: Performance improved — recent optimizations or cache warming likely effective.
<!-- LEDGER_INSIGHT_END -->
...
<summary><strong>🏷️ HTTP</strong> · 🟢 0.465ms · ↘️ ⚪ stable at 0.493ms (±0.074ms) (2 runs) (2026-08-19 18:56:37) · <a href="../../../tests/benchmarks/truth-latency.test.ts">source</a></summary>
<!-- LEDGER_INSIGHT_START -->
> [!NOTE]
> **Specific to this test**: Performance improved — recent optimizations or cache warming likely effective.
<!-- LEDGER_INSIGHT_END -->
...
<summary><strong>🏷️ Middleware</strong> · 🟢 3.173ms · ↘️ ⚪ stable at 3.53ms (±0.387ms) (2 runs) (2026-08-19 18:58:51) · <a href="../../../tests/benchmarks/hooks-performance.test.ts">source</a></summary>
<!-- LEDGER_INSIGHT_START -->
> [!NOTE]
> **Specific to this test**: Performance improved — recent optimizations or cache warming likely effective.
<!-- LEDGER_INSIGHT_END -->
...
<summary><strong>🏷️ System</strong> · 🟢 0.514ms · ↘️ ⚪ stable at 0.563ms (±0.117ms) (2 runs) (2026-08-19 18:58:59) · <a href="../../../tests/benchmarks/rest-api-performance.test.ts">source</a></summary>
<!-- LEDGER_INSIGHT_START -->
> [!NOTE]
> **Specific to this test**: Performance improved — recent optimizations or cache warming likely effective.
<!-- LEDGER_INSIGHT_END -->
...
<summary><strong>🏷️ Metadata</strong> · 🟢 0.756ms · ↘️ ⚪ stable at 0.859ms (±0.203ms) (2 runs) (2026-08-19 18:58:59) · <a href="../../../tests/benchmarks/rest-api-performance.test.ts">source</a></summary>
<!-- LEDGER_INSIGHT_START -->
> [!NOTE]
> **Specific to this test**: Performance improved — recent optimizations or cache warming likely effective.
<!-- LEDGER_INSIGHT_END -->
...
<summary><strong>🏷️ CRUD</strong> · 🟢 0.726ms · ↘️ ⚪ stable at 0.778ms (±0.126ms) (2 runs) (2026-08-19 18:58:59) · <a href="../../../tests/benchmarks/rest-api-performance.test.ts">source</a></summary>
<!-- LEDGER_INSIGHT_START -->
> [!NOTE]
> **Specific to this test**: Performance improved — recent optimizations or cache warming likely effective.
<!-- LEDGER_INSIGHT_END -->
...
<summary><strong>🏷️ REST API Performance</strong> · 🟢 0.514ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/rest-api-performance.test.ts">source</a></summary>
...
║                                Ran: 2026-08-19 18:58:59                                 ║
║Measures latency, throughput, and correctness of core REST endpoints: health check, schema, CRUD list, and search.║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Health Check                   │        0.514 ms │ p95:        0.959 ms │ RPS:      5,153 ║
║ Collection Schema              │        0.756 ms │ p95:        1.257 ms │ RPS:      3,458 ║
║ Collection Find (List)         │        0.753 ms │ p95:        1.185 ms │ RPS:      3,490 ║
║ Collection Search              │        0.726 ms │ p95:        1.126 ms │ RPS:      3,622 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
