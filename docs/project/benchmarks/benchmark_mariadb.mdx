...
| -------------------------------- | ------- | -------------------------------- | ------ | ------ |
| **Competitive Workload Replica** | 2.255ms | ⚪ established at 2.25ms (1 run) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 6.814ms | ⚪ established at 6.81ms (1 run) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 2.562ms | ⚪ established at 2.56ms (1 run) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 2.544ms | ⚪ established at 2.54ms (1 run) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 2.454ms | ⚪ established at 2.45ms (1 run) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.801ms | ⚪ established at 1.80ms (1 run) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 4.600ms | ⚪ established at 4.60ms (1 run) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 9.449ms | ⚪ established at 9.45ms (1 run) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 8.884ms | ⚪ established at 8.88ms (1 run) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 8.368ms | ⚪ established at 8.37ms (1 run) | < 5ms  | 🟢     |
...
**Run ID:** `f136797f-06d5-4e6b-8b0e-369dbc18cd69` · **Tests invoked:** 1 · **Metrics:** 10 · **DB:** mariadb

| Test                         | Metric                                   | Avg (ms) | p95 (ms) | RPS  | Trend | Detail                           |
| ---------------------------- | ---------------------------------------- | -------- | -------- | ---- | ----- | -------------------------------- |
| Competitive Workload Replica | findById (Concurrent 8c)                 | 2.255    | 3.000    | 3432 | 🟢    | ⚪ established at 2.25ms (1 run) |
| Competitive Workload Replica | findByIdRandom (Concurrent 8c)           | 6.814    | 9.240    | 1171 | 🟢    | ⚪ established at 6.81ms (1 run) |
| Competitive Workload Replica | listPlain (Concurrent 8c)                | 2.562    | 6.027    | 2991 | 🟢    | ⚪ established at 2.56ms (1 run) |
| Competitive Workload Replica | listFilterSort (Concurrent 8c)           | 2.544    | 3.185    | 2990 | 🟢    | ⚪ established at 2.54ms (1 run) |
| Competitive Workload Replica | listLarge (Concurrent 8c)                | 2.454    | 3.589    | 3096 | 🟢    | ⚪ established at 2.45ms (1 run) |
| Competitive Workload Replica | findMissing (Concurrent 8c)              | 1.801    | 2.179    | 4230 | 🟢    | ⚪ established at 1.80ms (1 run) |
| Competitive Workload Replica | GraphQL Collection Query (Concurrent 8c) | 4.600    | 6.135    | 1695 | 🟢    | ⚪ established at 4.60ms (1 run) |
| Competitive Workload Replica | create (Concurrent 8c)                   | 9.449    | 13.569   | 835  | 🟢    | ⚪ established at 9.45ms (1 run) |
| Competitive Workload Replica | update (Concurrent 8c)                   | 8.884    | 11.785   | 877  | 🟢    | ⚪ established at 8.88ms (1 run) |
| Competitive Workload Replica | mixed (Concurrent 8c 50/50)              | 8.368    | 12.627   | 919  | 🟢    | ⚪ established at 8.37ms (1 run) |
...
| ----------------------------------- | ----- | ------------------ | ------- |
| COMPETITIVE WORKLOAD REPLICA (warm) | 🟢    | `▆▁▂▂▂▇█`          | 8.884ms |
