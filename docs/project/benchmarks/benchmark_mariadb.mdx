...
| ------------------------ | ------- | --------------------------------- | ------ | ------ |
| **Database Performance** | 1.712ms | ⚪ established at 1.71ms (1 run)  | < 5ms  | 🟢     |
| **Database Performance** | 0.494ms | ⚪ established at 0.494ms (1 run) | < 5ms  | 🟢     |
| **Database Performance** | 0.638ms | ⚪ established at 0.638ms (1 run) | < 5ms  | 🟢     |
| **Database Performance** | 0.984ms | ⚪ established at 0.984ms (1 run) | < 5ms  | 🟢     |
| **Database Performance** | 0.447ms | ⚪ established at 0.447ms (1 run) | < 5ms  | 🟢     |
| **Database Performance** | 0.790ms | ⚪ established at 0.790ms (1 run) | < 5ms  | 🟢     |
| **Database Performance** | 1.618ms | ⚪ established at 1.62ms (1 run)  | < 5ms  | 🟢     |
| **Database Performance** | 9.217ms | ⚪ established at 9.22ms (1 run)  | < 5ms  | 🟢     |
...
| ----------------------------------------------- | ----- | --------- | ------- |
| database performance (BULK INSERT (100)) (warm) | 🟢    | `▁`       | 9.217ms |
...
**Run ID:** `bc2af811-c692-427d-a89a-549e00782dd1` · **Tests invoked:** 1 · **Metrics:** 8 · **DB:** mariadb

| Test                 | Metric               | Avg (ms) | p95 (ms) | RPS  | Trend | Detail                            |
| -------------------- | -------------------- | -------- | -------- | ---- | ----- | --------------------------------- |
| Database Performance | INSERT               | 1.712    | 2.218    | 501  | 🟢    | ⚪ established at 1.71ms (1 run)  |
| Database Performance | FIND ONE             | 0.494    | 0.587    | 1782 | 🟢    | ⚪ established at 0.494ms (1 run) |
| Database Performance | FIND MANY (limit 50) | 0.638    | 0.719    | 1389 | 🟢    | ⚪ established at 0.638ms (1 run) |
| Database Performance | UPDATE               | 0.984    | 1.149    | 891  | 🟢    | ⚪ established at 0.984ms (1 run) |
| Database Performance | NATIVE UPSERT        | 0.447    | 0.515    | 1955 | 🟢    | ⚪ established at 0.447ms (1 run) |
| Database Performance | COUNT                | 0.790    | 0.910    | 1100 | 🟢    | ⚪ established at 0.790ms (1 run) |
| Database Performance | DELETE               | 1.618    | 2.031    | 612  | 🟢    | ⚪ established at 1.62ms (1 run)  |
| Database Performance | BULK INSERT (100)    | 9.217    | 24.594   | 80   | 🟢    | ⚪ established at 9.22ms (1 run)  |
...
| --------------------------- | ----- | ------------------ | ------- |
| DATABASE PERFORMANCE (warm) | 🟢    | `▃▇▂▁█▁▄`          | 0.984ms |
...
<summary><strong>🏷️ database performance</strong> · 🟢 9.217ms · ➡️ ⚪ established at 9.22ms (1 run) (2026-08-04 11:18:48) · <a href="../../../tests/benchmarks/database-performance.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
```text
╔═════════════════════════════════════════════════════════════════════════════════════════╗
║                   SVELTYCMS — DATABASE ADAPTER PERFORMANCE (MARIADB)                    ║
║                   File: tests/benchmarks/database-performance.test.ts                   ║
║                                Ran: 2026-08-04 11:18:48                                 ║
║   Measures raw CRUD performance, indexing efficiency, and connection pool resilience    ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ INSERT                         │        1.712 ms │ p95:        2.218 ms │ RPS:        501 ║
║ FIND ONE                       │        0.494 ms │ p95:        0.587 ms │ RPS:      1,782 ║
║ FIND MANY (limit 50)           │        0.638 ms │ p95:        0.719 ms │ RPS:      1,389 ║
║ UPDATE                         │        0.984 ms │ p95:        1.149 ms │ RPS:        891 ║
║ NATIVE UPSERT                  │        0.447 ms │ p95:        0.515 ms │ RPS:      1,955 ║
║ COUNT                          │        0.790 ms │ p95:        0.910 ms │ RPS:      1,100 ║
║ DELETE                         │        1.618 ms │ p95:        2.031 ms │ RPS:        612 ║
║ BULK INSERT (100)              │        9.217 ms │ p95:       24.594 ms │ RPS:         80 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
<!-- LEDGER_TRUTH_END -->
