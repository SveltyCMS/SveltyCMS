...
**✅ PASS** _(partial invocation)_ · 1/42 tests · 41 skipped · **mariadb** · standalone run
...
| ------------------------ | ------- | -------------------------------------------- | ------ | ------ |
| **Database Performance** | 2.004ms | ⚪ stable at 1.80ms (±0.171ms) (2 runs)      | < 5ms  | 🟢     |
| **Database Performance** | 0.503ms | ⚪ stable at 0.495ms (±0.003ms) (2 runs)     | < 5ms  | 🟢     |
| **Database Performance** | 0.637ms | ⚪ stable at 0.641ms (±0.005ms) (2 runs)     | < 5ms  | 🟢     |
| **Database Performance** | 0.664ms | ⚪ established at 0.664ms (1 run)            | < 5ms  | 🟢     |
| **Database Performance** | 0.645ms | ⚪ established at 0.645ms (1 run)            | < 5ms  | 🟢     |
| **Database Performance** | 0.585ms | ⚪ established at 0.585ms (1 run)            | < 5ms  | 🟢     |
| **Database Performance** | 1.086ms | ⚪ established at 1.09ms (1 run)             | < 5ms  | 🟢     |
| **Database Performance** | 1.195ms | 🔴 slower: 0.986ms → 1.20ms (+21%) (2 runs)  | < 5ms  | 🟢     |
| **Database Performance** | 0.531ms | 🔴 slower: 0.450ms → 0.531ms (+18%) (2 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.936ms | 🔴 slower: 0.784ms → 0.936ms (+19%) (2 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.502ms | ⚪ established at 0.502ms (1 run)            | < 5ms  | 🟢     |
| **Database Performance** | 0.029ms | ⚪ established at 0.029ms (1 run)            | < 5ms  | 🟢     |
| **Database Performance** | 1.700ms | 🔴 slower: 1.63ms → 1.70ms (+4%) (2 runs)    | < 5ms  | 🟢     |
| **Database Performance** | 8.956ms | ⚪ stable at 9.03ms (±0.369ms) (2 runs)      | < 5ms  | 🟢     |
...
| ----------------------------------------------- | ----- | --------- | ------- |
| database performance (BULK INSERT (100)) (warm) | 🟢    | `█▁▃`     | 8.956ms |
...
quadrantChart
  ...
  quadrant-4 Critical — fix first
    Database Performance: [0.95, 0.54]
    Database Performance: [0.60, 0.95]
    Database Performance: [0.26, 0.85]
    Database Performance: [0.47, 0.91]
```
...
**Run ID:** `caae644e-d486-4fbd-9918-f0b59cf1434e` · **Tests invoked:** 1 · **Metrics:** 14 · **DB:** mariadb

| Test                 | Metric                 | Avg (ms) | p95 (ms) | RPS   | Trend | Detail                                       |
| -------------------- | ---------------------- | -------- | -------- | ----- | ----- | -------------------------------------------- |
| Database Performance | INSERT                 | 2.004    | 3.136    | 442   | 🟢    | ⚪ stable at 1.80ms (±0.171ms) (2 runs)      |
| Database Performance | FIND ONE               | 0.503    | 0.581    | 1757  | 🟢    | ⚪ stable at 0.495ms (±0.003ms) (2 runs)     |
| Database Performance | FIND MANY (limit 50)   | 0.637    | 0.729    | 1383  | 🟢    | ⚪ stable at 0.641ms (±0.005ms) (2 runs)     |
| Database Performance | FIND PAGE (50 hasMore) | 0.664    | 0.752    | 1344  | 🟢    | ⚪ established at 0.664ms (1 run)            |
| Database Performance | FIND PAGE keyset       | 0.645    | 0.767    | 1362  | 🟢    | ⚪ established at 0.645ms (1 run)            |
| Database Performance | FIND MANY offset 50    | 0.585    | 0.684    | 1509  | 🟢    | ⚪ established at 0.585ms (1 run)            |
| Database Performance | LIST+COUNT (legacy)    | 1.086    | 1.265    | 801   | 🟢    | ⚪ established at 1.09ms (1 run)             |
| Database Performance | COUNT ESTIMATE         | 0.502    | 0.595    | 1726  | 🟢    | ⚪ established at 0.502ms (1 run)            |
| Database Performance | COUNT CACHED           | 0.029    | 0.032    | 31013 | 🟢    | ⚪ established at 0.029ms (1 run)            |
| Database Performance | BULK INSERT (100)      | 8.956    | 21.311   | 81    | 🟢    | ⚪ stable at 9.03ms (±0.369ms) (2 runs)      |
| Database Performance | UPDATE                 | 1.195    | 1.410    | 725   | ⚪    | 🔴 slower: 0.986ms → 1.20ms (+21%) (2 runs)  |
| Database Performance | NATIVE UPSERT          | 0.531    | 0.607    | 1628  | ⚪    | 🔴 slower: 0.450ms → 0.531ms (+18%) (2 runs) |
| Database Performance | COUNT                  | 0.936    | 1.033    | 937   | ⚪    | 🔴 slower: 0.784ms → 0.936ms (+19%) (2 runs) |
| Database Performance | DELETE                 | 1.700    | 2.053    | 603   | ⚪    | 🔴 slower: 1.63ms → 1.70ms (+4%) (2 runs)    |
...
| --------------------------- | ----- | ------------------ | ------- |
| DATABASE PERFORMANCE (warm) | 🟢    | `▁▂▂█▄▁▄`          | 1.195ms |
...
<summary><strong>🏷️ API LAYER LATENCY</strong> · 🟢 5.592ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/api-latency.test.ts">source</a></summary>
...
║                                Ran: 2026-07-26 10:33:35                                 ║
║                      API Latency Benchmark (Production Optimized)                       ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ HTTP: findById @ 8c            │        5.592 ms │ p95:        9.823 ms │ RPS:        175 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
║                                Ran: 2026-07-26 10:33:21                                 ║
║     Validates performance claims by comparing SDK, Middleware, and Real HTTP Stack      ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Logic Baseline                 │        0.001 ms │ p95:        0.002 ms │ RPS:  1,626,898 ║
║ Local SDK (Full)               │        0.008 ms │ p95:        0.012 ms │ RPS:    130,050 ║
║ HTTP End-to-End                │        1.134 ms │ p95:        2.402 ms │ RPS:        882 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ Middleware & Hooks Performance</strong> · 🟢 1.212ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/hooks-performance.test.ts">source</a></summary>
...
║                                Ran: 2026-07-26 10:36:36                                 ║
║Measures the cost of the full middleware chain including Turbo, Security, Auth, and Audit via HTTP E2E.║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Static Asset (No Middleware)   │        1.212 ms │ p95:        2.144 ms │ RPS:        807 ║
║ Turbo Pipeline (Light)         │        0.880 ms │ p95:        1.477 ms │ RPS:      1,049 ║
║ Full Security + Auth Pipeline  │        2.682 ms │ p95:        4.019 ms │ RPS:        371 ║
║ REST with API Caching          │        3.874 ms │ p95:        5.922 ms │ RPS:        249 ║
║ Mutation + Audit Logging       │       21.344 ms │ p95:       27.703 ms │ RPS:         46 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ database performance</strong> · 🟢 8.956ms · ➡️ ⚪ stable at 9.03ms (±0.369ms) (2 runs) (2026-08-04 12:03:50) · <a href="../../../tests/benchmarks/database-performance.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
```text
╔═════════════════════════════════════════════════════════════════════════════════════════╗
║                   SVELTYCMS — DATABASE ADAPTER PERFORMANCE (MARIADB)                    ║
║                   File: tests/benchmarks/database-performance.test.ts                   ║
║                                Ran: 2026-08-04 12:03:50                                 ║
║   Measures raw CRUD performance, indexing efficiency, and connection pool resilience    ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ INSERT                         │        2.004 ms │ p95:        3.136 ms │ RPS:        442 ║
║ FIND ONE                       │        0.503 ms │ p95:        0.581 ms │ RPS:      1,757 ║
║ FIND MANY (limit 50)           │        0.637 ms │ p95:        0.729 ms │ RPS:      1,383 ║
║ FIND PAGE (50 hasMore)         │        0.664 ms │ p95:        0.752 ms │ RPS:      1,344 ║
║ FIND PAGE keyset               │        0.645 ms │ p95:        0.767 ms │ RPS:      1,362 ║
║ FIND MANY offset 50            │        0.585 ms │ p95:        0.684 ms │ RPS:      1,509 ║
║ LIST+COUNT (legacy)            │        1.086 ms │ p95:        1.265 ms │ RPS:        801 ║
║ UPDATE                         │        1.195 ms │ p95:        1.410 ms │ RPS:        725 ║
║ NATIVE UPSERT                  │        0.531 ms │ p95:        0.607 ms │ RPS:      1,628 ║
║ COUNT                          │        0.936 ms │ p95:        1.033 ms │ RPS:        937 ║
║ COUNT ESTIMATE                 │        0.502 ms │ p95:        0.595 ms │ RPS:      1,726 ║
║ COUNT CACHED                   │        0.029 ms │ p95:        0.032 ms │ RPS:     31,013 ║
║ DELETE                         │        1.700 ms │ p95:        2.053 ms │ RPS:        603 ║
║ BULK INSERT (100)              │        8.956 ms │ p95:       21.311 ms │ RPS:         81 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
<!-- LEDGER_TRUTH_END -->
...
<summary><strong>🏷️ Cache</strong> · 🟢 2.375ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/cache-performance.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
```text
╔═════════════════════════════════════════════════════════════════════════════════════════╗
║                            NEGATIVE CACHE PERFORMANCE AUDIT                             ║
║                      File: tests/benchmarks/negative-cache.test.ts                      ║
║                                Ran: 2026-07-26 10:35:21                                 ║
║        Measures Bloom-filter style missing-key cache speedup for repeated misses        ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ First Miss (DB)                │        2.375 ms │ p95:        4.696 ms │ RPS:        421 ║
║ Cached Miss (Negative Cache)   │        0.003 ms │ p95:        0.005 ms │ RPS:    360,081 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
<!-- LEDGER_TRUTH_END -->
...
<summary><strong>🏷️ SDK</strong> · 🟢 0.933ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/truth-latency.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
```text
╔═════════════════════════════════════════════════════════════════════════════════════════╗
║                           SVELTYCMS — SDK OVERHEAD TELEMETRY                            ║
║                  File: tests/benchmarks/local-api-performance.test.ts                   ║
║                                Ran: 2026-07-26 10:36:05                                 ║
║  Measures LocalCMS SDK overhead vs direct adapter calls to verify zero-tax dispatching  ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Direct Adapter Call            │        0.933 ms │ p95:        2.768 ms │ RPS:      1,072 ║
║ LocalCMS SDK Call              │        0.724 ms │ p95:        1.757 ms │ RPS:      1,382 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
<!-- LEDGER_TRUTH_END -->
...
<summary><strong>🏷️ Relational & Nested Queries</strong> · 🟢 6.243ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/relational-performance.test.ts">source</a></summary>
...
║                                Ran: 2026-07-26 10:35:43                                 ║
║Measures GraphQL resolver performance for shallow and deep relational queries including joins and nested population.║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Shallow Relational Query       │        6.243 ms │ p95:        9.486 ms │ RPS:        152 ║
║ Deep Relational Query          │        4.271 ms │ p95:        6.416 ms │ RPS:        221 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ Auth & RBAC Performance</strong> · 🟢 1.331ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/auth-performance.test.ts">source</a></summary>
...
║                                Ran: 2026-07-26 10:33:40                                 ║
║             Authentication & RBAC Pipeline Benchmark (Production Optimized)             ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Auth Validation @ 1c           │        1.331 ms │ p95:        1.966 ms │ RPS:        602 ║
║ HTTP Auth Pipeline @ 8c        │        3.377 ms │ p95:        4.928 ms │ RPS:        288 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ REST API Performance</strong> · 🟢 0.896ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/rest-api-performance.test.ts">source</a></summary>
...
║                                Ran: 2026-07-26 10:33:33                                 ║
║Measures latency, throughput, and correctness of core REST endpoints: health check, schema, CRUD list, and search.║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Health Check                   │        0.896 ms │ p95:        1.650 ms │ RPS:      1,116 ║
║ Collection Schema              │        2.281 ms │ p95:        3.463 ms │ RPS:        438 ║
║ Collection Find (List)         │        2.903 ms │ p95:        4.530 ms │ RPS:        345 ║
║ Collection Search              │        3.159 ms │ p95:        4.654 ms │ RPS:        317 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ GraphQL API Performance</strong> · 🟢 1.549ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/graphql-api-performance.test.ts">source</a></summary>
...
║                                Ran: 2026-07-26 10:34:58                                 ║
║   Measures GraphQL resolver performance and throughput across varied query scenarios.   ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ GQL: System Health             │        1.549 ms │ p95:        2.624 ms │ RPS:        646 ║
║ GQL: Collection List           │        6.226 ms │ p95:        9.879 ms │ RPS:        161 ║
║ GQL: Concurrent Load           │        4.791 ms │ p95:        8.347 ms │ RPS:        209 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ Realistic Mixed Workload</strong> · 🟢 4.167ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/mixed-workload.test.ts">source</a></summary>
...
<summary><strong>🏷️ GraphQL Load Stress</strong> · 🟢 6.288ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/graphql-stress.test.ts">source</a></summary>
...
║                                Ran: 2026-07-26 10:35:08                                 ║
║  Discovers the server's maximum sustainable GraphQL throughput by ramping concurrency   ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ GQL: 5c Warmup                 │        6.288 ms │ p95:        8.834 ms │ RPS:        144 ║
║ GQL: 10c Light                 │        9.995 ms │ p95:       14.197 ms │ RPS:         99 ║
║ GQL: 20c Moderate              │       15.771 ms │ p95:       20.790 ms │ RPS:         63 ║
║ GQL: 40c Heavy                 │       30.067 ms │ p95:       38.607 ms │ RPS:         34 ║
║ GQL: 60c Stress                │       43.164 ms │ p95:       57.989 ms │ RPS:         24 ║
║ GQL: 80c Extreme               │       61.944 ms │ p95:       84.819 ms │ RPS:         16 ║
║ GQL: 100c Max                  │       49.548 ms │ p95:       92.535 ms │ RPS:         20 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ Full Client Journey Simulation</strong> · 🟢 36.659ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/client-journey.test.ts">source</a></summary>
...
║                                Ran: 2026-07-26 10:36:23                                 ║
║ Measures the latency tax of internal CMS logic for AI enrichment and layout generation. ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ AI Text Enrichment             │        0.001 ms │ p95:        0.002 ms │ RPS:    793,966 ║
║ AI Layout Spec Generation      │        0.000 ms │ p95:        0.001 ms │ RPS:  1,258,917 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
