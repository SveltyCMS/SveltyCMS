...
| ------------------------ | ------- | --------------------------------- | ------ | ------ |
| **Database Performance** | 1.883ms | ⚪ established at 1.88ms (1 run)  | < 5ms  | 🟢     |
| **Database Performance** | 0.497ms | ⚪ established at 0.497ms (1 run) | < 5ms  | 🟢     |
| **Database Performance** | 0.643ms | ⚪ established at 0.643ms (1 run) | < 5ms  | 🟢     |
| **Database Performance** | 0.660ms | ⚪ established at 0.660ms (1 run) | < 5ms  | 🟢     |
| **Database Performance** | 0.928ms | ⚪ established at 0.928ms (1 run) | < 5ms  | 🟢     |
| **Database Performance** | 0.988ms | ⚪ established at 0.988ms (1 run) | < 5ms  | 🟢     |
| **Database Performance** | 0.453ms | ⚪ established at 0.453ms (1 run) | < 5ms  | 🟢     |
| **Database Performance** | 0.779ms | ⚪ established at 0.779ms (1 run) | < 5ms  | 🟢     |
| **Database Performance** | 0.423ms | ⚪ established at 0.423ms (1 run) | < 5ms  | 🟢     |
| **Database Performance** | 0.024ms | ⚪ established at 0.024ms (1 run) | < 5ms  | 🟢     |
| **Database Performance** | 1.648ms | ⚪ established at 1.65ms (1 run)  | < 5ms  | 🟢     |
| **Database Performance** | 8.848ms | ⚪ established at 8.85ms (1 run)  | < 5ms  | 🟢     |
...
| ----------------------------------------------- | ----- | --------- | ------- |
| database performance (BULK INSERT (100)) (warm) | 🟢    | `█▁`      | 8.848ms |
...
**Run ID:** `e28c9c74-b12c-40c2-9a99-3cbab7a2e94b` · **Tests invoked:** 1 · **Metrics:** 12 · **DB:** mariadb

| Test                 | Metric                 | Avg (ms) | p95 (ms) | RPS   | Trend | Detail                            |
| -------------------- | ---------------------- | -------- | -------- | ----- | ----- | --------------------------------- |
| Database Performance | INSERT                 | 1.883    | 2.907    | 472   | 🟢    | ⚪ established at 1.88ms (1 run)  |
| Database Performance | FIND ONE               | 0.497    | 0.583    | 1758  | 🟢    | ⚪ established at 0.497ms (1 run) |
| Database Performance | FIND MANY (limit 50)   | 0.643    | 0.730    | 1376  | 🟢    | ⚪ established at 0.643ms (1 run) |
| Database Performance | FIND PAGE (50 hasMore) | 0.660    | 0.757    | 1333  | 🟢    | ⚪ established at 0.660ms (1 run) |
| Database Performance | LIST+COUNT (legacy)    | 0.928    | 1.024    | 965   | 🟢    | ⚪ established at 0.928ms (1 run) |
| Database Performance | UPDATE                 | 0.988    | 1.127    | 894   | 🟢    | ⚪ established at 0.988ms (1 run) |
| Database Performance | NATIVE UPSERT          | 0.453    | 0.537    | 1894  | 🟢    | ⚪ established at 0.453ms (1 run) |
| Database Performance | COUNT                  | 0.779    | 0.874    | 1127  | 🟢    | ⚪ established at 0.779ms (1 run) |
| Database Performance | COUNT ESTIMATE         | 0.423    | 0.481    | 2077  | 🟢    | ⚪ established at 0.423ms (1 run) |
| Database Performance | COUNT CACHED           | 0.024    | 0.026    | 40189 | 🟢    | ⚪ established at 0.024ms (1 run) |
| Database Performance | DELETE                 | 1.648    | 2.110    | 637   | 🟢    | ⚪ established at 1.65ms (1 run)  |
| Database Performance | BULK INSERT (100)      | 8.848    | 21.082   | 84    | 🟢    | ⚪ established at 8.85ms (1 run)  |
...
| --------------------------- | ----- | ------------------ | ------- |
| DATABASE PERFORMANCE (warm) | 🟢    | `▂▁▂█▃▁▄`          | 0.988ms |
...
<summary><strong>🏷️ database performance</strong> · 🟢 8.848ms · ➡️ ⚪ established at 8.85ms (1 run) (2026-08-04 11:46:54) · <a href="../../../tests/benchmarks/database-performance.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
```text
╔═════════════════════════════════════════════════════════════════════════════════════════╗
║                   SVELTYCMS — DATABASE ADAPTER PERFORMANCE (MARIADB)                    ║
║                   File: tests/benchmarks/database-performance.test.ts                   ║
║                                Ran: 2026-08-04 11:46:54                                 ║
║   Measures raw CRUD performance, indexing efficiency, and connection pool resilience    ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ INSERT                         │        1.883 ms │ p95:        2.907 ms │ RPS:        472 ║
║ FIND ONE                       │        0.497 ms │ p95:        0.583 ms │ RPS:      1,758 ║
║ FIND MANY (limit 50)           │        0.643 ms │ p95:        0.730 ms │ RPS:      1,376 ║
║ FIND PAGE (50 hasMore)         │        0.660 ms │ p95:        0.757 ms │ RPS:      1,333 ║
║ LIST+COUNT (legacy)            │        0.928 ms │ p95:        1.024 ms │ RPS:        965 ║
║ UPDATE                         │        0.988 ms │ p95:        1.127 ms │ RPS:        894 ║
║ NATIVE UPSERT                  │        0.453 ms │ p95:        0.537 ms │ RPS:      1,894 ║
║ COUNT                          │        0.779 ms │ p95:        0.874 ms │ RPS:      1,127 ║
║ COUNT ESTIMATE                 │        0.423 ms │ p95:        0.481 ms │ RPS:      2,077 ║
║ COUNT CACHED                   │        0.024 ms │ p95:        0.026 ms │ RPS:     40,189 ║
║ DELETE                         │        1.648 ms │ p95:        2.110 ms │ RPS:        637 ║
║ BULK INSERT (100)              │        8.848 ms │ p95:       21.082 ms │ RPS:         84 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
<!-- LEDGER_TRUTH_END -->
