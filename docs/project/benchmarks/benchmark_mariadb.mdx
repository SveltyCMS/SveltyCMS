...
| -------------------------------- | -------- | --------------------------------- | ------ | ------ |
| **Competitive Workload Replica** | 1.803ms  | ⚪ established at 1.80ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 6.148ms  | ⚪ established at 6.15ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.750ms  | ⚪ established at 1.75ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 3.417ms  | ⚪ established at 3.42ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.969ms  | ⚪ established at 1.97ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 3.919ms  | ⚪ established at 3.92ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 10.800ms | ⚪ established at 10.80ms (1 run) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 23.536ms | ⚪ established at 23.54ms (1 run) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 14.020ms | ⚪ established at 14.02ms (1 run) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 10.968ms | ⚪ established at 10.97ms (1 run) | < 5ms  | 🟢     |
...
| ---------------------------------------------------- | ----- | --------- | ---------- |
| cold start phased (Cold Start (IDLE → READY)) (cold) | 🟢    | `▁`       | 1031.709ms |
| database performance (BULK INSERT (100)) (warm)      | 🟢    | `▁`       | 3.224ms    |
...
**Run ID:** `3b7f8a01-0b34-41a0-84f4-387e953bbe51` · **Tests invoked:** 1 · **Metrics:** 10 · **DB:** mariadb

| Test                         | Metric                                   | Avg (ms) | p95 (ms) | RPS  | Trend | Detail                            |
| ---------------------------- | ---------------------------------------- | -------- | -------- | ---- | ----- | --------------------------------- |
| Competitive Workload Replica | findById (Concurrent 8c)                 | 1.803    | 3.056    | 2569 | 🟢    | ⚪ established at 1.80ms (1 run)  |
| Competitive Workload Replica | findByIdRandom (Concurrent 8c)           | 6.148    | 11.229   | 1123 | 🟢    | ⚪ established at 6.15ms (1 run)  |
| Competitive Workload Replica | listPlain (Concurrent 8c)                | 1.750    | 3.350    | 2433 | 🟢    | ⚪ established at 1.75ms (1 run)  |
| Competitive Workload Replica | listFilterSort (Concurrent 8c)           | 3.417    | 6.274    | 1507 | 🟢    | ⚪ established at 3.42ms (1 run)  |
| Competitive Workload Replica | listLarge (Concurrent 8c)                | 1.969    | 3.291    | 2313 | 🟢    | ⚪ established at 1.97ms (1 run)  |
| Competitive Workload Replica | findMissing (Concurrent 8c)              | 3.919    | 6.998    | 1193 | 🟢    | ⚪ established at 3.92ms (1 run)  |
| Competitive Workload Replica | GraphQL Collection Query (Concurrent 8c) | 10.800   | 15.151   | 727  | 🟢    | ⚪ established at 10.80ms (1 run) |
| Competitive Workload Replica | create (Concurrent 8c)                   | 23.536   | 28.194   | 332  | 🟢    | ⚪ established at 23.54ms (1 run) |
| Competitive Workload Replica | update (Concurrent 8c)                   | 14.020   | 15.937   | 551  | 🟢    | ⚪ established at 14.02ms (1 run) |
| Competitive Workload Replica | mixed (Concurrent 8c 50/50)              | 10.968   | 21.567   | 616  | 🟢    | ⚪ established at 10.97ms (1 run) |
...
| ----------------------------------- | ----- | ------------------ | ---------- |
| CACHE PERFORMANCE (warm)            | 🟢    | `▁`                | 0.221ms    |
| COLD START PHASED (cold)            | 🟢    | `▁`                | 1031.709ms |
| DATABASE PERFORMANCE (warm)         | 🟢    | `▂▃█▁▂▁▁`          | 0.058ms    |
| HOOKS PERFORMANCE (warm)            | 🟢    | `▅█▄▁▃`            | 0.462ms    |
| TRANSACTION ACID (warm)             | 🟢    | `█▁`               | 0.455ms    |
| TRUTH LATENCY (warm)                | 🟢    | `█▁▁`              | 0.000ms    |
| COMPETITIVE WORKLOAD REPLICA (warm) | ⚪    | `▄▂▂▁▁▆█`          | 14.020ms   |
| REST API PERFORMANCE (warm)         | ⚪    | `▆█▅▁`             | 0.387ms    |
