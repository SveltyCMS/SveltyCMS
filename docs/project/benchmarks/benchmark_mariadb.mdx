...
| -------------------------------- | -------- | --------------------------------- | ------ | ------ |
| **Competitive Workload Replica** | 1.666ms  | ⚪ established at 1.67ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 5.785ms  | ⚪ established at 5.79ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.880ms  | ⚪ established at 1.88ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.554ms  | ⚪ established at 1.55ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.659ms  | ⚪ established at 1.66ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.600ms  | ⚪ established at 1.60ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 5.454ms  | ⚪ established at 5.45ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 16.404ms | ⚪ established at 16.40ms (1 run) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 14.945ms | ⚪ established at 14.95ms (1 run) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 7.745ms  | ⚪ established at 7.75ms (1 run)  | < 5ms  | 🟢     |
...
| -------------------------------------------------- | ----- | -------------- | ------- |
| database performance (FIND MANY (limit 50)) (warm) | 🟢    | `▂▄▅▅▆█▆▅▂▁▁▃` | 0.828ms |
...
**Run ID:** `eb237e63-ac5e-4f48-b4a6-7ec88aa0f74e` · **Tests invoked:** 1 · **Metrics:** 10 · **DB:** mariadb

| Test                         | Metric                         | Avg (ms) | p95 (ms) | RPS  | Trend | Detail                            |
| ---------------------------- | ------------------------------ | -------- | -------- | ---- | ----- | --------------------------------- |
| Competitive Workload Replica | findById (Concurrent 8c)       | 1.666    | 3.092    | 2770 | 🟢    | ⚪ established at 1.67ms (1 run)  |
| Competitive Workload Replica | findByIdRandom (Concurrent 8c) | 5.785    | 9.554    | 1189 | 🟢    | ⚪ established at 5.79ms (1 run)  |
| Competitive Workload Replica | listPlain (Concurrent 8c)      | 1.880    | 4.304    | 2586 | 🟢    | ⚪ established at 1.88ms (1 run)  |
| Competitive Workload Replica | listFilterSort (Concurrent 8c) | 1.554    | 2.690    | 2875 | 🟢    | ⚪ established at 1.55ms (1 run)  |
| Competitive Workload Replica | listLarge (Concurrent 8c)      | 1.659    | 2.757    | 2998 | 🟢    | ⚪ established at 1.66ms (1 run)  |
| Competitive Workload Replica | findMissing (Concurrent 8c)    | 1.600    | 3.339    | 3038 | 🟢    | ⚪ established at 1.60ms (1 run)  |
| Competitive Workload Replica | GraphQL Query (Concurrent 8c)  | 5.454    | 6.416    | 1366 | 🟢    | ⚪ established at 5.45ms (1 run)  |
| Competitive Workload Replica | create (Concurrent 8c)         | 16.404   | 20.538   | 473  | 🟢    | ⚪ established at 16.40ms (1 run) |
| Competitive Workload Replica | update (Concurrent 8c)         | 14.945   | 17.009   | 493  | 🟢    | ⚪ established at 14.95ms (1 run) |
| Competitive Workload Replica | mixed (Concurrent 8c 50/50)    | 7.745    | 12.067   | 716  | 🟢    | ⚪ established at 7.75ms (1 run)  |
...
| ----------------------------------- | ----- | ------------------ | -------- |
| DATABASE PERFORMANCE (warm)         | 🟢    | `▂▂█▂▁▃▁`          | 0.697ms  |
| TRANSACTION ACID (warm)             | 🟢    | `▃▂▅██▁▃`          | 4.927ms  |
