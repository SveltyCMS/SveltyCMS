...
| ------------------------ | ------- | --------------------------------- | ------ | ------ |
| **Database Performance** | 0.773ms | ⚪ established at 0.773ms (1 run) | < 5ms  | 🟢     |
| **Database Performance** | 0.712ms | ⚪ established at 0.712ms (1 run) | < 5ms  | 🟢     |
| **Database Performance** | 0.978ms | ⚪ established at 0.978ms (1 run) | < 5ms  | 🟢     |
| **Database Performance** | 1.044ms | ⚪ established at 1.04ms (1 run)  | < 5ms  | 🟢     |
| **Database Performance** | 0.884ms | ⚪ established at 0.884ms (1 run) | < 5ms  | 🟢     |
| **Database Performance** | 4.009ms | ⚪ established at 4.01ms (1 run)  | < 5ms  | 🟢     |
| **Database Performance** | 1.005ms | ⚪ established at 1.00ms (1 run)  | < 5ms  | 🟢     |
| **Database Performance** | 4.635ms | ⚪ established at 4.63ms (1 run)  | < 5ms  | 🟢     |
...
| ----------------------------------------------- | ----- | --------- | ------- |
| database performance (BULK INSERT (100)) (warm) | 🟢    | `▁`       | 4.635ms |
...
**Run ID:** `35445876-72d4-4e24-9771-4c1d681051b8` · **Tests invoked:** 1 · **Metrics:** 8 · **DB:** mongodb

| Test                 | Metric               | Avg (ms) | p95 (ms) | RPS  | Trend | Detail                            |
| -------------------- | -------------------- | -------- | -------- | ---- | ----- | --------------------------------- |
| Database Performance | INSERT               | 0.773    | 0.981    | 997  | 🟢    | ⚪ established at 0.773ms (1 run) |
| Database Performance | FIND ONE             | 0.712    | 0.898    | 1152 | 🟢    | ⚪ established at 0.712ms (1 run) |
| Database Performance | FIND MANY (limit 50) | 0.978    | 1.335    | 850  | 🟢    | ⚪ established at 0.978ms (1 run) |
| Database Performance | UPDATE               | 1.044    | 1.658    | 725  | 🟢    | ⚪ established at 1.04ms (1 run)  |
| Database Performance | NATIVE UPSERT        | 0.884    | 1.193    | 842  | 🟢    | ⚪ established at 0.884ms (1 run) |
| Database Performance | COUNT                | 4.009    | 5.687    | 247  | 🟢    | ⚪ established at 4.01ms (1 run)  |
| Database Performance | DELETE               | 1.005    | 1.933    | 844  | 🟢    | ⚪ established at 1.00ms (1 run)  |
| Database Performance | BULK INSERT (100)    | 4.635    | 7.568    | 201  | 🟢    | ⚪ established at 4.63ms (1 run)  |
...
| --------------------------- | ----- | ------------------ | ------- |
| DATABASE PERFORMANCE (warm) | 🟢    | `█▂▂▁▁▁▂`          | 1.044ms |
...
<summary><strong>🏷️ database performance</strong> · 🟢 4.635ms · ➡️ ⚪ established at 4.63ms (1 run) (2026-08-04 11:20:00) · <a href="../../../tests/benchmarks/database-performance.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
```text
╔═════════════════════════════════════════════════════════════════════════════════════════╗
║                   SVELTYCMS — DATABASE ADAPTER PERFORMANCE (MONGODB)                    ║
║                   File: tests/benchmarks/database-performance.test.ts                   ║
║                                Ran: 2026-08-04 11:20:00                                 ║
║   Measures raw CRUD performance, indexing efficiency, and connection pool resilience    ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ INSERT                         │        0.773 ms │ p95:        0.981 ms │ RPS:        997 ║
║ FIND ONE                       │        0.712 ms │ p95:        0.898 ms │ RPS:      1,152 ║
║ FIND MANY (limit 50)           │        0.978 ms │ p95:        1.335 ms │ RPS:        850 ║
║ UPDATE                         │        1.044 ms │ p95:        1.658 ms │ RPS:        725 ║
║ NATIVE UPSERT                  │        0.884 ms │ p95:        1.193 ms │ RPS:        842 ║
║ COUNT                          │        4.009 ms │ p95:        5.687 ms │ RPS:        247 ║
║ DELETE                         │        1.005 ms │ p95:        1.933 ms │ RPS:        844 ║
║ BULK INSERT (100)              │        4.635 ms │ p95:        7.568 ms │ RPS:        201 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
<!-- LEDGER_TRUTH_END -->
