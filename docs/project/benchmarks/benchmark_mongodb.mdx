...
| ------------------------ | ------- | --------------------------------- | ------ | ------ |
| **Database Performance** | 0.684ms | ⚪ established at 0.684ms (1 run) | < 5ms  | 🟢     |
| **Database Performance** | 0.596ms | ⚪ established at 0.596ms (1 run) | < 5ms  | 🟢     |
| **Database Performance** | 0.838ms | ⚪ established at 0.838ms (1 run) | < 5ms  | 🟢     |
| **Database Performance** | 0.833ms | ⚪ established at 0.833ms (1 run) | < 5ms  | 🟢     |
| **Database Performance** | 4.904ms | ⚪ established at 4.90ms (1 run)  | < 5ms  | 🟢     |
| **Database Performance** | 0.747ms | ⚪ established at 0.747ms (1 run) | < 5ms  | 🟢     |
| **Database Performance** | 0.748ms | ⚪ established at 0.748ms (1 run) | < 5ms  | 🟢     |
| **Database Performance** | 4.607ms | ⚪ established at 4.61ms (1 run)  | < 5ms  | 🟢     |
| **Database Performance** | 0.435ms | ⚪ established at 0.435ms (1 run) | < 5ms  | 🟢     |
| **Database Performance** | 0.024ms | ⚪ established at 0.024ms (1 run) | < 5ms  | 🟢     |
| **Database Performance** | 0.866ms | ⚪ established at 0.866ms (1 run) | < 5ms  | 🟢     |
| **Database Performance** | 4.245ms | ⚪ established at 4.25ms (1 run)  | < 5ms  | 🟢     |
...
| ----------------------------------------------- | ----- | --------- | ------- |
| database performance (BULK INSERT (100)) (warm) | 🟢    | `█▁`      | 4.245ms |
...
**Run ID:** `dc36a313-a6bb-4278-b126-c0887580ac64` · **Tests invoked:** 1 · **Metrics:** 12 · **DB:** mongodb

| Test                 | Metric                 | Avg (ms) | p95 (ms) | RPS   | Trend | Detail                            |
| -------------------- | ---------------------- | -------- | -------- | ----- | ----- | --------------------------------- |
| Database Performance | INSERT                 | 0.684    | 0.831    | 1125  | 🟢    | ⚪ established at 0.684ms (1 run) |
| Database Performance | FIND ONE               | 0.596    | 0.699    | 1446  | 🟢    | ⚪ established at 0.596ms (1 run) |
| Database Performance | FIND MANY (limit 50)   | 0.838    | 0.974    | 1033  | 🟢    | ⚪ established at 0.838ms (1 run) |
| Database Performance | FIND PAGE (50 hasMore) | 0.833    | 0.951    | 1042  | 🟢    | ⚪ established at 0.833ms (1 run) |
| Database Performance | LIST+COUNT (legacy)    | 4.904    | 6.309    | 199   | 🟢    | ⚪ established at 4.90ms (1 run)  |
| Database Performance | UPDATE                 | 0.747    | 0.891    | 1009  | 🟢    | ⚪ established at 0.747ms (1 run) |
| Database Performance | NATIVE UPSERT          | 0.748    | 0.909    | 993   | 🟢    | ⚪ established at 0.748ms (1 run) |
| Database Performance | COUNT                  | 4.607    | 6.445    | 215   | 🟢    | ⚪ established at 4.61ms (1 run)  |
| Database Performance | COUNT ESTIMATE         | 0.435    | 0.497    | 1960  | 🟢    | ⚪ established at 0.435ms (1 run) |
| Database Performance | COUNT CACHED           | 0.024    | 0.027    | 39673 | 🟢    | ⚪ established at 0.024ms (1 run) |
| Database Performance | DELETE                 | 0.866    | 1.757    | 967   | 🟢    | ⚪ established at 0.866ms (1 run) |
| Database Performance | BULK INSERT (100)      | 4.245    | 7.136    | 214   | 🟢    | ⚪ established at 4.25ms (1 run)  |
...
| --------------------------- | ----- | ------------------ | ------- |
| DATABASE PERFORMANCE (warm) | 🟢    | `▁▁▁▁█▁▁`          | 0.747ms |
...
<summary><strong>🏷️ database performance</strong> · 🟢 4.245ms · ➡️ ⚪ established at 4.25ms (1 run) (2026-08-04 11:48:27) · <a href="../../../tests/benchmarks/database-performance.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
```text
╔═════════════════════════════════════════════════════════════════════════════════════════╗
║                   SVELTYCMS — DATABASE ADAPTER PERFORMANCE (MONGODB)                    ║
║                   File: tests/benchmarks/database-performance.test.ts                   ║
║                                Ran: 2026-08-04 11:48:27                                 ║
║   Measures raw CRUD performance, indexing efficiency, and connection pool resilience    ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ INSERT                         │        0.684 ms │ p95:        0.831 ms │ RPS:      1,125 ║
║ FIND ONE                       │        0.596 ms │ p95:        0.699 ms │ RPS:      1,446 ║
║ FIND MANY (limit 50)           │        0.838 ms │ p95:        0.974 ms │ RPS:      1,033 ║
║ FIND PAGE (50 hasMore)         │        0.833 ms │ p95:        0.951 ms │ RPS:      1,042 ║
║ LIST+COUNT (legacy)            │        4.904 ms │ p95:        6.309 ms │ RPS:        199 ║
║ UPDATE                         │        0.747 ms │ p95:        0.891 ms │ RPS:      1,009 ║
║ NATIVE UPSERT                  │        0.748 ms │ p95:        0.909 ms │ RPS:        993 ║
║ COUNT                          │        4.607 ms │ p95:        6.445 ms │ RPS:        215 ║
║ COUNT ESTIMATE                 │        0.435 ms │ p95:        0.497 ms │ RPS:      1,960 ║
║ COUNT CACHED                   │        0.024 ms │ p95:        0.027 ms │ RPS:     39,673 ║
║ DELETE                         │        0.866 ms │ p95:        1.757 ms │ RPS:        967 ║
║ BULK INSERT (100)              │        4.245 ms │ p95:        7.136 ms │ RPS:        214 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
<!-- LEDGER_TRUTH_END -->
