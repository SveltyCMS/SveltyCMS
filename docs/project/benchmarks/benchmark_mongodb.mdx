...
**✅ PASS** _(partial invocation)_ · 1/36 tests · 35 skipped · **mongodb** · standalone run
...
| ------------------------ | ------- | ---------------------------------------- | ------ | ------ |
| **Database Performance** | 0.670ms | ⚪ stable at 0.729ms (±0.089ms) (2 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.600ms | ⚪ stable at 0.654ms (±0.116ms) (2 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.821ms | ⚪ stable at 0.908ms (±0.140ms) (2 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.867ms | ⚪ established at 0.867ms (1 run)        | < 5ms  | 🟢     |
| **Database Performance** | 0.748ms | ⚪ established at 0.748ms (1 run)        | < 5ms  | 🟢     |
| **Database Performance** | 0.705ms | ⚪ established at 0.705ms (1 run)        | < 5ms  | 🟢     |
| **Database Performance** | 4.925ms | ⚪ established at 4.92ms (1 run)         | < 5ms  | 🟢     |
| **Database Performance** | 0.752ms | ⚪ stable at 0.895ms (±0.297ms) (2 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.746ms | ⚪ stable at 0.816ms (±0.136ms) (2 runs) | < 5ms  | 🟢     |
| **Database Performance** | 3.817ms | ⚪ stable at 4.31ms (±0.598ms) (2 runs)  | < 5ms  | 🟢     |
| **Database Performance** | 0.492ms | ⚪ established at 0.492ms (1 run)        | < 5ms  | 🟢     |
| **Database Performance** | 0.025ms | ⚪ established at 0.025ms (1 run)        | < 5ms  | 🟢     |
| **Database Performance** | 0.972ms | ⚪ stable at 0.935ms (±0.139ms) (2 runs) | < 5ms  | 🟢     |
| **Database Performance** | 4.584ms | ⚪ stable at 4.44ms (±0.390ms) (2 runs)  | < 5ms  | 🟢     |
...
| ----------------------------------------------- | ----- | --------- | ------- |
| database performance (BULK INSERT (100)) (warm) | 🟢    | `█▁▇`     | 4.584ms |
...
quadrantChart
  ...
  quadrant-4 Critical — fix first
    Database Performance: [0.18, 0.40]
    Database Performance: [0.16, 0.41]
    Database Performance: [0.22, 0.48]
    Database Performance: [0.20, 0.80]
    Database Performance: [0.20, 0.43]
    Database Performance: [0.95, 0.57]
```
...
**Run ID:** `aba353ac-8818-4c4a-af96-0329843648e5` · **Tests invoked:** 1 · **Metrics:** 14 · **DB:** mongodb

| Test                 | Metric                 | Avg (ms) | p95 (ms) | RPS   | Trend | Detail                                   |
| -------------------- | ---------------------- | -------- | -------- | ----- | ----- | ---------------------------------------- |
| Database Performance | INSERT                 | 0.670    | 0.823    | 1167  | 🟢    | ⚪ stable at 0.729ms (±0.089ms) (2 runs) |
| Database Performance | FIND ONE               | 0.600    | 0.727    | 1420  | 🟢    | ⚪ stable at 0.654ms (±0.116ms) (2 runs) |
| Database Performance | FIND MANY (limit 50)   | 0.821    | 0.958    | 1055  | 🟢    | ⚪ stable at 0.908ms (±0.140ms) (2 runs) |
| Database Performance | FIND PAGE (50 hasMore) | 0.867    | 0.994    | 1007  | 🟢    | ⚪ established at 0.867ms (1 run)        |
| Database Performance | FIND PAGE keyset       | 0.748    | 0.863    | 1164  | 🟢    | ⚪ established at 0.748ms (1 run)        |
| Database Performance | FIND MANY offset 50    | 0.705    | 0.805    | 1251  | 🟢    | ⚪ established at 0.705ms (1 run)        |
| Database Performance | LIST+COUNT (legacy)    | 4.925    | 6.379    | 200   | 🟢    | ⚪ established at 4.92ms (1 run)         |
| Database Performance | UPDATE                 | 0.752    | 0.890    | 997   | 🟢    | ⚪ stable at 0.895ms (±0.297ms) (2 runs) |
| Database Performance | NATIVE UPSERT          | 0.746    | 0.884    | 1019  | 🟢    | ⚪ stable at 0.816ms (±0.136ms) (2 runs) |
| Database Performance | COUNT                  | 3.817    | 5.445    | 259   | 🟢    | ⚪ stable at 4.31ms (±0.598ms) (2 runs)  |
| Database Performance | COUNT ESTIMATE         | 0.492    | 0.672    | 1708  | 🟢    | ⚪ established at 0.492ms (1 run)        |
| Database Performance | COUNT CACHED           | 0.025    | 0.028    | 37204 | 🟢    | ⚪ established at 0.025ms (1 run)        |
| Database Performance | DELETE                 | 0.972    | 2.212    | 847   | 🟢    | ⚪ stable at 0.935ms (±0.139ms) (2 runs) |
| Database Performance | BULK INSERT (100)      | 4.584    | 7.584    | 181   | 🟢    | ⚪ stable at 4.44ms (±0.390ms) (2 runs)  |
...
| --------------------------- | ----- | ------------------ | ------- |
| DATABASE PERFORMANCE (warm) | 🟢    | `▁▁▁▁█▁▁`          | 0.752ms |
