...
| -------------------------------- | -------- | --------------------------------- | ------ | ------ |
| **Competitive Workload Replica** | 2.331ms  | ⚪ established at 2.33ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 7.667ms  | ⚪ established at 7.67ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 2.443ms  | ⚪ established at 2.44ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 2.417ms  | ⚪ established at 2.42ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 2.461ms  | ⚪ established at 2.46ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 2.244ms  | ⚪ established at 2.24ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 4.521ms  | ⚪ established at 4.52ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 10.063ms | ⚪ established at 10.06ms (1 run) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 9.596ms  | ⚪ established at 9.60ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 8.789ms  | ⚪ established at 8.79ms (1 run)  | < 5ms  | 🟢     |
...
**Run ID:** `f98ddea7-21bc-4cd8-bd5d-b05ac0e44346` · **Tests invoked:** 1 · **Metrics:** 10 · **DB:** mongodb

| Test                         | Metric                                   | Avg (ms) | p95 (ms) | RPS  | Trend | Detail                            |
| ---------------------------- | ---------------------------------------- | -------- | -------- | ---- | ----- | --------------------------------- |
| Competitive Workload Replica | findById (Concurrent 8c)                 | 2.331    | 3.672    | 3269 | 🟢    | ⚪ established at 2.33ms (1 run)  |
| Competitive Workload Replica | findByIdRandom (Concurrent 8c)           | 7.667    | 10.136   | 1030 | 🟢    | ⚪ established at 7.67ms (1 run)  |
| Competitive Workload Replica | listPlain (Concurrent 8c)                | 2.443    | 5.352    | 3140 | 🟢    | ⚪ established at 2.44ms (1 run)  |
| Competitive Workload Replica | listFilterSort (Concurrent 8c)           | 2.417    | 3.593    | 3139 | 🟢    | ⚪ established at 2.42ms (1 run)  |
| Competitive Workload Replica | listLarge (Concurrent 8c)                | 2.461    | 3.478    | 3099 | 🟢    | ⚪ established at 2.46ms (1 run)  |
| Competitive Workload Replica | findMissing (Concurrent 8c)              | 2.244    | 5.589    | 3419 | 🟢    | ⚪ established at 2.24ms (1 run)  |
| Competitive Workload Replica | GraphQL Collection Query (Concurrent 8c) | 4.521    | 6.307    | 1751 | 🟢    | ⚪ established at 4.52ms (1 run)  |
| Competitive Workload Replica | create (Concurrent 8c)                   | 10.063   | 15.454   | 788  | 🟢    | ⚪ established at 10.06ms (1 run) |
| Competitive Workload Replica | update (Concurrent 8c)                   | 9.596    | 11.367   | 832  | 🟢    | ⚪ established at 9.60ms (1 run)  |
| Competitive Workload Replica | mixed (Concurrent 8c 50/50)              | 8.789    | 11.282   | 899  | 🟢    | ⚪ established at 8.79ms (1 run)  |
...
| ----------------------------------- | ----- | ------------------ | ------- |
| COMPETITIVE WORKLOAD REPLICA (warm) | 🟢    | `▆▁▁▁▁▇█`          | 9.596ms |
