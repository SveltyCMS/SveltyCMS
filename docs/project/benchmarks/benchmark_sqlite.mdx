...
| ------------ | ------- | ---------------------------------------- | ------ | ------ |
| **System**   | 0.533ms | ⚪ stable at 0.645ms (±0.415ms) (5 runs) | < 5ms  | 🟢     |
| **Metadata** | 0.783ms | ⚪ stable at 0.851ms (±1.27ms) (5 runs)  | < 5ms  | 🟢     |
| **CRUD**     | 0.762ms | ⚪ stable at 0.845ms (±1.39ms) (5 runs)  | < 5ms  | 🟢     |
| **CRUD**     | 0.749ms | ⚪ stable at 0.835ms (±1.60ms) (5 runs)  | < 5ms  | 🟢     |
...
| ---------------------------------------------------- | ----- | -------------- | ---------- |
| api latency (HTTP: findById @ 8c) (warm)             | 🟢    | `██▂▂▁▁▁▁▁▁▁▁` | 2.143ms    |
| auth performance (Auth Validation @ 1c) (warm)       | 🟢    | `▁`            | 1.608ms    |
| cold start phased (Cold Start (IDLE → READY)) (cold) | 🟢    | `█▃▁▁`         | 1413.809ms |
| database performance (BULK INSERT (100)) (warm)      | 🟢    | `▆▅█▁▂▂▂▂▂▂▃▁` | 1.116ms    |
...
### Current Run Summary (2026-08-13)

> **Scope:** Only tests that ran in THIS invocation.

> ⚠️ Executive PASS/FAIL reflects the last full matrix run.

**Run ID:** `8d2101b7-3fed-44f1-8173-acbad3ab83af` · **Tests invoked:** 1 · **Metrics:** 4 · **DB:** sqlite

| Test                 | Metric                 | Avg (ms) | p95 (ms) | RPS  | Trend | Detail                                   |
| -------------------- | ---------------------- | -------- | -------- | ---- | ----- | ---------------------------------------- |
| Rest Api Performance | Health Check           | 0.533    | 1.110    | 1877 | 🟢    | ⚪ stable at 0.645ms (±0.415ms) (5 runs) |
| Rest Api Performance | Collection Schema      | 0.783    | 1.476    | 1277 | 🟢    | ⚪ stable at 0.851ms (±1.27ms) (5 runs)  |
| Rest Api Performance | Collection Find (List) | 0.762    | 1.474    | 1313 | 🟢    | ⚪ stable at 0.845ms (±1.39ms) (5 runs)  |
| Rest Api Performance | Collection Search      | 0.749    | 1.356    | 1335 | 🟢    | ⚪ stable at 0.835ms (±1.60ms) (5 runs)  |

<!-- SUMMARY_RUN_OVERLAY_END -->

<!-- SUMMARY_HISTORY_START -->

### Historical Trends (2026-08-13)
...
| REST API PERFORMANCE (warm)    | ⚪    | `██▁▆▇▆▁`          | 0.533ms    |
| TRANSACTION ACID (warm)        | ⚪    | `▆█▆▃▂▁`           | 0.145ms    |
...
<summary><strong>🏷️ cold start phased</strong> · 🟢 1413.809ms · ↘️ ⚪ stable at 1986.05ms (±2561.71ms) (3 runs) (2026-08-13 22:23:24) · <a href="../../../tests/benchmarks/cold-start-phased.test.ts">source</a></summary>
...
║                                Ran: 2026-08-13 22:23:24                                 ║
║       Measures server cold-start latency to READY state, using the built server.        ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Cold Start (IDLE → READY)      │     1413.809 ms │ p95:     1998.201 ms │ RPS:          0 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
║                                Ran: 2026-08-13 22:23:31                                 ║
║     Validates performance claims by comparing SDK, Middleware, and Real HTTP Stack      ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Logic Baseline                 │        0.000 ms │ p95:        0.001 ms │ RPS:  3,257,329 ║
║ Local SDK (Full)               │        0.007 ms │ p95:        0.013 ms │ RPS:    140,213 ║
║ HTTP End-to-End                │        0.490 ms │ p95:        0.613 ms │ RPS:      2,040 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ Middleware & Hooks Performance</strong> · 🟢 0.192ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/hooks-performance.test.ts">source</a></summary>
...
║                                Ran: 2026-08-13 22:24:38                                 ║
║Measures the cost of the full middleware chain including Turbo, Security, Auth, and Audit via HTTP E2E.║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Static Asset (No Middleware)   │        0.192 ms │ p95:        0.261 ms │ RPS:      4,752 ║
║ Turbo Pipeline (Light)         │        0.245 ms │ p95:        0.314 ms │ RPS:      3,682 ║
║ Full Security + Auth Pipeline  │        0.431 ms │ p95:        0.557 ms │ RPS:      1,980 ║
║ REST with API Caching          │        0.352 ms │ p95:        0.435 ms │ RPS:      2,490 ║
║ Mutation (audit logging disabled) │        1.363 ms │ p95:        1.631 ms │ RPS:        616 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ database performance</strong> · 🟢 1.116ms · ↘️ ⚪ stable at 1.23ms (±0.091ms) (7 runs) (2026-08-13 22:24:09) · <a href="../../../tests/benchmarks/database-performance.test.ts">source</a></summary>
<!-- LEDGER_INSIGHT_START -->
> [!NOTE]
> **Specific to this test**: Performance improved — recent optimizations or cache warming likely effective.
<!-- LEDGER_INSIGHT_END -->
...
║                                Ran: 2026-08-13 22:24:09                                 ║
║   Measures raw CRUD performance, indexing efficiency, and connection pool resilience    ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ INSERT                         │        0.046 ms │ p95:        0.063 ms │ RPS:     10,935 ║
║ FIND ONE                       │        0.006 ms │ p95:        0.008 ms │ RPS:    131,456 ║
║ FIND MANY (limit 50)           │        0.089 ms │ p95:        0.103 ms │ RPS:      9,194 ║
║ FIND PAGE (50 hasMore)         │        0.105 ms │ p95:        0.119 ms │ RPS:      7,771 ║
║ FIND PAGE keyset               │        0.098 ms │ p95:        0.116 ms │ RPS:      8,438 ║
║ FIND MANY offset 50            │        0.053 ms │ p95:        0.065 ms │ RPS:     14,891 ║
║ LIST+COUNT (legacy)            │        0.174 ms │ p95:        0.197 ms │ RPS:      4,959 ║
║ UPDATE                         │        0.026 ms │ p95:        0.030 ms │ RPS:     24,255 ║
║ UPDATE (no-returning)          │        0.022 ms │ p95:        0.026 ms │ RPS:     27,058 ║
║ NATIVE UPSERT                  │        0.057 ms │ p95:        0.066 ms │ RPS:     12,617 ║
║ COUNT                          │        0.107 ms │ p95:        0.114 ms │ RPS:      8,507 ║
║ COUNT ESTIMATE                 │        0.022 ms │ p95:        0.026 ms │ RPS:     39,918 ║
║ COUNT CACHED                   │        0.001 ms │ p95:        0.002 ms │ RPS:    539,180 ║
║ DELETE                         │        0.046 ms │ p95:        0.057 ms │ RPS:     14,979 ║
║ BULK INSERT (100)              │        1.116 ms │ p95:        1.279 ms │ RPS:        265 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ transaction acid</strong> · 🟢 0.145ms · ↘️ ⚪ stable at 0.446ms (±0.297ms) (2 runs) (2026-08-13 22:24:18) · <a href="../../../tests/benchmarks/transaction-acid.test.ts">source</a></summary>
<!-- LEDGER_INSIGHT_START -->
> [!NOTE]
> **Specific to this test**: Performance improved — recent optimizations or cache warming likely effective.
<!-- LEDGER_INSIGHT_END -->
...
║                                Ran: 2026-08-13 22:24:18                                 ║
║  Measures transaction commit latencies and rollback overhead across database adapters   ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ TX Commit                      │        0.190 ms │ p95:        0.379 ms │ RPS:      3,456 ║
║ TX Rollback Integrity          │        0.145 ms │ p95:        0.163 ms │ RPS:      6,883 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ Cache</strong> · ⚪ 0.356ms · ↘️ 🟢 faster: 0.803ms → 0.356ms (-56%) (6 runs) (2026-08-13 22:24:27) · <a href="../../../tests/benchmarks/cache-performance.test.ts">source</a></summary>
<!-- LEDGER_INSIGHT_START -->
> [!NOTE]
> **Specific to this test**: Performance improved — recent optimizations or cache warming likely effective.
<!-- LEDGER_INSIGHT_END -->
...
<summary><strong>🏷️ HTTP</strong> · 🟢 0.490ms · ↘️ ⚪ stable at 1.17ms (±1.28ms) (2 runs) (2026-08-13 22:23:42) · <a href="../../../tests/benchmarks/truth-latency.test.ts">source</a></summary>
<!-- LEDGER_INSIGHT_START -->
> [!NOTE]
> **Specific to this test**: Performance improved — recent optimizations or cache warming likely effective.
<!-- LEDGER_INSIGHT_END -->
...
<summary><strong>🏷️ Logic</strong> · 🟢 ⏳ pending · ↘️ ⚪ stable at 0.001ms (±0.001ms) (2 runs) (2026-08-13 22:23:42) · <a href="../../../tests/benchmarks/truth-latency.test.ts">source</a></summary>
<!-- LEDGER_INSIGHT_START -->
> [!NOTE]
> **Specific to this test**: Performance improved — recent optimizations or cache warming likely effective.
<!-- LEDGER_INSIGHT_END -->
...
<summary><strong>🏷️ SDK</strong> · ⚪ 0.007ms · ↘️ ⚪ stable at 0.009ms (±0.001ms) (2 runs) (2026-08-13 22:23:42) · <a href="../../../tests/benchmarks/truth-latency.test.ts">source</a></summary>
<!-- LEDGER_INSIGHT_START -->
> [!NOTE]
> **Specific to this test**: Performance improved — recent optimizations or cache warming likely effective.
<!-- LEDGER_INSIGHT_END -->
...
<summary><strong>🏷️ Middleware</strong> · 🟢 1.363ms · ↘️ ⚪ stable at 1.86ms (±0.372ms) (4 runs) (2026-08-13 22:24:38) · <a href="../../../tests/benchmarks/hooks-performance.test.ts">source</a></summary>
<!-- LEDGER_INSIGHT_START -->
> [!NOTE]
> **Specific to this test**: Performance improved — recent optimizations or cache warming likely effective.
<!-- LEDGER_INSIGHT_END -->
...
<summary><strong>🏷️ System</strong> · 🟢 0.533ms · ↘️ ⚪ stable at 0.645ms (±0.415ms) (5 runs) (2026-08-13 22:24:47) · <a href="../../../tests/benchmarks/rest-api-performance.test.ts">source</a></summary>
<!-- LEDGER_INSIGHT_START -->
> [!NOTE]
> **Specific to this test**: Performance improved — recent optimizations or cache warming likely effective.
<!-- LEDGER_INSIGHT_END -->
...
<summary><strong>🏷️ Metadata</strong> · 🟢 0.783ms · ↘️ ⚪ stable at 0.851ms (±1.27ms) (5 runs) (2026-08-13 22:24:47) · <a href="../../../tests/benchmarks/rest-api-performance.test.ts">source</a></summary>
<!-- LEDGER_INSIGHT_START -->
> [!NOTE]
> **Specific to this test**: Performance improved — recent optimizations or cache warming likely effective.
<!-- LEDGER_INSIGHT_END -->
...
<summary><strong>🏷️ CRUD</strong> · 🟢 0.749ms · ↘️ ⚪ stable at 0.835ms (±1.60ms) (5 runs) (2026-08-13 22:24:47) · <a href="../../../tests/benchmarks/rest-api-performance.test.ts">source</a></summary>
<!-- LEDGER_INSIGHT_START -->
> [!NOTE]
> **Specific to this test**: Performance improved — recent optimizations or cache warming likely effective.
<!-- LEDGER_INSIGHT_END -->
...
<summary><strong>🏷️ REST API Performance</strong> · 🟢 0.533ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/rest-api-performance.test.ts">source</a></summary>
...
║                                Ran: 2026-08-13 22:24:47                                 ║
║Measures latency, throughput, and correctness of core REST endpoints: health check, schema, CRUD list, and search.║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Health Check                   │        0.533 ms │ p95:        1.110 ms │ RPS:      1,877 ║
║ Collection Schema              │        0.783 ms │ p95:        1.476 ms │ RPS:      1,277 ║
║ Collection Find (List)         │        0.762 ms │ p95:        1.474 ms │ RPS:      1,313 ║
║ Collection Search              │        0.749 ms │ p95:        1.356 ms │ RPS:      1,335 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
