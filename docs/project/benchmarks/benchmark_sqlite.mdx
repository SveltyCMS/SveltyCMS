...
| ------------ | ------- | -------------------------------- | ------ | ------ |
| **System**   | 2.184ms | ⚪ established at 2.18ms (1 run) | < 5ms  | 🟢     |
| **Metadata** | 2.758ms | ⚪ established at 2.76ms (1 run) | < 5ms  | 🟢     |
| **CRUD**     | 4.675ms | ⚪ established at 4.67ms (1 run) | < 5ms  | 🟢     |
| **CRUD**     | 4.266ms | ⚪ established at 4.27ms (1 run) | < 5ms  | 🟢     |
...
| database performance (warm) | 🟢    | `█▂▁▃`    | 0.113ms |
...
**Run ID:** `87c0ad6b-5654-43c4-bb88-3a9593900e5d` · **Tests invoked:** 1 · **Metrics:** 4 · **DB:** sqlite

| Test                 | Metric                 | Avg (ms) | p95 (ms) | RPS | Trend | Detail                           |
| -------------------- | ---------------------- | -------- | -------- | --- | ----- | -------------------------------- |
| Rest Api Performance | Health Check           | 2.184    | 4.187    | 458 | 🟢    | ⚪ established at 2.18ms (1 run) |
| Rest Api Performance | Collection Schema      | 2.758    | 4.392    | 363 | 🟢    | ⚪ established at 2.76ms (1 run) |
| Rest Api Performance | Collection Find (List) | 4.675    | 7.985    | 214 | 🟢    | ⚪ established at 4.67ms (1 run) |
| Rest Api Performance | Collection Search      | 4.266    | 6.827    | 234 | 🟢    | ⚪ established at 4.27ms (1 run) |
...
| CACHE PERFORMANCE (warm)          | 🟢    | `█▁`                | 0.626ms   | 2    |
...
| DATABASE PERFORMANCE (warm)       | 🟢    | `█▂▁▃`              | 0.113ms   | 4    |
...
| HOOKS PERFORMANCE (warm)          | 🟢    | `█▅▁▂`              | 0.117ms   | 4    |
...
| TRANSACTION ACID (warm)           | ⚪    | `▇█▆▁`              | 0.338ms   | 4    |
...
║                                Ran: 2026-07-04 07:44:29                                 ║
║     Validates performance claims by comparing SDK, Middleware, and Real HTTP Stack      ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Logic Baseline                 │        0.001 ms │ p95:        0.001 ms │ RPS:  1,431,298 ║
║ Local SDK (Full)               │        0.007 ms │ p95:        0.012 ms │ RPS:    148,743 ║
║ HTTP End-to-End                │        0.745 ms │ p95:        1.550 ms │ RPS:      1,342 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ Middleware & Hooks Performance</strong> · 🟢 0.117ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/hooks-performance.test.ts">source</a></summary>
...
║                                Ran: 2026-07-04 07:47:55                                 ║
║Measures the cost of the full middleware chain including Turbo, Security, Auth, and Audit via HTTP E2E.║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Static Asset (No Middleware)   │        0.117 ms │ p95:        0.157 ms │ RPS:      8,317 ║
║ Turbo Pipeline (Light)         │        0.625 ms │ p95:        0.783 ms │ RPS:      1,474 ║
║ Full Security + Auth Pipeline  │        0.958 ms │ p95:        1.093 ms │ RPS:      1,002 ║
║ REST with API Caching          │        0.919 ms │ p95:        1.212 ms │ RPS:      1,035 ║
║ Mutation + Audit Logging       │        2.366 ms │ p95:        3.346 ms │ RPS:        423 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ Database Adapter Raw CRUD</strong> · 🟢 0.113ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/database-performance.test.ts">source</a></summary>
...
║                                Ran: 2026-07-04 07:45:40                                 ║
║   Measures raw CRUD performance, indexing efficiency, and connection pool resilience    ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ INSERT                         │        0.113 ms │ p95:        0.209 ms │ RPS:      5,425 ║
║ FIND ONE                       │        0.083 ms │ p95:        0.130 ms │ RPS:      9,630 ║
║ FIND MANY (limit 50)           │        0.107 ms │ p95:        0.165 ms │ RPS:      7,407 ║
║ UPDATE                         │        0.099 ms │ p95:        0.139 ms │ RPS:      7,735 ║
║ NATIVE UPSERT                  │        0.079 ms │ p95:        0.111 ms │ RPS:      9,428 ║
║ COUNT                          │        0.197 ms │ p95:        0.293 ms │ RPS:      4,412 ║
║ DELETE                         │        0.050 ms │ p95:        0.071 ms │ RPS:     14,727 ║
║ BULK INSERT (100)              │        2.126 ms │ p95:        3.841 ms │ RPS:        288 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ ACID Transaction Overhead</strong> · 🟢 0.338ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/transaction-acid.test.ts">source</a></summary>
...
║                                Ran: 2026-07-04 07:46:25                                 ║
║  Measures transaction commit latencies and rollback overhead across database adapters   ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ TX Commit                      │        0.338 ms │ p95:        0.760 ms │ RPS:      1,934 ║
║ TX Rollback Integrity          │        0.406 ms │ p95:        0.579 ms │ RPS:      2,464 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ Cache</strong> · 🟢 0.626ms · ➡️ ⚪ established at 0.626ms (1 run) (2026-07-04 07:47:09) · <a href="../../../tests/benchmarks/cache-performance.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
```text
╔═════════════════════════════════════════════════════════════════════════════════════════╗
║                           SVELTYCMS — CACHE EFFICIENCY AUDIT                            ║
║                    File: tests/benchmarks/cache-performance.test.ts                     ║
║                                Ran: 2026-07-04 07:47:09                                 ║
║  Measures cache hit vs miss latency and efficiency via real HTTP end-to-end requests.   ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Cache Miss (Bypass)            │        0.626 ms │ p95:        0.852 ms │ RPS:      1,435 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
<!-- LEDGER_TRUTH_END -->
...
<summary><strong>🏷️ HTTP</strong> · 🟢 0.745ms · ➡️ ⚪ established at 0.745ms (1 run) (2026-07-04 07:44:40) · <a href="../../../tests/benchmarks/truth-latency.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
> ⏳ Pending
<!-- LEDGER_TRUTH_END -->
...
<summary><strong>🏷️ Logic</strong> · 🟢 0.001ms · ➡️ ⚪ established at 0.001ms (1 run) (2026-07-04 07:44:40) · <a href="../../../tests/benchmarks/truth-latency.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
> ⏳ Pending
<!-- LEDGER_TRUTH_END -->
...
<summary><strong>🏷️ SDK</strong> · 🟢 0.007ms · ➡️ ⚪ established at 0.007ms (1 run) (2026-07-04 07:44:40) · <a href="../../../tests/benchmarks/truth-latency.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
> ⏳ Pending
<!-- LEDGER_TRUTH_END -->
...
<summary><strong>🏷️ unknown</strong> · ⚪ 0.406ms · ↗️ ⚪ stable at 0.382ms (±0.011ms) (3 runs) (2026-07-04 07:46:25) · <a href="../../../tests/benchmarks/transaction-acid.test.ts">source</a></summary>
...
<summary><strong>🏷️ Middleware</strong> · ⚪ 2.366ms · ↗️ 🔴 slower: 0.148ms → 2.37ms (+1499%) (3 runs) (2026-07-04 07:47:55) · <a href="../../../tests/benchmarks/hooks-performance.test.ts">source</a></summary>
<!-- LEDGER_INSIGHT_START -->
> [!NOTE]
...
**Severe degradation** (+1499%) — review recent commits immediately.
<!-- LEDGER_INSIGHT_END -->
...
<summary><strong>🏷️ System</strong> · 🟢 2.184ms · ➡️ ⚪ established at 2.18ms (1 run) (2026-07-04 07:48:38) · <a href="../../../tests/benchmarks/rest-api-performance.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
> ⏳ Pending
<!-- LEDGER_TRUTH_END -->
...
<summary><strong>🏷️ Metadata</strong> · 🟢 2.758ms · ➡️ ⚪ established at 2.76ms (1 run) (2026-07-04 07:48:38) · <a href="../../../tests/benchmarks/rest-api-performance.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
> ⏳ Pending
<!-- LEDGER_TRUTH_END -->
...
<summary><strong>🏷️ CRUD</strong> · 🟢 4.266ms · ➡️ ⚪ established at 4.27ms (1 run) (2026-07-04 07:48:38) · <a href="../../../tests/benchmarks/rest-api-performance.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
> ⏳ Pending
<!-- LEDGER_TRUTH_END -->
...
<summary><strong>🏷️ REST API Performance</strong> · 🟢 2.184ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/rest-api-performance.test.ts">source</a></summary>
...
║                                Ran: 2026-07-04 07:48:38                                 ║
║Measures latency, throughput, and correctness of core REST endpoints: health check, schema, CRUD list, and search.║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Health Check                   │        2.184 ms │ p95:        4.187 ms │ RPS:        458 ║
║ Collection Schema              │        2.758 ms │ p95:        4.392 ms │ RPS:        363 ║
║ Collection Find (List)         │        4.675 ms │ p95:        7.985 ms │ RPS:        214 ║
║ Collection Search              │        4.266 ms │ p95:        6.827 ms │ RPS:        234 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
