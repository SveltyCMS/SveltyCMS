...
| ------------------------ | ------- | ---------------------------------------- | ------ | ------ |
| **Database Performance** | 0.073ms | ⚪ stable at 0.074ms (±0.028ms) (4 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.053ms | ⚪ stable at 0.054ms (±0.011ms) (4 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.068ms | ⚪ stable at 0.069ms (±0.014ms) (4 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.074ms | ⚪ stable at 0.073ms (±0.031ms) (4 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.049ms | ⚪ stable at 0.050ms (±0.007ms) (4 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.118ms | ⚪ stable at 0.120ms (±0.033ms) (4 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.030ms | ⚪ stable at 0.030ms (±0.002ms) (4 runs) | < 5ms  | 🟢     |
| **Database Performance** | 2.248ms | ⚪ stable at 2.36ms (±0.206ms) (4 runs)  | < 5ms  | 🟢     |
...
| ----------------------------------------------- | ----- | --------- | ------- |
| database performance (BULK INSERT (100)) (warm) | 🟢    | `▂█▆▁▁`   | 2.248ms |
...
**Run ID:** `2b5fa7a6-112c-4ff6-8923-58c5b7895895` · **Tests invoked:** 1 · **Metrics:** 8 · **DB:** sqlite

| Test                 | Metric               | Avg (ms) | p95 (ms) | RPS   | Trend | Detail                                   |
| -------------------- | -------------------- | -------- | -------- | ----- | ----- | ---------------------------------------- |
| Database Performance | INSERT               | 0.073    | 0.095    | 6534  | 🟢    | ⚪ stable at 0.074ms (±0.028ms) (4 runs) |
| Database Performance | FIND ONE             | 0.053    | 0.061    | 17382 | 🟢    | ⚪ stable at 0.054ms (±0.011ms) (4 runs) |
| Database Performance | FIND MANY (limit 50) | 0.068    | 0.078    | 13830 | 🟢    | ⚪ stable at 0.069ms (±0.014ms) (4 runs) |
| Database Performance | UPDATE               | 0.074    | 0.087    | 11237 | 🟢    | ⚪ stable at 0.073ms (±0.031ms) (4 runs) |
| Database Performance | NATIVE UPSERT        | 0.049    | 0.055    | 16875 | 🟢    | ⚪ stable at 0.050ms (±0.007ms) (4 runs) |
| Database Performance | COUNT                | 0.118    | 0.126    | 8223  | 🟢    | ⚪ stable at 0.120ms (±0.033ms) (4 runs) |
| Database Performance | DELETE               | 0.030    | 0.035    | 25965 | 🟢    | ⚪ stable at 0.030ms (±0.002ms) (4 runs) |
| Database Performance | BULK INSERT (100)    | 2.248    | 4.022    | 203   | 🟢    | ⚪ stable at 2.36ms (±0.206ms) (4 runs)  |
...
| --------------------------- | ----- | ------------------ | ------- |
| DATABASE PERFORMANCE (warm) | 🟢    | `█▁▄▃▄▃▅`          | 0.074ms |
...
<summary><strong>🏷️ database performance</strong> · 🟢 2.248ms · ➡️ ⚪ stable at 2.36ms (±0.206ms) (4 runs) (2026-08-04 10:58:16) · <a href="../../../tests/benchmarks/database-performance.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
```text
╔═════════════════════════════════════════════════════════════════════════════════════════╗
║                    SVELTYCMS — DATABASE ADAPTER PERFORMANCE (SQLITE)                    ║
║                   File: tests/benchmarks/database-performance.test.ts                   ║
║                                Ran: 2026-08-04 10:58:16                                 ║
║   Measures raw CRUD performance, indexing efficiency, and connection pool resilience    ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ INSERT                         │        0.073 ms │ p95:        0.095 ms │ RPS:      6,534 ║
║ FIND ONE                       │        0.053 ms │ p95:        0.061 ms │ RPS:     17,382 ║
║ FIND MANY (limit 50)           │        0.068 ms │ p95:        0.078 ms │ RPS:     13,830 ║
║ UPDATE                         │        0.074 ms │ p95:        0.087 ms │ RPS:     11,237 ║
║ NATIVE UPSERT                  │        0.049 ms │ p95:        0.055 ms │ RPS:     16,875 ║
║ COUNT                          │        0.118 ms │ p95:        0.126 ms │ RPS:      8,223 ║
║ DELETE                         │        0.030 ms │ p95:        0.035 ms │ RPS:     25,965 ║
║ BULK INSERT (100)              │        2.248 ms │ p95:        4.022 ms │ RPS:        203 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
<!-- LEDGER_TRUTH_END -->
