...
| -------------- | ------- | ---------------------------------------- | ------ | ------ |
| **Middleware** | 0.476ms | ⚪ stable at 0.494ms (±0.017ms) (4 runs) | < 5ms  | 🟢     |
| **Middleware** | 0.287ms | ⚪ stable at 0.301ms (±0.032ms) (4 runs) | < 5ms  | 🟢     |
| **Middleware** | 0.845ms | ⚪ stable at 0.857ms (±0.007ms) (4 runs) | < 5ms  | 🟢     |
| **Middleware** | 0.849ms | ⚪ stable at 0.893ms (±0.078ms) (4 runs) | < 5ms  | 🟢     |
| **Middleware** | 2.272ms | ⚪ stable at 2.59ms (±0.456ms) (4 runs)  | < 5ms  | 🟢     |
...
**Run ID:** `2124cffa-7b52-4163-8de1-1c58c37ca942` · **Tests invoked:** 1 · **Metrics:** 5 · **DB:** sqlite

| Test              | Metric                        | Avg (ms) | p95 (ms) | RPS  | Trend | Detail                                   |
| ----------------- | ----------------------------- | -------- | -------- | ---- | ----- | ---------------------------------------- |
| Hooks Performance | Static Asset (No Middleware)  | 0.476    | 0.575    | 1983 | 🟢    | ⚪ stable at 0.494ms (±0.017ms) (4 runs) |
| Hooks Performance | Turbo Pipeline (Light)        | 0.287    | 0.356    | 3290 | 🟢    | ⚪ stable at 0.301ms (±0.032ms) (4 runs) |
| Hooks Performance | Full Security + Auth Pipeline | 0.845    | 1.110    | 1027 | 🟢    | ⚪ stable at 0.857ms (±0.007ms) (4 runs) |
| Hooks Performance | REST with API Caching         | 0.849    | 1.064    | 1063 | 🟢    | ⚪ stable at 0.893ms (±0.078ms) (4 runs) |
| Hooks Performance | Mutation + Audit Logging      | 2.272    | 3.410    | 414  | 🟢    | ⚪ stable at 2.59ms (±0.456ms) (4 runs)  |
