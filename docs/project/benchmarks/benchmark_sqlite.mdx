...
| ------------------------ | ------- | ---------------------------------------- | ------ | ------ |
| **Database Performance** | 0.070ms | ⚪ stable at 0.043ms (±0.044ms) (7 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.010ms | ⚪ stable at 0.010ms (±0.005ms) (7 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.115ms | ⚪ stable at 0.094ms (±0.027ms) (7 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.771ms | ⚪ stable at 0.682ms (±0.061ms) (7 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.612ms | ⚪ stable at 0.558ms (±0.103ms) (7 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.066ms | ⚪ stable at 0.055ms (±0.003ms) (7 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.222ms | ⚪ stable at 0.194ms (±0.020ms) (7 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.109ms | ⚪ stable at 0.085ms (±0.030ms) (7 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.060ms | ⚪ stable at 0.051ms (±0.010ms) (7 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.080ms | ⚪ stable at 0.076ms (±0.012ms) (7 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.150ms | ⚪ stable at 0.143ms (±0.028ms) (7 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.030ms | ⚪ stable at 0.032ms (±0.007ms) (7 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.003ms | ⚪ stable at 0.002ms (±0.001ms) (7 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.052ms | ⚪ stable at 0.054ms (±0.006ms) (7 runs) | < 5ms  | 🟢     |
| **Database Performance** | 1.500ms | ⚪ stable at 1.22ms (±0.523ms) (7 runs)  | < 5ms  | 🟢     |
...
| ---------------------------------------------------- | ----- | -------------- | ---------- |
| api latency (HTTP: findById @ 8c) (warm)             | 🟢    | `▃▁▂█▃▃▂`      | 4.783ms    |
...
quadrantChart
  ...
  quadrant-4 Critical — fix first
    ...
    Database Performance: [0.08, 0.36]
    Database Performance: [0.51, 0.21]
    Database Performance: [0.41, 0.15]
    Database Performance: [0.05, 0.32]
    Database Performance: [0.15, 0.23]
    Database Performance: [0.07, 0.45]
    Database Performance: [0.05, 0.28]
```
...
### Current Run Summary (2026-08-09)

> **Scope:** Only tests that ran in THIS invocation.

> ⚠️ Executive PASS/FAIL reflects the last full matrix run.

**Run ID:** `9c195735-a0b3-4e7d-adf3-8045a5ba403e` · **Tests invoked:** 1 · **Metrics:** 15 · **DB:** sqlite

| Test                 | Metric                 | Avg (ms) | p95 (ms) | RPS    | Trend | Detail                                   |
| -------------------- | ---------------------- | -------- | -------- | ------ | ----- | ---------------------------------------- |
| Database Performance | INSERT                 | 0.070    | 0.099    | 7762   | 🟢    | ⚪ stable at 0.043ms (±0.044ms) (7 runs) |
| Database Performance | FIND ONE               | 0.010    | 0.014    | 93983  | 🟢    | ⚪ stable at 0.010ms (±0.005ms) (7 runs) |
| Database Performance | FIND MANY (limit 50)   | 0.115    | 0.145    | 7757   | 🟢    | ⚪ stable at 0.094ms (±0.027ms) (7 runs) |
| Database Performance | FIND PAGE (50 hasMore) | 0.771    | 0.874    | 1257   | 🟢    | ⚪ stable at 0.682ms (±0.061ms) (7 runs) |
| Database Performance | FIND PAGE keyset       | 0.612    | 0.685    | 1572   | 🟢    | ⚪ stable at 0.558ms (±0.103ms) (7 runs) |
| Database Performance | LIST+COUNT (legacy)    | 0.222    | 0.258    | 4206   | 🟢    | ⚪ stable at 0.194ms (±0.020ms) (7 runs) |
| Database Performance | UPDATE                 | 0.109    | 0.135    | 7567   | 🟢    | ⚪ stable at 0.085ms (±0.030ms) (7 runs) |
| Database Performance | UPDATE (no-returning)  | 0.060    | 0.073    | 12786  | 🟢    | ⚪ stable at 0.051ms (±0.010ms) (7 runs) |
| Database Performance | NATIVE UPSERT          | 0.080    | 0.097    | 10335  | 🟢    | ⚪ stable at 0.076ms (±0.012ms) (7 runs) |
| Database Performance | COUNT                  | 0.150    | 0.169    | 6227   | 🟢    | ⚪ stable at 0.143ms (±0.028ms) (7 runs) |
| Database Performance | COUNT ESTIMATE         | 0.030    | 0.036    | 29971  | 🟢    | ⚪ stable at 0.032ms (±0.007ms) (7 runs) |
| Database Performance | COUNT CACHED           | 0.003    | 0.006    | 258582 | 🟢    | ⚪ stable at 0.002ms (±0.001ms) (7 runs) |
| Database Performance | DELETE                 | 0.052    | 0.067    | 14700  | 🟢    | ⚪ stable at 0.054ms (±0.006ms) (7 runs) |
| Database Performance | BULK INSERT (100)      | 1.500    | 1.751    | 194    | 🟢    | ⚪ stable at 1.22ms (±0.523ms) (7 runs)  |
| Database Performance | FIND MANY offset 50    | 0.066    | 0.081    | 13653  | ⚪    | ⚪ stable at 0.055ms (±0.003ms) (7 runs) |

<!-- SUMMARY_RUN_OVERLAY_END -->

<!-- SUMMARY_HISTORY_START -->

### Historical Trends (2026-08-09)
...
<summary><strong>🏷️ Middleware & Hooks Performance</strong> · 🟢 0.780ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/hooks-performance.test.ts">source</a></summary>
...
║                                Ran: 2026-08-09 22:11:42                                 ║
║Measures the cost of the full middleware chain including Turbo, Security, Auth, and Audit via HTTP E2E.║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Static Asset (No Middleware)   │        0.780 ms │ p95:        0.955 ms │ RPS:      1,172 ║
║ Turbo Pipeline (Light)         │        0.377 ms │ p95:        0.518 ms │ RPS:      2,399 ║
║ Full Security + Auth Pipeline  │        0.980 ms │ p95:        1.510 ms │ RPS:        947 ║
║ REST with API Caching          │        0.829 ms │ p95:        1.170 ms │ RPS:      1,112 ║
║ Mutation + Audit Logging       │        2.095 ms │ p95:        3.013 ms │ RPS:        437 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
