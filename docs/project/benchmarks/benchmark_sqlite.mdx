...
| -------------------------------- | -------- | ------------------------------------------ | ------ | ------ |
| **Competitive Workload Replica** | 1.766ms  | ⚪ stable at 2.04ms (±0.329ms) (7 runs)    | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 4.828ms  | ⚪ stable at 4.97ms (±0.699ms) (7 runs)    | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.916ms  | ⚪ stable at 1.93ms (±0.296ms) (7 runs)    | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.716ms  | ⚪ stable at 1.98ms (±0.204ms) (7 runs)    | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 2.354ms  | 🔴 slower: 1.81ms → 2.35ms (+30%) (7 runs) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.769ms  | ⚪ stable at 1.44ms (±0.403ms) (7 runs)    | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 5.515ms  | ⚪ stable at 4.96ms (±1.58ms) (3 runs)     | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 10.323ms | ⚪ stable at 10.78ms (±8.05ms) (7 runs)    | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 11.371ms | ⚪ stable at 13.17ms (±5.97ms) (7 runs)    | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 6.610ms  | ⚪ stable at 7.42ms (±3.02ms) (7 runs)     | < 5ms  | 🟢     |
...
quadrantChart
  ...
  quadrant-4 Critical — fix first
    Competitive Workload Replica: [0.16, 0.45]
    Competitive Workload Replica: [0.15, 0.44]
    Competitive Workload Replica: [0.21, 0.95]
    Competitive Workload Replica: [0.16, 0.76]
    Competitive Workload Replica: [0.49, 0.37]
    Competitive Workload Replica: [0.95, 0.45]
    Competitive Workload Replica: [0.58, 0.36]
```
...
**Run ID:** `1a931e78-bee1-4a80-acb8-9d4a5bb387b5` · **Tests invoked:** 1 · **Metrics:** 10 · **DB:** sqlite

| Test                         | Metric                                   | Avg (ms) | p95 (ms) | RPS  | Trend | Detail                                     |
| ---------------------------- | ---------------------------------------- | -------- | -------- | ---- | ----- | ------------------------------------------ |
| Competitive Workload Replica | findById (Concurrent 8c)                 | 1.766    | 3.334    | 2654 | 🟢    | ⚪ stable at 2.04ms (±0.329ms) (7 runs)    |
| Competitive Workload Replica | findByIdRandom (Concurrent 8c)           | 4.828    | 8.504    | 1424 | 🟢    | ⚪ stable at 4.97ms (±0.699ms) (7 runs)    |
| Competitive Workload Replica | listPlain (Concurrent 8c)                | 1.916    | 3.933    | 2442 | 🟢    | ⚪ stable at 1.93ms (±0.296ms) (7 runs)    |
| Competitive Workload Replica | listFilterSort (Concurrent 8c)           | 1.716    | 2.820    | 2741 | 🟢    | ⚪ stable at 1.98ms (±0.204ms) (7 runs)    |
| Competitive Workload Replica | findMissing (Concurrent 8c)              | 1.769    | 4.857    | 2663 | 🟢    | ⚪ stable at 1.44ms (±0.403ms) (7 runs)    |
| Competitive Workload Replica | GraphQL Collection Query (Concurrent 8c) | 5.515    | 6.878    | 1364 | 🟢    | ⚪ stable at 4.96ms (±1.58ms) (3 runs)     |
| Competitive Workload Replica | create (Concurrent 8c)                   | 10.323   | 27.211   | 754  | 🟢    | ⚪ stable at 10.78ms (±8.05ms) (7 runs)    |
| Competitive Workload Replica | update (Concurrent 8c)                   | 11.371   | 26.993   | 689  | 🟢    | ⚪ stable at 13.17ms (±5.97ms) (7 runs)    |
| Competitive Workload Replica | mixed (Concurrent 8c 50/50)              | 6.610    | 10.921   | 1074 | 🟢    | ⚪ stable at 7.42ms (±3.02ms) (7 runs)     |
| Competitive Workload Replica | listLarge (Concurrent 8c)                | 2.354    | 4.516    | 2151 | ⚪    | 🔴 slower: 1.81ms → 2.35ms (+30%) (7 runs) |
...
<summary><strong>🏷️ Stress</strong> · 🟢 46.459ms · ➡️ ⚪ established at 46.46ms (1 run) (2026-08-19 12:35:09) · <a href="../../../tests/benchmarks/graphql-stress.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
> ⏳ Pending
<!-- LEDGER_TRUTH_END -->
...
<summary><strong>🏷️ GraphQL Load Stress</strong> · 🟢 4.075ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/graphql-stress.test.ts">source</a></summary>
...
║                                Ran: 2026-08-19 12:35:09                                 ║
║  Discovers the server's maximum sustainable GraphQL throughput by ramping concurrency   ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ GQL: 5c Warmup                 │        4.075 ms │ p95:        5.156 ms │ RPS:      1,071 ║
║ GQL: 10c Light                 │        5.937 ms │ p95:        7.432 ms │ RPS:      1,490 ║
║ GQL: 20c Moderate              │       18.654 ms │ p95:       21.051 ms │ RPS:      1,078 ║
║ GQL: 40c Heavy                 │       28.895 ms │ p95:       35.170 ms │ RPS:      1,310 ║
║ GQL: 60c Stress                │       31.467 ms │ p95:       44.291 ms │ RPS:      1,661 ║
║ GQL: 80c Extreme               │       36.888 ms │ p95:       47.465 ms │ RPS:      1,837 ║
║ GQL: 100c Max                  │       46.459 ms │ p95:       56.658 ms │ RPS:      1,848 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
