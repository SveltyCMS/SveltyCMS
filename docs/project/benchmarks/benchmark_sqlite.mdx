...
| ------------ | ------- | --------------------------------- | ------ | ------ |
| **System**   | 0.435ms | ⚪ established at 0.435ms (1 run) | < 5ms  | 🟢     |
| **Metadata** | 0.569ms | ⚪ established at 0.569ms (1 run) | < 5ms  | 🟢     |
| **CRUD**     | 0.553ms | ⚪ established at 0.553ms (1 run) | < 5ms  | 🟢     |
| **CRUD**     | 0.506ms | ⚪ established at 0.506ms (1 run) | < 5ms  | 🟢     |
...
| ---------------------------------------------------- | ----- | --------- | ---------- |
| cold start phased (Cold Start (IDLE → READY)) (cold) | 🟢    | `▁`       | 1125.085ms |
| database performance (BULK INSERT (100)) (warm)      | 🟢    | `▁`       | 0.907ms    |
...
### Current Run Summary (2026-08-17)

> **Scope:** Only tests that ran in THIS invocation.

> ⚠️ Executive PASS/FAIL reflects the last full matrix run.

**Run ID:** `7e014dd0-631f-4e69-b9b0-b973c142e11d` · **Tests invoked:** 1 · **Metrics:** 4 · **DB:** sqlite

| Test                 | Metric                 | Avg (ms) | p95 (ms) | RPS  | Trend | Detail                            |
| -------------------- | ---------------------- | -------- | -------- | ---- | ----- | --------------------------------- |
| Rest Api Performance | Health Check           | 0.435    | 1.158    | 2298 | 🟢    | ⚪ established at 0.435ms (1 run) |
| Rest Api Performance | Collection Schema      | 0.569    | 1.114    | 1759 | 🟢    | ⚪ established at 0.569ms (1 run) |
| Rest Api Performance | Collection Find (List) | 0.553    | 1.123    | 1808 | 🟢    | ⚪ established at 0.553ms (1 run) |
| Rest Api Performance | Collection Search      | 0.506    | 1.049    | 1978 | 🟢    | ⚪ established at 0.506ms (1 run) |

<!-- SUMMARY_RUN_OVERLAY_END -->

<!-- SUMMARY_HISTORY_START -->

### Historical Trends (2026-08-17)
...
| --------------------------- | ----- | ------------------ | ---------- |
| CACHE PERFORMANCE (warm)    | 🟢    | `▁`                | 0.233ms    |
| COLD START PHASED (cold)    | 🟢    | `▁`                | 1125.085ms |
| DATABASE PERFORMANCE (warm) | 🟢    | `▅▄▂█▂▁▁`          | 0.020ms    |
| HOOKS PERFORMANCE (warm)    | 🟢    | `▂█▂▁▂`            | 0.264ms    |
| TRANSACTION ACID (warm)     | 🟢    | `█▁`               | 0.112ms    |
| TRUTH LATENCY (warm)        | 🟢    | `█▁▁`              | 0.000ms    |
| REST API PERFORMANCE (warm) | ⚪    | `▇█▅▁`             | 0.435ms    |
...
<summary><strong>🏷️ cold start phased</strong> · 🟢 1125.085ms · ➡️ ⚪ established at 1125.09ms (1 run) (2026-08-17 19:23:22) · <a href="../../../tests/benchmarks/cold-start-phased.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
```text
╔═════════════════════════════════════════════════════════════════════════════════════════╗
║                           SVELTYCMS — PHASED COLD START AUDIT                           ║
║                    File: tests/benchmarks/cold-start-phased.test.ts                     ║
║                                Ran: 2026-08-17 19:23:22                                 ║
║       Measures server cold-start latency to READY state, using the built server.        ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Cold Start (IDLE → READY)      │     1125.085 ms │ p95:     1276.123 ms │ RPS:          0 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
<!-- LEDGER_TRUTH_END -->
...
║                                Ran: 2026-08-17 19:23:28                                 ║
║     Validates performance claims by comparing SDK, Middleware, and Real HTTP Stack      ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Logic Baseline                 │        0.000 ms │ p95:        0.001 ms │ RPS:  3,441,354 ║
║ Local SDK (Full)               │        0.007 ms │ p95:        0.013 ms │ RPS:    134,792 ║
║ HTTP End-to-End                │        0.798 ms │ p95:        1.816 ms │ RPS:      1,254 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ Middleware & Hooks Performance</strong> · 🟢 0.130ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/hooks-performance.test.ts">source</a></summary>
...
║                                Ran: 2026-08-17 19:24:16                                 ║
║Measures the cost of the full middleware chain including Turbo, Security, Auth, and Audit via HTTP E2E.║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Static Asset (No Middleware)   │        0.130 ms │ p95:        0.176 ms │ RPS:      6,548 ║
║ Turbo Pipeline (Light)         │        0.264 ms │ p95:        0.384 ms │ RPS:      3,123 ║
║ Full Security + Auth Pipeline  │        0.337 ms │ p95:        0.538 ms │ RPS:      2,657 ║
║ REST with API Caching          │        0.266 ms │ p95:        0.383 ms │ RPS:      3,255 ║
║ Mutation (audit logging disabled) │        1.167 ms │ p95:        1.323 ms │ RPS:        720 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ database performance</strong> · 🟢 0.907ms · ➡️ ⚪ established at 0.907ms (1 run) (2026-08-17 19:23:56) · <a href="../../../tests/benchmarks/database-performance.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
```text
╔═════════════════════════════════════════════════════════════════════════════════════════╗
║                    SVELTYCMS — DATABASE ADAPTER PERFORMANCE (SQLITE)                    ║
║                   File: tests/benchmarks/database-performance.test.ts                   ║
║                                Ran: 2026-08-17 19:23:56                                 ║
║   Measures raw CRUD performance, indexing efficiency, and connection pool resilience    ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ INSERT                         │        0.032 ms │ p95:        0.045 ms │ RPS:     14,971 ║
║ FIND ONE                       │        0.005 ms │ p95:        0.007 ms │ RPS:    165,899 ║
║ FIND MANY (limit 50)           │        0.080 ms │ p95:        0.096 ms │ RPS:     10,251 ║
║ FIND PAGE (50 hasMore)         │        0.101 ms │ p95:        0.122 ms │ RPS:      8,052 ║
║ FIND PAGE keyset               │        0.093 ms │ p95:        0.108 ms │ RPS:      9,085 ║
║ FIND MANY offset 50            │        0.050 ms │ p95:        0.063 ms │ RPS:     17,592 ║
║ LIST+COUNT (legacy)            │        0.182 ms │ p95:        0.197 ms │ RPS:      4,887 ║
║ UPDATE                         │        0.021 ms │ p95:        0.025 ms │ RPS:     26,092 ║
║ UPDATE (no-returning)          │        0.020 ms │ p95:        0.027 ms │ RPS:     28,873 ║
║ NATIVE UPSERT                  │        0.052 ms │ p95:        0.059 ms │ RPS:     14,742 ║
║ COUNT                          │        0.127 ms │ p95:        0.132 ms │ RPS:      7,283 ║
║ COUNT ESTIMATE                 │        0.018 ms │ p95:        0.022 ms │ RPS:     45,850 ║
║ COUNT CACHED                   │        0.001 ms │ p95:        0.002 ms │ RPS:    828,396 ║
║ DELETE                         │        0.041 ms │ p95:        0.050 ms │ RPS:     15,949 ║
║ BULK INSERT (100)              │        0.907 ms │ p95:        1.076 ms │ RPS:        570 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
<!-- LEDGER_TRUTH_END -->
...
<summary><strong>🏷️ transaction acid</strong> · 🟢 0.112ms · ➡️ ⚪ established at 0.112ms (1 run) (2026-08-17 19:24:02) · <a href="../../../tests/benchmarks/transaction-acid.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
```text
╔═════════════════════════════════════════════════════════════════════════════════════════╗
║                            SVELTYCMS — ACID INTEGRITY AUDIT                             ║
║                     File: tests/benchmarks/transaction-acid.test.ts                     ║
║                                Ran: 2026-08-17 19:24:02                                 ║
║  Measures transaction commit latencies and rollback overhead across database adapters   ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ TX Commit                      │        0.179 ms │ p95:        0.400 ms │ RPS:      3,760 ║
║ TX Rollback Integrity          │        0.112 ms │ p95:        0.122 ms │ RPS:      8,956 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
<!-- LEDGER_TRUTH_END -->
...
<summary><strong>🏷️ Cache</strong> · 🟢 0.233ms · ➡️ ⚪ established at 0.233ms (1 run) (2026-08-17 19:24:08) · <a href="../../../tests/benchmarks/cache-performance.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
```text
╔═════════════════════════════════════════════════════════════════════════════════════════╗
║                           SVELTYCMS — CACHE EFFICIENCY AUDIT                            ║
║                    File: tests/benchmarks/cache-performance.test.ts                     ║
║                                Ran: 2026-08-17 19:24:08                                 ║
║  Measures cache hit vs miss latency and efficiency via real HTTP end-to-end requests.   ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Cache Miss (Bypass)            │        0.233 ms │ p95:        0.362 ms │ RPS:      3,452 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
<!-- LEDGER_TRUTH_END -->
...
<summary><strong>🏷️ HTTP</strong> · 🟢 0.798ms · ➡️ ⚪ established at 0.798ms (1 run) (2026-08-17 19:23:39) · <a href="../../../tests/benchmarks/truth-latency.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
> ⏳ Pending
<!-- LEDGER_TRUTH_END -->
...
<summary><strong>🏷️ Logic</strong> · 🟢 ⏳ pending · ➡️ ⚪ established at 0ms (1 run) (2026-08-17 19:23:39) · <a href="../../../tests/benchmarks/truth-latency.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
> ⏳ Pending
<!-- LEDGER_TRUTH_END -->
...
<summary><strong>🏷️ SDK</strong> · 🟢 0.007ms · ➡️ ⚪ established at 0.007ms (1 run) (2026-08-17 19:23:39) · <a href="../../../tests/benchmarks/truth-latency.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
```text
╔═════════════════════════════════════════════════════════════════════════════════════════╗
...
<summary><strong>🏷️ Middleware</strong> · 🟢 1.167ms · ➡️ ⚪ established at 1.17ms (1 run) (2026-08-17 19:24:16) · <a href="../../../tests/benchmarks/hooks-performance.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
> ⏳ Pending
<!-- LEDGER_TRUTH_END -->
...
<summary><strong>🏷️ System</strong> · 🟢 0.435ms · ➡️ ⚪ established at 0.435ms (1 run) (2026-08-17 19:24:21) · <a href="../../../tests/benchmarks/rest-api-performance.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
> ⏳ Pending
<!-- LEDGER_TRUTH_END -->
...
<summary><strong>🏷️ Metadata</strong> · 🟢 0.569ms · ➡️ ⚪ established at 0.569ms (1 run) (2026-08-17 19:24:21) · <a href="../../../tests/benchmarks/rest-api-performance.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
> ⏳ Pending
<!-- LEDGER_TRUTH_END -->
...
<summary><strong>🏷️ CRUD</strong> · 🟢 0.506ms · ➡️ ⚪ established at 0.506ms (1 run) (2026-08-17 19:24:21) · <a href="../../../tests/benchmarks/rest-api-performance.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
> ⏳ Pending
<!-- LEDGER_TRUTH_END -->
...
<summary><strong>🏷️ REST API Performance</strong> · 🟢 0.435ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/rest-api-performance.test.ts">source</a></summary>
...
║                                Ran: 2026-08-17 19:24:21                                 ║
║Measures latency, throughput, and correctness of core REST endpoints: health check, schema, CRUD list, and search.║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Health Check                   │        0.435 ms │ p95:        1.158 ms │ RPS:      2,298 ║
║ Collection Schema              │        0.569 ms │ p95:        1.114 ms │ RPS:      1,759 ║
║ Collection Find (List)         │        0.553 ms │ p95:        1.123 ms │ RPS:      1,808 ║
║ Collection Search              │        0.506 ms │ p95:        1.049 ms │ RPS:      1,978 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
