...
<summary><strong>🏷️ Middleware & Hooks Performance</strong> · 🟢 0.622ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/hooks-performance.test.ts">source</a></summary>
...
║                                Ran: 2026-07-26 10:29:30                                 ║
║Measures the cost of the full middleware chain including Turbo, Security, Auth, and Audit via HTTP E2E.║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Static Asset (No Middleware)   │        0.622 ms │ p95:        0.749 ms │ RPS:      1,470 ║
║ Turbo Pipeline (Light)         │        0.410 ms │ p95:        0.507 ms │ RPS:      2,231 ║
║ Full Security + Auth Pipeline  │        1.048 ms │ p95:        1.400 ms │ RPS:        848 ║
║ REST with API Caching          │        1.079 ms │ p95:        1.548 ms │ RPS:        834 ║
║ Mutation + Audit Logging       │        3.869 ms │ p95:        5.408 ms │ RPS:        236 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ database performance</strong> · 🟢 0.131ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/database-performance.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
```text
╔═════════════════════════════════════════════════════════════════════════════════════════╗
║                    SVELTYCMS — DATABASE ADAPTER PERFORMANCE (SQLITE)                    ║
║                   File: tests/benchmarks/database-performance.test.ts                   ║
║                                Ran: 2026-07-26 10:30:37                                 ║
║   Measures raw CRUD performance, indexing efficiency, and connection pool resilience    ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ INSERT                         │        0.131 ms │ p95:        0.196 ms │ RPS:      3,073 ║
║ FIND ONE                       │        0.084 ms │ p95:        0.106 ms │ RPS:     10,846 ║
║ FIND MANY (limit 50)           │        0.101 ms │ p95:        0.124 ms │ RPS:      9,020 ║
║ UPDATE                         │        0.110 ms │ p95:        0.139 ms │ RPS:      7,035 ║
║ NATIVE UPSERT                  │        0.075 ms │ p95:        0.097 ms │ RPS:     10,797 ║
║ COUNT                          │        0.183 ms │ p95:        0.217 ms │ RPS:      4,834 ║
║ DELETE                         │        0.045 ms │ p95:        0.058 ms │ RPS:     16,424 ║
║ BULK INSERT (100)              │        3.288 ms │ p95:        5.223 ms │ RPS:        136 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
<!-- LEDGER_TRUTH_END -->
