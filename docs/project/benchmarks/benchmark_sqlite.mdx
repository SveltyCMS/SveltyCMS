...
| ------------ | ------- | ------------------------------------------ | ------ | ------ |
| **System**   | 2.141ms | ⚪ stable at 2.48ms (±1.16ms) (3 runs)     | < 5ms  | 🟢     |
| **Metadata** | 2.622ms | ⚪ stable at 2.48ms (±1.16ms) (3 runs)     | < 5ms  | 🟢     |
| **CRUD**     | 4.293ms | 🔴 slower: 2.48ms → 4.29ms (+73%) (3 runs) | < 5ms  | 🟢     |
| **CRUD**     | 4.091ms | ⚪ stable at 2.48ms (±1.16ms) (3 runs)     | < 5ms  | 🟢     |
...
**Run ID:** `23b816ad-2c0d-4462-a11e-f60a8702abea` · **Tests invoked:** 1 · **Metrics:** 4 · **DB:** sqlite

| Test                 | Metric                 | Avg (ms) | p95 (ms) | RPS | Trend | Detail                                     |
| -------------------- | ---------------------- | -------- | -------- | --- | ----- | ------------------------------------------ |
| Rest Api Performance | Health Check           | 2.141    | 4.155    | 467 | 🟢    | ⚪ stable at 2.48ms (±1.16ms) (3 runs)     |
| Rest Api Performance | Collection Schema      | 2.622    | 4.195    | 381 | 🟢    | ⚪ stable at 2.48ms (±1.16ms) (3 runs)     |
| Rest Api Performance | Collection Search      | 4.091    | 6.689    | 244 | 🟢    | ⚪ stable at 2.48ms (±1.16ms) (3 runs)     |
| Rest Api Performance | Collection Find (List) | 4.293    | 7.020    | 233 | ⚪    | 🔴 slower: 2.48ms → 4.29ms (+73%) (3 runs) |
...
| REST API PERFORMANCE (warm)       | 🟢    | `▃▁█▁`              | 2.141ms   | 4    |
...
<summary><strong>🏷️ REST API Performance</strong> · 🟢 2.141ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/rest-api-performance.test.ts">source</a></summary>
...
║                                Ran: 2026-07-04 10:03:05                                 ║
║Measures latency, throughput, and correctness of core REST endpoints: health check, schema, CRUD list, and search.║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Health Check                   │        2.141 ms │ p95:        4.155 ms │ RPS:        467 ║
║ Collection Schema              │        2.622 ms │ p95:        4.195 ms │ RPS:        381 ║
║ Collection Find (List)         │        4.293 ms │ p95:        7.020 ms │ RPS:        233 ║
║ Collection Search              │        4.091 ms │ p95:        6.689 ms │ RPS:        244 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
