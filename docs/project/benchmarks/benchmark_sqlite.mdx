...
| -------------- | ------- | ---------------------------------------- | ------ | ------ |
| **Middleware** | 0.469ms | ⚪ stable at 0.476ms (±0.369ms) (7 runs) | < 5ms  | 🟢     |
| **Middleware** | 0.274ms | ⚪ stable at 0.287ms (±0.262ms) (7 runs) | < 5ms  | 🟢     |
| **Middleware** | 0.881ms | ⚪ stable at 0.898ms (±0.209ms) (7 runs) | < 5ms  | 🟢     |
| **Middleware** | 0.891ms | ⚪ stable at 0.881ms (±0.132ms) (7 runs) | < 5ms  | 🟢     |
| **Middleware** | 2.549ms | ⚪ stable at 2.53ms (±0.456ms) (7 runs)  | < 5ms  | 🟢     |
...
**Run ID:** `2054ed7a-1e95-4958-8c44-25c70e850b09` · **Tests invoked:** 1 · **Metrics:** 5 · **DB:** sqlite

| Test              | Metric                        | Avg (ms) | p95 (ms) | RPS  | Trend | Detail                                   |
| ----------------- | ----------------------------- | -------- | -------- | ---- | ----- | ---------------------------------------- |
| Hooks Performance | Static Asset (No Middleware)  | 0.469    | 0.552    | 1970 | 🟢    | ⚪ stable at 0.476ms (±0.369ms) (7 runs) |
| Hooks Performance | Turbo Pipeline (Light)        | 0.274    | 0.353    | 3361 | 🟢    | ⚪ stable at 0.287ms (±0.262ms) (7 runs) |
| Hooks Performance | Full Security + Auth Pipeline | 0.881    | 1.068    | 949  | 🟢    | ⚪ stable at 0.898ms (±0.209ms) (7 runs) |
| Hooks Performance | REST with API Caching         | 0.891    | 1.142    | 976  | 🟢    | ⚪ stable at 0.881ms (±0.132ms) (7 runs) |
| Hooks Performance | Mutation + Audit Logging      | 2.549    | 3.706    | 381  | 🟢    | ⚪ stable at 2.53ms (±0.456ms) (7 runs)  |
...
| HOOKS PERFORMANCE (warm)    | 🟢    | `▂▁▃█▃▂▁`          | 0.274ms |
...
<summary><strong>🏷️ Middleware & Hooks Performance</strong> · 🟢 0.469ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/hooks-performance.test.ts">source</a></summary>
...
║                                Ran: 2026-08-04 20:57:12                                 ║
║Measures the cost of the full middleware chain including Turbo, Security, Auth, and Audit via HTTP E2E.║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Static Asset (No Middleware)   │        0.469 ms │ p95:        0.552 ms │ RPS:      1,970 ║
║ Turbo Pipeline (Light)         │        0.274 ms │ p95:        0.353 ms │ RPS:      3,361 ║
║ Full Security + Auth Pipeline  │        0.881 ms │ p95:        1.068 ms │ RPS:        949 ║
║ REST with API Caching          │        0.891 ms │ p95:        1.142 ms │ RPS:        976 ║
║ Mutation + Audit Logging       │        2.549 ms │ p95:        3.706 ms │ RPS:        381 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ Middleware</strong> · 🟢 2.549ms · ➡️ ⚪ stable at 2.53ms (±0.456ms) (7 runs) (2026-08-04 20:57:12) · <a href="../../../tests/benchmarks/hooks-performance.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
> ⏳ Pending
<!-- LEDGER_TRUTH_END -->
