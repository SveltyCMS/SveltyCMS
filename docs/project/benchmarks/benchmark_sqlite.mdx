...
| ------------ | ------- | -------------------------------------------- | ------ | ------ |
| **System**   | 0.805ms | 🔴 slower: 0.560ms → 0.805ms (+44%) (7 runs) | < 5ms  | 🟢     |
| **Metadata** | 1.246ms | 🔴 slower: 0.798ms → 1.25ms (+56%) (7 runs)  | < 5ms  | 🟢     |
| **CRUD**     | 1.213ms | 🔴 slower: 0.804ms → 1.21ms (+51%) (7 runs)  | < 5ms  | 🟢     |
| **CRUD**     | 1.410ms | 🔴 slower: 0.764ms → 1.41ms (+85%) (7 runs)  | < 5ms  | 🟢     |
...
| database performance (BULK INSERT (100)) (warm)      | 🟢    | `▁▁▁▂▂▂▂▂▁█▇▃` | 1.484ms    |
...
**Run ID:** `c5da0079-541e-405d-abc6-4847002f9c59` · **Tests invoked:** 1 · **Metrics:** 4 · **DB:** sqlite

| Test                 | Metric                 | Avg (ms) | p95 (ms) | RPS  | Trend | Detail                                       |
| -------------------- | ---------------------- | -------- | -------- | ---- | ----- | -------------------------------------------- |
| Rest Api Performance | Health Check           | 0.805    | 1.938    | 3323 | ⚪    | 🔴 slower: 0.560ms → 0.805ms (+44%) (7 runs) |
| Rest Api Performance | Collection Schema      | 1.246    | 2.748    | 2106 | ⚪    | 🔴 slower: 0.798ms → 1.25ms (+56%) (7 runs)  |
| Rest Api Performance | Collection Find (List) | 1.213    | 2.641    | 2203 | ⚪    | 🔴 slower: 0.804ms → 1.21ms (+51%) (7 runs)  |
| Rest Api Performance | Collection Search      | 1.410    | 3.085    | 1943 | ⚪    | 🔴 slower: 0.764ms → 1.41ms (+85%) (7 runs)  |
...
| DATABASE PERFORMANCE (warm)         | 🟢    | `▅▅▂█▃▁▁`          | 0.036ms    |
...
<summary><strong>🏷️ database performance</strong> · 🟢 0.075ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/database-performance.test.ts">source</a></summary>
...
║                                Ran: 2026-08-20 20:55:03                                 ║
║   Measures raw CRUD performance, indexing efficiency, and connection pool resilience    ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ INSERT                         │        0.075 ms │ p95:        0.123 ms │ RPS:      5,110 ║
║ FIND ONE                       │        0.010 ms │ p95:        0.013 ms │ RPS:     74,199 ║
║ FIND MANY (limit 50)           │        0.128 ms │ p95:        0.165 ms │ RPS:      5,821 ║
║ FIND PAGE (50 hasMore)         │        0.149 ms │ p95:        0.186 ms │ RPS:      5,233 ║
║ FIND PAGE keyset               │        0.145 ms │ p95:        0.186 ms │ RPS:      5,445 ║
║ FIND MANY offset 50            │        0.073 ms │ p95:        0.094 ms │ RPS:     10,437 ║
║ LIST+COUNT (legacy)            │        0.246 ms │ p95:        0.302 ms │ RPS:      3,291 ║
║ UPDATE                         │        0.063 ms │ p95:        0.083 ms │ RPS:      7,838 ║
║ UPDATE (no-returning)          │        0.053 ms │ p95:        0.066 ms │ RPS:      9,069 ║
║ NATIVE UPSERT                  │        0.098 ms │ p95:        0.123 ms │ RPS:      6,114 ║
║ COUNT                          │        0.150 ms │ p95:        0.171 ms │ RPS:      5,720 ║
║ COUNT ESTIMATE                 │        0.034 ms │ p95:        0.043 ms │ RPS:     23,057 ║
║ COUNT CACHED                   │        0.001 ms │ p95:        0.002 ms │ RPS:    594,373 ║
║ DELETE                         │        0.103 ms │ p95:        0.138 ms │ RPS:      5,295 ║
║ BULK INSERT (100)              │        1.937 ms │ p95:        2.713 ms │ RPS:        156 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
