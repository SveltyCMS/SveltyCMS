...
| -------- | --------- | ---------------------------------- | ------ | ------ |
| **SDK**  | 116.344ms | ⚪ established at 116.34ms (1 run) | < 5ms  | 🟢     |
| **HTTP** | 105.226ms | ⚪ established at 105.23ms (1 run) | < 5ms  | 🟢     |
...
**Run ID:** `94c13f7b-ff2b-42a2-a4e1-a7b0669d0521` · **Tests invoked:** 1 · **Metrics:** 2 · **DB:** sqlite

| Test              | Metric                | Avg (ms) | p95 (ms) | RPS | Trend | Detail                             |
| ----------------- | --------------------- | -------- | -------- | --- | ----- | ---------------------------------- |
| Media Performance | SDK: Media Processing | 116.344  | 132.149  | 17  | 🟢    | ⚪ established at 116.34ms (1 run) |
| Media Performance | HTTP: Media Upload    | 105.226  | 137.979  | 16  | 🟢    | ⚪ established at 105.23ms (1 run) |
...
| CACHE SERVICE (warm)     | 🟢    | `█▁▂▂▁▂▂`          | 2.505ms   |
| INDEX PRESSURE (warm)    | 🟢    | `▁█`               | 0.574ms   |
| MEDIA PERFORMANCE (warm) | 🟢    | `▆█▁▂`             | 116.344ms |
| MIGRATION SCALE (warm)   | 🟢    | `▁`                | 16.399ms  |
| SEO PERFORMANCE (warm)   | 🟢    | `▁▇▃█`             | 2.823ms   |
