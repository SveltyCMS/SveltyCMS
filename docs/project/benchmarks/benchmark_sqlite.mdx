...
| ------------------------ | ------- | ---------------------------------------- | ------ | ------ |
| **Database Performance** | 0.077ms | ⚪ stable at 0.074ms (±0.002ms) (6 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.058ms | ⚪ stable at 0.053ms (±0.003ms) (6 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.074ms | ⚪ stable at 0.069ms (±0.003ms) (6 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.086ms | ⚪ established at 0.086ms (1 run)        | < 5ms  | 🟢     |
| **Database Performance** | 0.072ms | ⚪ established at 0.072ms (1 run)        | < 5ms  | 🟢     |
| **Database Performance** | 0.050ms | ⚪ established at 0.050ms (1 run)        | < 5ms  | 🟢     |
| **Database Performance** | 0.192ms | ⚪ established at 0.192ms (1 run)        | < 5ms  | 🟢     |
| **Database Performance** | 0.087ms | ⚪ stable at 0.074ms (±0.004ms) (6 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.054ms | ⚪ stable at 0.050ms (±0.002ms) (6 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.120ms | ⚪ stable at 0.119ms (±0.002ms) (6 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.023ms | ⚪ established at 0.023ms (1 run)        | < 5ms  | 🟢     |
| **Database Performance** | 0.024ms | ⚪ established at 0.024ms (1 run)        | < 5ms  | 🟢     |
| **Database Performance** | 0.032ms | ⚪ stable at 0.030ms (±0.001ms) (6 runs) | < 5ms  | 🟢     |
| **Database Performance** | 2.521ms | ⚪ stable at 2.33ms (±0.181ms) (6 runs)  | < 5ms  | 🟢     |
...
| ----------------------------------------------- | ----- | --------- | ------- |
| database performance (BULK INSERT (100)) (warm) | 🟢    | `▂▇▆▁▁▄█` | 2.521ms |
...
quadrantChart
  ...
  quadrant-4 Critical — fix first
    Database Performance: [0.05, 0.42]
    Database Performance: [0.05, 0.40]
    Database Performance: [0.05, 0.88]
    Database Performance: [0.95, 0.41]
```
...
### Current Run Summary (2026-08-04)

> **Scope:** Only tests that ran in THIS invocation.

> ⚠️ Executive PASS/FAIL reflects the last full matrix run.

**Run ID:** `43f144a6-a75d-4af4-8954-bc75795215f1` · **Tests invoked:** 1 · **Metrics:** 14 · **DB:** sqlite

| Test                 | Metric                 | Avg (ms) | p95 (ms) | RPS   | Trend | Detail                                   |
| -------------------- | ---------------------- | -------- | -------- | ----- | ----- | ---------------------------------------- |
| Database Performance | INSERT                 | 0.077    | 0.100    | 5393  | 🟢    | ⚪ stable at 0.074ms (±0.002ms) (6 runs) |
| Database Performance | FIND ONE               | 0.058    | 0.068    | 15607 | 🟢    | ⚪ stable at 0.053ms (±0.003ms) (6 runs) |
| Database Performance | FIND PAGE (50 hasMore) | 0.086    | 0.102    | 10561 | 🟢    | ⚪ established at 0.086ms (1 run)        |
| Database Performance | FIND PAGE keyset       | 0.072    | 0.085    | 12687 | 🟢    | ⚪ established at 0.072ms (1 run)        |
| Database Performance | FIND MANY offset 50    | 0.050    | 0.061    | 18484 | 🟢    | ⚪ established at 0.050ms (1 run)        |
| Database Performance | LIST+COUNT (legacy)    | 0.192    | 0.211    | 4926  | 🟢    | ⚪ established at 0.192ms (1 run)        |
| Database Performance | COUNT                  | 0.120    | 0.130    | 8003  | 🟢    | ⚪ stable at 0.119ms (±0.002ms) (6 runs) |
| Database Performance | COUNT ESTIMATE         | 0.023    | 0.028    | 39041 | 🟢    | ⚪ established at 0.023ms (1 run)        |
| Database Performance | COUNT CACHED           | 0.024    | 0.026    | 38356 | 🟢    | ⚪ established at 0.024ms (1 run)        |
| Database Performance | BULK INSERT (100)      | 2.521    | 4.838    | 186   | 🟢    | ⚪ stable at 2.33ms (±0.181ms) (6 runs)  |
| Database Performance | FIND MANY (limit 50)   | 0.074    | 0.088    | 12276 | ⚪    | ⚪ stable at 0.069ms (±0.003ms) (6 runs) |
| Database Performance | UPDATE                 | 0.087    | 0.100    | 9427  | ⚪    | ⚪ stable at 0.074ms (±0.004ms) (6 runs) |
| Database Performance | NATIVE UPSERT          | 0.054    | 0.062    | 14337 | ⚪    | ⚪ stable at 0.050ms (±0.002ms) (6 runs) |
| Database Performance | DELETE                 | 0.032    | 0.039    | 22152 | ⚪    | ⚪ stable at 0.030ms (±0.001ms) (6 runs) |

<!-- SUMMARY_RUN_OVERLAY_END -->

<!-- SUMMARY_HISTORY_START -->

### Historical Trends (2026-08-04)
...
| --------------------------- | ----- | ------------------ | ------- |
| DATABASE PERFORMANCE (warm) | 🟢    | `▁▃▂▂█▁▃`          | 0.087ms |
| HOOKS PERFORMANCE (warm)    | 🟢    | `▃▁▃█▃▂▁`          | 0.287ms |
...
║                                Ran: 2026-07-26 14:55:36                                 ║
║     Validates performance claims by comparing SDK, Middleware, and Real HTTP Stack      ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Logic Baseline                 │        0.001 ms │ p95:        0.000 ms │ RPS:  1,985,440 ║
║ Local SDK (Full)               │        0.008 ms │ p95:        0.016 ms │ RPS:    123,885 ║
║ HTTP End-to-End                │        1.315 ms │ p95:        2.725 ms │ RPS:        760 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ Middleware & Hooks Performance</strong> · 🟢 0.476ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/hooks-performance.test.ts">source</a></summary>
...
║                                Ran: 2026-07-31 20:26:17                                 ║
║Measures the cost of the full middleware chain including Turbo, Security, Auth, and Audit via HTTP E2E.║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Static Asset (No Middleware)   │        0.476 ms │ p95:        0.575 ms │ RPS:      1,983 ║
║ Turbo Pipeline (Light)         │        0.287 ms │ p95:        0.356 ms │ RPS:      3,290 ║
║ Full Security + Auth Pipeline  │        0.845 ms │ p95:        1.110 ms │ RPS:      1,027 ║
║ REST with API Caching          │        0.849 ms │ p95:        1.064 ms │ RPS:      1,063 ║
║ Mutation + Audit Logging       │        2.272 ms │ p95:        3.410 ms │ RPS:        414 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ database performance</strong> · 🟢 2.521ms · ↗️ ⚪ stable at 2.33ms (±0.181ms) (6 runs) (2026-08-04 12:00:20) · <a href="../../../tests/benchmarks/database-performance.test.ts">source</a></summary>
...
║                                Ran: 2026-08-04 12:00:20                                 ║
║   Measures raw CRUD performance, indexing efficiency, and connection pool resilience    ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ INSERT                         │        0.077 ms │ p95:        0.100 ms │ RPS:      5,393 ║
║ FIND ONE                       │        0.058 ms │ p95:        0.068 ms │ RPS:     15,607 ║
║ FIND MANY (limit 50)           │        0.074 ms │ p95:        0.088 ms │ RPS:     12,276 ║
║ FIND PAGE (50 hasMore)         │        0.086 ms │ p95:        0.102 ms │ RPS:     10,561 ║
║ FIND PAGE keyset               │        0.072 ms │ p95:        0.085 ms │ RPS:     12,687 ║
║ FIND MANY offset 50            │        0.050 ms │ p95:        0.061 ms │ RPS:     18,484 ║
║ LIST+COUNT (legacy)            │        0.192 ms │ p95:        0.211 ms │ RPS:      4,926 ║
║ UPDATE                         │        0.087 ms │ p95:        0.100 ms │ RPS:      9,427 ║
║ NATIVE UPSERT                  │        0.054 ms │ p95:        0.062 ms │ RPS:     14,337 ║
║ COUNT                          │        0.120 ms │ p95:        0.130 ms │ RPS:      8,003 ║
║ COUNT ESTIMATE                 │        0.023 ms │ p95:        0.028 ms │ RPS:     39,041 ║
║ COUNT CACHED                   │        0.024 ms │ p95:        0.026 ms │ RPS:     38,356 ║
║ DELETE                         │        0.032 ms │ p95:        0.039 ms │ RPS:     22,152 ║
║ BULK INSERT (100)              │        2.521 ms │ p95:        4.838 ms │ RPS:        186 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ ACID Transaction Overhead</strong> · 🟢 0.381ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/transaction-acid.test.ts">source</a></summary>
...
║                                Ran: 2026-07-26 10:30:40                                 ║
║  Measures transaction commit latencies and rollback overhead across database adapters   ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ TX Commit                      │        0.381 ms │ p95:        0.791 ms │ RPS:      1,745 ║
║ TX Rollback Integrity          │        0.342 ms │ p95:        0.368 ms │ RPS:      2,928 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ Cache</strong> · 🟢 0.224ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/cache-performance.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
```text
╔═════════════════════════════════════════════════════════════════════════════════════════╗
║                            NEGATIVE CACHE PERFORMANCE AUDIT                             ║
║                      File: tests/benchmarks/negative-cache.test.ts                      ║
║                                Ran: 2026-07-26 14:57:30                                 ║
║        Measures Bloom-filter style missing-key cache speedup for repeated misses        ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ First Miss (DB)                │        0.224 ms │ p95:        0.306 ms │ RPS:      4,472 ║
║ Cached Miss (Negative Cache)   │        0.003 ms │ p95:        0.007 ms │ RPS:    308,597 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
<!-- LEDGER_TRUTH_END -->
...
<summary><strong>🏷️ SDK</strong> · 🟢 0.027ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/truth-latency.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
```text
╔═════════════════════════════════════════════════════════════════════════════════════════╗
...
<summary><strong>🏷️ Middleware</strong> · 🟢 2.272ms · ↘️ ⚪ stable at 2.59ms (±0.456ms) (4 runs) (2026-07-31 20:26:17) · <a href="../../../tests/benchmarks/hooks-performance.test.ts">source</a></summary>
<!-- LEDGER_INSIGHT_START -->
> [!NOTE]
...
║                                Ran: 2026-07-26 10:30:43                                 ║
║Measures overhead of WAF request analysis, audit log persistence, Argon2id password hashing, and RBAC permission checks.║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ WAF Deep Analysis              │        0.003 ms │ p95:        0.005 ms │ RPS:    279,774 ║
║ Audit Log Persistence          │        0.195 ms │ p95:        0.180 ms │ RPS:      5,136 ║
║ Argon2id Password Hashing      │        2.835 ms │ p95:       10.322 ms │ RPS:        353 ║
║ Dispatcher-Only Permission Check │        0.000 ms │ p95:        0.000 ms │ RPS:  8,565,311 ║
║ Full Defense-in-Depth Check    │        0.000 ms │ p95:        0.000 ms │ RPS:  6,825,939 ║
║ Admin Verification + Permission Check │        0.000 ms │ p95:        0.000 ms │ RPS:  8,602,151 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ REST API Performance</strong> · 🟢 0.960ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/rest-api-performance.test.ts">source</a></summary>
...
║                                Ran: 2026-07-26 14:55:52                                 ║
║Measures latency, throughput, and correctness of core REST endpoints: health check, schema, CRUD list, and search.║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Health Check                   │        0.960 ms │ p95:        1.811 ms │ RPS:      1,042 ║
║ Collection Schema              │        2.402 ms │ p95:        3.911 ms │ RPS:        416 ║
║ Collection Find (List)         │        2.501 ms │ p95:        3.772 ms │ RPS:        400 ║
║ Collection Search              │        2.335 ms │ p95:        3.615 ms │ RPS:        428 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
