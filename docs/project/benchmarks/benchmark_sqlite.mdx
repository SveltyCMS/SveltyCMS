...
| -------------------------------- | -------- | --------------------------------------- | ------ | ------ |
| **Competitive Workload Replica** | 1.891ms  | ⚪ stable at 2.00ms (±0.319ms) (7 runs) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 5.363ms  | ⚪ stable at 5.48ms (±0.525ms) (7 runs) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.937ms  | ⚪ stable at 2.12ms (±0.274ms) (7 runs) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 2.001ms  | ⚪ stable at 1.97ms (±0.396ms) (7 runs) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 2.541ms  | ⚪ stable at 2.46ms (±0.292ms) (7 runs) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.514ms  | ⚪ stable at 1.80ms (±0.440ms) (7 runs) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 5.546ms  | ⚪ stable at 5.24ms (±1.32ms) (6 runs)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 9.503ms  | ⚪ stable at 10.15ms (±2.54ms) (7 runs) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 10.727ms | ⚪ stable at 10.23ms (±4.17ms) (7 runs) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 7.136ms  | ⚪ stable at 6.60ms (±2.43ms) (7 runs)  | < 5ms  | 🟢     |
...
| database performance (BULK INSERT (100)) (warm)      | 🟢    | `▂▁▁▁▁▂▂▂▂▂▁█` | 2.092ms    |
...
quadrantChart
  ...
  quadrant-4 Critical — fix first
    Competitive Workload Replica: [0.27, 0.42]
    Competitive Workload Replica: [0.21, 0.79]
    Competitive Workload Replica: [0.95, 0.41]
```
...
**Run ID:** `4f89f544-33d5-4080-88c6-cba759802eda` · **Tests invoked:** 1 · **Metrics:** 10 · **DB:** sqlite

| Test                         | Metric                                   | Avg (ms) | p95 (ms) | RPS  | Trend | Detail                                  |
| ---------------------------- | ---------------------------------------- | -------- | -------- | ---- | ----- | --------------------------------------- |
| Competitive Workload Replica | findById (Concurrent 8c)                 | 1.891    | 3.128    | 2522 | 🟢    | ⚪ stable at 2.00ms (±0.319ms) (7 runs) |
| Competitive Workload Replica | findByIdRandom (Concurrent 8c)           | 5.363    | 7.002    | 1358 | 🟢    | ⚪ stable at 5.48ms (±0.525ms) (7 runs) |
| Competitive Workload Replica | listPlain (Concurrent 8c)                | 1.937    | 4.076    | 2401 | 🟢    | ⚪ stable at 2.12ms (±0.274ms) (7 runs) |
| Competitive Workload Replica | listFilterSort (Concurrent 8c)           | 2.001    | 4.018    | 2484 | 🟢    | ⚪ stable at 1.97ms (±0.396ms) (7 runs) |
| Competitive Workload Replica | listLarge (Concurrent 8c)                | 2.541    | 4.595    | 2000 | 🟢    | ⚪ stable at 2.46ms (±0.292ms) (7 runs) |
| Competitive Workload Replica | findMissing (Concurrent 8c)              | 1.514    | 3.133    | 2947 | 🟢    | ⚪ stable at 1.80ms (±0.440ms) (7 runs) |
| Competitive Workload Replica | GraphQL Collection Query (Concurrent 8c) | 5.546    | 7.592    | 1365 | 🟢    | ⚪ stable at 5.24ms (±1.32ms) (6 runs)  |
| Competitive Workload Replica | create (Concurrent 8c)                   | 9.503    | 24.492   | 809  | 🟢    | ⚪ stable at 10.15ms (±2.54ms) (7 runs) |
| Competitive Workload Replica | update (Concurrent 8c)                   | 10.727   | 25.564   | 727  | 🟢    | ⚪ stable at 10.23ms (±4.17ms) (7 runs) |
| Competitive Workload Replica | mixed (Concurrent 8c 50/50)              | 7.136    | 10.370   | 976  | 🟢    | ⚪ stable at 6.60ms (±2.43ms) (7 runs)  |
...
| DATABASE PERFORMANCE (warm)         | 🟢    | `▄▃▂█▃▁▁`          | 0.047ms    |
...
| COMPETITIVE WORKLOAD REPLICA (warm) | ⚪    | `▄▁▁▂▁▅█`          | 10.727ms   |
...
║                                Ran: 2026-08-20 09:40:32                                 ║
║     Validates performance claims by comparing SDK, Middleware, and Real HTTP Stack      ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Logic Baseline                 │        0.000 ms │ p95:        0.000 ms │ RPS:  3,963,012 ║
║ Local SDK (Full)               │        0.005 ms │ p95:        0.011 ms │ RPS:    200,120 ║
║ HTTP End-to-End                │        0.560 ms │ p95:        1.437 ms │ RPS:      1,787 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ database performance</strong> · ⚪ 2.092ms · ↗️ 🔴 slower: 1.36ms → 2.09ms (+54%) (7 runs) (2026-08-20 09:40:27) · <a href="../../../tests/benchmarks/database-performance.test.ts">source</a></summary>
...
║                                Ran: 2026-08-20 09:40:27                                 ║
║   Measures raw CRUD performance, indexing efficiency, and connection pool resilience    ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ INSERT                         │        0.061 ms │ p95:        0.090 ms │ RPS:      6,456 ║
║ FIND ONE                       │        0.007 ms │ p95:        0.009 ms │ RPS:    116,675 ║
║ FIND MANY (limit 50)           │        0.096 ms │ p95:        0.116 ms │ RPS:      7,250 ║
║ FIND PAGE (50 hasMore)         │        0.121 ms │ p95:        0.146 ms │ RPS:      5,668 ║
║ FIND PAGE keyset               │        0.110 ms │ p95:        0.136 ms │ RPS:      6,866 ║
║ FIND MANY offset 50            │        0.060 ms │ p95:        0.078 ms │ RPS:     12,563 ║
║ LIST+COUNT (legacy)            │        0.224 ms │ p95:        0.271 ms │ RPS:      3,418 ║
║ UPDATE                         │        0.058 ms │ p95:        0.074 ms │ RPS:      9,369 ║
║ UPDATE (no-returning)          │        0.047 ms │ p95:        0.060 ms │ RPS:     11,972 ║
║ NATIVE UPSERT                  │        0.086 ms │ p95:        0.104 ms │ RPS:      7,549 ║
║ COUNT                          │        0.133 ms │ p95:        0.153 ms │ RPS:      5,637 ║
║ COUNT ESTIMATE                 │        0.030 ms │ p95:        0.039 ms │ RPS:     24,152 ║
║ COUNT CACHED                   │        0.001 ms │ p95:        0.002 ms │ RPS:    486,447 ║
║ DELETE                         │        0.090 ms │ p95:        0.132 ms │ RPS:      6,273 ║
║ BULK INSERT (100)              │        2.092 ms │ p95:        4.213 ms │ RPS:        164 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ HTTP</strong> · ⚪ 0.541ms · ↗️ 🔴 slower: 0.472ms → 0.541ms (+15%) (7 runs) (2026-08-20 09:11:47) · <a href="../../../tests/benchmarks/truth-latency.test.ts">source</a></summary>
<!-- LEDGER_INSIGHT_START -->
> [!NOTE]
...
<summary><strong>🏷️ Logic</strong> · 🟢 ⏳ pending · ➡️ ⚪ stable at 0ms (7 runs) (2026-08-20 09:11:47) · <a href="../../../tests/benchmarks/truth-latency.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
> ⏳ Pending
<!-- LEDGER_TRUTH_END -->
...
<summary><strong>🏷️ SDK</strong> · 🟢 0.007ms · ↗️ ⚪ stable at 0.006ms (±0.004ms) (7 runs) (2026-08-20 09:11:47) · <a href="../../../tests/benchmarks/truth-latency.test.ts">source</a></summary>
<!-- LEDGER_INSIGHT_START -->
> [!NOTE]
> **Specific to this test**: Both avg and p95 degraded — likely adapter or infrastructure bottleneck. Check DB connection pool, indexes, or recent commits.  
...
<summary><strong>🏷️ GraphQL Load Stress</strong> · 🟢 5.566ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/graphql-stress.test.ts">source</a></summary>
...
║                                Ran: 2026-08-20 09:24:05                                 ║
║  Discovers the server's maximum sustainable GraphQL throughput by ramping concurrency   ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ GQL: 5c Warmup                 │        5.566 ms │ p95:        7.067 ms │ RPS:        786 ║
║ GQL: 10c Light                 │        8.828 ms │ p95:       12.374 ms │ RPS:        944 ║
║ GQL: 20c Moderate              │       14.643 ms │ p95:       21.169 ms │ RPS:      1,170 ║
║ GQL: 40c Heavy                 │       33.945 ms │ p95:       53.609 ms │ RPS:        922 ║
║ GQL: 60c Stress                │       48.972 ms │ p95:       72.025 ms │ RPS:        952 ║
║ GQL: 80c Extreme               │       49.218 ms │ p95:       68.478 ms │ RPS:      1,190 ║
║ GQL: 100c Max                  │       64.183 ms │ p95:       84.452 ms │ RPS:      1,198 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
