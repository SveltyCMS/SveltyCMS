...
| ------------------------ | ------- | ---------------------------------------- | ------ | ------ |
| **Database Performance** | 0.074ms | ⚪ stable at 0.074ms (±0.002ms) (5 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.054ms | ⚪ stable at 0.053ms (±0.003ms) (5 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.071ms | ⚪ stable at 0.068ms (±0.001ms) (5 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.073ms | ⚪ established at 0.073ms (1 run)        | < 5ms  | 🟢     |
| **Database Performance** | 0.191ms | ⚪ established at 0.191ms (1 run)        | < 5ms  | 🟢     |
| **Database Performance** | 0.077ms | ⚪ stable at 0.074ms (±0.001ms) (5 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.051ms | ⚪ stable at 0.049ms (±0.002ms) (5 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.119ms | ⚪ stable at 0.119ms (±0.002ms) (5 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.024ms | ⚪ established at 0.024ms (1 run)        | < 5ms  | 🟢     |
| **Database Performance** | 0.024ms | ⚪ established at 0.024ms (1 run)        | < 5ms  | 🟢     |
| **Database Performance** | 0.031ms | ⚪ stable at 0.030ms (5 runs)            | < 5ms  | 🟢     |
| **Database Performance** | 2.376ms | ⚪ stable at 2.28ms (±0.181ms) (5 runs)  | < 5ms  | 🟢     |
...
| ----------------------------------------------- | ----- | --------- | ------- |
| database performance (BULK INSERT (100)) (warm) | 🟢    | `▂█▆▁▁▅`  | 2.376ms |
...
**Run ID:** `e9cc5c05-ed30-4509-ac6c-9bb093be8bb7` · **Tests invoked:** 1 · **Metrics:** 12 · **DB:** sqlite

| Test                 | Metric                 | Avg (ms) | p95 (ms) | RPS   | Trend | Detail                                   |
| -------------------- | ---------------------- | -------- | -------- | ----- | ----- | ---------------------------------------- |
| Database Performance | INSERT                 | 0.074    | 0.097    | 6001  | 🟢    | ⚪ stable at 0.074ms (±0.002ms) (5 runs) |
| Database Performance | FIND ONE               | 0.054    | 0.062    | 17169 | 🟢    | ⚪ stable at 0.053ms (±0.003ms) (5 runs) |
| Database Performance | FIND PAGE (50 hasMore) | 0.073    | 0.086    | 12766 | 🟢    | ⚪ established at 0.073ms (1 run)        |
| Database Performance | LIST+COUNT (legacy)    | 0.191    | 0.213    | 4907  | 🟢    | ⚪ established at 0.191ms (1 run)        |
| Database Performance | NATIVE UPSERT          | 0.051    | 0.057    | 15943 | 🟢    | ⚪ stable at 0.049ms (±0.002ms) (5 runs) |
| Database Performance | COUNT                  | 0.119    | 0.131    | 7880  | 🟢    | ⚪ stable at 0.119ms (±0.002ms) (5 runs) |
| Database Performance | COUNT ESTIMATE         | 0.024    | 0.027    | 38701 | 🟢    | ⚪ established at 0.024ms (1 run)        |
| Database Performance | COUNT CACHED           | 0.024    | 0.027    | 39516 | 🟢    | ⚪ established at 0.024ms (1 run)        |
| Database Performance | BULK INSERT (100)      | 2.376    | 4.593    | 194   | 🟢    | ⚪ stable at 2.28ms (±0.181ms) (5 runs)  |
| Database Performance | FIND MANY (limit 50)   | 0.071    | 0.084    | 12943 | ⚪    | ⚪ stable at 0.068ms (±0.001ms) (5 runs) |
| Database Performance | UPDATE                 | 0.077    | 0.090    | 11078 | ⚪    | ⚪ stable at 0.074ms (±0.001ms) (5 runs) |
| Database Performance | DELETE                 | 0.031    | 0.036    | 24857 | ⚪    | ⚪ stable at 0.030ms (5 runs)            |
...
| --------------------------- | ----- | ------------------ | ------- |
| DATABASE PERFORMANCE (warm) | 🟢    | `▂▁▂▂█▁▂`          | 0.077ms |
...
<summary><strong>🏷️ database performance</strong> · 🟢 2.376ms · ➡️ ⚪ stable at 2.28ms (±0.181ms) (5 runs) (2026-08-04 11:43:33) · <a href="../../../tests/benchmarks/database-performance.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
```text
╔═════════════════════════════════════════════════════════════════════════════════════════╗
║                    SVELTYCMS — DATABASE ADAPTER PERFORMANCE (SQLITE)                    ║
║                   File: tests/benchmarks/database-performance.test.ts                   ║
║                                Ran: 2026-08-04 11:43:33                                 ║
║   Measures raw CRUD performance, indexing efficiency, and connection pool resilience    ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ INSERT                         │        0.074 ms │ p95:        0.097 ms │ RPS:      6,001 ║
║ FIND ONE                       │        0.054 ms │ p95:        0.062 ms │ RPS:     17,169 ║
║ FIND MANY (limit 50)           │        0.071 ms │ p95:        0.084 ms │ RPS:     12,943 ║
║ FIND PAGE (50 hasMore)         │        0.073 ms │ p95:        0.086 ms │ RPS:     12,766 ║
║ LIST+COUNT (legacy)            │        0.191 ms │ p95:        0.213 ms │ RPS:      4,907 ║
║ UPDATE                         │        0.077 ms │ p95:        0.090 ms │ RPS:     11,078 ║
║ NATIVE UPSERT                  │        0.051 ms │ p95:        0.057 ms │ RPS:     15,943 ║
║ COUNT                          │        0.119 ms │ p95:        0.131 ms │ RPS:      7,880 ║
║ COUNT ESTIMATE                 │        0.024 ms │ p95:        0.027 ms │ RPS:     38,701 ║
║ COUNT CACHED                   │        0.024 ms │ p95:        0.027 ms │ RPS:     39,516 ║
║ DELETE                         │        0.031 ms │ p95:        0.036 ms │ RPS:     24,857 ║
║ BULK INSERT (100)              │        2.376 ms │ p95:        4.593 ms │ RPS:        194 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
<!-- LEDGER_TRUTH_END -->
