...
║                                Ran: 2026-07-08 11:23:34                                 ║
║     Validates performance claims by comparing SDK, Middleware, and Real HTTP Stack      ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Logic Baseline                 │        0.000 ms │ p95:        0.001 ms │ RPS:  2,106,742 ║
║ Local SDK (Full)               │        0.005 ms │ p95:        0.009 ms │ RPS:    194,401 ║
║ HTTP End-to-End                │        0.567 ms │ p95:        0.964 ms │ RPS:      1,764 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ Middleware & Hooks Performance</strong> · 🟢 0.151ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/hooks-performance.test.ts">source</a></summary>
...
║                                Ran: 2026-07-08 11:27:09                                 ║
║Measures the cost of the full middleware chain including Turbo, Security, Auth, and Audit via HTTP E2E.║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Static Asset (No Middleware)   │        0.151 ms │ p95:        0.263 ms │ RPS:      6,643 ║
║ Turbo Pipeline (Light)         │        0.438 ms │ p95:        0.531 ms │ RPS:      2,010 ║
║ Full Security + Auth Pipeline  │        0.586 ms │ p95:        0.682 ms │ RPS:      1,495 ║
║ REST with API Caching          │        0.532 ms │ p95:        0.595 ms │ RPS:      1,801 ║
║ Mutation + Audit Logging       │        2.980 ms │ p95:        3.830 ms │ RPS:        307 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ Database Adapter Raw CRUD</strong> · 🟢 0.135ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/database-performance.test.ts">source</a></summary>
...
║                                Ran: 2026-07-08 11:24:55                                 ║
║   Measures raw CRUD performance, indexing efficiency, and connection pool resilience    ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ INSERT                         │        0.135 ms │ p95:        0.234 ms │ RPS:      3,420 ║
║ FIND ONE                       │        0.064 ms │ p95:        0.089 ms │ RPS:     13,815 ║
║ FIND MANY (limit 50)           │        0.076 ms │ p95:        0.099 ms │ RPS:     11,572 ║
║ UPDATE                         │        0.086 ms │ p95:        0.123 ms │ RPS:      8,834 ║
║ NATIVE UPSERT                  │        0.064 ms │ p95:        0.100 ms │ RPS:     12,243 ║
║ COUNT                          │        0.158 ms │ p95:        0.237 ms │ RPS:      5,906 ║
║ DELETE                         │        0.039 ms │ p95:        0.058 ms │ RPS:     17,856 ║
║ BULK INSERT (100)              │        2.814 ms │ p95:        4.864 ms │ RPS:        157 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ ACID Transaction Overhead</strong> · 🟢 0.267ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/transaction-acid.test.ts">source</a></summary>
...
║                                Ran: 2026-07-08 11:25:39                                 ║
║  Measures transaction commit latencies and rollback overhead across database adapters   ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ TX Commit                      │        0.267 ms │ p95:        0.635 ms │ RPS:      2,376 ║
║ TX Rollback Integrity          │        0.310 ms │ p95:        0.529 ms │ RPS:      3,229 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ Cache</strong> · 🟢 0.449ms · ➡️ ⚪ established at 0.449ms (1 run) (2026-07-08 11:26:23) · <a href="../../../tests/benchmarks/cache-performance.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
```text
╔═════════════════════════════════════════════════════════════════════════════════════════╗
║                           SVELTYCMS — CACHE EFFICIENCY AUDIT                            ║
║                    File: tests/benchmarks/cache-performance.test.ts                     ║
║                                Ran: 2026-07-08 11:26:23                                 ║
║  Measures cache hit vs miss latency and efficiency via real HTTP end-to-end requests.   ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Cache Miss (Bypass)            │        0.449 ms │ p95:        0.636 ms │ RPS:      2,011 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
<!-- LEDGER_TRUTH_END -->
...
<summary><strong>🏷️ SDK</strong> · 🟢 0.005ms · ➡️ ⚪ established at 0.005ms (1 run) (2026-07-08 11:23:45) · <a href="../../../tests/benchmarks/truth-latency.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
```text
╔═════════════════════════════════════════════════════════════════════════════════════════╗
...
<summary><strong>🏷️ unknown</strong> · 🟢 0.310ms · ➡️ ⚪ established at 0.310ms (1 run) (2026-07-08 11:25:39) · <a href="../../../tests/benchmarks/transaction-acid.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
```text
╔═════════════════════════════════════════════════════════════════════════════════════════╗
...
<summary><strong>🏷️ REST API Performance</strong> · 🟢 0.713ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/rest-api-performance.test.ts">source</a></summary>
...
║                                Ran: 2026-07-08 11:27:53                                 ║
║Measures latency, throughput, and correctness of core REST endpoints: health check, schema, CRUD list, and search.║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Health Check                   │        0.713 ms │ p95:        1.357 ms │ RPS:      1,402 ║
║ Collection Schema              │        0.924 ms │ p95:        1.602 ms │ RPS:      1,082 ║
║ Collection Find (List)         │        1.184 ms │ p95:        2.113 ms │ RPS:        845 ║
║ Collection Search              │        1.248 ms │ p95:        2.143 ms │ RPS:        802 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
