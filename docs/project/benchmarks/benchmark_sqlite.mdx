...
| ------------------------ | ------- | ---------------------------------------- | ------ | ------ |
| **Database Performance** | 0.074ms | ⚪ stable at 0.070ms (±0.039ms) (7 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.009ms | ⚪ stable at 0.010ms (±0.004ms) (7 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.106ms | ⚪ stable at 0.115ms (±0.031ms) (7 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.650ms | ⚪ stable at 0.694ms (±0.112ms) (7 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.477ms | ⚪ stable at 0.533ms (±0.103ms) (7 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.060ms | ⚪ stable at 0.063ms (±0.013ms) (7 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.232ms | ⚪ stable at 0.210ms (±0.031ms) (7 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.113ms | ⚪ stable at 0.109ms (±0.036ms) (7 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.072ms | ⚪ stable at 0.060ms (±0.017ms) (7 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.073ms | ⚪ stable at 0.076ms (±0.009ms) (7 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.135ms | ⚪ stable at 0.140ms (±0.036ms) (7 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.028ms | ⚪ stable at 0.030ms (±0.008ms) (7 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.001ms | ⚪ stable at 0.003ms (±0.131ms) (7 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.051ms | ⚪ stable at 0.056ms (±0.006ms) (7 runs) | < 5ms  | 🟢     |
| **Database Performance** | 1.661ms | ⚪ stable at 1.61ms (±0.499ms) (7 runs)  | < 5ms  | 🟢     |
...
| database performance (BULK INSERT (100)) (warm)      | 🟢    | `▂▂▁▁▁▃▆▇▄▅█▆` | 1.661ms    |
...
quadrantChart
  ...
  quadrant-4 Critical — fix first
    Database Performance: [0.05, 0.15]
    Database Performance: [0.48, 0.16]
    Database Performance: [0.23, 0.16]
    Database Performance: [0.07, 0.30]
    Database Performance: [0.05, 0.95]
    Database Performance: [0.05, 0.13]
```
...
**Run ID:** `dd7e5afe-e8d1-497f-af51-fcdca45c9ab2` · **Tests invoked:** 1 · **Metrics:** 15 · **DB:** sqlite

| Test                 | Metric                 | Avg (ms) | p95 (ms) | RPS    | Trend | Detail                                   |
| -------------------- | ---------------------- | -------- | -------- | ------ | ----- | ---------------------------------------- |
| Database Performance | INSERT                 | 0.074    | 0.115    | 5953   | 🟢    | ⚪ stable at 0.070ms (±0.039ms) (7 runs) |
| Database Performance | FIND ONE               | 0.009    | 0.013    | 81881  | 🟢    | ⚪ stable at 0.010ms (±0.004ms) (7 runs) |
| Database Performance | FIND MANY (limit 50)   | 0.106    | 0.148    | 7066   | 🟢    | ⚪ stable at 0.115ms (±0.031ms) (7 runs) |
| Database Performance | FIND PAGE (50 hasMore) | 0.650    | 0.824    | 1285   | 🟢    | ⚪ stable at 0.694ms (±0.112ms) (7 runs) |
| Database Performance | FIND PAGE keyset       | 0.477    | 0.611    | 1683   | 🟢    | ⚪ stable at 0.533ms (±0.103ms) (7 runs) |
| Database Performance | FIND MANY offset 50    | 0.060    | 0.087    | 11898  | 🟢    | ⚪ stable at 0.063ms (±0.013ms) (7 runs) |
| Database Performance | LIST+COUNT (legacy)    | 0.232    | 0.307    | 3568   | 🟢    | ⚪ stable at 0.210ms (±0.031ms) (7 runs) |
| Database Performance | UPDATE                 | 0.113    | 0.146    | 6373   | 🟢    | ⚪ stable at 0.109ms (±0.036ms) (7 runs) |
| Database Performance | UPDATE (no-returning)  | 0.072    | 0.093    | 9696   | 🟢    | ⚪ stable at 0.060ms (±0.017ms) (7 runs) |
| Database Performance | NATIVE UPSERT          | 0.073    | 0.101    | 9516   | 🟢    | ⚪ stable at 0.076ms (±0.009ms) (7 runs) |
| Database Performance | COUNT                  | 0.135    | 0.153    | 6258   | 🟢    | ⚪ stable at 0.140ms (±0.036ms) (7 runs) |
| Database Performance | COUNT ESTIMATE         | 0.028    | 0.035    | 29253  | 🟢    | ⚪ stable at 0.030ms (±0.008ms) (7 runs) |
| Database Performance | COUNT CACHED           | 0.001    | 0.002    | 440232 | 🟢    | ⚪ stable at 0.003ms (±0.131ms) (7 runs) |
| Database Performance | DELETE                 | 0.051    | 0.068    | 12435  | 🟢    | ⚪ stable at 0.056ms (±0.006ms) (7 runs) |
| Database Performance | BULK INSERT (100)      | 1.661    | 2.145    | 172    | 🟢    | ⚪ stable at 1.61ms (±0.499ms) (7 runs)  |
...
| DATABASE PERFORMANCE (warm)    | 🟢    | `█▆▁▃▁▁▁`          | 0.072ms    |
...
<summary><strong>🏷️ database performance</strong> · 🟢 1.661ms · ➡️ ⚪ stable at 1.61ms (±0.499ms) (7 runs) (2026-08-12 08:30:59) · <a href="../../../tests/benchmarks/database-performance.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
```text
╔═════════════════════════════════════════════════════════════════════════════════════════╗
║                    SVELTYCMS — DATABASE ADAPTER PERFORMANCE (SQLITE)                    ║
║                   File: tests/benchmarks/database-performance.test.ts                   ║
║                                Ran: 2026-08-12 08:30:59                                 ║
║   Measures raw CRUD performance, indexing efficiency, and connection pool resilience    ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ INSERT                         │        0.074 ms │ p95:        0.115 ms │ RPS:      5,953 ║
║ FIND ONE                       │        0.009 ms │ p95:        0.013 ms │ RPS:     81,881 ║
║ FIND MANY (limit 50)           │        0.106 ms │ p95:        0.148 ms │ RPS:      7,066 ║
║ FIND PAGE (50 hasMore)         │        0.650 ms │ p95:        0.824 ms │ RPS:      1,285 ║
║ FIND PAGE keyset               │        0.477 ms │ p95:        0.611 ms │ RPS:      1,683 ║
║ FIND MANY offset 50            │        0.060 ms │ p95:        0.087 ms │ RPS:     11,898 ║
║ LIST+COUNT (legacy)            │        0.232 ms │ p95:        0.307 ms │ RPS:      3,568 ║
║ UPDATE                         │        0.113 ms │ p95:        0.146 ms │ RPS:      6,373 ║
║ UPDATE (no-returning)          │        0.072 ms │ p95:        0.093 ms │ RPS:      9,696 ║
║ NATIVE UPSERT                  │        0.073 ms │ p95:        0.101 ms │ RPS:      9,516 ║
║ COUNT                          │        0.135 ms │ p95:        0.153 ms │ RPS:      6,258 ║
║ COUNT ESTIMATE                 │        0.028 ms │ p95:        0.035 ms │ RPS:     29,253 ║
║ COUNT CACHED                   │        0.001 ms │ p95:        0.002 ms │ RPS:    440,232 ║
║ DELETE                         │        0.051 ms │ p95:        0.068 ms │ RPS:     12,435 ║
║ BULK INSERT (100)              │        1.661 ms │ p95:        2.145 ms │ RPS:        172 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
<!-- LEDGER_TRUTH_END -->
...
<summary><strong>🏷️ Database Failover & Reconnection</strong> · 🟢 47.260ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/database-failover.test.ts">source</a></summary>
