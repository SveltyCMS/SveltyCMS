...
<summary><strong>🏷️ API LAYER LATENCY</strong> · 🟢 8.432ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/api-latency.test.ts">source</a></summary>
...
║                                Ran: 2026-08-08 11:14:36                                 ║
║       Cold full-pipeline findById + warm TURBO-HIT path after responseCache fill.       ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ HTTP: findById @ 8c            │        8.432 ms │ p95:       13.725 ms │ RPS:        116 ║
║ HTTP: findById TURBO-HIT @ 8c  │        3.217 ms │ p95:        4.341 ms │ RPS:        308 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
║                                Ran: 2026-08-08 11:14:14                                 ║
║     Validates performance claims by comparing SDK, Middleware, and Real HTTP Stack      ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Logic Baseline                 │        0.001 ms │ p95:        0.002 ms │ RPS:  1,173,709 ║
║ Local SDK (Full)               │        0.008 ms │ p95:        0.015 ms │ RPS:    121,857 ║
║ HTTP End-to-End                │        1.913 ms │ p95:        3.857 ms │ RPS:        523 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ Cache</strong> · 🟢 0.549ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/cache-performance.test.ts">source</a></summary>
<!-- LEDGER_INSIGHT_START -->
> [!NOTE]
> **Specific to this test**: Both avg and p95 degraded — likely adapter or infrastructure bottleneck. Check DB connection pool, indexes, or recent commits.  
...
║                                Ran: 2026-08-08 11:16:35                                 ║
║        Measures Bloom-filter style missing-key cache speedup for repeated misses        ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ First Miss (DB)                │        0.549 ms │ p95:        0.787 ms │ RPS:      1,820 ║
║ Cached Miss (Negative Cache)   │        0.147 ms │ p95:        0.255 ms │ RPS:      6,817 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ SDK</strong> · 🟢 0.038ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/truth-latency.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
```text
╔═════════════════════════════════════════════════════════════════════════════════════════╗
║                           SVELTYCMS — SDK OVERHEAD TELEMETRY                            ║
║                  File: tests/benchmarks/local-api-performance.test.ts                   ║
║                                Ran: 2026-08-08 11:17:11                                 ║
║  Measures LocalCMS SDK overhead vs direct adapter calls to verify zero-tax dispatching  ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Direct Adapter Call            │        0.038 ms │ p95:        0.061 ms │ RPS:     26,505 ║
║ LocalCMS SDK Call              │        0.032 ms │ p95:        0.051 ms │ RPS:     31,244 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
<!-- LEDGER_TRUTH_END -->
...
<summary><strong>🏷️ Simulated Admin UX Vitality</strong> · 🟢 2.479ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/admin-ux-vitality.test.ts">source</a></summary>
...
║                                Ran: 2026-08-08 11:16:39                                 ║
║             Forms and widget registry performance via real HTTP endpoints.              ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Schema Resolution (8f)         │        2.479 ms │ p95:        3.593 ms │ RPS:        389 ║
║ Collection List (11 cols)      │        2.110 ms │ p95:        3.018 ms │ RPS:        449 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ Entry Edit Hydration</strong> · 🟢 0.124ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/entry-edit-hydration.test.ts">source</a></summary>
...
║                                Ran: 2026-08-08 11:17:13                                 ║
║Measures 50-field form mount (widget loader resolve + prefetch) and first-input sync latency.║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ 50-Field Loader Resolve        │        0.124 ms │ p95:        0.153 ms │ RPS:      7,420 ║
║ Widget Prefetch (5 types)      │        0.034 ms │ p95:        0.045 ms │ RPS:     27,047 ║
║ First Input (field patch)      │        0.000 ms │ p95:        0.000 ms │ RPS:  4,369,102 ║
║ First Input (JSON.stringify)   │        0.009 ms │ p95:        0.010 ms │ RPS:    104,436 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ Relational & Nested Queries</strong> · 🟢 9.411ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/relational-performance.test.ts">source</a></summary>
...
║                                Ran: 2026-08-08 11:16:58                                 ║
║Measures GraphQL resolver performance for shallow and deep relational queries including joins and nested population.║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Shallow Relational Query       │        9.411 ms │ p95:       14.110 ms │ RPS:        104 ║
║ Deep Relational Query          │        6.892 ms │ p95:       10.014 ms │ RPS:        142 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ OpenAPI Specification Performance</strong> · 🟢 2.080ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/openapi-performance.test.ts">source</a></summary>
...
║                                Ran: 2026-08-08 11:16:49                                 ║
║Measures dynamic OpenAPI spec generation speed and cached documentation endpoint performance.║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Cold OpenAPI Generation        │        2.080 ms │ p95:        3.368 ms │ RPS:        481 ║
║ Warm OpenAPI Hit (Cached)      │        1.542 ms │ p95:        1.960 ms │ RPS:        576 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ Auth & RBAC Performance</strong> · 🟢 1.720ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/auth-performance.test.ts">source</a></summary>
...
║                                Ran: 2026-08-08 11:14:42                                 ║
║             Authentication & RBAC Pipeline Benchmark (Production Optimized)             ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Auth Validation @ 1c           │        1.720 ms │ p95:        2.345 ms │ RPS:        519 ║
║ HTTP Auth Pipeline @ 8c        │        5.583 ms │ p95:        8.396 ms │ RPS:        177 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ REST API Performance</strong> · 🟢 1.226ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/rest-api-performance.test.ts">source</a></summary>
...
║                                Ran: 2026-08-08 11:14:32                                 ║
║Measures latency, throughput, and correctness of core REST endpoints: health check, schema, CRUD list, and search.║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Health Check                   │        1.226 ms │ p95:        2.539 ms │ RPS:        816 ║
║ Collection Schema              │        2.342 ms │ p95:        3.473 ms │ RPS:        427 ║
║ Collection Find (List)         │        2.514 ms │ p95:        3.928 ms │ RPS:        398 ║
║ Collection Search              │        2.766 ms │ p95:        4.761 ms │ RPS:        362 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ GraphQL API Performance</strong> · 🟢 3.936ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/graphql-api-performance.test.ts">source</a></summary>
...
║                                Ran: 2026-08-08 11:16:06                                 ║
║              Measures GraphQL resolver performance across query scenarios,              ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ GQL: System Health [cold]      │        3.936 ms │ p95:        6.746 ms │ RPS:        254 ║
║ GQL: System Health [hot]       │        2.687 ms │ p95:        4.888 ms │ RPS:        372 ║
║ GQL: Collection List [cold]    │       13.522 ms │ p95:       21.126 ms │ RPS:         74 ║
║ GQL: Collection List [hot]     │        8.888 ms │ p95:       14.709 ms │ RPS:        113 ║
║ GQL: Concurrent Load [cold]    │       11.260 ms │ p95:       17.228 ms │ RPS:         89 ║
║ GQL: Concurrent Load [hot]     │        7.384 ms │ p95:       10.654 ms │ RPS:        135 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ Enterprise SEO Suite Audit</strong> · 🟢 3.595ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/seo-performance.test.ts">source</a></summary>
...
║                                Ran: 2026-08-08 11:17:02                                 ║
║Measures redirect lookup latency, dynamic sitemap.xml generation, robots.txt serving, and 404 logging performance.║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Redirect Lookup (301)          │        3.595 ms │ p95:        5.376 ms │ RPS:        278 ║
║ Dynamic Sitemap XML            │        1.244 ms │ p95:        2.359 ms │ RPS:        804 ║
║ Robots.txt Generation          │        4.976 ms │ p95:        7.330 ms │ RPS:        201 ║
║ Missing Path (404 Log)         │        5.091 ms │ p95:        7.339 ms │ RPS:        196 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ Realistic Mixed Workload</strong> · 🟢 4.584ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/mixed-workload.test.ts">source</a></summary>
...
<summary><strong>🏷️ GraphQL Load Stress</strong> · 🟢 11.867ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/graphql-stress.test.ts">source</a></summary>
...
║                                Ran: 2026-08-08 11:16:23                                 ║
║  Discovers the server's maximum sustainable GraphQL throughput by ramping concurrency   ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ GQL: 5c Warmup                 │       11.867 ms │ p95:       17.218 ms │ RPS:         83 ║
║ GQL: 10c Light                 │       17.552 ms │ p95:       25.393 ms │ RPS:         53 ║
║ GQL: 20c Moderate              │       42.871 ms │ p95:       66.330 ms │ RPS:         23 ║
║ GQL: 40c Heavy                 │       66.730 ms │ p95:       94.459 ms │ RPS:         15 ║
║ GQL: 60c Stress                │       80.961 ms │ p95:      114.201 ms │ RPS:         12 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ Chaos & Infrastructure Resilience</strong> · 🟢 162.766ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/chaos-resilience.test.ts">source</a></summary>
