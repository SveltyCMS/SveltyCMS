...
<summary><strong>🏷️ API LAYER LATENCY</strong> · 🟢 3.976ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/api-latency.test.ts">source</a></summary>
...
║                                Ran: 2026-07-26 10:27:04                                 ║
║                      API Latency Benchmark (Production Optimized)                       ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ HTTP: findById @ 8c            │        3.976 ms │ p95:        6.031 ms │ RPS:        244 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
║                                Ran: 2026-07-26 10:26:46                                 ║
║     Validates performance claims by comparing SDK, Middleware, and Real HTTP Stack      ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Logic Baseline                 │        0.001 ms │ p95:        0.001 ms │ RPS:  1,424,501 ║
║ Local SDK (Full)               │        0.009 ms │ p95:        0.017 ms │ RPS:    105,794 ║
║ HTTP End-to-End                │        1.148 ms │ p95:        2.384 ms │ RPS:        871 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
║                                Ran: 2026-07-26 10:30:53                                 ║
║        Measures L1 cache hit latency and pattern invalidation overhead at scale         ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Cache L1 Hit                   │        0.001 ms │ p95:        0.002 ms │ RPS:    983,049 ║
║ Pattern Invalidation (1k items @ 200k noise) │       10.728 ms │ p95:       14.688 ms │ RPS:         93 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
<!-- LEDGER_TRUTH_END -->
...
<summary><strong>🏷️ Simulated Admin UX Vitality</strong> · 🟢 1.874ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/admin-ux-vitality.test.ts">source</a></summary>
...
║                                Ran: 2026-07-26 10:28:38                                 ║
║             Forms and widget registry performance via real HTTP endpoints.              ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Schema Resolution (8f)         │        1.874 ms │ p95:        2.851 ms │ RPS:        512 ║
║ Collection List (11 cols)      │        1.715 ms │ p95:        2.481 ms │ RPS:        559 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ OpenAPI Specification Performance</strong> · 🟢 2.016ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/openapi-performance.test.ts">source</a></summary>
...
║                                Ran: 2026-07-26 10:28:48                                 ║
║Measures dynamic OpenAPI spec generation speed and cached documentation endpoint performance.║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Cold OpenAPI Generation        │        2.016 ms │ p95:        4.053 ms │ RPS:        496 ║
║ Warm OpenAPI Hit (Cached)      │        1.203 ms │ p95:        1.442 ms │ RPS:        750 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ Auth & RBAC Performance</strong> · 🟢 0.832ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/auth-performance.test.ts">source</a></summary>
...
║                                Ran: 2026-07-26 10:27:08                                 ║
║             Authentication & RBAC Pipeline Benchmark (Production Optimized)             ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Auth Validation @ 1c           │        0.832 ms │ p95:        1.006 ms │ RPS:      1,094 ║
║ HTTP Auth Pipeline @ 8c        │        3.289 ms │ p95:        4.939 ms │ RPS:        295 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ REST API Performance</strong> · 🟢 0.938ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/rest-api-performance.test.ts">source</a></summary>
...
║                                Ran: 2026-07-26 10:27:02                                 ║
║Measures latency, throughput, and correctness of core REST endpoints: health check, schema, CRUD list, and search.║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Health Check                   │        0.938 ms │ p95:        1.784 ms │ RPS:      1,066 ║
║ Collection Schema              │        2.447 ms │ p95:        3.842 ms │ RPS:        409 ║
║ Collection Find (List)         │        2.844 ms │ p95:        4.364 ms │ RPS:        352 ║
║ Collection Search              │        3.366 ms │ p95:        5.343 ms │ RPS:        297 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ GraphQL API Performance</strong> · 🟢 1.442ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/graphql-api-performance.test.ts">source</a></summary>
...
║                                Ran: 2026-07-26 10:28:18                                 ║
║   Measures GraphQL resolver performance and throughput across varied query scenarios.   ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ GQL: System Health             │        1.442 ms │ p95:        2.500 ms │ RPS:        693 ║
║ GQL: Collection List           │        5.347 ms │ p95:        8.618 ms │ RPS:        187 ║
║ GQL: Concurrent Load           │        4.567 ms │ p95:        7.926 ms │ RPS:        219 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ GraphQL Load Stress</strong> · 🟢 4.400ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/graphql-stress.test.ts">source</a></summary>
...
║                                Ran: 2026-07-26 10:28:28                                 ║
║  Discovers the server's maximum sustainable GraphQL throughput by ramping concurrency   ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ GQL: 5c Warmup                 │        4.400 ms │ p95:        5.942 ms │ RPS:        200 ║
║ GQL: 10c Light                 │        8.599 ms │ p95:       11.850 ms │ RPS:        115 ║
║ GQL: 20c Moderate              │       16.744 ms │ p95:       23.086 ms │ RPS:         60 ║
║ GQL: 40c Heavy                 │       29.972 ms │ p95:       38.586 ms │ RPS:         34 ║
║ GQL: 60c Stress                │       45.243 ms │ p95:       59.387 ms │ RPS:         23 ║
║ GQL: 80c Extreme               │       58.802 ms │ p95:       79.409 ms │ RPS:         17 ║
║ GQL: 100c Max                  │       47.212 ms │ p95:       89.265 ms │ RPS:         21 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ Chaos & Infrastructure Resilience</strong> · 🟢 163.849ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/chaos-resilience.test.ts">source</a></summary>
