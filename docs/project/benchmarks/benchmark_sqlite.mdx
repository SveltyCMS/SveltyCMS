...
| --------- | ------- | --------------------------------------- | ------ | ------ |
| **HTTP**  | 2.247ms | ⚪ stable at 5.34ms (±2.97ms) (7 runs)  | < 5ms  | 🟢     |
| **TURBO** | 1.281ms | ⚪ stable at 2.29ms (±0.787ms) (7 runs) | < 5ms  | 🟢     |
...
**Run ID:** `abe068d4-a767-462e-9b73-0e3a222d4459` · **Tests invoked:** 1 · **Metrics:** 2 · **DB:** sqlite

| Test        | Metric                        | Avg (ms) | p95 (ms) | RPS | Trend | Detail                                  |
| ----------- | ----------------------------- | -------- | -------- | --- | ----- | --------------------------------------- |
| Api Latency | HTTP: findById @ 8c           | 2.247    | 4.565    | 434 | 🟢    | ⚪ stable at 5.34ms (±2.97ms) (7 runs)  |
| Api Latency | HTTP: findById TURBO-HIT @ 8c | 1.281    | 2.311    | 757 | 🟢    | ⚪ stable at 2.29ms (±0.787ms) (7 runs) |
...
| HOOKS PERFORMANCE (warm)       | 🟢    | `▂▁▂█▂▂▁`          | 0.292ms    |
...
<summary><strong>🏷️ database performance</strong> · 🟢 1.198ms · ➡️ ⚪ stable at 1.23ms (±0.372ms) (7 runs) (2026-08-13 19:08:55) · <a href="../../../tests/benchmarks/database-performance.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
```text
╔═════════════════════════════════════════════════════════════════════════════════════════╗
║                    SVELTYCMS — DATABASE ADAPTER PERFORMANCE (SQLITE)                    ║
║                   File: tests/benchmarks/database-performance.test.ts                   ║
║                                Ran: 2026-08-13 19:08:55                                 ║
║   Measures raw CRUD performance, indexing efficiency, and connection pool resilience    ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ INSERT                         │        0.064 ms │ p95:        0.115 ms │ RPS:      7,398 ║
║ FIND ONE                       │        0.007 ms │ p95:        0.011 ms │ RPS:    106,913 ║
║ FIND MANY (limit 50)           │        0.105 ms │ p95:        0.148 ms │ RPS:      7,509 ║
║ FIND PAGE (50 hasMore)         │        0.111 ms │ p95:        0.135 ms │ RPS:      6,774 ║
║ FIND PAGE keyset               │        0.104 ms │ p95:        0.137 ms │ RPS:      7,177 ║
║ FIND MANY offset 50            │        0.054 ms │ p95:        0.068 ms │ RPS:     14,624 ║
║ LIST+COUNT (legacy)            │        0.174 ms │ p95:        0.194 ms │ RPS:      4,716 ║
║ UPDATE                         │        0.027 ms │ p95:        0.034 ms │ RPS:     19,555 ║
║ UPDATE (no-returning)          │        0.031 ms │ p95:        0.054 ms │ RPS:     17,211 ║
║ NATIVE UPSERT                  │        0.059 ms │ p95:        0.071 ms │ RPS:     10,607 ║
║ COUNT                          │        0.107 ms │ p95:        0.117 ms │ RPS:      7,931 ║
║ COUNT ESTIMATE                 │        0.022 ms │ p95:        0.026 ms │ RPS:     36,893 ║
║ COUNT CACHED                   │        0.001 ms │ p95:        0.002 ms │ RPS:    484,470 ║
║ DELETE                         │        0.050 ms │ p95:        0.079 ms │ RPS:     11,724 ║
║ BULK INSERT (100)              │        1.198 ms │ p95:        1.554 ms │ RPS:        238 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
<!-- LEDGER_TRUTH_END -->
...
<summary><strong>🏷️ HTTP</strong> · 🟢 2.247ms · ↘️ ⚪ stable at 5.34ms (±2.97ms) (7 runs) (2026-08-13 19:09:10) · <a href="../../../tests/benchmarks/api-latency.test.ts">source</a></summary>
<!-- LEDGER_INSIGHT_START -->
> [!NOTE]
...
<summary><strong>🏷️ SDK</strong> · 🟢 0.213ms · ↘️ ⚪ stable at 0.268ms (±0.087ms) (6 runs) (2026-08-13 19:09:05) · <a href="../../../tests/benchmarks/local-cms-crud.test.ts">source</a></summary>
<!-- LEDGER_INSIGHT_START -->
> [!NOTE]
> **Specific to this test**: Performance improved — recent optimizations or cache warming likely effective.  
