...
| ------------------------ | ------- | ---------------------------------------- | ------ | ------ |
| **Database Performance** | 0.063ms | ⚪ stable at 0.072ms (±0.016ms) (7 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.010ms | ⚪ stable at 0.010ms (±0.004ms) (7 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.119ms | ⚪ stable at 0.115ms (±0.028ms) (7 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.709ms | ⚪ stable at 0.694ms (±0.121ms) (7 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.534ms | ⚪ stable at 0.533ms (±0.108ms) (7 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.069ms | ⚪ stable at 0.063ms (±0.013ms) (7 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.267ms | ⚪ stable at 0.222ms (±0.029ms) (7 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.141ms | ⚪ stable at 0.112ms (±0.015ms) (7 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.073ms | ⚪ stable at 0.066ms (±0.013ms) (7 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.072ms | ⚪ stable at 0.076ms (±0.007ms) (7 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.142ms | ⚪ stable at 0.140ms (±0.036ms) (7 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.036ms | ⚪ stable at 0.030ms (±0.010ms) (7 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.002ms | ⚪ stable at 0.003ms (±0.131ms) (7 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.051ms | ⚪ stable at 0.056ms (±0.005ms) (7 runs) | < 5ms  | 🟢     |
| **Database Performance** | 1.552ms | ⚪ stable at 1.66ms (±0.346ms) (7 runs)  | < 5ms  | 🟢     |
...
| database performance (BULK INSERT (100)) (warm)      | 🟢    | `▂▁▁▁▃▆▇▄▅█▆▅` | 1.552ms    |
...
quadrantChart
  ...
  quadrant-4 Critical — fix first
    Database Performance: [0.06, 0.37]
    Database Performance: [0.07, 0.29]
    Database Performance: [0.27, 0.61]
    Database Performance: [0.14, 0.78]
    Database Performance: [0.07, 0.32]
    Database Performance: [0.05, 0.60]
    Database Performance: [0.05, 0.95]
    Database Performance: [0.05, 0.27]
```
...
**Run ID:** `7741178e-c8f3-49ec-ba92-d6e8b39a18a8` · **Tests invoked:** 1 · **Metrics:** 15 · **DB:** sqlite

| Test                 | Metric                 | Avg (ms) | p95 (ms) | RPS    | Trend | Detail                                   |
| -------------------- | ---------------------- | -------- | -------- | ------ | ----- | ---------------------------------------- |
| Database Performance | INSERT                 | 0.063    | 0.107    | 8112   | 🟢    | ⚪ stable at 0.072ms (±0.016ms) (7 runs) |
| Database Performance | FIND ONE               | 0.010    | 0.016    | 86670  | 🟢    | ⚪ stable at 0.010ms (±0.004ms) (7 runs) |
| Database Performance | FIND MANY (limit 50)   | 0.119    | 0.164    | 7414   | 🟢    | ⚪ stable at 0.115ms (±0.028ms) (7 runs) |
| Database Performance | FIND PAGE (50 hasMore) | 0.709    | 0.856    | 1373   | 🟢    | ⚪ stable at 0.694ms (±0.121ms) (7 runs) |
| Database Performance | FIND PAGE keyset       | 0.534    | 0.673    | 1825   | 🟢    | ⚪ stable at 0.533ms (±0.108ms) (7 runs) |
| Database Performance | FIND MANY offset 50    | 0.069    | 0.095    | 12697  | 🟢    | ⚪ stable at 0.063ms (±0.013ms) (7 runs) |
| Database Performance | UPDATE (no-returning)  | 0.073    | 0.105    | 10818  | 🟢    | ⚪ stable at 0.066ms (±0.013ms) (7 runs) |
| Database Performance | NATIVE UPSERT          | 0.072    | 0.100    | 11350  | 🟢    | ⚪ stable at 0.076ms (±0.007ms) (7 runs) |
| Database Performance | COUNT                  | 0.142    | 0.186    | 6530   | 🟢    | ⚪ stable at 0.140ms (±0.036ms) (7 runs) |
| Database Performance | COUNT ESTIMATE         | 0.036    | 0.053    | 22012  | 🟢    | ⚪ stable at 0.030ms (±0.010ms) (7 runs) |
| Database Performance | COUNT CACHED           | 0.002    | 0.003    | 342743 | 🟢    | ⚪ stable at 0.003ms (±0.131ms) (7 runs) |
| Database Performance | DELETE                 | 0.051    | 0.076    | 13800  | 🟢    | ⚪ stable at 0.056ms (±0.005ms) (7 runs) |
| Database Performance | BULK INSERT (100)      | 1.552    | 2.064    | 199    | 🟢    | ⚪ stable at 1.66ms (±0.346ms) (7 runs)  |
| Database Performance | LIST+COUNT (legacy)    | 0.267    | 0.385    | 3540   | ⚪    | ⚪ stable at 0.222ms (±0.029ms) (7 runs) |
| Database Performance | UPDATE                 | 0.141    | 0.231    | 5905   | ⚪    | ⚪ stable at 0.112ms (±0.015ms) (7 runs) |
...
<summary><strong>🏷️ database performance</strong> · 🟢 1.552ms · ↘️ ⚪ stable at 1.66ms (±0.346ms) (7 runs) (2026-08-12 11:44:23) · <a href="../../../tests/benchmarks/database-performance.test.ts">source</a></summary>
...
║                                Ran: 2026-08-12 11:44:23                                 ║
║   Measures raw CRUD performance, indexing efficiency, and connection pool resilience    ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ INSERT                         │        0.063 ms │ p95:        0.107 ms │ RPS:      8,112 ║
║ FIND ONE                       │        0.010 ms │ p95:        0.016 ms │ RPS:     86,670 ║
║ FIND MANY (limit 50)           │        0.119 ms │ p95:        0.164 ms │ RPS:      7,414 ║
║ FIND PAGE (50 hasMore)         │        0.709 ms │ p95:        0.856 ms │ RPS:      1,373 ║
║ FIND PAGE keyset               │        0.534 ms │ p95:        0.673 ms │ RPS:      1,825 ║
║ FIND MANY offset 50            │        0.069 ms │ p95:        0.095 ms │ RPS:     12,697 ║
║ LIST+COUNT (legacy)            │        0.267 ms │ p95:        0.385 ms │ RPS:      3,540 ║
║ UPDATE                         │        0.141 ms │ p95:        0.231 ms │ RPS:      5,905 ║
║ UPDATE (no-returning)          │        0.073 ms │ p95:        0.105 ms │ RPS:     10,818 ║
║ NATIVE UPSERT                  │        0.072 ms │ p95:        0.100 ms │ RPS:     11,350 ║
║ COUNT                          │        0.142 ms │ p95:        0.186 ms │ RPS:      6,530 ║
║ COUNT ESTIMATE                 │        0.036 ms │ p95:        0.053 ms │ RPS:     22,012 ║
║ COUNT CACHED                   │        0.002 ms │ p95:        0.003 ms │ RPS:    342,743 ║
║ DELETE                         │        0.051 ms │ p95:        0.076 ms │ RPS:     13,800 ║
║ BULK INSERT (100)              │        1.552 ms │ p95:        2.064 ms │ RPS:        199 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
