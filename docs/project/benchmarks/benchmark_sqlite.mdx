...
| -------- | ------- | ---------------------------------------- | ------ | ------ |
| **DB**   | 0.012ms | ⚪ stable at 0.006ms (±0.004ms) (7 runs) | < 5ms  | 🟢     |
| **SDK**  | 0.001ms | ⚪ stable at 0.001ms (7 runs)            | < 5ms  | 🟢     |
| **SDK**  | 0.008ms | ⚪ stable at 0.009ms (±0.005ms) (7 runs) | < 5ms  | 🟢     |
| **SDK**  | 0.119ms | ⚪ stable at 0.121ms (±0.055ms) (7 runs) | < 5ms  | 🟢     |
| **SDK**  | 0.078ms | ⚪ stable at 0.091ms (±0.027ms) (7 runs) | < 5ms  | 🟢     |
| **SDK**  | 0.223ms | ⚪ stable at 0.240ms (±0.065ms) (7 runs) | < 5ms  | 🟢     |
...
| database performance (BULK INSERT (100)) (warm)      | 🟢    | `▁▁▂▁▁▁▄▄▂▆█▂` | 1.490ms    |
...
**Run ID:** `77a3e2f3-9382-44bb-9ab6-f54f29659965` · **Tests invoked:** 1 · **Metrics:** 6 · **DB:** sqlite

| Test           | Metric                   | Avg (ms) | p95 (ms) | RPS    | Trend | Detail                                   |
| -------------- | ------------------------ | -------- | -------- | ------ | ----- | ---------------------------------------- |
| Local Cms Crud | Adapter FIND ONE         | 0.012    | 0.026    | 62023  | 🟢    | ⚪ stable at 0.006ms (±0.004ms) (7 runs) |
| Local Cms Crud | LocalCMS findById (warm) | 0.001    | 0.002    | 427808 | 🟢    | ⚪ stable at 0.001ms (7 runs)            |
| Local Cms Crud | LocalCMS findById (cold) | 0.008    | 0.012    | 84259  | 🟢    | ⚪ stable at 0.009ms (±0.005ms) (7 runs) |
| Local Cms Crud | LocalCMS create          | 0.119    | 0.167    | 4028   | 🟢    | ⚪ stable at 0.121ms (±0.055ms) (7 runs) |
| Local Cms Crud | LocalCMS update          | 0.078    | 0.108    | 5925   | 🟢    | ⚪ stable at 0.091ms (±0.027ms) (7 runs) |
| Local Cms Crud | LocalCMS mixed C/U/R     | 0.223    | 0.314    | 2214   | 🟢    | ⚪ stable at 0.240ms (±0.065ms) (7 runs) |
...
| COMPETITIVE WORKLOAD REPLICA (warm) | ⚪    | `▅▁▁▁▁▅█`          | 7.473ms    |
| CONCURRENCY MAX (warm)              | ⚪    | `▂▁█`              | 1.058ms    |
| DATABASE PERFORMANCE (warm)         | ⚪    | `▁▁▂▁▁▁█`          | 1.490ms    |
...
<summary><strong>🏷️ database performance</strong> · 🟢 1.490ms · ↘️ ⚪ stable at 2.00ms (±1.29ms) (7 runs) (2026-08-21 20:04:16) · <a href="../../../tests/benchmarks/database-performance.test.ts">source</a></summary>
...
║                                Ran: 2026-08-21 20:04:16                                 ║
║   Measures raw CRUD performance, indexing efficiency, and connection pool resilience    ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ INSERT                         │        0.092 ms │ p95:        0.142 ms │ RPS:      3,890 ║
║ FIND ONE                       │        0.008 ms │ p95:        0.011 ms │ RPS:     86,948 ║
║ FIND MANY (limit 50)           │        0.115 ms │ p95:        0.146 ms │ RPS:      6,669 ║
║ FIND PAGE (50 hasMore)         │        0.150 ms │ p95:        0.243 ms │ RPS:      4,335 ║
║ FIND PAGE keyset               │        0.136 ms │ p95:        0.189 ms │ RPS:      5,177 ║
║ FIND MANY offset 50            │        0.069 ms │ p95:        0.091 ms │ RPS:     11,132 ║
║ LIST+COUNT (legacy)            │        0.218 ms │ p95:        0.271 ms │ RPS:      3,408 ║
║ UPDATE                         │        0.047 ms │ p95:        0.063 ms │ RPS:     10,090 ║
║ UPDATE (no-returning)          │        0.042 ms │ p95:        0.059 ms │ RPS:     12,011 ║
║ NATIVE UPSERT                  │        0.090 ms │ p95:        0.107 ms │ RPS:      6,932 ║
║ COUNT                          │        0.128 ms │ p95:        0.159 ms │ RPS:      6,702 ║
║ COUNT ESTIMATE                 │        0.022 ms │ p95:        0.027 ms │ RPS:     38,287 ║
║ COUNT CACHED                   │        0.001 ms │ p95:        0.002 ms │ RPS:    797,413 ║
║ DELETE                         │        0.067 ms │ p95:        0.089 ms │ RPS:      7,907 ║
║ BULK INSERT (100)              │        1.490 ms │ p95:        2.367 ms │ RPS:        209 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ SDK</strong> · 🟢 0.137ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/local-cms-crud.test.ts">source</a></summary>
<!-- LEDGER_INSIGHT_START -->
> [!NOTE]
> **Specific to this test**: Performance improved — recent optimizations or cache warming likely effective.
<!-- LEDGER_INSIGHT_END -->
...
║                                Ran: 2026-08-21 20:34:01                                 ║
║         SDK (LocalCMS collections namespace) vs direct adapter CRUD comparison.         ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Direct insert                  │        0.137 ms │ p95:        0.000 ms │ RPS:      7,300 ║
║ SDK create                     │        0.141 ms │ p95:        0.000 ms │ RPS:      7,080 ║
║ Direct findOne                 │        0.007 ms │ p95:        0.000 ms │ RPS:    151,604 ║
║ SDK find (bypassCache)         │        0.007 ms │ p95:        0.000 ms │ RPS:    137,580 ║
║ Direct update                  │        0.055 ms │ p95:        0.000 ms │ RPS:     18,202 ║
║ SDK update                     │        0.062 ms │ p95:        0.000 ms │ RPS:     16,210 ║
║ SDK create (detached)          │        0.116 ms │ p95:        0.000 ms │ RPS:     17,168 ║
║ SDK update (detached)          │        0.057 ms │ p95:        0.000 ms │ RPS:     17,691 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
