...
| -------------------------------- | -------- | --------------------------------- | ------ | ------ |
| **Competitive Workload Replica** | 1.970ms  | ⚪ established at 1.97ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 5.754ms  | ⚪ established at 5.75ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.629ms  | ⚪ established at 1.63ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.835ms  | ⚪ established at 1.83ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.536ms  | ⚪ established at 1.54ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.404ms  | ⚪ established at 1.40ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 5.325ms  | ⚪ established at 5.33ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 17.403ms | ⚪ established at 17.40ms (1 run) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 12.218ms | ⚪ established at 12.22ms (1 run) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 6.554ms  | ⚪ established at 6.55ms (1 run)  | < 5ms  | 🟢     |
...
| ----------------------------------------------- | ----- | -------------- | ------- |
| database performance (BULK INSERT (100)) (warm) | 🟢    | `▃▄▄▅██▇▂▂▂▁▃` | 4.098ms |
...
**Run ID:** `82317c73-a46e-44c9-acc8-7d8268a05161` · **Tests invoked:** 1 · **Metrics:** 10 · **DB:** postgresql

| Test                         | Metric                         | Avg (ms) | p95 (ms) | RPS  | Trend | Detail                            |
| ---------------------------- | ------------------------------ | -------- | -------- | ---- | ----- | --------------------------------- |
| Competitive Workload Replica | findById (Concurrent 8c)       | 1.970    | 4.197    | 2546 | 🟢    | ⚪ established at 1.97ms (1 run)  |
| Competitive Workload Replica | findByIdRandom (Concurrent 8c) | 5.754    | 13.567   | 986  | 🟢    | ⚪ established at 5.75ms (1 run)  |
| Competitive Workload Replica | listPlain (Concurrent 8c)      | 1.629    | 2.829    | 2720 | 🟢    | ⚪ established at 1.63ms (1 run)  |
| Competitive Workload Replica | listFilterSort (Concurrent 8c) | 1.835    | 3.933    | 2690 | 🟢    | ⚪ established at 1.83ms (1 run)  |
| Competitive Workload Replica | listLarge (Concurrent 8c)      | 1.536    | 2.604    | 2961 | 🟢    | ⚪ established at 1.54ms (1 run)  |
| Competitive Workload Replica | findMissing (Concurrent 8c)    | 1.404    | 2.395    | 3296 | 🟢    | ⚪ established at 1.40ms (1 run)  |
| Competitive Workload Replica | GraphQL Query (Concurrent 8c)  | 5.325    | 7.565    | 1399 | 🟢    | ⚪ established at 5.33ms (1 run)  |
| Competitive Workload Replica | create (Concurrent 8c)         | 17.403   | 20.280   | 432  | 🟢    | ⚪ established at 17.40ms (1 run) |
| Competitive Workload Replica | update (Concurrent 8c)         | 12.218   | 16.535   | 623  | 🟢    | ⚪ established at 12.22ms (1 run) |
| Competitive Workload Replica | mixed (Concurrent 8c 50/50)    | 6.554    | 12.521   | 839  | 🟢    | ⚪ established at 6.55ms (1 run)  |
...
**Series:** 3 · **DB:** postgresql

| Metric                              | Trend | Sparkline (last 7) | Latest   |
| ----------------------------------- | ----- | ------------------ | -------- |
| DATABASE PERFORMANCE (warm)         | 🟢    | `▁▁▃█▂▂▂`          | 1.994ms  |
| TRANSACTION ACID (warm)             | 🟢    | `▅▆█▂▂▂▁`          | 5.543ms  |
