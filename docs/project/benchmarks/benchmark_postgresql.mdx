...
| ------------------------ | ------- | --------------------------------- | ------ | ------ |
| **Database Performance** | 2.221ms | ⚪ established at 2.22ms (1 run)  | < 5ms  | 🟢     |
| **Database Performance** | 0.855ms | ⚪ established at 0.855ms (1 run) | < 5ms  | 🟢     |
| **Database Performance** | 0.968ms | ⚪ established at 0.968ms (1 run) | < 5ms  | 🟢     |
| **Database Performance** | 1.006ms | ⚪ established at 1.01ms (1 run)  | < 5ms  | 🟢     |
| **Database Performance** | 4.845ms | ⚪ established at 4.84ms (1 run)  | < 5ms  | 🟢     |
| **Database Performance** | 2.231ms | ⚪ established at 2.23ms (1 run)  | < 5ms  | 🟢     |
| **Database Performance** | 2.044ms | ⚪ established at 2.04ms (1 run)  | < 5ms  | 🟢     |
| **Database Performance** | 2.160ms | ⚪ established at 2.16ms (1 run)  | < 5ms  | 🟢     |
| **Database Performance** | 0.721ms | ⚪ established at 0.721ms (1 run) | < 5ms  | 🟢     |
| **Database Performance** | 0.024ms | ⚪ established at 0.024ms (1 run) | < 5ms  | 🟢     |
| **Database Performance** | 2.060ms | ⚪ established at 2.06ms (1 run)  | < 5ms  | 🟢     |
| **Database Performance** | 7.285ms | ⚪ established at 7.29ms (1 run)  | < 5ms  | 🟢     |
...
| ----------------------------------------------- | ----- | --------- | ------- |
| database performance (BULK INSERT (100)) (warm) | 🟢    | `█▁`      | 7.285ms |
...
**Run ID:** `e07a1a07-6721-48e1-9c85-c924bb926b53` · **Tests invoked:** 1 · **Metrics:** 12 · **DB:** postgresql

| Test                 | Metric                 | Avg (ms) | p95 (ms) | RPS   | Trend | Detail                            |
| -------------------- | ---------------------- | -------- | -------- | ----- | ----- | --------------------------------- |
| Database Performance | INSERT                 | 2.221    | 2.910    | 396   | 🟢    | ⚪ established at 2.22ms (1 run)  |
| Database Performance | FIND ONE               | 0.855    | 0.967    | 1030  | 🟢    | ⚪ established at 0.855ms (1 run) |
| Database Performance | FIND MANY (limit 50)   | 0.968    | 1.158    | 907   | 🟢    | ⚪ established at 0.968ms (1 run) |
| Database Performance | FIND PAGE (50 hasMore) | 1.006    | 1.332    | 843   | 🟢    | ⚪ established at 1.01ms (1 run)  |
| Database Performance | LIST+COUNT (legacy)    | 4.845    | 6.095    | 200   | 🟢    | ⚪ established at 4.84ms (1 run)  |
| Database Performance | UPDATE                 | 2.231    | 2.799    | 403   | 🟢    | ⚪ established at 2.23ms (1 run)  |
| Database Performance | NATIVE UPSERT          | 2.044    | 2.454    | 434   | 🟢    | ⚪ established at 2.04ms (1 run)  |
| Database Performance | COUNT                  | 2.160    | 2.570    | 411   | 🟢    | ⚪ established at 2.16ms (1 run)  |
| Database Performance | COUNT ESTIMATE         | 0.721    | 0.829    | 1223  | 🟢    | ⚪ established at 0.721ms (1 run) |
| Database Performance | COUNT CACHED           | 0.024    | 0.026    | 40330 | 🟢    | ⚪ established at 0.024ms (1 run) |
| Database Performance | DELETE                 | 2.060    | 2.482    | 480   | 🟢    | ⚪ established at 2.06ms (1 run)  |
| Database Performance | BULK INSERT (100)      | 7.285    | 9.192    | 135   | 🟢    | ⚪ established at 7.29ms (1 run)  |
...
| --------------------------- | ----- | ------------------ | ------- |
| DATABASE PERFORMANCE (warm) | 🟢    | `▁▁▁▃█▃▃`          | 2.231ms |
...
<summary><strong>🏷️ database performance</strong> · 🟢 7.285ms · ➡️ ⚪ established at 7.29ms (1 run) (2026-08-04 11:45:25) · <a href="../../../tests/benchmarks/database-performance.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
```text
╔═════════════════════════════════════════════════════════════════════════════════════════╗
║                  SVELTYCMS — DATABASE ADAPTER PERFORMANCE (POSTGRESQL)                  ║
║                   File: tests/benchmarks/database-performance.test.ts                   ║
║                                Ran: 2026-08-04 11:45:25                                 ║
║   Measures raw CRUD performance, indexing efficiency, and connection pool resilience    ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ INSERT                         │        2.221 ms │ p95:        2.910 ms │ RPS:        396 ║
║ FIND ONE                       │        0.855 ms │ p95:        0.967 ms │ RPS:      1,030 ║
║ FIND MANY (limit 50)           │        0.968 ms │ p95:        1.158 ms │ RPS:        907 ║
║ FIND PAGE (50 hasMore)         │        1.006 ms │ p95:        1.332 ms │ RPS:        843 ║
║ LIST+COUNT (legacy)            │        4.845 ms │ p95:        6.095 ms │ RPS:        200 ║
║ UPDATE                         │        2.231 ms │ p95:        2.799 ms │ RPS:        403 ║
║ NATIVE UPSERT                  │        2.044 ms │ p95:        2.454 ms │ RPS:        434 ║
║ COUNT                          │        2.160 ms │ p95:        2.570 ms │ RPS:        411 ║
║ COUNT ESTIMATE                 │        0.721 ms │ p95:        0.829 ms │ RPS:      1,223 ║
║ COUNT CACHED                   │        0.024 ms │ p95:        0.026 ms │ RPS:     40,330 ║
║ DELETE                         │        2.060 ms │ p95:        2.482 ms │ RPS:        480 ║
║ BULK INSERT (100)              │        7.285 ms │ p95:        9.192 ms │ RPS:        135 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
<!-- LEDGER_TRUTH_END -->
