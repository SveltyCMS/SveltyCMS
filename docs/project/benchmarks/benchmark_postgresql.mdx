...
| ------------ | ------- | ---------------------------------------- | ------ | ------ |
| **System**   | 0.517ms | ⚪ stable at 0.564ms (±0.112ms) (4 runs) | < 5ms  | 🟢     |
| **Metadata** | 0.746ms | ⚪ stable at 0.901ms (±0.166ms) (4 runs) | < 5ms  | 🟢     |
| **CRUD**     | 0.739ms | ⚪ stable at 0.898ms (±0.201ms) (4 runs) | < 5ms  | 🟢     |
| **CRUD**     | 0.701ms | ⚪ stable at 0.960ms (±0.381ms) (4 runs) | < 5ms  | 🟢     |
...
| ---------------------------------------------------- | ----- | -------------- | ---------- |
| cold start phased (Cold Start (IDLE → READY)) (cold) | 🟢    | `█▆▅▃▁`        | 1798.817ms |
| database performance (BULK INSERT (100)) (warm)      | 🟢    | `█▇▃▃▃▂▃▅▃▂▂▁` | 3.555ms    |
...
**Run ID:** `ec6657a2-1b3e-4116-950d-ef5a224e1b04` · **Tests invoked:** 1 · **Metrics:** 4 · **DB:** postgresql

| Test                 | Metric                 | Avg (ms) | p95 (ms) | RPS  | Trend | Detail                                   |
| -------------------- | ---------------------- | -------- | -------- | ---- | ----- | ---------------------------------------- |
| Rest Api Performance | Health Check           | 0.517    | 0.986    | 5116 | 🟢    | ⚪ stable at 0.564ms (±0.112ms) (4 runs) |
| Rest Api Performance | Collection Schema      | 0.746    | 1.245    | 3510 | 🟢    | ⚪ stable at 0.901ms (±0.166ms) (4 runs) |
| Rest Api Performance | Collection Find (List) | 0.739    | 1.154    | 3562 | 🟢    | ⚪ stable at 0.898ms (±0.201ms) (4 runs) |
| Rest Api Performance | Collection Search      | 0.701    | 1.091    | 3716 | 🟢    | ⚪ stable at 0.960ms (±0.381ms) (4 runs) |
...
| ----------------------------------- | ----- | ------------------ | ---------- |
| CACHE PERFORMANCE (warm)            | 🟢    | `▅█▂▂▁`            | 0.353ms    |
| DATABASE PERFORMANCE (warm)         | 🟢    | `▁▁▃█▅▄▄`          | 1.657ms    |
| TRANSACTION ACID (warm)             | 🟢    | `█▇▅▅▃▄▁`          | 2.728ms    |
| TRUTH LATENCY (warm)                | 🟢    | `▁▁▁██▁▁`          | 0.000ms    |
| COLD START PHASED (cold)            | ⚪    | `█▆▅▃▁`            | 1798.817ms |
| COMPETITIVE WORKLOAD REPLICA (warm) | ⚪    | `▄▁▁▁▁▄█`          | 12.218ms   |
| HOOKS PERFORMANCE (warm)            | ⚪    | `▂▁▂█▂▂▁`          | 0.636ms    |
| REST API PERFORMANCE (warm)         | ⚪    | `█▇▁▇▇▆▁`          | 0.517ms    |
...
<summary><strong>🏷️ cold start phased</strong> · ⚪ 1798.817ms · ↘️ 🟢 faster: 1897.95ms → 1798.82ms (-5%) (4 runs) (2026-08-19 18:59:24) · <a href="../../../tests/benchmarks/cold-start-phased.test.ts">source</a></summary>
...
║                                Ran: 2026-08-19 18:59:24                                 ║
║       Measures server cold-start latency to READY state, using the built server.        ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Cold Start (IDLE → READY)      │     1798.817 ms │ p95:     2646.246 ms │ RPS:          0 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
║                                Ran: 2026-08-19 18:59:31                                 ║
║     Validates performance claims by comparing SDK, Middleware, and Real HTTP Stack      ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Logic Baseline                 │        0.000 ms │ p95:        0.001 ms │ RPS:  2,744,739 ║
║ Local SDK (Full)               │        0.004 ms │ p95:        0.007 ms │ RPS:    246,427 ║
║ HTTP End-to-End                │        0.452 ms │ p95:        0.576 ms │ RPS:      2,213 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ Middleware & Hooks Performance</strong> · 🟢 0.940ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/hooks-performance.test.ts">source</a></summary>
...
║                                Ran: 2026-08-19 19:02:04                                 ║
║Measures the cost of the full middleware chain including Turbo, Security, Auth, and Audit via HTTP E2E.║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Static Asset (No Middleware)   │        0.940 ms │ p95:        1.619 ms │ RPS:      3,051 ║
║ Turbo Pipeline (Light)         │        0.636 ms │ p95:        1.015 ms │ RPS:      3,798 ║
║ Full Security + Auth Pipeline  │        1.029 ms │ p95:        1.745 ms │ RPS:      2,199 ║
║ REST with API Caching          │        0.886 ms │ p95:        1.461 ms │ RPS:      2,961 ║
║ Mutation (audit logging disabled) │        3.557 ms │ p95:        4.494 ms │ RPS:        272 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ database performance</strong> · 🟢 3.555ms · ↘️ ⚪ stable at 3.98ms (±0.408ms) (7 runs) (2026-08-19 19:01:31) · <a href="../../../tests/benchmarks/database-performance.test.ts">source</a></summary>
<!-- LEDGER_INSIGHT_START -->
> [!NOTE]
> **Specific to this test**: Performance improved — recent optimizations or cache warming likely effective.
<!-- LEDGER_INSIGHT_END -->
...
║                                Ran: 2026-08-19 19:01:31                                 ║
║   Measures raw CRUD performance, indexing efficiency, and connection pool resilience    ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ INSERT                         │        1.614 ms │ p95:        1.941 ms │ RPS:        613 ║
║ FIND ONE                       │        0.394 ms │ p95:        0.483 ms │ RPS:      2,466 ║
║ FIND MANY (limit 50)           │        1.030 ms │ p95:        1.199 ms │ RPS:        889 ║
║ FIND PAGE (50 hasMore)         │        1.084 ms │ p95:        1.260 ms │ RPS:        819 ║
║ FIND PAGE keyset               │        1.088 ms │ p95:        1.277 ms │ RPS:        818 ║
║ FIND MANY offset 50            │        0.921 ms │ p95:        1.086 ms │ RPS:        944 ║
║ LIST+COUNT (legacy)            │        2.658 ms │ p95:        5.163 ms │ RPS:        376 ║
║ UPDATE                         │        1.682 ms │ p95:        2.021 ms │ RPS:        530 ║
║ UPDATE (no-returning)          │        1.657 ms │ p95:        2.013 ms │ RPS:        537 ║
║ NATIVE UPSERT                  │        2.093 ms │ p95:        2.477 ms │ RPS:        416 ║
║ COUNT                          │        1.016 ms │ p95:        1.234 ms │ RPS:        862 ║
║ COUNT ESTIMATE                 │        0.707 ms │ p95:        0.864 ms │ RPS:      1,235 ║
║ COUNT CACHED                   │        0.001 ms │ p95:        0.001 ms │ RPS:    578,025 ║
║ DELETE                         │        2.078 ms │ p95:        2.516 ms │ RPS:        479 ║
║ BULK INSERT (100)              │        3.555 ms │ p95:        4.155 ms │ RPS:        268 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ transaction acid</strong> · 🟢 2.728ms · ↘️ ⚪ stable at 4.04ms (±2.70ms) (7 runs) (2026-08-19 19:01:43) · <a href="../../../tests/benchmarks/transaction-acid.test.ts">source</a></summary>
<!-- LEDGER_INSIGHT_START -->
> [!NOTE]
> **Specific to this test**: Performance improved — recent optimizations or cache warming likely effective.
<!-- LEDGER_INSIGHT_END -->
...
║                                Ran: 2026-08-19 19:01:43                                 ║
║  Measures transaction commit latencies and rollback overhead across database adapters   ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ TX Commit                      │        3.229 ms │ p95:        4.135 ms │ RPS:      1,153 ║
║ TX Rollback Integrity          │        2.728 ms │ p95:        3.068 ms │ RPS:        367 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ Cache</strong> · 🟢 0.353ms · ↘️ ⚪ stable at 0.402ms (±0.111ms) (4 runs) (2026-08-19 19:01:52) · <a href="../../../tests/benchmarks/cache-performance.test.ts">source</a></summary>
<!-- LEDGER_INSIGHT_START -->
> [!NOTE]
> **Specific to this test**: Performance improved — recent optimizations or cache warming likely effective.
<!-- LEDGER_INSIGHT_END -->
...
<summary><strong>🏷️ Middleware</strong> · 🟢 3.557ms · ↘️ ⚪ stable at 4.26ms (±1.48ms) (4 runs) (2026-08-19 19:02:04) · <a href="../../../tests/benchmarks/hooks-performance.test.ts">source</a></summary>
<!-- LEDGER_INSIGHT_START -->
> [!NOTE]
> **Specific to this test**: Performance improved — recent optimizations or cache warming likely effective.
<!-- LEDGER_INSIGHT_END -->
...
<summary><strong>🏷️ System</strong> · 🟢 0.517ms · ↘️ ⚪ stable at 0.564ms (±0.112ms) (4 runs) (2026-08-19 19:02:13) · <a href="../../../tests/benchmarks/rest-api-performance.test.ts">source</a></summary>
<!-- LEDGER_INSIGHT_START -->
> [!NOTE]
> **Specific to this test**: Performance improved — recent optimizations or cache warming likely effective.
<!-- LEDGER_INSIGHT_END -->
...
<summary><strong>🏷️ Metadata</strong> · 🟢 0.746ms · ↘️ ⚪ stable at 0.901ms (±0.166ms) (4 runs) (2026-08-19 19:02:13) · <a href="../../../tests/benchmarks/rest-api-performance.test.ts">source</a></summary>
<!-- LEDGER_INSIGHT_START -->
> [!NOTE]
> **Specific to this test**: Performance improved — recent optimizations or cache warming likely effective.
<!-- LEDGER_INSIGHT_END -->
...
<summary><strong>🏷️ CRUD</strong> · 🟢 0.701ms · ↘️ ⚪ stable at 0.960ms (±0.381ms) (4 runs) (2026-08-19 19:02:13) · <a href="../../../tests/benchmarks/rest-api-performance.test.ts">source</a></summary>
<!-- LEDGER_INSIGHT_START -->
> [!NOTE]
> **Specific to this test**: Performance improved — recent optimizations or cache warming likely effective.
<!-- LEDGER_INSIGHT_END -->
...
<summary><strong>🏷️ Logic</strong> · 🟢 ⏳ pending · ➡️ ⚪ stable at 0ms (4 runs) (2026-08-19 18:59:38) · <a href="../../../tests/benchmarks/truth-latency.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
> ⏳ Pending
<!-- LEDGER_TRUTH_END -->
...
<summary><strong>🏷️ SDK</strong> · 🟢 0.004ms · ➡️ ⚪ stable at 0.004ms (±0.013ms) (4 runs) (2026-08-19 18:59:38) · <a href="../../../tests/benchmarks/truth-latency.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
```text
╔═════════════════════════════════════════════════════════════════════════════════════════╗
...
<summary><strong>🏷️ HTTP</strong> · 🟢 0.452ms · ↘️ ⚪ stable at 0.522ms (±0.121ms) (4 runs) (2026-08-19 18:59:38) · <a href="../../../tests/benchmarks/truth-latency.test.ts">source</a></summary>
<!-- LEDGER_INSIGHT_START -->
> [!NOTE]
> **Specific to this test**: Performance improved — recent optimizations or cache warming likely effective.
<!-- LEDGER_INSIGHT_END -->
...
<summary><strong>🏷️ REST API Performance</strong> · 🟢 0.517ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/rest-api-performance.test.ts">source</a></summary>
...
║                                Ran: 2026-08-19 19:02:13                                 ║
║Measures latency, throughput, and correctness of core REST endpoints: health check, schema, CRUD list, and search.║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Health Check                   │        0.517 ms │ p95:        0.986 ms │ RPS:      5,116 ║
║ Collection Schema              │        0.746 ms │ p95:        1.245 ms │ RPS:      3,510 ║
║ Collection Find (List)         │        0.739 ms │ p95:        1.154 ms │ RPS:      3,562 ║
║ Collection Search              │        0.701 ms │ p95:        1.091 ms │ RPS:      3,716 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
