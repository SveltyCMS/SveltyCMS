...
| -------------------------------- | ------- | -------------------------------------------- | ------ | ------ |
| **Competitive Workload Replica** | 0.228ms | ⚪ stable at 0.176ms (±0.044ms) (7 runs)     | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 0.811ms | ⚪ stable at 0.627ms (±0.298ms) (7 runs)     | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.192ms | ⚪ stable at 0.727ms (±0.803ms) (7 runs)     | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 2.022ms | ⚪ stable at 1.34ms (±1.50ms) (7 runs)       | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 0.293ms | ⚪ stable at 0.294ms (±0.096ms) (7 runs)     | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.389ms | ⚪ stable at 1.20ms (±0.297ms) (7 runs)      | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.985ms | 🔴 slower: 0.628ms → 1.99ms (+216%) (7 runs) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 3.760ms | ⚪ stable at 2.75ms (±1.08ms) (7 runs)       | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 0.253ms | ⚪ stable at 0.214ms (±0.059ms) (7 runs)     | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.419ms | ⚪ stable at 1.06ms (±0.427ms) (7 runs)      | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 0.272ms | ⚪ stable at 0.186ms (±0.096ms) (7 runs)     | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 0.799ms | ⚪ stable at 0.473ms (±0.415ms) (7 runs)     | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 2.830ms | ⚪ stable at 3.04ms (±0.609ms) (7 runs)      | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 4.644ms | ⚪ stable at 5.02ms (±1.93ms) (7 runs)       | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 2.632ms | ⚪ stable at 3.15ms (±0.352ms) (7 runs)      | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 4.499ms | ⚪ stable at 5.08ms (±1.61ms) (7 runs)       | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.108ms | ⚪ stable at 1.02ms (±0.292ms) (7 runs)      | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 3.073ms | ⚪ stable at 2.44ms (±1.39ms) (7 runs)       | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.435ms | ⚪ stable at 1.29ms (±0.306ms) (7 runs)      | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 4.377ms | ⚪ stable at 3.19ms (±1.28ms) (7 runs)       | < 5ms  | 🟢     |
| **Ingestion**                    | 0.042ms | ⚪ stable at 0.044ms (±0.007ms) (7 runs)     | < 5ms  | 🟢     |
...
quadrantChart
  ...
  quadrant-4 Critical — fix first
    Competitive Workload Replica: [0.05, 0.14]
    Competitive Workload Replica: [0.18, 0.14]
    Competitive Workload Replica: [0.26, 0.30]
    Competitive Workload Replica: [0.45, 0.23]
    Competitive Workload Replica: [0.31, 0.08]
    Competitive Workload Replica: [0.44, 0.95]
    Competitive Workload Replica: [0.84, 0.17]
...
**Run ID:** `01a0d99a-c508-74df-b18c-472eede2053a` · **Tests invoked:** 1 · **Metrics:** 21 · **DB:** postgresql

| Test                         | Metric                              | Avg (ms) | p95 (ms) | RPS   | Trend | Detail                            |
| ---------------------------- | ----------------------------------- | -------- | -------- | ----- | ----- | --------------------------------- |
| Competitive Workload Replica | findById (Warm Sequential)          | 0.228    | 0.301    | 4367  | 🟢    | ⚪ established at 0.228ms (1 run) |
| Competitive Workload Replica | findById (Warm Concurrent 8c)       | 0.811    | 1.268    | 9795  | 🟢    | ⚪ established at 0.811ms (1 run) |
| Competitive Workload Replica | findByIdRandom (Warm Sequential)    | 1.192    | 2.266    | 837   | 🟢    | ⚪ established at 1.19ms (1 run)  |
| Competitive Workload Replica | findByIdRandom (Warm Concurrent 8c) | 2.022    | 3.019    | 3937  | 🟢    | ⚪ established at 2.02ms (1 run)  |
| Competitive Workload Replica | listFilterSort (Warm Sequential)    | 0.293    | 0.378    | 3392  | 🟢    | ⚪ established at 0.293ms (1 run) |
| Competitive Workload Replica | listFilterSort (Warm Concurrent 8c) | 1.389    | 1.790    | 5671  | 🟢    | ⚪ established at 1.39ms (1 run)  |
| Competitive Workload Replica | listLarge (Warm Sequential)         | 1.985    | 14.275   | 503   | 🟢    | ⚪ established at 1.99ms (1 run)  |
| Competitive Workload Replica | listLarge (Warm Concurrent 8c)      | 3.760    | 9.558    | 2104  | 🟢    | ⚪ established at 3.76ms (1 run)  |
| Competitive Workload Replica | listPlain (Warm Sequential)         | 0.253    | 0.365    | 3936  | 🟢    | ⚪ established at 0.253ms (1 run) |
| Competitive Workload Replica | listPlain (Warm Concurrent 8c)      | 1.419    | 2.095    | 5557  | 🟢    | ⚪ established at 1.42ms (1 run)  |
| Competitive Workload Replica | findMissing (Warm Sequential)       | 0.272    | 0.382    | 3651  | 🟢    | ⚪ established at 0.272ms (1 run) |
| Competitive Workload Replica | findMissing (Warm Concurrent 8c)    | 0.799    | 1.084    | 9817  | 🟢    | ⚪ established at 0.799ms (1 run) |
| Competitive Workload Replica | create (Warm Sequential)            | 2.830    | 3.808    | 353   | 🟢    | ⚪ established at 2.83ms (1 run)  |
| Competitive Workload Replica | create (Warm Concurrent 8c)         | 4.644    | 6.742    | 1698  | 🟢    | ⚪ established at 4.64ms (1 run)  |
| Competitive Workload Replica | update (Warm Sequential)            | 2.632    | 3.412    | 380   | 🟢    | ⚪ established at 2.63ms (1 run)  |
| Competitive Workload Replica | update (Warm Concurrent 8c)         | 4.499    | 6.331    | 1769  | 🟢    | ⚪ established at 4.50ms (1 run)  |
| Competitive Workload Replica | graphql (Warm Sequential)           | 1.108    | 1.679    | 901   | 🟢    | ⚪ established at 1.11ms (1 run)  |
| Competitive Workload Replica | graphql (Warm Concurrent 8c)        | 3.073    | 4.037    | 2562  | 🟢    | ⚪ established at 3.07ms (1 run)  |
| Competitive Workload Replica | mixed (Warm Sequential)             | 1.435    | 3.400    | 696   | 🟢    | ⚪ established at 1.44ms (1 run)  |
| Competitive Workload Replica | mixed (Warm Concurrent 8c)          | 4.377    | 9.113    | 1789  | 🟢    | ⚪ established at 4.38ms (1 run)  |
| Competitive Workload Replica | Seed Burst (5000 docs, HTTP)        | 0.042    | 0.042    | 23886 | 🟢    | ⚪ established at 0.042ms (1 run) |
...
<summary><strong>🏷️ competitive workload replica</strong> · 🟢 4.377ms · ➡️ ⚪ established at 4.38ms (1 run) (2026-09-25 17:26:52) · <a href="../../../tests/benchmarks/competitive-workload-replica.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
```text
╔═══════════════════════════════════════════════════════════════════════════════════════════════════════╗
║                                SVELTYCMS — SEED BURST (DATASET SETUP)                                 ║
║                      File: tests/benchmarks/competitive-workload-replica.test.ts                      ║
║                                       Ran: 2026-09-25 17:26:52                                        ║
║              Seq + concurrent (8 workers), harness iteration counts, median of N rounds.              ║
╠═══════════════════════════════════════════════════════════════════════════════════════════════════════╣
║ Seed Burst (5000 docs, HTTP)   │        0.042 ms │ p95:        0.042 ms │ RPS:     23,886 ║
╚═══════════════════════════════════════════════════════════════════════════════════════════════════════╝
```
<!-- LEDGER_TRUTH_END -->
...
<summary><strong>🏷️ Ingestion</strong> · 🟢 0.042ms · ➡️ ⚪ established at 0.042ms (1 run) (2026-09-25 17:26:52) · <a href="../../../tests/benchmarks/competitive-workload-replica.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
> ⏳ Pending
<!-- LEDGER_TRUTH_END -->
