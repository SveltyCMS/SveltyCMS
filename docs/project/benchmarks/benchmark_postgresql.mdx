...
| ------------------ | ------- | -------------------------------- | ------ | ------ |
| **Scale Spectrum** | 3.230ms | ⚪ established at 3.23ms (1 run) | < 5ms  | 🟢     |
| **Scale Spectrum** | 3.543ms | ⚪ established at 3.54ms (1 run) | < 5ms  | 🟢     |
| **Scale Spectrum** | 4.025ms | ⚪ established at 4.03ms (1 run) | < 5ms  | 🟢     |
| **Scale Spectrum** | 3.595ms | ⚪ established at 3.60ms (1 run) | < 5ms  | 🟢     |
| **Scale Spectrum** | 2.884ms | ⚪ established at 2.88ms (1 run) | < 5ms  | 🟢     |
| **Scale Spectrum** | 2.817ms | ⚪ established at 2.82ms (1 run) | < 5ms  | 🟢     |
| **Scale Spectrum** | 3.035ms | ⚪ established at 3.04ms (1 run) | < 5ms  | 🟢     |
| **Scale Spectrum** | 3.745ms | ⚪ established at 3.75ms (1 run) | < 5ms  | 🟢     |
| **Scale Spectrum** | 4.568ms | ⚪ established at 4.57ms (1 run) | < 5ms  | 🟢     |
| **Scale Spectrum** | 2.442ms | ⚪ established at 2.44ms (1 run) | < 5ms  | 🟢     |
| **Scale Spectrum** | 3.113ms | ⚪ established at 3.11ms (1 run) | < 5ms  | 🟢     |
| **Scale Spectrum** | 3.236ms | ⚪ established at 3.24ms (1 run) | < 5ms  | 🟢     |
| **Scale Spectrum** | 5.777ms | ⚪ established at 5.78ms (1 run) | < 5ms  | 🟢     |
| **Scale Spectrum** | 2.453ms | ⚪ established at 2.45ms (1 run) | < 5ms  | 🟢     |
| **Scale Spectrum** | 2.372ms | ⚪ established at 2.37ms (1 run) | < 5ms  | 🟢     |
| **Scale Spectrum** | 3.008ms | ⚪ established at 3.01ms (1 run) | < 5ms  | 🟢     |
| **Scale Spectrum** | 5.418ms | ⚪ established at 5.42ms (1 run) | < 5ms  | 🟢     |
| **Scale Spectrum** | 2.352ms | ⚪ established at 2.35ms (1 run) | < 5ms  | 🟢     |
| **Scale Spectrum** | 2.387ms | ⚪ established at 2.39ms (1 run) | < 5ms  | 🟢     |
| **Scale Spectrum** | 2.967ms | ⚪ established at 2.97ms (1 run) | < 5ms  | 🟢     |
| **Scale Spectrum** | 4.981ms | ⚪ established at 4.98ms (1 run) | < 5ms  | 🟢     |
| **Scale Spectrum** | 2.039ms | ⚪ established at 2.04ms (1 run) | < 5ms  | 🟢     |
| **Scale Spectrum** | 2.018ms | ⚪ established at 2.02ms (1 run) | < 5ms  | 🟢     |
| **Scale Spectrum** | 2.802ms | ⚪ established at 2.80ms (1 run) | < 5ms  | 🟢     |
| **Scale Spectrum** | 5.499ms | ⚪ established at 5.50ms (1 run) | < 5ms  | 🟢     |
| **Scale Spectrum** | 1.698ms | ⚪ established at 1.70ms (1 run) | < 5ms  | 🟢     |
| **Scale Spectrum** | 2.082ms | ⚪ established at 2.08ms (1 run) | < 5ms  | 🟢     |
| **Scale Spectrum** | 3.180ms | ⚪ established at 3.18ms (1 run) | < 5ms  | 🟢     |
| **Scale Spectrum** | 5.621ms | ⚪ established at 5.62ms (1 run) | < 5ms  | 🟢     |
| **Scale Spectrum** | 1.743ms | ⚪ established at 1.74ms (1 run) | < 5ms  | 🟢     |
| **Scale Spectrum** | 2.354ms | ⚪ established at 2.35ms (1 run) | < 5ms  | 🟢     |
| **Scale Spectrum** | 2.564ms | ⚪ established at 2.56ms (1 run) | < 5ms  | 🟢     |
...
**Run ID:** `f1e074ad-944d-450d-908f-b502c65ca28c` · **Tests invoked:** 1 · **Metrics:** 32 · **DB:** postgresql

| Test           | Metric                  | Avg (ms) | p95 (ms) | RPS  | Trend | Detail                           |
| -------------- | ----------------------- | -------- | -------- | ---- | ----- | -------------------------------- |
| Scale Spectrum | findByIdRandom @ 1      | 3.230    | 3.646    | 2379 | 🟢    | ⚪ established at 3.23ms (1 run) |
| Scale Spectrum | listFilterSort @ 1      | 3.543    | 4.844    | 2185 | 🟢    | ⚪ established at 3.54ms (1 run) |
| Scale Spectrum | graphql @ 1             | 4.025    | 6.275    | 1923 | 🟢    | ⚪ established at 4.03ms (1 run) |
| Scale Spectrum | create @ 1              | 3.595    | 4.725    | 1084 | 🟢    | ⚪ established at 3.60ms (1 run) |
| Scale Spectrum | findByIdRandom @ 10     | 2.884    | 4.356    | 2677 | 🟢    | ⚪ established at 2.88ms (1 run) |
| Scale Spectrum | listFilterSort @ 10     | 2.817    | 4.422    | 2749 | 🟢    | ⚪ established at 2.82ms (1 run) |
| Scale Spectrum | graphql @ 10            | 3.035    | 3.393    | 2531 | 🟢    | ⚪ established at 3.04ms (1 run) |
| Scale Spectrum | create @ 10             | 3.745    | 4.952    | 1055 | 🟢    | ⚪ established at 3.75ms (1 run) |
| Scale Spectrum | findByIdRandom @ 100    | 4.568    | 8.657    | 1652 | 🟢    | ⚪ established at 4.57ms (1 run) |
| Scale Spectrum | listFilterSort @ 100    | 2.442    | 3.337    | 3124 | 🟢    | ⚪ established at 2.44ms (1 run) |
| Scale Spectrum | graphql @ 100           | 3.113    | 6.090    | 2493 | 🟢    | ⚪ established at 3.11ms (1 run) |
| Scale Spectrum | create @ 100            | 3.236    | 4.464    | 1195 | 🟢    | ⚪ established at 3.24ms (1 run) |
| Scale Spectrum | findByIdRandom @ 1000   | 5.777    | 9.032    | 1344 | 🟢    | ⚪ established at 5.78ms (1 run) |
| Scale Spectrum | listFilterSort @ 1000   | 2.453    | 5.958    | 3168 | 🟢    | ⚪ established at 2.45ms (1 run) |
| Scale Spectrum | graphql @ 1000          | 2.372    | 2.681    | 3240 | 🟢    | ⚪ established at 2.37ms (1 run) |
| Scale Spectrum | create @ 1000           | 3.008    | 4.056    | 1285 | 🟢    | ⚪ established at 3.01ms (1 run) |
| Scale Spectrum | findByIdRandom @ 5000   | 5.418    | 7.010    | 1441 | 🟢    | ⚪ established at 5.42ms (1 run) |
| Scale Spectrum | listFilterSort @ 5000   | 2.352    | 4.814    | 3298 | 🟢    | ⚪ established at 2.35ms (1 run) |
| Scale Spectrum | graphql @ 5000          | 2.387    | 2.875    | 3201 | 🟢    | ⚪ established at 2.39ms (1 run) |
| Scale Spectrum | create @ 5000           | 2.967    | 3.917    | 1333 | 🟢    | ⚪ established at 2.97ms (1 run) |
| Scale Spectrum | findByIdRandom @ 10000  | 4.981    | 6.830    | 1549 | 🟢    | ⚪ established at 4.98ms (1 run) |
| Scale Spectrum | listFilterSort @ 10000  | 2.039    | 5.059    | 3795 | 🟢    | ⚪ established at 2.04ms (1 run) |
| Scale Spectrum | graphql @ 10000         | 2.018    | 2.193    | 3811 | 🟢    | ⚪ established at 2.02ms (1 run) |
| Scale Spectrum | create @ 10000          | 2.802    | 4.018    | 1398 | 🟢    | ⚪ established at 2.80ms (1 run) |
| Scale Spectrum | findByIdRandom @ 50000  | 5.499    | 8.906    | 1399 | 🟢    | ⚪ established at 5.50ms (1 run) |
| Scale Spectrum | listFilterSort @ 50000  | 1.698    | 1.834    | 4518 | 🟢    | ⚪ established at 1.70ms (1 run) |
| Scale Spectrum | graphql @ 50000         | 2.082    | 2.635    | 3701 | 🟢    | ⚪ established at 2.08ms (1 run) |
| Scale Spectrum | create @ 50000          | 3.180    | 4.528    | 1228 | 🟢    | ⚪ established at 3.18ms (1 run) |
| Scale Spectrum | findByIdRandom @ 100000 | 5.621    | 7.710    | 1372 | 🟢    | ⚪ established at 5.62ms (1 run) |
| Scale Spectrum | listFilterSort @ 100000 | 1.743    | 2.007    | 4410 | 🟢    | ⚪ established at 1.74ms (1 run) |
| Scale Spectrum | graphql @ 100000        | 2.354    | 5.369    | 3294 | 🟢    | ⚪ established at 2.35ms (1 run) |
| Scale Spectrum | create @ 100000         | 2.564    | 3.544    | 1482 | 🟢    | ⚪ established at 2.56ms (1 run) |
