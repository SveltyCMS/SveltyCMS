...
| ------------------------ | ------- | --------------------------------- | ------ | ------ |
| **Database Performance** | 2.267ms | ⚪ established at 2.27ms (1 run)  | < 5ms  | 🟢     |
| **Database Performance** | 0.853ms | ⚪ established at 0.853ms (1 run) | < 5ms  | 🟢     |
| **Database Performance** | 0.924ms | ⚪ established at 0.924ms (1 run) | < 5ms  | 🟢     |
| **Database Performance** | 2.156ms | ⚪ established at 2.16ms (1 run)  | < 5ms  | 🟢     |
| **Database Performance** | 2.090ms | ⚪ established at 2.09ms (1 run)  | < 5ms  | 🟢     |
| **Database Performance** | 0.967ms | ⚪ established at 0.967ms (1 run) | < 5ms  | 🟢     |
| **Database Performance** | 2.090ms | ⚪ established at 2.09ms (1 run)  | < 5ms  | 🟢     |
| **Database Performance** | 7.367ms | ⚪ established at 7.37ms (1 run)  | < 5ms  | 🟢     |
...
| ----------------------------------------------- | ----- | --------- | ------- |
| database performance (BULK INSERT (100)) (warm) | 🟢    | `▁`       | 7.367ms |
...
**Run ID:** `aa261371-be23-4fd6-a334-dd641d7f5365` · **Tests invoked:** 1 · **Metrics:** 8 · **DB:** postgresql

| Test                 | Metric               | Avg (ms) | p95 (ms) | RPS  | Trend | Detail                            |
| -------------------- | -------------------- | -------- | -------- | ---- | ----- | --------------------------------- |
| Database Performance | INSERT               | 2.267    | 2.943    | 389  | 🟢    | ⚪ established at 2.27ms (1 run)  |
| Database Performance | FIND ONE             | 0.853    | 1.009    | 1022 | 🟢    | ⚪ established at 0.853ms (1 run) |
| Database Performance | FIND MANY (limit 50) | 0.924    | 1.071    | 951  | 🟢    | ⚪ established at 0.924ms (1 run) |
| Database Performance | UPDATE               | 2.156    | 2.562    | 418  | 🟢    | ⚪ established at 2.16ms (1 run)  |
| Database Performance | NATIVE UPSERT        | 2.090    | 2.576    | 418  | 🟢    | ⚪ established at 2.09ms (1 run)  |
| Database Performance | COUNT                | 0.967    | 1.121    | 895  | 🟢    | ⚪ established at 0.967ms (1 run) |
| Database Performance | DELETE               | 2.090    | 2.679    | 456  | 🟢    | ⚪ established at 2.09ms (1 run)  |
| Database Performance | BULK INSERT (100)    | 7.367    | 9.394    | 134  | 🟢    | ⚪ established at 7.37ms (1 run)  |
...
| --------------------------- | ----- | ------------------ | ------- |
| DATABASE PERFORMANCE (warm) | 🟢    | `▂▇▁▁█▇▇`          | 2.156ms |
...
<summary><strong>🏷️ database performance</strong> · 🟢 7.367ms · ➡️ ⚪ established at 7.37ms (1 run) (2026-08-04 11:17:26) · <a href="../../../tests/benchmarks/database-performance.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
```text
╔═════════════════════════════════════════════════════════════════════════════════════════╗
║                  SVELTYCMS — DATABASE ADAPTER PERFORMANCE (POSTGRESQL)                  ║
║                   File: tests/benchmarks/database-performance.test.ts                   ║
║                                Ran: 2026-08-04 11:17:26                                 ║
║   Measures raw CRUD performance, indexing efficiency, and connection pool resilience    ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ INSERT                         │        2.267 ms │ p95:        2.943 ms │ RPS:        389 ║
║ FIND ONE                       │        0.853 ms │ p95:        1.009 ms │ RPS:      1,022 ║
║ FIND MANY (limit 50)           │        0.924 ms │ p95:        1.071 ms │ RPS:        951 ║
║ UPDATE                         │        2.156 ms │ p95:        2.562 ms │ RPS:        418 ║
║ NATIVE UPSERT                  │        2.090 ms │ p95:        2.576 ms │ RPS:        418 ║
║ COUNT                          │        0.967 ms │ p95:        1.121 ms │ RPS:        895 ║
║ DELETE                         │        2.090 ms │ p95:        2.679 ms │ RPS:        456 ║
║ BULK INSERT (100)              │        7.367 ms │ p95:        9.394 ms │ RPS:        134 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
<!-- LEDGER_TRUTH_END -->
