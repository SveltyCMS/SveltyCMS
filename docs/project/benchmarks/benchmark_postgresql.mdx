...
| -------------------------------- | ------- | --------------------------------- | ------ | ------ |
| **Competitive Workload Replica** | 0.239ms | ⚪ established at 0.239ms (1 run) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.072ms | ⚪ established at 1.07ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.172ms | ⚪ established at 1.17ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 2.844ms | ⚪ established at 2.84ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 0.323ms | ⚪ established at 0.323ms (1 run) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.172ms | ⚪ established at 1.17ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 0.423ms | ⚪ established at 0.423ms (1 run) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.648ms | ⚪ established at 1.65ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 0.266ms | ⚪ established at 0.266ms (1 run) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.035ms | ⚪ established at 1.03ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 0.315ms | ⚪ established at 0.315ms (1 run) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 0.848ms | ⚪ established at 0.848ms (1 run) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 3.683ms | ⚪ established at 3.68ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 5.575ms | ⚪ established at 5.58ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 3.748ms | ⚪ established at 3.75ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 5.657ms | ⚪ established at 5.66ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.009ms | ⚪ established at 1.01ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 2.339ms | ⚪ established at 2.34ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.783ms | ⚪ established at 1.78ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 3.178ms | ⚪ established at 3.18ms (1 run)  | < 5ms  | 🟢     |
...
**Run ID:** `df0140c9-6320-4626-b9bb-dd3978fe7652` · **Tests invoked:** 1 · **Metrics:** 20 · **DB:** postgresql

| Test                         | Metric                              | Avg (ms) | p95 (ms) | RPS  | Trend | Detail                            |
| ---------------------------- | ----------------------------------- | -------- | -------- | ---- | ----- | --------------------------------- |
| Competitive Workload Replica | findById (Warm Sequential)          | 0.239    | 0.314    | 4172 | 🟢    | ⚪ established at 0.239ms (1 run) |
| Competitive Workload Replica | findById (Warm Concurrent 8c)       | 1.072    | 1.258    | 7403 | 🟢    | ⚪ established at 1.07ms (1 run)  |
| Competitive Workload Replica | findByIdRandom (Warm Sequential)    | 1.172    | 1.710    | 852  | 🟢    | ⚪ established at 1.17ms (1 run)  |
| Competitive Workload Replica | findByIdRandom (Warm Concurrent 8c) | 2.844    | 4.186    | 2794 | 🟢    | ⚪ established at 2.84ms (1 run)  |
| Competitive Workload Replica | listFilterSort (Warm Sequential)    | 0.323    | 0.440    | 3084 | 🟢    | ⚪ established at 0.323ms (1 run) |
| Competitive Workload Replica | listFilterSort (Warm Concurrent 8c) | 1.172    | 1.418    | 6699 | 🟢    | ⚪ established at 1.17ms (1 run)  |
| Competitive Workload Replica | listLarge (Warm Sequential)         | 0.423    | 0.527    | 2354 | 🟢    | ⚪ established at 0.423ms (1 run) |
| Competitive Workload Replica | listLarge (Warm Concurrent 8c)      | 1.648    | 1.897    | 4763 | 🟢    | ⚪ established at 1.65ms (1 run)  |
| Competitive Workload Replica | listPlain (Warm Sequential)         | 0.266    | 0.354    | 3740 | 🟢    | ⚪ established at 0.266ms (1 run) |
| Competitive Workload Replica | listPlain (Warm Concurrent 8c)      | 1.035    | 1.280    | 7580 | 🟢    | ⚪ established at 1.03ms (1 run)  |
| Competitive Workload Replica | findMissing (Warm Sequential)       | 0.315    | 0.427    | 3160 | 🟢    | ⚪ established at 0.315ms (1 run) |
| Competitive Workload Replica | findMissing (Warm Concurrent 8c)    | 0.848    | 0.996    | 9260 | 🟢    | ⚪ established at 0.848ms (1 run) |
| Competitive Workload Replica | create (Warm Sequential)            | 3.683    | 4.864    | 271  | 🟢    | ⚪ established at 3.68ms (1 run)  |
| Competitive Workload Replica | create (Warm Concurrent 8c)         | 5.575    | 7.901    | 1417 | 🟢    | ⚪ established at 5.58ms (1 run)  |
| Competitive Workload Replica | update (Warm Sequential)            | 3.748    | 4.934    | 267  | 🟢    | ⚪ established at 3.75ms (1 run)  |
| Competitive Workload Replica | update (Warm Concurrent 8c)         | 5.657    | 9.310    | 1409 | 🟢    | ⚪ established at 5.66ms (1 run)  |
| Competitive Workload Replica | graphql (Warm Sequential)           | 1.009    | 1.389    | 989  | 🟢    | ⚪ established at 1.01ms (1 run)  |
| Competitive Workload Replica | graphql (Warm Concurrent 8c)        | 2.339    | 2.901    | 3366 | 🟢    | ⚪ established at 2.34ms (1 run)  |
| Competitive Workload Replica | mixed (Warm Sequential)             | 1.783    | 4.715    | 560  | 🟢    | ⚪ established at 1.78ms (1 run)  |
| Competitive Workload Replica | mixed (Warm Concurrent 8c)          | 3.178    | 7.990    | 2423 | 🟢    | ⚪ established at 3.18ms (1 run)  |
...
<summary><strong>🏷️ competitive workload replica</strong> · 🟢 3.178ms · ➡️ ⚪ established at 3.18ms (1 run) (2026-09-21 18:53:46) · <a href="../../../tests/benchmarks/competitive-workload-replica.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
```text
╔═══════════════════════════════════════════════════════════════════════════════════════════════════════╗
║                  COMPETITIVE HARNESS REPLICA (POSTGRESQL — 10000 Docs, COLD vs WARM)                  ║
║                      File: tests/benchmarks/competitive-workload-replica.test.ts                      ║
║                                       Ran: 2026-09-21 18:53:46                                        ║
║              Seq + concurrent (8 workers), harness iteration counts, median of N rounds.              ║
╠═══════════════════════════════════════════════════════════════════════════════════════════════════════╣
║ findById (Cold Sequential)   │ Cold:     3.96 ms │ Warm:     0.359 ms │ p95:     0.441 ms │   2,721 RPS ║
║ findById (Cold Concurrent 8c) │ Cold:     0.44 ms │ Warm:     1.492 ms │ p95:     2.123 ms │   5,185 RPS ║
║ findByIdRandom (Cold Sequential) │ Cold:     2.54 ms │ Warm:     1.394 ms │ p95:     2.528 ms │     716 RPS ║
║ findByIdRandom (Cold Concurrent 8c) │ Cold:     2.12 ms │ Warm:     3.479 ms │ p95:     4.589 ms │   2,233 RPS ║
║ listFilterSort (Cold Sequential) │ Cold:   116.61 ms │ Warm:     1.539 ms │ p95:     0.513 ms │     649 RPS ║
║ listFilterSort (Cold Concurrent 8c) │ Cold:     0.37 ms │ Warm:     1.848 ms │ p95:     2.608 ms │   4,191 RPS ║
║ listLarge (Cold Sequential)  │ Cold:    40.39 ms │ Warm:     1.048 ms │ p95:     0.796 ms │     952 RPS ║
║ listLarge (Cold Concurrent 8c) │ Cold:     0.48 ms │ Warm:     2.180 ms │ p95:     2.622 ms │   3,537 RPS ║
║ listPlain (Cold Sequential)  │ Cold:     6.40 ms │ Warm:     0.380 ms │ p95:     0.406 ms │   2,621 RPS ║
║ listPlain (Cold Concurrent 8c) │ Cold:     0.40 ms │ Warm:     1.368 ms │ p95:     1.770 ms │   5,541 RPS ║
║ findMissing (Cold Sequential) │ Cold:     6.44 ms │ Warm:     0.371 ms │ p95:     0.426 ms │   2,684 RPS ║
║ findMissing (Cold Concurrent 8c) │ Cold:     0.33 ms │ Warm:     1.398 ms │ p95:     1.939 ms │   5,514 RPS ║
║ create (Cold Sequential)     │ Cold:     7.86 ms │ Warm:     4.147 ms │ p95:     5.323 ms │     241 RPS ║
║ create (Cold Concurrent 8c)  │ Cold:     5.09 ms │ Warm:     6.526 ms │ p95:     8.859 ms │   1,193 RPS ║
║ update (Cold Sequential)     │ Cold:     4.88 ms │ Warm:     4.146 ms │ p95:     4.929 ms │     241 RPS ║
║ update (Cold Concurrent 8c)  │ Cold:     4.42 ms │ Warm:     7.366 ms │ p95:    11.160 ms │   1,039 RPS ║
║ graphql (Cold Sequential)    │ Cold:    11.93 ms │ Warm:     1.288 ms │ p95:     1.789 ms │     776 RPS ║
║ graphql (Cold Concurrent 8c) │ Cold:     2.52 ms │ Warm:     2.996 ms │ p95:     3.597 ms │   2,625 RPS ║
║ mixed (Cold Sequential)      │ Cold:     1.91 ms │ Warm:     1.688 ms │ p95:     4.224 ms │     592 RPS ║
║ mixed (Cold Concurrent 8c)   │ Cold:     0.40 ms │ Warm:     3.562 ms │ p95:     8.235 ms │   2,107 RPS ║
║ findById (Warm Sequential)   │ Cold:     0.41 ms │ Warm:     0.239 ms │ p95:     0.314 ms │   4,172 RPS ║
║ findById (Warm Concurrent 8c) │ Cold:     0.36 ms │ Warm:     1.072 ms │ p95:     1.258 ms │   7,403 RPS ║
║ findByIdRandom (Warm Sequential) │ Cold:     2.32 ms │ Warm:     1.172 ms │ p95:     1.710 ms │     852 RPS ║
║ findByIdRandom (Warm Concurrent 8c) │ Cold:     0.33 ms │ Warm:     2.844 ms │ p95:     4.186 ms │   2,794 RPS ║
║ listFilterSort (Warm Sequential) │ Cold:     0.44 ms │ Warm:     0.323 ms │ p95:     0.440 ms │   3,084 RPS ║
║ listFilterSort (Warm Concurrent 8c) │ Cold:     0.32 ms │ Warm:     1.172 ms │ p95:     1.418 ms │   6,699 RPS ║
║ listLarge (Warm Sequential)  │ Cold:     0.37 ms │ Warm:     0.423 ms │ p95:     0.527 ms │   2,354 RPS ║
║ listLarge (Warm Concurrent 8c) │ Cold:     0.41 ms │ Warm:     1.648 ms │ p95:     1.897 ms │   4,763 RPS ║
║ listPlain (Warm Sequential)  │ Cold:     2.64 ms │ Warm:     0.266 ms │ p95:     0.354 ms │   3,740 RPS ║
║ listPlain (Warm Concurrent 8c) │ Cold:     0.27 ms │ Warm:     1.035 ms │ p95:     1.280 ms │   7,580 RPS ║
║ findMissing (Warm Sequential) │ Cold:     0.26 ms │ Warm:     0.315 ms │ p95:     0.427 ms │   3,160 RPS ║
║ findMissing (Warm Concurrent 8c) │ Cold:     0.27 ms │ Warm:     0.848 ms │ p95:     0.996 ms │   9,260 RPS ║
║ create (Warm Sequential)     │ Cold:    20.14 ms │ Warm:     3.683 ms │ p95:     4.864 ms │     271 RPS ║
║ create (Warm Concurrent 8c)  │ Cold:     3.78 ms │ Warm:     5.575 ms │ p95:     7.901 ms │   1,417 RPS ║
║ update (Warm Sequential)     │ Cold:     5.75 ms │ Warm:     3.748 ms │ p95:     4.934 ms │     267 RPS ║
║ update (Warm Concurrent 8c)  │ Cold:     3.99 ms │ Warm:     5.657 ms │ p95:     9.310 ms │   1,409 RPS ║
║ graphql (Warm Sequential)    │ Cold:     1.03 ms │ Warm:     1.009 ms │ p95:     1.389 ms │     989 RPS ║
║ graphql (Warm Concurrent 8c) │ Cold:     1.34 ms │ Warm:     2.339 ms │ p95:     2.901 ms │   3,366 RPS ║
║ mixed (Warm Sequential)      │ Cold:     3.15 ms │ Warm:     1.783 ms │ p95:     4.715 ms │     560 RPS ║
║ mixed (Warm Concurrent 8c)   │ Cold:     0.72 ms │ Warm:     3.178 ms │ p95:     7.990 ms │   2,423 RPS ║
╚═══════════════════════════════════════════════════════════════════════════════════════════════════════╝
```
<!-- LEDGER_TRUTH_END -->
