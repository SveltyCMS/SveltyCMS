...
║                                Ran: 2026-08-28 13:23:10                                 ║
║     Validates performance claims by comparing SDK, Middleware, and Real HTTP Stack      ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Logic Baseline                 │        0.000 ms │ p95:        0.001 ms │ RPS:    513,699 ║
║ Local SDK (Full)               │        0.005 ms │ p95:        0.009 ms │ RPS:    177,347 ║
║ HTTP End-to-End                │        0.445 ms │ p95:        0.555 ms │ RPS:      2,234 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ Middleware & Hooks Performance</strong> · 🟢 0.830ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/hooks-performance.test.ts">source</a></summary>
...
║                                Ran: 2026-08-28 13:25:27                                 ║
║Measures the cost of the full middleware chain including Turbo, Security, Auth, and Audit via HTTP E2E.║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Static Asset (No Middleware)   │        0.830 ms │ p95:        1.737 ms │ RPS:      4,303 ║
║ Turbo Pipeline (Light)         │        0.718 ms │ p95:        1.934 ms │ RPS:      4,875 ║
║ Full Security + Auth Pipeline  │        0.985 ms │ p95:        1.969 ms │ RPS:      3,743 ║
║ REST with API Caching          │        0.877 ms │ p95:        1.782 ms │ RPS:      4,195 ║
║ Mutation (audit logging disabled) │        2.475 ms │ p95:        3.945 ms │ RPS:        374 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ database performance</strong> · 🟢 6.733ms · ➡️ ⚪ established at 6.73ms (1 run) (2026-08-28 13:24:57) · <a href="../../../tests/benchmarks/database-performance.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
```text
╔═════════════════════════════════════════════════════════════════════════════════════════╗
║                  SVELTYCMS — DATABASE ADAPTER PERFORMANCE (POSTGRESQL)                  ║
║                   File: tests/benchmarks/database-performance.test.ts                   ║
║                                Ran: 2026-08-28 13:24:57                                 ║
║   Measures raw CRUD performance, indexing efficiency, and connection pool resilience.   ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ INSERT                         │        1.725 ms │ p95:        3.409 ms │ RPS:        512 ║
║ FIND ONE                       │        0.378 ms │ p95:        0.510 ms │ RPS:      2,349 ║
║ FIND MANY (limit 50)           │        1.097 ms │ p95:        2.655 ms │ RPS:        794 ║
║ QUERY BUILDER LIST (50)        │        1.884 ms │ p95:        3.537 ms │ RPS:        473 ║
║ FIND PAGE (50 hasMore)         │        1.196 ms │ p95:        2.766 ms │ RPS:        723 ║
║ FIND PAGE keyset               │        1.200 ms │ p95:        2.702 ms │ RPS:        737 ║
║ FIND MANY offset 50            │        0.990 ms │ p95:        2.384 ms │ RPS:        895 ║
║ LIST+COUNT (legacy)            │        1.172 ms │ p95:        2.812 ms │ RPS:        742 ║
║ UPDATE                         │        1.752 ms │ p95:        3.311 ms │ RPS:        512 ║
║ UPDATE (no-returning)          │        1.712 ms │ p95:        3.284 ms │ RPS:        524 ║
║ NATIVE UPSERT                  │        2.111 ms │ p95:        4.226 ms │ RPS:        413 ║
║ COUNT                          │        0.897 ms │ p95:        2.382 ms │ RPS:        983 ║
║ COUNT ESTIMATE                 │        0.682 ms │ p95:        1.181 ms │ RPS:      1,278 ║
║ COUNT CACHED                   │        0.001 ms │ p95:        0.003 ms │ RPS:    539,287 ║
║ DELETE (Active Rows)           │        2.186 ms │ p95:        4.140 ms │ RPS:        396 ║
║ BULK INSERT (100)              │        5.798 ms │ p95:        7.461 ms │ RPS:        169 ║
║ BULK UPDATE (100 heterogeneous) │        8.146 ms │ p95:       10.732 ms │ RPS:        120 ║
║ BULK UPDATE (100 homogeneous)  │        6.733 ms │ p95:        9.213 ms │ RPS:        144 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
<!-- LEDGER_TRUTH_END -->
...
<summary><strong>🏷️ transaction acid</strong> · 🟢 2.580ms · ↘️ ⚪ stable at 3.49ms (±1.42ms) (7 runs) (2026-08-28 13:25:08) · <a href="../../../tests/benchmarks/transaction-acid.test.ts">source</a></summary>
...
║                                Ran: 2026-08-28 13:25:08                                 ║
║  Measures transaction commit latencies and rollback overhead across database adapters   ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ TX Commit                      │        1.026 ms │ p95:        2.704 ms │ RPS:      3,347 ║
║ TX Rollback Integrity          │        2.580 ms │ p95:        4.498 ms │ RPS:        384 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ Cache</strong> · 🟢 0.279ms · ➡️ ⚪ established at 0.279ms (1 run) (2026-08-28 13:25:16) · <a href="../../../tests/benchmarks/cache-performance.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
```text
╔═════════════════════════════════════════════════════════════════════════════════════════╗
║                           SVELTYCMS — CACHE EFFICIENCY AUDIT                            ║
║                    File: tests/benchmarks/cache-performance.test.ts                     ║
║                                Ran: 2026-08-28 13:25:16                                 ║
║  Measures cache hit vs miss latency and efficiency via real HTTP end-to-end requests.   ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ Cache Miss (Bypass)            │        0.326 ms │ p95:        0.500 ms │ RPS:      2,727 ║
║ Cache Hit (L1 Warm)            │        0.279 ms │ p95:        0.375 ms │ RPS:      3,203 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
<!-- LEDGER_TRUTH_END -->
...
<summary><strong>🏷️ SDK</strong> · 🟢 0.005ms · ↗️ ⚪ stable at 0.004ms (±0.013ms) (6 runs) (2026-08-28 13:23:17) · <a href="../../../tests/benchmarks/truth-latency.test.ts">source</a></summary>
<!-- LEDGER_INSIGHT_START -->
> [!NOTE]
...
<summary><strong>🏷️ REST API Performance</strong> · 🟢 0.651ms · ➡️ recorded (awaiting trend) · <a href="../../../tests/benchmarks/rest-api-performance.test.ts">source</a></summary>
...
║                                Ran: 2026-08-28 13:25:37                                 ║
║Measures latency, throughput, and correctness of core REST endpoints: health check, schema, single read, list, and search.║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ System Health Check            │        0.651 ms │ p95:        1.594 ms │ RPS:      5,468 ║
║ Collection Schema Metadata     │        0.819 ms │ p95:        1.762 ms │ RPS:      4,454 ║
║ Single Document Read           │        0.764 ms │ p95:        1.621 ms │ RPS:      4,822 ║
║ Collection Find (List Limit 20) │        0.864 ms │ p95:        1.686 ms │ RPS:      4,308 ║
║ Collection Search Query        │        0.802 ms │ p95:        1.612 ms │ RPS:      4,590 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
