...
| -------------------------------- | -------- | --------------------------------- | ------ | ------ |
| **Competitive Workload Replica** | 2.909ms  | ⚪ established at 2.91ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 8.275ms  | ⚪ established at 8.28ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 3.134ms  | ⚪ established at 3.13ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.752ms  | ⚪ established at 1.75ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.687ms  | ⚪ established at 1.69ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.225ms  | ⚪ established at 1.23ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 7.223ms  | ⚪ established at 7.22ms (1 run)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 14.948ms | ⚪ established at 14.95ms (1 run) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 17.855ms | ⚪ established at 17.86ms (1 run) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 8.179ms  | ⚪ established at 8.18ms (1 run)  | < 5ms  | 🟢     |
...
| ---------------------------------------------------- | ----- | --------- | --------- |
| cold start phased (Cold Start (IDLE → READY)) (cold) | 🟢    | `▁`       | 953.807ms |
| database performance (BULK INSERT (100)) (warm)      | 🟢    | `▁`       | 1.881ms   |
...
**Run ID:** `234c0152-57bb-4953-b4b9-62c1d81ae95d` · **Tests invoked:** 1 · **Metrics:** 10 · **DB:** postgresql

| Test                         | Metric                                   | Avg (ms) | p95 (ms) | RPS  | Trend | Detail                            |
| ---------------------------- | ---------------------------------------- | -------- | -------- | ---- | ----- | --------------------------------- |
| Competitive Workload Replica | findById (Concurrent 8c)                 | 2.909    | 5.225    | 1545 | 🟢    | ⚪ established at 2.91ms (1 run)  |
| Competitive Workload Replica | findByIdRandom (Concurrent 8c)           | 8.275    | 19.692   | 797  | 🟢    | ⚪ established at 8.28ms (1 run)  |
| Competitive Workload Replica | listPlain (Concurrent 8c)                | 3.134    | 5.248    | 1559 | 🟢    | ⚪ established at 3.13ms (1 run)  |
| Competitive Workload Replica | listFilterSort (Concurrent 8c)           | 1.752    | 3.087    | 2705 | 🟢    | ⚪ established at 1.75ms (1 run)  |
| Competitive Workload Replica | listLarge (Concurrent 8c)                | 1.687    | 4.016    | 2811 | 🟢    | ⚪ established at 1.69ms (1 run)  |
| Competitive Workload Replica | findMissing (Concurrent 8c)              | 1.225    | 2.717    | 3868 | 🟢    | ⚪ established at 1.23ms (1 run)  |
| Competitive Workload Replica | GraphQL Collection Query (Concurrent 8c) | 7.223    | 9.591    | 1070 | 🟢    | ⚪ established at 7.22ms (1 run)  |
| Competitive Workload Replica | create (Concurrent 8c)                   | 14.948   | 32.617   | 523  | 🟢    | ⚪ established at 14.95ms (1 run) |
| Competitive Workload Replica | update (Concurrent 8c)                   | 17.855   | 24.981   | 432  | 🟢    | ⚪ established at 17.86ms (1 run) |
| Competitive Workload Replica | mixed (Concurrent 8c 50/50)              | 8.179    | 14.813   | 809  | 🟢    | ⚪ established at 8.18ms (1 run)  |
...
| ----------------------------------- | ----- | ------------------ | --------- |
| CACHE PERFORMANCE (warm)            | 🟢    | `▁`                | 0.286ms   |
| COLD START PHASED (cold)            | 🟢    | `▁`                | 953.807ms |
| DATABASE PERFORMANCE (warm)         | 🟢    | `█▁▄▂▇▁▁`          | 0.215ms   |
| HOOKS PERFORMANCE (warm)            | 🟢    | `▄█▃▁▃`            | 0.575ms   |
| TRANSACTION ACID (warm)             | 🟢    | `█▁`               | 0.495ms   |
| TRUTH LATENCY (warm)                | 🟢    | `█▁▁`              | 0.000ms   |
| COMPETITIVE WORKLOAD REPLICA (warm) | ⚪    | `▄▁▁▁▂▄█`          | 17.855ms  |
| REST API PERFORMANCE (warm)         | ⚪    | `▄▇█▁`             | 0.316ms   |
