...
| -------------------------------- | ------- | -------------------------------------------- | ------ | ------ |
| **Competitive Workload Replica** | 0.176ms | ⚪ stable at 0.178ms (±0.094ms) (7 runs)     | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 0.581ms | ⚪ stable at 0.627ms (±0.599ms) (7 runs)     | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 0.171ms | 🟢 faster: 0.974ms → 0.171ms (-82%) (7 runs) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 0.552ms | 🟢 faster: 2.18ms → 0.552ms (-75%) (7 runs)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 0.244ms | ⚪ stable at 0.345ms (±0.092ms) (7 runs)     | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.114ms | ⚪ stable at 1.41ms (±0.607ms) (7 runs)      | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 0.628ms | ⚪ stable at 0.529ms (±0.184ms) (7 runs)     | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 2.746ms | ⚪ stable at 2.53ms (±1.25ms) (7 runs)       | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 0.187ms | ⚪ stable at 0.216ms (±0.040ms) (7 runs)     | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 0.647ms | ⚪ stable at 0.790ms (±0.342ms) (7 runs)     | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 0.116ms | ⚪ stable at 0.216ms (±0.112ms) (7 runs)     | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 0.416ms | ⚪ stable at 0.500ms (±0.358ms) (7 runs)     | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 2.859ms | ⚪ stable at 3.04ms (±0.628ms) (7 runs)      | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 4.356ms | ⚪ stable at 5.02ms (±1.03ms) (7 runs)       | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 2.720ms | 🟢 faster: 3.23ms → 2.72ms (-16%) (7 runs)   | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 4.697ms | 🟢 faster: 6.12ms → 4.70ms (-23%) (7 runs)   | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 0.956ms | ⚪ stable at 0.965ms (±0.403ms) (7 runs)     | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 2.268ms | ⚪ stable at 2.44ms (±0.475ms) (7 runs)      | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.275ms | ⚪ stable at 1.52ms (±0.237ms) (7 runs)      | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 2.260ms | 🟢 faster: 3.19ms → 2.26ms (-29%) (7 runs)   | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 0.142ms | ⚪ established at 0.142ms (1 run)            | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 0.283ms | ⚪ established at 0.283ms (1 run)            | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.142ms | ⚪ established at 1.14ms (1 run)             | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.978ms | ⚪ established at 1.98ms (1 run)             | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 0.507ms | ⚪ established at 0.507ms (1 run)            | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.140ms | ⚪ established at 1.14ms (1 run)             | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 3.694ms | ⚪ established at 3.69ms (1 run)             | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 8.336ms | ⚪ established at 8.34ms (1 run)             | < 5ms  | 🟢     |
| **Ingestion**                    | 0.736ms | ⚪ established at 0.736ms (1 run)            | < 5ms  | 🟢     |
...
quadrantChart
  ...
  quadrant-4 Critical — fix first
    ...
    Competitive Workload Replica: [0.12, 0.91]
    Competitive Workload Replica: [0.05, 0.36]
    Competitive Workload Replica: [0.24, 0.26]
    Competitive Workload Replica: [0.13, 0.23]
    Competitive Workload Replica: [0.58, 0.10]
    Competitive Workload Replica: [0.05, 0.16]
    Competitive Workload Replica: [0.14, 0.22]
```
...
### Current Run Summary (2026-09-24)

> **Scope:** Only tests that ran in THIS invocation.

> ⚠️ Executive PASS/FAIL reflects the last full matrix run.

**Run ID:** `a95777cf-5520-4351-997c-ad729067972d` · **Tests invoked:** 1 · **Metrics:** 29 · **DB:** postgresql

| Test                         | Metric                              | Avg (ms) | p95 (ms) | RPS   | Trend | Detail                                       |
| ---------------------------- | ----------------------------------- | -------- | -------- | ----- | ----- | -------------------------------------------- |
| Competitive Workload Replica | findById (Warm Sequential)          | 0.150    | 0.225    | 6605  | 🟢    | ⚪ stable at 0.176ms (±0.094ms) (7 runs)     |
| Competitive Workload Replica | findById (Warm Concurrent 8c)       | 0.551    | 0.728    | 14399 | 🟢    | ⚪ stable at 0.627ms (±0.604ms) (7 runs)     |
| Competitive Workload Replica | listFilterSort (Warm Sequential)    | 0.254    | 0.349    | 3918  | 🟢    | ⚪ stable at 0.345ms (±0.120ms) (7 runs)     |
| Competitive Workload Replica | listFilterSort (Warm Concurrent 8c) | 1.005    | 1.326    | 6923  | 🟢    | ⚪ stable at 1.20ms (±0.326ms) (7 runs)      |
| Competitive Workload Replica | listLarge (Warm Concurrent 8c)      | 2.726    | 4.805    | 2894  | 🟢    | ⚪ stable at 2.53ms (±0.616ms) (7 runs)      |
| Competitive Workload Replica | listPlain (Warm Sequential)         | 0.193    | 0.255    | 5168  | 🟢    | ⚪ stable at 0.214ms (±0.059ms) (7 runs)     |
| Competitive Workload Replica | listPlain (Warm Concurrent 8c)      | 0.680    | 0.823    | 11518 | 🟢    | ⚪ stable at 0.788ms (±0.427ms) (7 runs)     |
| Competitive Workload Replica | findMissing (Warm Sequential)       | 0.120    | 0.253    | 8276  | 🟢    | ⚪ stable at 0.170ms (±0.097ms) (7 runs)     |
| Competitive Workload Replica | findMissing (Warm Concurrent 8c)    | 0.408    | 0.502    | 19151 | 🟢    | ⚪ stable at 0.486ms (±0.358ms) (7 runs)     |
| Competitive Workload Replica | create (Warm Sequential)            | 2.780    | 3.238    | 360   | 🟢    | ⚪ stable at 2.98ms (±0.608ms) (7 runs)      |
| Competitive Workload Replica | create (Warm Concurrent 8c)         | 4.475    | 5.783    | 1763  | 🟢    | ⚪ stable at 4.73ms (±0.962ms) (7 runs)      |
| Competitive Workload Replica | update (Warm Sequential)            | 2.882    | 3.503    | 347   | 🟢    | ⚪ stable at 3.21ms (±0.274ms) (7 runs)      |
| Competitive Workload Replica | update (Warm Concurrent 8c)         | 4.719    | 6.078    | 1673  | 🟢    | ⚪ stable at 5.61ms (±1.34ms) (7 runs)       |
| Competitive Workload Replica | graphql (Warm Concurrent 8c)        | 2.351    | 2.839    | 3350  | 🟢    | ⚪ stable at 2.42ms (±0.374ms) (7 runs)      |
| Competitive Workload Replica | mixed (Warm Sequential)             | 1.156    | 2.944    | 864   | 🟢    | ⚪ stable at 1.47ms (±0.306ms) (7 runs)      |
| Competitive Workload Replica | mixed (Warm Concurrent 8c)          | 2.273    | 5.470    | 3359  | 🟢    | ⚪ stable at 2.98ms (±0.569ms) (7 runs)      |
| Competitive Workload Replica | findById (Sweep 1c)                 | 0.163    | 0.301    | 6117  | 🟢    | ⚪ established at 0.163ms (1 run)            |
| Competitive Workload Replica | findById (Sweep 4c)                 | 0.245    | 0.335    | 16295 | 🟢    | ⚪ established at 0.245ms (1 run)            |
| Competitive Workload Replica | findById (Sweep 16c)                | 0.981    | 1.327    | 16210 | 🟢    | ⚪ established at 0.981ms (1 run)            |
| Competitive Workload Replica | findById (Sweep 32c)                | 2.928    | 6.329    | 10679 | 🟢    | ⚪ established at 2.93ms (1 run)             |
| Competitive Workload Replica | listLarge (Sweep 1c)                | 0.612    | 0.912    | 1630  | 🟢    | ⚪ established at 0.612ms (1 run)            |
| Competitive Workload Replica | listLarge (Sweep 4c)                | 1.144    | 2.350    | 3485  | 🟢    | ⚪ established at 1.14ms (1 run)             |
| Competitive Workload Replica | listLarge (Sweep 16c)               | 4.350    | 8.599    | 3657  | 🟢    | ⚪ established at 4.35ms (1 run)             |
| Competitive Workload Replica | listLarge (Sweep 32c)               | 7.884    | 16.471   | 3972  | 🟢    | ⚪ established at 7.88ms (1 run)             |
| Competitive Workload Replica | Seed Burst (500 docs, HTTP)         | 0.393    | 0.393    | 2546  | 🟢    | ⚪ established at 0.393ms (1 run)            |
| Competitive Workload Replica | findByIdRandom (Warm Sequential)    | 0.164    | 0.227    | 6064  | ⚪    | 🟢 faster: 0.974ms → 0.164ms (-83%) (7 runs) |
| Competitive Workload Replica | findByIdRandom (Warm Concurrent 8c) | 0.534    | 0.809    | 14790 | ⚪    | 🟢 faster: 2.05ms → 0.534ms (-74%) (7 runs)  |
| Competitive Workload Replica | listLarge (Warm Sequential)         | 0.813    | 1.297    | 1227  | ⚪    | 🔴 slower: 0.529ms → 0.813ms (+54%) (7 runs) |
| Competitive Workload Replica | graphql (Warm Sequential)           | 1.241    | 2.425    | 805   | ⚪    | 🔴 slower: 0.956ms → 1.24ms (+30%) (7 runs)  |

<!-- SUMMARY_RUN_OVERLAY_END -->

<!-- SUMMARY_HISTORY_START -->

### Historical Trends (2026-09-24)
...
<summary><strong>🏷️ competitive workload replica</strong> · 🟢 7.884ms · ➡️ ⚪ established at 7.88ms (1 run) (2026-09-24 20:45:53) · <a href="../../../tests/benchmarks/competitive-workload-replica.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
```text
╔═══════════════════════════════════════════════════════════════════════════════════════════════════════╗
║                                SVELTYCMS — SEED BURST (DATASET SETUP)                                 ║
║                      File: tests/benchmarks/competitive-workload-replica.test.ts                      ║
║                                       Ran: 2026-09-24 20:45:53                                        ║
║              Seq + concurrent (8 workers), harness iteration counts, median of N rounds.              ║
╠═══════════════════════════════════════════════════════════════════════════════════════════════════════╣
║ Seed Burst (500 docs, HTTP)    │        0.393 ms │ p95:        0.393 ms │ RPS:      2,546 ║
╚═══════════════════════════════════════════════════════════════════════════════════════════════════════╝
```
<!-- LEDGER_TRUTH_END -->
...
<summary><strong>🏷️ Ingestion</strong> · 🟢 0.393ms · ➡️ ⚪ established at 0.393ms (1 run) (2026-09-24 20:45:53) · <a href="../../../tests/benchmarks/competitive-workload-replica.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
> ⏳ Pending
<!-- LEDGER_TRUTH_END -->
