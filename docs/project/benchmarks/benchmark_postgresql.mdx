...
| -------------------------------- | ------- | -------------------------------------------- | ------ | ------ |
| **Competitive Workload Replica** | 0.478ms | ⚪ stable at 0.463ms (±0.013ms) (2 runs)     | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 2.550ms | 🔴 slower: 2.23ms → 2.55ms (+15%) (2 runs)   | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 2.265ms | 🔴 slower: 0.415ms → 2.27ms (+445%) (2 runs) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 9.396ms | 🔴 slower: 2.07ms → 9.40ms (+355%) (2 runs)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 0.608ms | ⚪ stable at 0.627ms (±0.109ms) (2 runs)     | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 3.334ms | 🔴 slower: 2.98ms → 3.33ms (+12%) (2 runs)   | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 0.686ms | ⚪ stable at 0.708ms (±0.079ms) (2 runs)     | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 3.114ms | 🟢 faster: 3.47ms → 3.11ms (-10%) (2 runs)   | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 0.569ms | 🔴 slower: 0.502ms → 0.569ms (+13%) (2 runs) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 2.456ms | ⚪ stable at 2.48ms (±0.081ms) (2 runs)      | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 0.500ms | 🔴 slower: 0.324ms → 0.500ms (+55%) (2 runs) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 2.189ms | 🔴 slower: 1.41ms → 2.19ms (+55%) (2 runs)   | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 3.807ms | 🔴 slower: 3.27ms → 3.81ms (+16%) (2 runs)   | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 5.396ms | ⚪ stable at 5.81ms (±0.737ms) (2 runs)      | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 3.862ms | 🔴 slower: 3.17ms → 3.86ms (+22%) (2 runs)   | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 6.459ms | 🔴 slower: 5.59ms → 6.46ms (+16%) (2 runs)   | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 0.674ms | ⚪ stable at 0.451ms (±0.167ms) (2 runs)     | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 3.200ms | 🔴 slower: 2.07ms → 3.20ms (+54%) (2 runs)   | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 2.740ms | 🔴 slower: 0.453ms → 2.74ms (+506%) (2 runs) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 7.343ms | 🔴 slower: 2.28ms → 7.34ms (+222%) (2 runs)  | < 5ms  | 🟢     |
...
quadrantChart
  ...
  quadrant-4 Critical — fix first
    Competitive Workload Replica: [0.27, 0.05]
    Competitive Workload Replica: [0.24, 0.88]
    Competitive Workload Replica: [0.95, 0.70]
    Competitive Workload Replica: [0.35, 0.05]
    Competitive Workload Replica: [0.33, 0.05]
    Competitive Workload Replica: [0.06, 0.05]
    Competitive Workload Replica: [0.05, 0.11]
    Competitive Workload Replica: [0.23, 0.11]
```
...
**Run ID:** `200e02e2-0e2c-4d20-85ea-3c5a4e3fdb9d` · **Tests invoked:** 1 · **Metrics:** 20 · **DB:** postgresql

| Test                         | Metric                              | Avg (ms) | p95 (ms) | RPS  | Trend | Detail                                       |
| ---------------------------- | ----------------------------------- | -------- | -------- | ---- | ----- | -------------------------------------------- |
| Competitive Workload Replica | findById (Warm Sequential)          | 0.478    | 0.576    | 2080 | 🟢    | ⚪ stable at 0.463ms (±0.013ms) (2 runs)     |
| Competitive Workload Replica | listFilterSort (Warm Sequential)    | 0.608    | 0.804    | 1636 | 🟢    | ⚪ stable at 0.627ms (±0.109ms) (2 runs)     |
| Competitive Workload Replica | listLarge (Warm Sequential)         | 0.686    | 0.918    | 1452 | 🟢    | ⚪ stable at 0.708ms (±0.079ms) (2 runs)     |
| Competitive Workload Replica | listPlain (Warm Concurrent 8c)      | 2.456    | 3.031    | 3202 | 🟢    | ⚪ stable at 2.48ms (±0.081ms) (2 runs)      |
| Competitive Workload Replica | create (Warm Concurrent 8c)         | 5.396    | 8.191    | 1465 | 🟢    | ⚪ stable at 5.81ms (±0.737ms) (2 runs)      |
| Competitive Workload Replica | graphql (Warm Sequential)           | 0.674    | 0.845    | 1478 | 🟢    | ⚪ stable at 0.451ms (±0.167ms) (2 runs)     |
| Competitive Workload Replica | findById (Warm Concurrent 8c)       | 2.550    | 3.529    | 3109 | ⚪    | 🔴 slower: 2.23ms → 2.55ms (+15%) (2 runs)   |
| Competitive Workload Replica | findByIdRandom (Warm Sequential)    | 2.265    | 3.468    | 441  | ⚪    | 🔴 slower: 0.415ms → 2.27ms (+445%) (2 runs) |
| Competitive Workload Replica | findByIdRandom (Warm Concurrent 8c) | 9.396    | 12.698   | 846  | ⚪    | 🔴 slower: 2.07ms → 9.40ms (+355%) (2 runs)  |
| Competitive Workload Replica | listFilterSort (Warm Concurrent 8c) | 3.334    | 5.595    | 2361 | ⚪    | 🔴 slower: 2.98ms → 3.33ms (+12%) (2 runs)   |
| Competitive Workload Replica | listLarge (Warm Concurrent 8c)      | 3.114    | 3.876    | 2522 | ⚪    | 🟢 faster: 3.47ms → 3.11ms (-10%) (2 runs)   |
| Competitive Workload Replica | listPlain (Warm Sequential)         | 0.569    | 0.708    | 1749 | ⚪    | 🔴 slower: 0.502ms → 0.569ms (+13%) (2 runs) |
| Competitive Workload Replica | findMissing (Warm Sequential)       | 0.500    | 0.599    | 1991 | ⚪    | 🔴 slower: 0.324ms → 0.500ms (+55%) (2 runs) |
| Competitive Workload Replica | findMissing (Warm Concurrent 8c)    | 2.189    | 2.579    | 3582 | ⚪    | 🔴 slower: 1.41ms → 2.19ms (+55%) (2 runs)   |
| Competitive Workload Replica | create (Warm Sequential)            | 3.807    | 5.048    | 262  | ⚪    | 🔴 slower: 3.27ms → 3.81ms (+16%) (2 runs)   |
| Competitive Workload Replica | update (Warm Sequential)            | 3.862    | 4.928    | 258  | ⚪    | 🔴 slower: 3.17ms → 3.86ms (+22%) (2 runs)   |
| Competitive Workload Replica | update (Warm Concurrent 8c)         | 6.459    | 9.241    | 1231 | ⚪    | 🔴 slower: 5.59ms → 6.46ms (+16%) (2 runs)   |
| Competitive Workload Replica | graphql (Warm Concurrent 8c)        | 3.200    | 3.982    | 2456 | ⚪    | 🔴 slower: 2.07ms → 3.20ms (+54%) (2 runs)   |
| Competitive Workload Replica | mixed (Warm Sequential)             | 2.740    | 5.648    | 364  | ⚪    | 🔴 slower: 0.453ms → 2.74ms (+506%) (2 runs) |
| Competitive Workload Replica | mixed (Warm Concurrent 8c)          | 7.343    | 17.624   | 1074 | ⚪    | 🔴 slower: 2.28ms → 7.34ms (+222%) (2 runs)  |
