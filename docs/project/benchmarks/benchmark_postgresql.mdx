...
| -------------------------------- | -------- | ------------------------------------------- | ------ | ------ |
| **Competitive Workload Replica** | 4.868ms  | 🔴 slower: 3.52ms → 4.87ms (+38%) (2 runs)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 10.207ms | ⚪ stable at 9.97ms (±2.49ms) (2 runs)      | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 4.062ms  | ⚪ stable at 4.56ms (±1.38ms) (2 runs)      | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 3.980ms  | ⚪ stable at 3.97ms (±2.02ms) (2 runs)      | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 5.129ms  | ⚪ stable at 4.35ms (±2.82ms) (2 runs)      | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 4.810ms  | ⚪ stable at 3.69ms (±2.58ms) (2 runs)      | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 7.642ms  | ⚪ stable at 7.12ms (±2.67ms) (2 runs)      | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 18.166ms | ⚪ stable at 16.47ms (±3.00ms) (2 runs)     | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 11.856ms | ⚪ stable at 13.56ms (±6.20ms) (2 runs)     | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 12.304ms | 🔴 slower: 9.55ms → 12.30ms (+29%) (2 runs) | < 5ms  | 🟢     |
...
quadrantChart
  ...
  quadrant-4 Critical — fix first
    Competitive Workload Replica: [0.27, 0.95]
    Competitive Workload Replica: [0.22, 0.29]
    Competitive Workload Replica: [0.28, 0.47]
    Competitive Workload Replica: [0.26, 0.79]
    Competitive Workload Replica: [0.95, 0.27]
    Competitive Workload Replica: [0.65, 0.33]
    Competitive Workload Replica: [0.68, 0.75]
```
...
**Run ID:** `5ee8b088-fa23-46ca-a70d-4392faa97dd3` · **Tests invoked:** 1 · **Metrics:** 10 · **DB:** postgresql

| Test                         | Metric                                   | Avg (ms) | p95 (ms) | RPS  | Trend | Detail                                      |
| ---------------------------- | ---------------------------------------- | -------- | -------- | ---- | ----- | ------------------------------------------- |
| Competitive Workload Replica | findByIdRandom (Concurrent 8c)           | 10.207   | 33.734   | 769  | 🟢    | ⚪ stable at 9.97ms (±2.49ms) (2 runs)      |
| Competitive Workload Replica | listPlain (Concurrent 8c)                | 4.062    | 8.247    | 1900 | 🟢    | ⚪ stable at 4.56ms (±1.38ms) (2 runs)      |
| Competitive Workload Replica | listFilterSort (Concurrent 8c)           | 3.980    | 5.785    | 1949 | 🟢    | ⚪ stable at 3.97ms (±2.02ms) (2 runs)      |
| Competitive Workload Replica | listLarge (Concurrent 8c)                | 5.129    | 6.754    | 1511 | 🟢    | ⚪ stable at 4.35ms (±2.82ms) (2 runs)      |
| Competitive Workload Replica | findMissing (Concurrent 8c)              | 4.810    | 7.115    | 1605 | 🟢    | ⚪ stable at 3.69ms (±2.58ms) (2 runs)      |
| Competitive Workload Replica | GraphQL Collection Query (Concurrent 8c) | 7.642    | 10.939   | 1021 | 🟢    | ⚪ stable at 7.12ms (±2.67ms) (2 runs)      |
| Competitive Workload Replica | create (Concurrent 8c)                   | 18.166   | 22.904   | 430  | 🟢    | ⚪ stable at 16.47ms (±3.00ms) (2 runs)     |
| Competitive Workload Replica | update (Concurrent 8c)                   | 11.856   | 15.773   | 659  | 🟢    | ⚪ stable at 13.56ms (±6.20ms) (2 runs)     |
| Competitive Workload Replica | findById (Concurrent 8c)                 | 4.868    | 9.053    | 1557 | ⚪    | 🔴 slower: 3.52ms → 4.87ms (+38%) (2 runs)  |
| Competitive Workload Replica | mixed (Concurrent 8c 50/50)              | 12.304   | 19.419   | 620  | ⚪    | 🔴 slower: 9.55ms → 12.30ms (+29%) (2 runs) |
...
| ----------------------------------- | ----- | ------------------ | -------- |
| COMPETITIVE WORKLOAD REPLICA (warm) | 🟢    | `▁▁▂▁█▅▅`          | 11.856ms |
