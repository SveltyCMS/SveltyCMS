...
**✅ PASS** · 34/45 tests · 11 skipped · **POSTGRESQL** · Bun 1.4.2
...
> **🔴 media-performance** (postgresql): +3907% | 50.01ms vs 1.25ms baseline
> **🔴 api-latency** (postgresql): +84% | 2.72ms vs 1.48ms baseline
...
```text
╔═════════════════════════════════════════════════════════════════════════════════════════╗
║                       COMPETITIVE 9-WORKLOAD REPLICA (POSTGRESQL)                       ║
║               File: tests/benchmarks/competitive-workload-replica.test.ts               ║
║                                Ran: 2026-08-26 17:17:14                                 ║
║Measures the exact 9 workloads tested in the external benchmark harness against the local server.║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ findById (Concurrent 8c)       │        2.485 ms │ p95:        3.238 ms │ RPS:      3,049 ║
║ findByIdRandom (Concurrent 8c) │        8.552 ms │ p95:       24.943 ms │ RPS:        913 ║
║ listPlain (Concurrent 8c)      │        2.607 ms │ p95:        5.279 ms │ RPS:      2,943 ║
║ listFilterSort (Concurrent 8c) │        2.932 ms │ p95:        3.816 ms │ RPS:      2,573 ║
║ listLarge (Concurrent 8c)      │        2.517 ms │ p95:        3.550 ms │ RPS:      3,041 ║
║ findMissing (Concurrent 8c)    │        2.532 ms │ p95:        6.246 ms │ RPS:      3,041 ║
║ GraphQL Collection Query (Concurrent 8c) │        5.014 ms │ p95:        7.447 ms │ RPS:      1,561 ║
║ create (Concurrent 8c)         │        8.319 ms │ p95:       11.209 ms │ RPS:        921 ║
║ update (Concurrent 8c)         │        9.056 ms │ p95:       13.321 ms │ RPS:        859 ║
║ mixed (Concurrent 8c 50/50)    │        7.491 ms │ p95:       10.122 ms │ RPS:      1,007 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
<!-- LEDGER_TRUTH_END -->
