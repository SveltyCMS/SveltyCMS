...
| -------------------------------- | ------- | --------------------------------------- | ------ | ------ |
| **Competitive Workload Replica** | 2.485ms | ⚪ stable at 3.09ms (±1.21ms) (6 runs)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 8.552ms | ⚪ stable at 8.70ms (±1.97ms) (6 runs)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 2.607ms | ⚪ stable at 3.63ms (±1.32ms) (6 runs)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 2.932ms | ⚪ stable at 2.96ms (±1.28ms) (6 runs)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 2.517ms | ⚪ stable at 2.92ms (±2.58ms) (6 runs)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 2.532ms | ⚪ stable at 2.46ms (±2.62ms) (6 runs)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 5.014ms | ⚪ stable at 5.79ms (±2.76ms) (5 runs)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 8.319ms | ⚪ stable at 14.97ms (±9.50ms) (5 runs) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 9.056ms | ⚪ stable at 10.46ms (±3.00ms) (5 runs) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 7.491ms | ⚪ stable at 8.72ms (±2.72ms) (5 runs)  | < 5ms  | 🟢     |
...
quadrantChart
  ...
  quadrant-4 Critical — fix first
    Competitive Workload Replica: [0.27, 0.44]
    Competitive Workload Replica: [0.29, 0.63]
    Competitive Workload Replica: [0.28, 0.31]
    Competitive Workload Replica: [0.55, 0.30]
    Competitive Workload Replica: [0.92, 0.95]
    Competitive Workload Replica: [0.95, 0.30]
    Competitive Workload Replica: [0.83, 0.32]
```
...
**Run ID:** `361649c3-f93b-4e92-8ee3-44dd47511926` · **Tests invoked:** 1 · **Metrics:** 10 · **DB:** postgresql

| Test                         | Metric                                   | Avg (ms) | p95 (ms) | RPS  | Trend | Detail                                  |
| ---------------------------- | ---------------------------------------- | -------- | -------- | ---- | ----- | --------------------------------------- |
| Competitive Workload Replica | findById (Concurrent 8c)                 | 2.485    | 3.238    | 3049 | 🟢    | ⚪ stable at 3.09ms (±1.21ms) (6 runs)  |
| Competitive Workload Replica | findByIdRandom (Concurrent 8c)           | 8.552    | 24.943   | 913  | 🟢    | ⚪ stable at 8.70ms (±1.97ms) (6 runs)  |
| Competitive Workload Replica | listPlain (Concurrent 8c)                | 2.607    | 5.279    | 2943 | 🟢    | ⚪ stable at 3.63ms (±1.32ms) (6 runs)  |
| Competitive Workload Replica | listFilterSort (Concurrent 8c)           | 2.932    | 3.816    | 2573 | 🟢    | ⚪ stable at 2.96ms (±1.28ms) (6 runs)  |
| Competitive Workload Replica | listLarge (Concurrent 8c)                | 2.517    | 3.550    | 3041 | 🟢    | ⚪ stable at 2.92ms (±2.58ms) (6 runs)  |
| Competitive Workload Replica | findMissing (Concurrent 8c)              | 2.532    | 6.246    | 3041 | 🟢    | ⚪ stable at 2.46ms (±2.62ms) (6 runs)  |
| Competitive Workload Replica | GraphQL Collection Query (Concurrent 8c) | 5.014    | 7.447    | 1561 | 🟢    | ⚪ stable at 5.79ms (±2.76ms) (5 runs)  |
| Competitive Workload Replica | create (Concurrent 8c)                   | 8.319    | 11.209   | 921  | 🟢    | ⚪ stable at 14.97ms (±9.50ms) (5 runs) |
| Competitive Workload Replica | update (Concurrent 8c)                   | 9.056    | 13.321   | 859  | 🟢    | ⚪ stable at 10.46ms (±3.00ms) (5 runs) |
| Competitive Workload Replica | mixed (Concurrent 8c 50/50)              | 7.491    | 10.122   | 1007 | 🟢    | ⚪ stable at 8.72ms (±2.72ms) (5 runs)  |
...
| ----------------------------------- | ----- | ------------------ | ------- |
| COMPETITIVE WORKLOAD REPLICA (warm) | 🟢    | `▇▁▁▁▁▆█`          | 9.056ms |
