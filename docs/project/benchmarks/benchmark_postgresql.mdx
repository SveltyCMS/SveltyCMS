...
| -------------------------------- | -------- | --------------------------------------------- | ------ | ------ |
| **Competitive Workload Replica** | 0.431ms  | 🔴 slower: 0.191ms → 0.431ms (+126%) (7 runs) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 0.796ms  | ⚪ stable at 0.703ms (±0.265ms) (7 runs)      | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 0.597ms  | ⚪ stable at 0.727ms (±0.543ms) (7 runs)      | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.108ms  | ⚪ stable at 1.58ms (±0.698ms) (7 runs)       | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 0.574ms  | 🔴 slower: 0.303ms → 0.574ms (+89%) (7 runs)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 3.648ms  | 🔴 slower: 1.39ms → 3.65ms (+163%) (7 runs)   | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 2.309ms  | 🔴 slower: 0.813ms → 2.31ms (+184%) (7 runs)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 7.274ms  | 🔴 slower: 3.76ms → 7.27ms (+93%) (7 runs)    | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 0.531ms  | 🔴 slower: 0.264ms → 0.531ms (+101%) (7 runs) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.311ms  | ⚪ stable at 1.23ms (±0.640ms) (7 runs)       | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 0.459ms  | 🔴 slower: 0.222ms → 0.459ms (+107%) (7 runs) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.046ms  | ⚪ stable at 0.618ms (±0.545ms) (7 runs)      | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 10.064ms | 🔴 slower: 3.35ms → 10.06ms (+201%) (7 runs)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 14.287ms | 🔴 slower: 6.40ms → 14.29ms (+123%) (7 runs)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 8.791ms  | 🔴 slower: 3.12ms → 8.79ms (+182%) (7 runs)   | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 12.534ms | 🔴 slower: 5.08ms → 12.53ms (+147%) (7 runs)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 3.901ms  | 🔴 slower: 1.11ms → 3.90ms (+252%) (7 runs)   | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 5.920ms  | 🔴 slower: 3.07ms → 5.92ms (+93%) (7 runs)    | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 4.005ms  | 🔴 slower: 1.29ms → 4.00ms (+210%) (7 runs)   | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 6.372ms  | ⚪ stable at 3.55ms (±2.10ms) (7 runs)        | < 5ms  | 🟢     |
| **Ingestion**                    | 3.383ms  | ⚪ established at 3.38ms (1 run)              | < 5ms  | 🟢     |
...
| database performance (BULK INSERT (100)) (warm) | 🟢    | `▁`       | 5.493ms |
...
quadrantChart
  ...
  quadrant-4 Critical — fix first
    Competitive Workload Replica: [0.05, 0.50]
    Competitive Workload Replica: [0.06, 0.05]
    Competitive Workload Replica: [0.05, 0.07]
    Competitive Workload Replica: [0.08, 0.12]
    Competitive Workload Replica: [0.05, 0.35]
    Competitive Workload Replica: [0.26, 0.65]
    Competitive Workload Replica: [0.16, 0.73]
    Competitive Workload Replica: [0.51, 0.37]
```
...
**Run ID:** `01a0dd42-56e9-7297-839e-4ec998388b2b` · **Tests invoked:** 1 · **Metrics:** 21 · **DB:** postgresql

| Test                         | Metric                              | Avg (ms) | p95 (ms) | RPS  | Trend | Detail                                      |
| ---------------------------- | ----------------------------------- | -------- | -------- | ---- | ----- | ------------------------------------------- |
| Competitive Workload Replica | findById (Warm Sequential)          | 0.431    | 0.767    | 2303 | 🟢    | ⚪ stable at 0.228ms (±0.270ms) (3 runs)    |
| Competitive Workload Replica | findById (Warm Concurrent 8c)       | 0.796    | 1.446    | 9929 | 🟢    | ⚪ stable at 0.811ms (±0.418ms) (3 runs)    |
| Competitive Workload Replica | findByIdRandom (Warm Sequential)    | 0.597    | 0.855    | 1666 | 🟢    | ⚪ stable at 0.727ms (±0.633ms) (3 runs)    |
| Competitive Workload Replica | findByIdRandom (Warm Concurrent 8c) | 1.108    | 1.818    | 7143 | 🟢    | ⚪ stable at 1.58ms (±0.698ms) (3 runs)     |
| Competitive Workload Replica | listFilterSort (Warm Sequential)    | 0.574    | 0.826    | 1735 | 🟢    | ⚪ stable at 0.303ms (±0.357ms) (3 runs)    |
| Competitive Workload Replica | listLarge (Warm Sequential)         | 2.309    | 12.844   | 432  | 🟢    | ⚪ stable at 0.986ms (±1.06ms) (3 runs)     |
| Competitive Workload Replica | listPlain (Warm Sequential)         | 0.531    | 0.775    | 1873 | 🟢    | ⚪ stable at 0.253ms (±0.446ms) (3 runs)    |
| Competitive Workload Replica | listPlain (Warm Concurrent 8c)      | 1.311    | 2.507    | 5933 | 🟢    | ⚪ stable at 1.42ms (±0.438ms) (3 runs)     |
| Competitive Workload Replica | findMissing (Warm Sequential)       | 0.459    | 0.692    | 2167 | 🟢    | ⚪ stable at 0.272ms (±0.410ms) (3 runs)    |
| Competitive Workload Replica | findMissing (Warm Concurrent 8c)    | 1.046    | 2.201    | 7516 | 🟢    | ⚪ stable at 0.799ms (±0.446ms) (3 runs)    |
| Competitive Workload Replica | create (Warm Sequential)            | 10.064   | 14.654   | 99   | 🟢    | ⚪ stable at 4.32ms (±5.50ms) (3 runs)      |
| Competitive Workload Replica | create (Warm Concurrent 8c)         | 14.287   | 16.947   | 296  | 🟢    | ⚪ stable at 6.45ms (±6.92ms) (3 runs)      |
| Competitive Workload Replica | update (Warm Sequential)            | 8.791    | 12.479   | 114  | 🟢    | ⚪ stable at 3.16ms (±4.91ms) (3 runs)      |
| Competitive Workload Replica | update (Warm Concurrent 8c)         | 12.534   | 17.884   | 633  | 🟢    | ⚪ stable at 5.08ms (±7.87ms) (3 runs)      |
| Competitive Workload Replica | graphql (Warm Sequential)           | 3.901    | 4.837    | 256  | 🟢    | ⚪ stable at 1.11ms (±2.91ms) (3 runs)      |
| Competitive Workload Replica | graphql (Warm Concurrent 8c)        | 5.920    | 7.834    | 1332 | 🟢    | ⚪ stable at 3.70ms (±4.28ms) (3 runs)      |
| Competitive Workload Replica | mixed (Warm Concurrent 8c)          | 6.372    | 13.919   | 1202 | 🟢    | ⚪ stable at 4.38ms (±1.46ms) (3 runs)      |
| Competitive Workload Replica | Seed Burst (50 docs, HTTP)          | 3.383    | 3.383    | 296  | 🟢    | ⚪ established at 3.38ms (1 run)            |
| Competitive Workload Replica | listFilterSort (Warm Concurrent 8c) | 3.648    | 15.332   | 2155 | ⚪    | 🔴 slower: 1.39ms → 3.65ms (+163%) (3 runs) |
| Competitive Workload Replica | listLarge (Warm Concurrent 8c)      | 7.274    | 14.750   | 1082 | ⚪    | 🔴 slower: 3.83ms → 7.27ms (+90%) (3 runs)  |
| Competitive Workload Replica | mixed (Warm Sequential)             | 4.005    | 10.328   | 249  | ⚪    | 🔴 slower: 1.44ms → 4.00ms (+179%) (3 runs) |
...
<summary><strong>🏷️ database performance</strong> · 🟢 5.886ms · ➡️ ⚪ established at 5.89ms (1 run) (2026-09-25 16:15:00) · <a href="../../../tests/benchmarks/database-performance.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
```text
╔═══════════════════════════════════════════════════════════════════════════════════════════════════════╗
║                         SVELTYCMS — DATABASE ADAPTER PERFORMANCE (POSTGRESQL)                         ║
║                          File: tests/benchmarks/database-performance.test.ts                          ║
║                                       Ran: 2026-09-25 16:15:00                                        ║
║          Measures raw CRUD performance, indexing efficiency, and connection pool resilience.          ║
╠═══════════════════════════════════════════════════════════════════════════════════════════════════════╣
║ INSERT                       │ Cold:     4.01 ms │ Warm:     2.050 ms │ p95:     3.212 ms │     463 RPS ║
║ FIND ONE                     │ Cold:     2.65 ms │ Warm:     0.467 ms │ p95:     0.865 ms │   1,946 RPS ║
║ FIND MANY (limit 50)         │ Cold:     6.49 ms │ Warm:     1.410 ms │ p95:     2.428 ms │     665 RPS ║
║ FILTER (blob field, 1 match) │ Cold:    23.31 ms │ Warm:     1.876 ms │ p95:     2.658 ms │     515 RPS ║
║ QUERY BUILDER LIST (50)      │ Cold:     8.37 ms │ Warm:     5.547 ms │ p95:     6.997 ms │     176 RPS ║
║ FIND PAGE (50 hasMore)       │ Cold:     3.93 ms │ Warm:     1.330 ms │ p95:     2.162 ms │     676 RPS ║
║ FIND PAGE keyset             │ Cold:    40.56 ms │ Warm:     1.079 ms │ p95:     1.641 ms │     852 RPS ║
║ FIND MANY offset 50          │ Cold:     4.30 ms │ Warm:     1.126 ms │ p95:     1.852 ms │     821 RPS ║
║ LIST+COUNT (legacy)          │ Cold:     4.82 ms │ Warm:     1.937 ms │ p95:     2.869 ms │     485 RPS ║
║ UPDATE                       │ Cold:     6.67 ms │ Warm:     1.997 ms │ p95:     3.331 ms │     464 RPS ║
║ UPDATE (no-returning)        │ Cold:     5.23 ms │ Warm:     1.781 ms │ p95:     2.242 ms │     552 RPS ║
║ NATIVE UPSERT                │ Cold:     5.63 ms │ Warm:     2.263 ms │ p95:     3.151 ms │     424 RPS ║
║ COUNT                        │ Cold:     4.02 ms │ Warm:     2.140 ms │ p95:     3.585 ms │     441 RPS ║
║ COUNT ESTIMATE               │ Cold:     2.44 ms │ Warm:     0.676 ms │ p95:     1.057 ms │   1,403 RPS ║
║ COUNT CACHED                 │ Cold:     6.11 ms │ Warm:     0.001 ms │ p95:     0.003 ms │ 499,276 RPS ║
║ DELETE (Active Rows)         │ Cold:    32.06 ms │ Warm:     2.149 ms │ p95:     2.947 ms │     442 RPS ║
║ BULK INSERT (100)            │ Cold:     7.38 ms │ Warm:     5.493 ms │ p95:     7.032 ms │     175 RPS ║
║ BULK UPDATE (100 heterogeneous) │ Cold:    20.32 ms │ Warm:     6.315 ms │ p95:     7.978 ms │     155 RPS ║
║ BULK UPDATE (100 homogeneous) │ Cold:    14.87 ms │ Warm:     5.886 ms │ p95:     8.925 ms │     154 RPS ║
╚═══════════════════════════════════════════════════════════════════════════════════════════════════════╝
```
<!-- LEDGER_TRUTH_END -->
...
<summary><strong>🏷️ competitive workload replica</strong> · 🟢 6.372ms · ↗️ ⚪ stable at 4.38ms (±1.46ms) (3 runs) (2026-09-26 10:28:50) · <a href="../../../tests/benchmarks/competitive-workload-replica.test.ts">source</a></summary>
<!-- LEDGER_INSIGHT_START -->
> [!NOTE]
> **Specific to this test**: Both avg and p95 degraded — likely adapter or infrastructure bottleneck. Check DB connection pool, indexes, or recent commits.  
...
║                                       Ran: 2026-09-26 10:28:51                                        ║
║              Seq + concurrent (8 workers), harness iteration counts, median of N rounds.              ║
╠═══════════════════════════════════════════════════════════════════════════════════════════════════════╣
║ Seed Burst (50 docs, HTTP)     │        3.383 ms │ p95:        3.383 ms │ RPS:        296 ║
╚═══════════════════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ Ingestion</strong> · 🟢 3.383ms · ➡️ ⚪ established at 3.38ms (1 run) (2026-09-26 10:28:51) · <a href="../../../tests/benchmarks/competitive-workload-replica.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
> ⏳ Pending
<!-- LEDGER_TRUTH_END -->
