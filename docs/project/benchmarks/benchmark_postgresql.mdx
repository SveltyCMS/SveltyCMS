...
**✅ PASS** _(partial invocation)_ · 1/42 tests · 41 skipped · **postgresql** · standalone run
...
| ------------------------ | ------- | ----------------------------------------- | ------ | ------ |
| **Database Performance** | 2.323ms | 🔴 slower: 2.24ms → 2.32ms (+4%) (2 runs) | < 5ms  | 🟢     |
| **Database Performance** | 0.886ms | ⚪ stable at 0.854ms (±0.002ms) (2 runs)  | < 5ms  | 🟢     |
| **Database Performance** | 0.952ms | ⚪ stable at 0.946ms (±0.044ms) (2 runs)  | < 5ms  | 🟢     |
| **Database Performance** | 1.008ms | ⚪ established at 1.01ms (1 run)          | < 5ms  | 🟢     |
| **Database Performance** | 0.996ms | ⚪ established at 0.996ms (1 run)         | < 5ms  | 🟢     |
| **Database Performance** | 0.904ms | ⚪ established at 0.904ms (1 run)         | < 5ms  | 🟢     |
| **Database Performance** | 2.233ms | ⚪ established at 2.23ms (1 run)          | < 5ms  | 🟢     |
| **Database Performance** | 2.293ms | ⚪ stable at 2.19ms (±0.075ms) (2 runs)   | < 5ms  | 🟢     |
| **Database Performance** | 2.094ms | ⚪ stable at 2.07ms (±0.046ms) (2 runs)   | < 5ms  | 🟢     |
| **Database Performance** | 2.197ms | ⚪ stable at 1.56ms (±1.19ms) (2 runs)    | < 5ms  | 🟢     |
| **Database Performance** | 0.745ms | ⚪ established at 0.745ms (1 run)         | < 5ms  | 🟢     |
| **Database Performance** | 0.024ms | ⚪ established at 0.024ms (1 run)         | < 5ms  | 🟢     |
| **Database Performance** | 2.070ms | ⚪ stable at 2.08ms (±0.030ms) (2 runs)   | < 5ms  | 🟢     |
| **Database Performance** | 7.256ms | ⚪ stable at 7.33ms (±0.082ms) (2 runs)   | < 5ms  | 🟢     |
...
| ----------------------------------------------- | ----- | --------- | ------- |
| database performance (BULK INSERT (100)) (warm) | 🟢    | `█▃▁`     | 7.256ms |
...
**Run ID:** `c41de3d0-0bec-4620-90a2-6f22a9aaedca` · **Tests invoked:** 1 · **Metrics:** 14 · **DB:** postgresql

| Test                 | Metric                 | Avg (ms) | p95 (ms) | RPS   | Trend | Detail                                    |
| -------------------- | ---------------------- | -------- | -------- | ----- | ----- | ----------------------------------------- |
| Database Performance | FIND MANY (limit 50)   | 0.952    | 1.123    | 923   | 🟢    | ⚪ stable at 0.946ms (±0.044ms) (2 runs)  |
| Database Performance | FIND PAGE (50 hasMore) | 1.008    | 1.168    | 885   | 🟢    | ⚪ established at 1.01ms (1 run)          |
| Database Performance | FIND PAGE keyset       | 0.996    | 1.146    | 893   | 🟢    | ⚪ established at 0.996ms (1 run)         |
| Database Performance | FIND MANY offset 50    | 0.904    | 1.061    | 976   | 🟢    | ⚪ established at 0.904ms (1 run)         |
| Database Performance | LIST+COUNT (legacy)    | 2.233    | 2.709    | 420   | 🟢    | ⚪ established at 2.23ms (1 run)          |
| Database Performance | UPDATE                 | 2.293    | 2.827    | 390   | 🟢    | ⚪ stable at 2.19ms (±0.075ms) (2 runs)   |
| Database Performance | NATIVE UPSERT          | 2.094    | 2.500    | 421   | 🟢    | ⚪ stable at 2.07ms (±0.046ms) (2 runs)   |
| Database Performance | COUNT                  | 2.197    | 2.655    | 405   | 🟢    | ⚪ stable at 1.56ms (±1.19ms) (2 runs)    |
| Database Performance | COUNT ESTIMATE         | 0.745    | 0.867    | 1181  | 🟢    | ⚪ established at 0.745ms (1 run)         |
| Database Performance | COUNT CACHED           | 0.024    | 0.026    | 40749 | 🟢    | ⚪ established at 0.024ms (1 run)         |
| Database Performance | DELETE                 | 2.070    | 2.495    | 477   | 🟢    | ⚪ stable at 2.08ms (±0.030ms) (2 runs)   |
| Database Performance | BULK INSERT (100)      | 7.256    | 9.221    | 137   | 🟢    | ⚪ stable at 7.33ms (±0.082ms) (2 runs)   |
| Database Performance | INSERT                 | 2.323    | 3.075    | 382   | ⚪    | 🔴 slower: 2.24ms → 2.32ms (+4%) (2 runs) |
| Database Performance | FIND ONE               | 0.886    | 1.055    | 982   | ⚪    | ⚪ stable at 0.854ms (±0.002ms) (2 runs)  |
...
| --------------------------- | ----- | ------------------ | ------- |
| DATABASE PERFORMANCE (warm) | 🟢    | `▁▂▂██▇█`          | 2.293ms |
...
<summary><strong>🏷️ database performance</strong> · 🟢 7.256ms · ➡️ ⚪ stable at 7.33ms (±0.082ms) (2 runs) (2026-08-04 12:02:11) · <a href="../../../tests/benchmarks/database-performance.test.ts">source</a></summary>
<!-- LEDGER_TRUTH_START -->
```text
╔═════════════════════════════════════════════════════════════════════════════════════════╗
║                  SVELTYCMS — DATABASE ADAPTER PERFORMANCE (POSTGRESQL)                  ║
║                   File: tests/benchmarks/database-performance.test.ts                   ║
║                                Ran: 2026-08-04 12:02:11                                 ║
║   Measures raw CRUD performance, indexing efficiency, and connection pool resilience    ║
╠═════════════════════════════════════════════════════════════════════════════════════════╣
║ INSERT                         │        2.323 ms │ p95:        3.075 ms │ RPS:        382 ║
║ FIND ONE                       │        0.886 ms │ p95:        1.055 ms │ RPS:        982 ║
║ FIND MANY (limit 50)           │        0.952 ms │ p95:        1.123 ms │ RPS:        923 ║
║ FIND PAGE (50 hasMore)         │        1.008 ms │ p95:        1.168 ms │ RPS:        885 ║
║ FIND PAGE keyset               │        0.996 ms │ p95:        1.146 ms │ RPS:        893 ║
║ FIND MANY offset 50            │        0.904 ms │ p95:        1.061 ms │ RPS:        976 ║
║ LIST+COUNT (legacy)            │        2.233 ms │ p95:        2.709 ms │ RPS:        420 ║
║ UPDATE                         │        2.293 ms │ p95:        2.827 ms │ RPS:        390 ║
║ NATIVE UPSERT                  │        2.094 ms │ p95:        2.500 ms │ RPS:        421 ║
║ COUNT                          │        2.197 ms │ p95:        2.655 ms │ RPS:        405 ║
║ COUNT ESTIMATE                 │        0.745 ms │ p95:        0.867 ms │ RPS:      1,181 ║
║ COUNT CACHED                   │        0.024 ms │ p95:        0.026 ms │ RPS:     40,749 ║
║ DELETE                         │        2.070 ms │ p95:        2.495 ms │ RPS:        477 ║
║ BULK INSERT (100)              │        7.256 ms │ p95:        9.221 ms │ RPS:        137 ║
╚═════════════════════════════════════════════════════════════════════════════════════════╝
```
<!-- LEDGER_TRUTH_END -->
