...
| -------------------------------- | ------- | -------------------------------------------- | ------ | ------ |
| **Competitive Workload Replica** | 0.191ms | ⚪ stable at 0.176ms (±0.040ms) (7 runs)     | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 0.627ms | ⚪ stable at 0.614ms (±0.230ms) (7 runs)     | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 0.803ms | ⚪ stable at 0.727ms (±0.931ms) (7 runs)     | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.821ms | ⚪ stable at 1.34ms (±1.47ms) (7 runs)       | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 0.378ms | 🔴 slower: 0.293ms → 0.378ms (+29%) (7 runs) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.628ms | ⚪ stable at 1.35ms (±0.563ms) (7 runs)      | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 0.567ms | ⚪ stable at 0.716ms (±0.333ms) (7 runs)     | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 3.714ms | ⚪ stable at 3.61ms (±1.11ms) (7 runs)       | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 0.349ms | ⚪ stable at 0.235ms (±0.077ms) (7 runs)     | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 0.779ms | ⚪ stable at 1.07ms (±0.772ms) (7 runs)      | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 0.231ms | ⚪ stable at 0.186ms (±0.102ms) (7 runs)     | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 0.457ms | ⚪ stable at 0.556ms (±0.383ms) (7 runs)     | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 2.808ms | ⚪ stable at 2.86ms (±1.49ms) (7 runs)       | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 4.752ms | ⚪ stable at 4.64ms (±1.97ms) (7 runs)       | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 2.567ms | ⚪ stable at 3.12ms (±0.439ms) (7 runs)      | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 4.539ms | ⚪ stable at 4.99ms (±2.00ms) (7 runs)       | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 0.606ms | 🟢 faster: 1.07ms → 0.606ms (-44%) (7 runs)  | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 2.840ms | ⚪ stable at 2.88ms (±1.39ms) (7 runs)       | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.444ms | ⚪ stable at 1.29ms (±0.249ms) (7 runs)      | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 2.966ms | ⚪ stable at 3.26ms (±1.93ms) (7 runs)       | < 5ms  | 🟢     |
| **Ingestion**                    | 0.045ms | ⚪ stable at 0.043ms (±0.009ms) (7 runs)     | < 5ms  | 🟢     |
...
quadrantChart
  ...
  quadrant-4 Critical — fix first
    Competitive Workload Replica: [0.05, 0.18]
    Competitive Workload Replica: [0.18, 0.22]
    Competitive Workload Replica: [0.40, 0.73]
    Competitive Workload Replica: [0.08, 0.60]
    Competitive Workload Replica: [0.36, 0.42]
    Competitive Workload Replica: [0.12, 0.43]
    Competitive Workload Replica: [0.08, 0.95]
    Competitive Workload Replica: [0.17, 0.56]
```
...
**Run ID:** `01a0da13-c89f-7375-b172-5e3c904957b4` · **Tests invoked:** 1 · **Metrics:** 21 · **DB:** postgresql

| Test                         | Metric                              | Avg (ms) | p95 (ms) | RPS   | Trend | Detail                                       |
| ---------------------------- | ----------------------------------- | -------- | -------- | ----- | ----- | -------------------------------------------- |
| Competitive Workload Replica | findById (Warm Sequential)          | 0.191    | 0.245    | 5182  | 🟢    | ⚪ stable at 0.169ms (±0.027ms) (7 runs)     |
| Competitive Workload Replica | findById (Warm Concurrent 8c)       | 0.627    | 0.826    | 12641 | 🟢    | ⚪ stable at 0.614ms (±0.298ms) (7 runs)     |
| Competitive Workload Replica | findByIdRandom (Warm Sequential)    | 0.803    | 0.932    | 1243  | 🟢    | ⚪ stable at 0.861ms (±0.820ms) (7 runs)     |
| Competitive Workload Replica | findByIdRandom (Warm Concurrent 8c) | 1.821    | 2.516    | 4369  | 🟢    | ⚪ stable at 1.77ms (±1.85ms) (7 runs)       |
| Competitive Workload Replica | listFilterSort (Warm Sequential)    | 0.378    | 0.499    | 2635  | 🟢    | ⚪ stable at 0.294ms (±0.112ms) (7 runs)     |
| Competitive Workload Replica | listFilterSort (Warm Concurrent 8c) | 1.628    | 2.275    | 4836  | 🟢    | ⚪ stable at 1.20ms (±0.297ms) (7 runs)      |
| Competitive Workload Replica | listLarge (Warm Sequential)         | 0.567    | 0.846    | 1758  | 🟢    | ⚪ stable at 0.628ms (±0.187ms) (7 runs)     |
| Competitive Workload Replica | listLarge (Warm Concurrent 8c)      | 3.714    | 11.285   | 2128  | 🟢    | ⚪ stable at 2.75ms (±1.08ms) (7 runs)       |
| Competitive Workload Replica | listPlain (Warm Concurrent 8c)      | 0.779    | 0.975    | 10065 | 🟢    | ⚪ stable at 1.06ms (±0.427ms) (7 runs)      |
| Competitive Workload Replica | findMissing (Warm Sequential)       | 0.231    | 0.329    | 4304  | 🟢    | ⚪ stable at 0.186ms (±0.102ms) (7 runs)     |
| Competitive Workload Replica | findMissing (Warm Concurrent 8c)    | 0.457    | 0.569    | 17152 | 🟢    | ⚪ stable at 0.473ms (±0.415ms) (7 runs)     |
| Competitive Workload Replica | create (Warm Sequential)            | 2.808    | 3.822    | 356   | 🟢    | ⚪ stable at 3.04ms (±0.609ms) (7 runs)      |
| Competitive Workload Replica | create (Warm Concurrent 8c)         | 4.752    | 6.894    | 1671  | 🟢    | ⚪ stable at 5.02ms (±1.93ms) (7 runs)       |
| Competitive Workload Replica | update (Warm Sequential)            | 2.567    | 3.011    | 389   | 🟢    | ⚪ stable at 3.15ms (±0.538ms) (7 runs)      |
| Competitive Workload Replica | update (Warm Concurrent 8c)         | 4.539    | 7.241    | 1746  | 🟢    | ⚪ stable at 6.12ms (±1.98ms) (7 runs)       |
| Competitive Workload Replica | graphql (Warm Sequential)           | 0.606    | 0.916    | 1646  | 🟢    | ⚪ stable at 1.07ms (±0.381ms) (7 runs)      |
| Competitive Workload Replica | graphql (Warm Concurrent 8c)        | 2.840    | 3.448    | 2765  | 🟢    | ⚪ stable at 2.40ms (±0.607ms) (7 runs)      |
| Competitive Workload Replica | mixed (Warm Sequential)             | 1.444    | 3.950    | 692   | 🟢    | ⚪ stable at 1.29ms (±0.321ms) (7 runs)      |
| Competitive Workload Replica | mixed (Warm Concurrent 8c)          | 2.966    | 6.235    | 2605  | 🟢    | ⚪ stable at 2.68ms (±0.985ms) (7 runs)      |
| Competitive Workload Replica | Seed Burst (10000 docs, HTTP)       | 0.045    | 0.045    | 22179 | 🟢    | ⚪ stable at 0.043ms (±0.009ms) (7 runs)     |
| Competitive Workload Replica | listPlain (Warm Sequential)         | 0.349    | 0.647    | 2856  | ⚪    | 🔴 slower: 0.214ms → 0.349ms (+63%) (7 runs) |
...
<summary><strong>🏷️ competitive workload replica</strong> · 🟢 2.966ms · ↘️ ⚪ stable at 3.19ms (±1.65ms) (7 runs) (2026-09-25 19:39:24) · <a href="../../../tests/benchmarks/competitive-workload-replica.test.ts">source</a></summary>
<!-- LEDGER_INSIGHT_START -->
> [!NOTE]
> **Specific to this test**: Performance improved — recent optimizations or cache warming likely effective.
<!-- LEDGER_INSIGHT_END -->
...
║                                       Ran: 2026-09-25 19:39:24                                        ║
║              Seq + concurrent (8 workers), harness iteration counts, median of N rounds.              ║
╠═══════════════════════════════════════════════════════════════════════════════════════════════════════╣
║ Seed Burst (10000 docs, HTTP)  │        0.045 ms │ p95:        0.045 ms │ RPS:     22,179 ║
╚═══════════════════════════════════════════════════════════════════════════════════════════════════════╝
```
...
<summary><strong>🏷️ Ingestion</strong> · 🟢 0.045ms · ↗️ ⚪ stable at 0.043ms (±0.017ms) (7 runs) (2026-09-25 19:39:24) · <a href="../../../tests/benchmarks/competitive-workload-replica.test.ts">source</a></summary>
<!-- LEDGER_INSIGHT_START -->
> [!NOTE]
