...
| -------------------------------- | -------- | ------------------------------------------ | ------ | ------ |
| **Competitive Workload Replica** | 2.215ms  | ⚪ stable at 2.52ms (±0.378ms) (7 runs)    | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 6.879ms  | ⚪ stable at 8.55ms (±1.59ms) (7 runs)     | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 2.138ms  | ⚪ stable at 2.61ms (±0.329ms) (7 runs)    | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 2.386ms  | 🟢 faster: 2.78ms → 2.39ms (-14%) (7 runs) | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 2.886ms  | ⚪ stable at 2.89ms (±0.556ms) (7 runs)    | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 1.821ms  | ⚪ stable at 2.03ms (±0.624ms) (7 runs)    | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 4.451ms  | ⚪ stable at 4.88ms (±0.380ms) (7 runs)    | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 10.637ms | ⚪ stable at 8.46ms (±2.19ms) (7 runs)     | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 8.746ms  | ⚪ stable at 8.86ms (±0.783ms) (7 runs)    | < 5ms  | 🟢     |
| **Competitive Workload Replica** | 6.969ms  | ⚪ stable at 8.22ms (±2.26ms) (7 runs)     | < 5ms  | 🟢     |
...
quadrantChart
  ...
  quadrant-4 Critical — fix first
    Competitive Workload Replica: [0.21, 0.47]
    Competitive Workload Replica: [0.65, 0.76]
    Competitive Workload Replica: [0.20, 0.70]
    Competitive Workload Replica: [0.22, 0.56]
    Competitive Workload Replica: [0.17, 0.40]
    Competitive Workload Replica: [0.42, 0.35]
    Competitive Workload Replica: [0.95, 0.95]
    Competitive Workload Replica: [0.66, 0.59]
```
...
**Run ID:** `13c9e2c1-1b49-4b29-be6e-f637de1c886a` · **Tests invoked:** 1 · **Metrics:** 10 · **DB:** postgresql

| Test                         | Metric                                   | Avg (ms) | p95 (ms) | RPS  | Trend | Detail                                     |
| ---------------------------- | ---------------------------------------- | -------- | -------- | ---- | ----- | ------------------------------------------ |
| Competitive Workload Replica | findById (Concurrent 8c)                 | 2.215    | 2.860    | 3418 | 🟢    | ⚪ stable at 2.52ms (±0.378ms) (7 runs)    |
| Competitive Workload Replica | findByIdRandom (Concurrent 8c)           | 6.879    | 10.918   | 1109 | 🟢    | ⚪ stable at 8.55ms (±1.59ms) (7 runs)     |
| Competitive Workload Replica | listPlain (Concurrent 8c)                | 2.138    | 3.131    | 3462 | 🟢    | ⚪ stable at 2.61ms (±0.329ms) (7 runs)    |
| Competitive Workload Replica | listLarge (Concurrent 8c)                | 2.886    | 6.368    | 2662 | 🟢    | ⚪ stable at 2.89ms (±0.556ms) (7 runs)    |
| Competitive Workload Replica | findMissing (Concurrent 8c)              | 1.821    | 2.092    | 4201 | 🟢    | ⚪ stable at 2.03ms (±0.624ms) (7 runs)    |
| Competitive Workload Replica | GraphQL Collection Query (Concurrent 8c) | 4.451    | 7.039    | 1770 | 🟢    | ⚪ stable at 4.88ms (±0.380ms) (7 runs)    |
| Competitive Workload Replica | create (Concurrent 8c)                   | 10.637   | 32.920   | 738  | 🟢    | ⚪ stable at 8.46ms (±2.19ms) (7 runs)     |
| Competitive Workload Replica | update (Concurrent 8c)                   | 8.746    | 12.495   | 901  | 🟢    | ⚪ stable at 8.86ms (±0.783ms) (7 runs)    |
| Competitive Workload Replica | mixed (Concurrent 8c 50/50)              | 6.969    | 10.411   | 1112 | 🟢    | ⚪ stable at 8.22ms (±2.26ms) (7 runs)     |
| Competitive Workload Replica | listFilterSort (Concurrent 8c)           | 2.386    | 3.853    | 3197 | ⚪    | 🟢 faster: 2.78ms → 2.39ms (-14%) (7 runs) |
...
| ----------------------------------- | ----- | ------------------ | ------- |
| COMPETITIVE WORKLOAD REPLICA (warm) | 🟢    | `▆▁▂▂▁▆█`          | 8.746ms |
