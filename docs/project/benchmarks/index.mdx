...
**2026-08-13 local SQLite rebaseline (rebuild `bun run build` first for HTTP turbo):**

| Metric                                | Result                                              |
| ------------------------------------- | --------------------------------------------------- |
| LocalCMS findById warm (L1)           | **~0.001 ms** · ~489k RPS                           |
| LocalCMS findById cold                | ~0.007 ms (≈ adapter)                               |
| LocalCMS create                       | ~0.094 ms · ~6.1k RPS                               |
| LocalCMS update                       | **~0.073 ms · ~7.3k RPS** (was ~0.44 ms)            |
| LocalCMS mixed C/U/R                  | ~0.225 ms                                           |
| HTTP findById **cold** (cache-busted) | **~2.4 ms** @ 8c                                    |
