...
| :-------------------------------------------------------- | :------ | :--------- | :------- | :------ | :-- | :----- |
| [ **SQLITE**](./benchmark_sqlite.mdx)                     | 🟢 PASS | 0ms        | —        | —       | —   | —      |
| [ **SQLITE+REDIS**](./benchmark_sqlite_redis.mdx)         | 🟢 PASS | 0ms        | —        | —       | —   | —      |
| [ **MONGODB**](./benchmark_mongodb.mdx)                   | 🟢 PASS | 0ms        | —        | —       | —   | —      |
| [ **MONGODB+REDIS**](./benchmark_mongodb_redis.mdx)       | ⚪ N/A  | -          | -        | -       | -   | -      |
| [ **POSTGRESQL**](./benchmark_postgresql.mdx)             | 🟢 PASS | 0ms        | —        | —       | —   | —      |
| [ **POSTGRESQL+REDIS**](./benchmark_postgresql_redis.mdx) | 🟢 PASS | 0ms        | —        | —       | —   | —      |
| [ **MARIADB**](./benchmark_mariadb.mdx)                   | 🟢 PASS | 0ms        | —        | —       | —   | —      |
| [ **MARIADB+REDIS**](./benchmark_mariadb_redis.mdx)       | 🟢 PASS | 0ms        | —        | —       | —   | —      |
