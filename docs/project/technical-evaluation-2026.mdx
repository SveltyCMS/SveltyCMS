...
- **Non-Destructive Editing:** Includes a native canvas-based editor with focal-point cropping and local manipulation via **Sharp**, maintaining full version history for all edits.
