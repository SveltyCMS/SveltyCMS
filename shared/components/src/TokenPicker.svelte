...
<script lang="ts">
	...
	import { modifierMetadata } from '@shared/services/token/modifiers';
	import { page } from '$app/state';
	import { collection, collectionValue } from '@shared/stores/collectionStore.svelte';
	...
	import type { TokenDefinition, ModifierMetadata } from '@shared/services/token/types';
