<!--
@file shared/components/src/imageEditor/widgets/Watermark/Controls.svelte
@component
Controls for the Watermark tool. 

Features:
- Adds a watermark to the image
- Deletes the watermark from the image
- Positions the watermark on the image
