/**
 * @file shared/database/src/seed.ts
...
import type { DatabaseAdapter, Theme, DatabaseId } from '@shared/database/dbInterface';
...
// @ts-ignore - shared/utils outside of rootDir
