...
<div
	class="my-6 overflow-hidden rounded-xl border border-surface-500/30 bg-surface-500/10 text-surface-100 shadow-lg dark:border-surface-500/40"
>
	<!-- Header Bar -->
	<div
		class="flex flex-wrap items-center justify-between gap-2 border-b border-surface-500/40 bg-surface-900/80 px-4 py-2.5"
	>
		...
		<div class="flex items-center gap-2">
			<!-- Language Tabs -->
			<div
				class="flex items-center gap-1 rounded-lg bg-surface-900/60 p-1"
				role="tablist"
			...
			>
				{#each availableLangs as lang (lang)}
					<button
						...
						class="rounded-md px-2.5 py-1 text-xs font-medium transition-colors {activeLang === lang
