	...
	>
		...
		<div class="flex flex-col gap-1 w-full max-w-[36rem] mx-auto flex-[1_1_10rem] max-w-64 mx-0">
			<div class="flex gap-2.5 items-center">
				...
				/>
				<div
					class="inline-flex flex-[0_0_auto] gap-0.5 items-center h-auto min-h-0 p-0.5 bg-[--editor-chrome-elevated] border border-[--editor-chrome-border] rounded-full shrink-0 px-0.5"
				>
					<label
						class="inline-flex gap-0 items-center justify-center h-7 min-w-[2.75rem] px-2 cursor-text"
					>
						<input
						...
						/>
						<span
							class="shrink-0 text-[11px] font-medium leading-none text-[rgba(255,255,255,0.92)]"
		...
		>
			...
			>
				<iconify-icon icon="mdi:image-size-select-actual" width="15" aria-hidden="true"
				></iconify-icon>
				<span>100%</span>
			</button>
		</div>
