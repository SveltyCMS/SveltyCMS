...
<div
	...
	role="toolbar"
	aria-label="Focal point controls"
>
	<div
	...
	>
		...
		>
			<span
				class="inline-flex flex-[0_0_auto] gap-1.5 items-center h-7 px-2.5 text-[11px] font-medium whitespace-nowrap cursor-default rounded-full text-white bg-white/10 border-white/14"
				aria-hidden="true"
			>
		...
		>
			<label
				class="inline-flex flex-[0_0_auto] gap-1.5 items-center h-7 px-2.5 text-[11px] font-medium text-[--editor-chrome-text] whitespace-nowrap cursor-default bg-transparent border border-transparent rounded-full"
				for="focal-x"
			>
				<span>X</span>
				<input
		...
		<span
			class="text-[10px] italic text-[rgba(255,255,255,0.4)] whitespace-nowrap gap-[0.35rem] items-center hidden sm:inline-flex"
		>
			<iconify-icon icon="mdi:mouse-left-click-outline" width="14" aria-hidden="true"
			></iconify-icon>
