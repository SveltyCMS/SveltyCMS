...
{#if show}
	...
	{#if showMedia}
		<div
			class="bg-surface-100-900 fixed left-[50%] top-[50%] z-[999999999] flex h-[90%] w-[95%] translate-x-[-50%] translate-y-[-50%] flex-col rounded border-[1px] border-surface-400 p-2"
		>
