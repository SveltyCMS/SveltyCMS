<!--
@file src/components/system/grid/Grid.svelte
@component
**Grid component for displaying items in a grid with drag-and-drop functionality**

@example
<Grid />

### Props
- `columnItems` {array} - Array of column objects
- `gridSettings` {object} - Object containing grid settings
- `onfinalize` {function} - Function to handle drag-and-drop finalize event
-->
