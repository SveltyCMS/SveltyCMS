...
<div class="space-y-6 max-w-full pb-32">
	...
	<!-- Info Alert -->
	<div class="alert preset-filled-tertiary-500 dark:preset-filled-primary-500/10 border-s-4 border-tertiary-500 dark:border-primary-500 rounded-lg p-4 mb-6">
