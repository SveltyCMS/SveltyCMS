<!--
@file src/components/widgets/group/Group.svelte
@component
**Group widget**

Displays a group of fields, either in a simple grouped layout or within tabs.

<Group bind:field={field} />

**Props:**
- `field` - {FieldType} - The field type definition for the group.
-->
		...
		<div class="mb-4">
			...
			<div class="flex flex-wrap items-center justify-center gap-1 overflow-auto">
				{#each field.fields as subField}
					{@const widgetPath = `/src/components/widgets/${subField.widget.Name.toLowerCase()}/${subField.widget.Name}.svelte`}
