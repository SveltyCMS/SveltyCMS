...
<input use:setFile
       ...
       type="file" />
<Cropper bind:SCALE={scale} bind:rotateDetails={rotateDetails} image={widgetValue?.[0]} bind:rotate={rotate} bind:blurs={blurs} bind:crop_left={crop_left} bind:crop_right={crop_right} bind:crop_top={crop_top} bind:crop_bottom={crop_bottom}/>
