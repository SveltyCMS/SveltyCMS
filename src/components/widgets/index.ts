...
const widgetsInit = {
	...
	MediaUpload, // MediaUpload - file upload field
	MegaMenu, // MegaMenu - mega menu field
	...
	RichText, // RichText - rich text editor field
	Seo, // Seo - SEO fields
	Text // Text - text field
};

// Initialize widgets immediately
let initializedWidgets = widgetsInit;
...
export function initWidgets(): void {
	try {
		initializedWidgets = { ...widgetsInit };
...
export const widgets = initializedWidgets;

// Create and initialize widgets object
const widgetsInstance = initializedWidgets;
