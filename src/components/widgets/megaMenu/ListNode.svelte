...
<button
	...
	class="header header-level-{level} relative mb-2 flex w-full min-w-[200px] cursor-default items-center justify-start gap-2 rounded border border-surface-300 px-1"
