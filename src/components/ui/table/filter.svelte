...
<div
	class="flex items-center justify-between gap-4 p-4 border-b border-surface-500/30 dark:border-surface-500/40 bg-surface-500/50 dark:bg-surface-900/50"
>
	...
	<div class="flex items-center gap-2">
		...
		<Button variant="primary" size="sm" leadingIcon="mingcute:add-line">New</Button>
	</div>
</div>
