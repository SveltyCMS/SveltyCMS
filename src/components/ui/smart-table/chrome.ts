...
export const SMART_TABLE_THEAD =
  "sticky top-0 z-10 border-b border-surface-500/30 bg-secondary-500/10 text-tertiary-500 dark:border-surface-500/40 dark:bg-surface-900 dark:text-primary-500";

/** Header cell label button row */
export const SMART_TABLE_TH =
  "border-e border-surface-500/30 px-2 py-2 text-center text-xs font-semibold uppercase tracking-wide dark:border-surface-600 sm:text-sm";

/** Body cell */
export const SMART_TABLE_TD =
  "border-e border-surface-500/30 px-2 py-2 text-center align-middle dark:border-surface-500/40";

/** Sticky pagination footer (matches entry-list) */
export const SMART_TABLE_PAGINATION_BAR =
  "sticky bottom-0 z-10 mt-1 flex shrink-0 flex-col items-center justify-center border-t border-surface-500/30 bg-secondary-500/10 py-2 dark:border-surface-500/40 dark:bg-surface-800 md:flex-row md:justify-between md:gap-3 md:px-4 md:py-3";

/** Selected row highlight */
export const SMART_TABLE_ROW_SELECTED = "bg-tertiary-500/10 dark:bg-primary-500/10";

/** Hover row (non-selected) */
export const SMART_TABLE_ROW_HOVER =
  "transition-colors hover:bg-surface-500/10 dark:hover:bg-surface-900/20";

/** Column manager strip (DnD) */
export const SMART_TABLE_COLUMN_MANAGER =
  "flex flex-col justify-center rounded-t-md border-b border-surface-500/30 bg-surface-500/10 p-2 text-center dark:border-surface-500/40 dark:bg-surface-800";
...
export const SMART_TABLE_PIN_START =
  "sticky inset-s-0 z-[5] bg-white shadow-[2px_0_4px_-2px_rgba(0,0,0,0.12)] dark:bg-surface-900";

/** Sticky pin: logical end edge (actions column) */
export const SMART_TABLE_PIN_END =
  "sticky end-0 z-[5] bg-white shadow-[-2px_0_4px_-2px_rgba(0,0,0,0.12)] dark:bg-surface-900";
