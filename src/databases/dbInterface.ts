...
export interface DatabaseId {
	toString(): string;
	equals(otherId: DatabaseId): boolean;
}
...
export interface CollectionModel {
	modelName: string;
	find(query: Record<string, unknown>): Promise<DocumentContent[]>;
	updateOne(query: Record<string, unknown>, update: Record<string, unknown>): Promise<DocumentContent>;
	updateMany(query: Record<string, unknown>, update: Record<string, unknown>): Promise<DocumentContent[]>;
	insertMany(docs: DocumentContent[]): Promise<DocumentContent[]>;
	deleteOne(query: Record<string, unknown>): Promise<number>;
	deleteMany(query: Record<string, unknown>): Promise<number>;
...
export interface dbInterface {
	...
	findOne(collection: string, query: Record<string, unknown>): Promise<DocumentContent>; // Find one document from a collection
	findMany(collection: string, query: Record<string, unknown>): Promise<DocumentContent[]>; // Find multiple documents from a collection
	insertOne(collection: string, doc: DocumentContent): Promise<DocumentContent>; // Insert one document into a collection
	insertMany(collection: string, docs: DocumentContent[]): Promise<DocumentContent[]>; // Insert many documents into a collection
	updateOne(collection: string, query: Record<string, unknown>, update: Record<string, unknown>): Promise<DocumentContent>; // Update only one document in a collection
	updateMany(collection: string, query: Record<string, unknown>, update: Record<string, unknown>): Promise<DocumentContent[]>; // Update many documents in a collection
	deleteOne(collection: string, query: Record<string, unknown>): Promise<number>; // Delete documents in a collection
	deleteMany(collection: string, query: Record<string, unknown>): Promise<number>; // Delete documents in a collection
	countDocuments(collection: string, query?: Record<string, unknown>): Promise<number>; // Count documents in a collection
	convertId(id: string): DatabaseId; // Convert mongo ObjectId to string
