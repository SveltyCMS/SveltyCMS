...
export const BUILT_IN_BLUEPRINTS: ImportBlueprint[] = [
  ...
  },
  {
    ...
    name: "WooCommerce Products → Products",
    description:
      "WooCommerce WXR or REST catalog import with variants nested, SKU, price, sale price, and stock.",
    version: "2.1.0",
    ...
    fieldMappings: [
      ...
      {
        sourceField: "inventoryQuantity",
        targetField: "inventoryQty",
        widgetType: "number",
        confidence: "high",
        action: "map",
      },
