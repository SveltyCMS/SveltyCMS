---
path: "src/plugins/smart-importer/docs/drupal-migration"
...
| :--------------------------- | :---------------------------- | :------------------------------------------------------------------------------------------------------ |
| **Views**                    | Database queries, not content | [Smart Table](/docs/reference/components/smart-table) — filtered + sorted collection lists              |
| **Rules / Workflows**        | PHP logic                     | [Automations](/docs/guides/content/automations.mdx) — event-driven tasks                                |
| **Custom Modules**           | PHP code                      | [Plugins](/docs/reference/architecture/plugin-architecture.mdx) or [Widgets](/docs/development/widgets) |
| **Themes**                   | Twig/PHP templates            | [Design System](/docs/guides/configuration/admin-theme-settings) — admin theme + Tailwind v4            |
...
| **Webforms**                 | Custom form builder           | [BuzzForm Builder](/docs/guides/content/collection-builder.mdx) — visual form builder                   |
| **Paragraphs**               | Nested entity references      | Imported as `rawCustomFields` — restructure into Group widgets after import                             |
| **Layout Builder**           | Visual layout system          | [Storyblok-style slices](/docs/development/widgets) — component-based layouts                           |
...
### Step 2 — Export from Drupal {#method-b-step-2-export}
...
### Step 3 — Import into SveltyCMS {#method-b-step-3-import}
...
Use the [Migration Control Plane](/docs/plugins/smart-importer#partial-selective-migration) to import selectively:
...
- [Collection Builder Guide](/docs/guides/content/collection-builder.mdx)
