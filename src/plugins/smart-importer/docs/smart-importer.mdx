---
path: "src/plugins/smart-importer/docs/smart-importer"
id: "smart-importer"
title: "Smart AI-Driven Migration Pro"
description: "Enterprise Universal Content Pipeline — 36+ platforms, AI mapping, visual wizard, background jobs, audit logging, PII scrubbing."
category: "Migration"
version: "2.1.0"
...
A comprehensive migration tool for headless CMS platforms — supporting 36+ source platforms, spreadsheets, databases, APIs, and Markdown — with AI-guided field mapping, visual transformation, background jobs, and enterprise-grade security.
...
bun run migrate scaffold --file=products.csv --format=csv
...
### Import Features (All Tiers)

| #   | Feature                                                                   |
| :-- | :------------------------------------------------------------------------ |
| 1   | Auto-detect 36+ CMS platforms + CSV/Markdown/SQL/API                      |
...
- [Drupal → SveltyCMS Step-by-Step Guide](./drupal-migration.mdx)
- [WordPress → SveltyCMS Step-by-Step Guide](./wordpress-migration.mdx)
