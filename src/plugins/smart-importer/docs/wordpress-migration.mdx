...
| :-------------------------------------- | :------------------------ | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Plugins** (Yoast, checkout PHP, etc.) | PHP code, not data        | [Plugins](/docs/guides/development/plugin/architecture.mdx) — Stripe, SEO, etc. WooCommerce **catalog data** does migrate (see [WooCommerce Products](#woocommerce-products) below). |
...
Imported SKUs land in the ecommerce **preset** `products` collection. Add the **Commerce Inventory** dashboard widget (14-day trial) to watch low stock — see [E-Commerce Overview](/docs/reference/architecture/ecommerce-overview.mdx). Checkout PHP / cart sessions do **not** migrate; those belong in the optional Commerce plugin.
