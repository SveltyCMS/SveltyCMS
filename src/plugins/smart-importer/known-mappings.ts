...
export const KNOWN_MAPPINGS: Record<string, KnownFieldMapping[]> = {
  wordpress: [
    ...
    { source: "content:encoded", target: "content", confidence: 90, type: "richtext" },
    { source: "excerpt:encoded", target: "excerpt", confidence: 85, type: "text" },
    { source: "wp:post_name", target: "slug", confidence: 90, type: "text" },
    { source: "wp:status", target: "status", confidence: 85, type: "select" },
    { source: "wp:post_date", target: "createdAt", confidence: 90, type: "date" },
    { source: "wp:post_modified", target: "updatedAt", confidence: 90, type: "date" },
    { source: "dc:creator", target: "author", confidence: 75, type: "text" },
    { source: "wp:post_parent", target: "parentId", confidence: 70, type: "relation" },
    { source: "wp:menu_order", target: "order", confidence: 70, type: "number" },
    { source: "_thumbnail_id", target: "featuredImage", confidence: 80, type: "media" },
    { source: "category", target: "categories", confidence: 85, type: "taxonomy" },
  ...
  drupal: [
    ...
    { source: "field_summary", target: "excerpt", confidence: 80, type: "text" },
    ...
    { source: "field_category", target: "categories", confidence: 85, type: "taxonomy" },
    { source: "field_image", target: "featuredImage", confidence: 80, type: "media" },
    { source: "field_media", target: "featuredImage", confidence: 75, type: "media" },
  ],
  strapi: [
    { source: "title", target: "title", confidence: 95, type: "text" },
    ...
    { source: "published_at", target: "publishedAt", confidence: 85, type: "date" },
  ...
  directus: [
    ...
    { source: "date_created", target: "createdAt", confidence: 90, type: "date" },
    { source: "date_updated", target: "updatedAt", confidence: 90, type: "date" },
    { source: "image", target: "featuredImage", confidence: 80, type: "media" },
  ],
  sveltycms: [
    { source: "title", target: "title", confidence: 95, type: "text" },
