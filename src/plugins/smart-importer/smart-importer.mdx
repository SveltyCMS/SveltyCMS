---
path: "src/plugins/smart-importer/smart-importer"
id: "smart-importer"
...
pricing: "Free for 5 platforms + universal formats; Pro tier unlocks all 36 platforms + enterprise features"
tags: [migration, AI, wordpress, drupal, contentful, sanity, shopify, headless]
updated: "2026-09-22"
---

# Smart AI-Driven Migration Pro

A comprehensive migration tool for headless CMS platforms — supporting 40+ source platforms, spreadsheets, databases, APIs, and Markdown — with AI-guided field mapping, visual transformation, background jobs, and enterprise-grade security.
...
**E-commerce:** Shopify, WooCommerce (WXR + REST JSON), Magento, PrestaShop, OpenCart

Catalog imports target the optional ecommerce **preset** (`products` + variants). WooCommerce: `--format=woocommerce` (WXR or REST JSON). Shopify: `--format=shopify`. After import, add the **Commerce Orders** and **Commerce Inventory** dashboard widgets (freemium, 14-day trial) from the admin dashboard picker. Map: [E-Commerce Overview](/docs/guides/content/ecommerce.mdx). Checkout sessions / PHP carts are **not** imported — enable the optional Commerce plugin for guest checkout.
...
- [Plugin Architecture](/docs/reference/architecture/plugin-architecture.mdx)
- [Marketplace System](/docs/reference/architecture/marketplace.mdx)
- [AI Integration](/docs/development/ai-integration.mdx)
- [Token System](/docs/reference/architecture/token-system.mdx)
