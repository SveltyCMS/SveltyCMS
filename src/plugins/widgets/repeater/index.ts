/**
 * @file src/widgets/custom/Repeater/index.ts
...
import { array, maxLength, minLength, nullable, object, pipe } from "valibot";
import type { RepeaterProps } from "./types";

// ...

// Helper to generate schema for a single row based on defined fields
const validationSchema = (field: FieldInstance & RepeaterProps) => {
...
const RepeaterWidget = createWidget<RepeaterProps>({
  ...
  displayComponentPath: "/src/widgets/custom/repeater/display.svelte",
  validationSchema,
