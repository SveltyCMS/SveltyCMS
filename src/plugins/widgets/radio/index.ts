/**
 * @file src/widgets/custom/Radio/index.ts
...
const RadioWidget = createWidget<RadioProps>({
  ...
  inputComponentPath: "/src/widgets/custom/radio/input.svelte",
  displayComponentPath: "/src/widgets/custom/radio/display.svelte",
