...
class ContentManager {
	...
	// Wait for initialization to complete (noop for now, can be extended for async init logic)
	async waitForInitialization(): Promise<void> {
		// No-op: placeholder for future async initialization logic if needed
		return;
	}
