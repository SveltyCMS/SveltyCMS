...
<div class="ai-status">
	...
	>
		<iconify-icon
			...
			width={14}
			class="ai-status__icon ai-status__icon--{statusInfo.color}"
		></iconify-icon>
	...
	{#if isExpanded && capabilities}
		<div class="ai-status__detail" role="tooltip">
			<div class="ai-status__detail-row">
				<span>Runtime</span>
				<span
					class="ai-status__detail-value {capabilities.runtimeReady
						? 'text-success'
						: 'text-danger'}"
				>
			...
			<div class="ai-status__detail-row">
				<span>WebGPU</span>
				<span
					class="ai-status__detail-value {capabilities.webgpu ? 'text-success' : 'text-danger'}"
				>
			...
			<div class="ai-status__detail-row">
				<span>WebNN (NPU)</span>
				<span
					class="ai-status__detail-value {capabilities.webnn ? 'text-success' : 'text-surface'}"
				>
			...
			<div class="ai-status__detail-row">
				...
				<span
					class="ai-status__detail-value {capabilities.xnnpack ? 'text-success' : 'text-surface'}"
				>
...
<style>
	...
	.ai-status__icon--success {
		color: #22c55e;
	}
	.ai-status__icon--warning {
		color: #eab308;
	}
	.ai-status__icon--danger {
		color: #ef4444;
	}
	.ai-status__icon--surface {
		color: #a1a1aa;
	}
