...
<script lang="ts">
	...
	function toggleAiMode() {
		if (aiDashboardSpec) {
			...
			// Provide a mock AI layout. In production, this would be streamed from the MCP server.
			aiDashboardSpec = {
				root: 'layout',
				elements: {
					layout: {
					...
					header: {
						...
						options: {
							widget: 'Text',
							content: 'This unique dashboard structure was generated by SveltyCMS AI via MCP in response to a natural language prompt.'
						}
					},
					users: {
						type: 'Control',
						...
						label: 'Mock List',
						options: { widget: 'Text', content: 'List widget placeholder inside the generative layout.' }
					}
				}
			} as unknown as Spec;
		}
