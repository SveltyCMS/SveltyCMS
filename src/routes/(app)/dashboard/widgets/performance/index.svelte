<!--
@file src/routes/(app)/dashboard/widgets/performance/index.svelte
@component
					...
					<div class="flex-1 grid grid-cols-1 gap-4 text-sm">
						...
						<div class="space-y-2">
							...
							<div class="flex justify-between items-center bg-surface-500/10 dark:bg-surface-800 rounded px-4 py-2.5 border border-transparent dark:border-surface-500/40">
								...
								<span class="font-mono font-semibold tabular-nums text-[var(--admin-text-body)]">{formatNumber(metrics.requests.total)}</span>
							</div>
							<div class="flex justify-between items-center bg-surface-500/10 dark:bg-surface-800 rounded px-4 py-2.5 border border-transparent dark:border-surface-500/40">
