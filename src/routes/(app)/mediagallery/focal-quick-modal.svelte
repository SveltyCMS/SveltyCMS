...
{#if show}
	...
	>
		...
		>
			<!-- Header -->
			<header
				class="flex items-center justify-between border-b border-surface-500/30 p-4 dark:text-surface-50"
			>
			...
			<div class="p-4">
				...
				>
					...
					>
						<!-- Outer glow -->
						<div
							class="absolute inset-0 w-8 h-8 rounded-full bg-tertiary-500 dark:bg-primary-500/20 blur-sm -translate-x-1/2 -translate-y-1/2"
						></div>
						<!-- Crosshair icon -->
						<iconify-icon
							icon="mdi:crosshairs-gps"
							width="32"
							class="text-tertiary-500 dark:text-primary-500 drop-shadow-lg relative z-10"
						></iconify-icon>
					</div>
				</div>
			...
			<!-- Footer -->
			<footer
				class="flex items-center justify-between border-t border-surface-500/30 p-4 dark:text-surface-50"
			>
