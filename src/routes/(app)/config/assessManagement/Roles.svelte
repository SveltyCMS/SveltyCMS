<script lang="ts">
	...
	import { authInterface } from '@src/auth/authInterface';
	import type { Role, RoleTemplate } from '@src/auth/types';
...
<div class="my-4">
	...
	<div class="mb-4">
		...
		<div class="mt-2">
			<select bind:value={selectedTemplate} on:change={() => applyTemplate(selectedTemplate)} class="rounded border p-2">
