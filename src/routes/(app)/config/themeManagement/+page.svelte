...
{#if customThemes.length === 0}
	<p class="text-tertiary-500 dark:text-primary-500 my-2 text-center sm:text-left">
	...
	<a
		...
		class="preset-tonal-primary border-primary-500 btn w-full gap-2 border py-6"
	>
