...
<div class="wrapper mb-2 max-h-[calc(100vh-65px)] overflow-auto">
	<h2 class="text-tertiary-600 dark:text-primary-500 mb-4 text-center font-bold">{m.config_body()}</h2>
	<div class="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4 dark:text-white">
		<!-- Collection -->
		<PermissionGuard config={permissionConfigs.collectionbuilder}>
			<a href="/config/collectionbuilder" class="btn border text-center" aria-label={m.config_collectionbuilder()}>
		...
		<PermissionGuard config={permissionConfigs.graphql}>
			<a href="/api/graphql" target="_blank" rel="noopener noreferrer" aria-label={m.config_graphql()} class="btn border text-center">
		...
		<PermissionGuard config={permissionConfigs.imageeditor}>
			<a href="/imageEditor" aria-label={m.config_imageeditor()} class="btn border text-center">
		...
		<PermissionGuard config={permissionConfigs.dashboard}>
			<a href="/dashboard" class="btn border py-4 text-center" aria-label={m.config_Dashboard()}>
		...
		<a
			...
			class="btn bg-primary-500 py-4 text-center text-black"
			aria-label={m.config_Martketplace()}
		>
			<iconify-icon icon="icon-park-outline:shopping-bag" class="text-3xl lg:text-2xl"></iconify-icon>
		...
		<PermissionGuard config={permissionConfigs.widgetManagement}>
			<a href="/config/widgetManagement" aria-label="Widget Management" class="btn bg-primary-500 py-4 text-center text-black">
				<iconify-icon icon="mdi:widgets" class="text text-3xl lg:text-2xl"></iconify-icon>
		...
		<PermissionGuard config={permissionConfigs.themeManagement}>
			<a href="/config/themeManagement" aria-label="Theme Management" class="btn bg-primary-500 py-4 text-center text-black">
				<iconify-icon icon="ph:layout" class="text-3xl lg:text-2xl"></iconify-icon>
		...
		<PermissionGuard config={permissionConfigs.settings}>
			<a href="/config/systemsetting" aria-label="System Settings" class="btn bg-error-500 py-4 text-center text-white">
				<iconify-icon icon="uil:setting" class="text-3xl lg:text-2xl"></iconify-icon>
		...
		<PermissionGuard config={permissionConfigs.accessManagement}>
			<a href="/config/assessManagement" aria-label="Access Management" class="btn bg-error-500 py-4 text-center text-white">
				<iconify-icon icon="mdi:account-group" class="text-3xl lg:text-2xl"></iconify-icon>
