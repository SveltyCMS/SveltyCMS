	...
	<div class="space-y-5 text-surface-100">
		<div class="rounded-2xl border border-surface-200-800 bg-surface-100-900 p-4 shadow-sm">
			...
			<button
				...
				class="flex w-full items-center justify-between rounded-xl border border-surface-200-800 bg-surface-50-950 px-4 py-3 text-start transition-colors hover:border-primary-500/60 hover:bg-surface-100-900"
