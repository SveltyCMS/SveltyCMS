				...
				{#if widget.pillar}
					<div class="flex items-center gap-4 pt-1 text-xs text-surface-500">
						<div class="flex items-center gap-1" title="Input Component">
							<iconify-icon icon="mdi:form-textbox" width={24}></iconify-icon>
							<span>Input</span>
						</div>
						<div class="flex items-center gap-1" title="Display Component">
							<iconify-icon icon="mdi:monitor-dashboard" width={24}></iconify-icon>
							<span>Display</span>
						</div>
						<div class="flex items-center gap-1" title="Database/Validation">
							<iconify-icon icon="mdi:database-check" width={24}></iconify-icon>
							<span>DB/Valid</span>
						</div>
					</div>
				{/if}
