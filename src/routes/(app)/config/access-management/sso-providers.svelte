			...
			<div class="border-t border-surface-500/20 pt-4 space-y-4">
				<div class="flex items-center justify-between">
					...
					<label class="flex items-center gap-2 cursor-pointer">
						<input aria-label="Enable JIT Provisioning" type="checkbox" bind:checked={formJitProvisioning} class="rounded border-surface-500/30 text-tertiary-500 focus:ring-tertiary-500" />
				...
				{#if formJitProvisioning}
					<div class="grid grid-cols-1 md:grid-cols-3 gap-4 p-3 rounded bg-surface-500/10 border border-surface-500/20">
						...
						<div class="flex items-center pt-5">
							<label class="flex items-center gap-2 cursor-pointer">
								<input aria-label="Synchronize roles on each login" type="checkbox" bind:checked={formSyncRolesOnLogin} class="rounded border-surface-500/30 text-tertiary-500 focus:ring-tertiary-500" />
