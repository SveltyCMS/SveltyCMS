...
### Features
- Dynamic title, description, and tips based on active tool
- Quick action buttons for resetting and applying changes
- Keyboard shortcut hints for common actions
-->
