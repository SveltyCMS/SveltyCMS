...
<style lang="postcss">
	...
	.select-input {
		@apply rounded-md border px-2 py-1.5 text-sm;
	...
	.slider {
		@apply h-2 w-48 cursor-pointer appearance-none rounded-full;
	...
	.value {
		@apply min-w-[2.5rem] text-right text-sm font-semibold;
