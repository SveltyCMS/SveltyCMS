...
{#each $categories as category, index}
	<div
		class="tooltip_right arrow relative mb-1 h-[40px] cursor-pointer overflow-visible rounded-sm bg-[#363b4e] bg-surface-600 py-2 text-center text-white"
...
{/each}
{#if modeSet == 'edit'}
	<button class="variant-ghost-primary btn mt-2 w-full" on:click={saveConfig}>Save Collections</button>
{/if}
