			...
			<div class="z-0 mx-auto mb-[5%] mt-[15%] w-full overflow-y-auto rounded-md bg-white p-4 lg:w-4/5" class:hide={active !== 0}>
				...
				{#if !PWforgot && !PWreset}
					...
					<div class="mt-4 flex flex-col items-center gap-2 sm:flex-row sm:justify-between">
						...
						<div class="flex w-full justify-between gap-2 sm:w-auto">
							<button type="submit" form="signin-form" class="bg-surface-500 text-white btn w-full sm:w-auto" aria-label={m.form_signin()}>
								{m.form_signin()}
						...
						<div class="mt-4 flex w-full justify-between sm:mt-0 sm:w-auto">
							<button
								type="button"
								class="ring-2 ring-surface-500 btn w-full text-black sm:w-auto"
					...
					<div class="flex w-full flex-col gap-4">
						...
						<div class="flex flex-col gap-3">
							...
							<div class="flex gap-3">
								<button type="button" onclick={back2FAToLogin} class="bg-surface-100 text-surface-900 dark:bg-surface-900 dark:text-surface-100 btn flex-1">
								...
								<button
									...
									class="bg-primary-500 text-white btn flex-1"
								>
									{#if isVerifying2FA}
				...
				{#if PWforgot && !PWreset}
					...
					>
						...
						<div class="mt-4 flex items-center justify-between">
							<button type="submit" class="bg-surface-500 text-white btn" aria-label={m.form_resetpassword()}>
							...
							<button
								type="button"
								class="bg-surface-500 text-white btn-icon"
								aria-label="Back"
								onclick={() => {
									PWforgot = false;
									PWreset = false;
				...
				{#if PWforgot && PWreset}
					...
					>
						...
						<div class="mt-4 flex items-center justify-between">
							<button type="submit" aria-label={m.signin_savenewpassword()} class="bg-surface-500 text-white btn ml-2 mt-6">
