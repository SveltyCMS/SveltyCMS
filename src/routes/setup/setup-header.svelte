							...
							<div class="custom-scrollbar max-h-64 overflow-y-auto">
								{#each filteredLanguages as lang (lang)}
									<button
										...
										class="flex w-full items-center justify-between px-3 py-2 text-start rounded-md cursor-pointer hover:bg-surface-200/60 dark:hover:bg-surface-700/60 transition-colors"
									>
