...
{#if $modalStore[0]}
	<div class="card mx-auto max-w-lg space-y-4 p-4 lg:p-8">
		<header class="card-header flex flex-col items-center justify-center space-y-4 text-center">
		...
		<section class="space-y-4 p-4 text-center">
