...
- ✅ **Tiptap-Powered**: Built on Tiptap 3.x for superior extensibility and performance
...
- ✅ **Global Accessibility (RTL)**: Native Right-to-Left detection and optimized alignment for Middle Eastern locales
- ✅ **Dynamic Logic**: High-performance NodeView stability for custom interactive widgets
...
- **Directional UI**: The Tiptap 3.x engine applies `dir="rtl"` to the content editable area, with improved ghost image positioning for drag handles in mixed-direction content.
...
- ✅ Enhanced RTL drag-and-drop stability
- ✅ Improved NodeView re-rendering logic
- ✅ Markdown roundtrip HTML entity decoding fixes
