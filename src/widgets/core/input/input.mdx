...
title: 'Input Widget'
description: 'A versatile text input widget with dynamic validation and support for various input types.'
order: 1
...
For more information on widget development, see the [Widget Architecture Guide](/docs/dev-guide/widget-architecture).
