...
description: 'Enterprise-grade Tiptap-based WYSIWYG editor with configurable toolbar and secure HTML storage for SveltyCMS'
order: 101
...
<blockquote>
	**Enterprise WYSIWYG editor** powered by Tiptap with configurable toolbar, multilingual support, and secure HTML storage for rich content editing.
</blockquote>
