/**
 * @file src/widgets/core/email/index.ts
...
const blockDisposableEmail = custom<string>((input: any) => {
...
const validationSchema = (field: FieldInstance) => {
  ...
  if (field.required) {
    return pipe(string(), minLength(1, "Email is required"), base);
  }
...
const EmailWidget = createWidget<EmailProps>({
  ...
  displayComponentPath: "/src/widgets/core/email/display.svelte",
  validationSchema,
