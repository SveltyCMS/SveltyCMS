...
description: 'Enterprise media selector with modal library, drag-and-drop upload, and multi-file support for SveltyCMS'
order: 104
...
<blockquote>
	**Enterprise media management widget** with modal-based library, drag-and-drop upload, multi-file support, and optimized file reference storage.
</blockquote>
