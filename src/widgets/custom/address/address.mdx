...
<blockquote>
	**Enterprise address input widget** with optional Mapbox integration for interactive mapping, geocoding, and structured address data storage.
</blockquote>
...
- ✅ **Validation**: Valibot schema ensures complete, valid addresses
...
The Address widget is part of SveltyCMS and is licensed under the MIT License.
