---
path: "src/widgets/custom/date-range/daterange.mdx"
...
- Input component: ` $args[0].Value.ToLower() — editor UI with two native date inputs and simple presets.
- Display component: ` $args[0].Value.ToLower() — renders a compact, localized date-range string plus duration/context.
...
- ` $args[0].Value.ToLower() — component source and validation schema
