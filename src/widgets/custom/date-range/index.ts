/**
 * @file src/widgets/custom/Daterange/index.ts
...
const DateRangeWidget = createWidget<DateRangeProps>({
  ...
  inputComponentPath: "/src/widgets/custom/date-range/input.svelte",
  displayComponentPath: "/src/widgets/custom/date-range/display.svelte",
...
export type DateRangeWidgetData = ValibotInput<ReturnType<typeof createValidationSchema>>;
