...
description: 'Enterprise-grade currency input widget with locale-aware formatting, numeric storage, and calculation support for SveltyCMS'
order: 301
...
<blockquote>
	**Enterprise currency input widget** that stores precise numeric values while displaying and accepting localized, formatted currency strings with
	proper symbols and thousand separators.
</blockquote>
