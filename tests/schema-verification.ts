...
const fieldRemoved = comparison.changes.find(
  (c) => c.type === "field_removed" && c.fieldName === "description",
);
const requiredAdded = comparison.changes.find(
  (c) => c.type === "required_added" && c.fieldName === "title",
);
