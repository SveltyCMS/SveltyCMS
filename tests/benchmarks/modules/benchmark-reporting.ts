 ...
 */
import { persistRun, loadHistory, type HistoryEntry } from "./benchmark-history";
...
export async function computeAndApplyTrend(result: any, shortLabel?: string): Promise<void> {
